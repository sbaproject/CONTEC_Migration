...
Module AE_PROC
    ...
    Public Function AE_Change(ByRef PP As clsPP, ByRef CP As clsCP, ByRef Ct As Control _
                              , Optional ByRef pFormLoadFlag As Boolean = True) As Boolean
        '2019/03/26 CHG E N D

        '2019/03/26 ADD START
        If pFormLoadFlag = False Then
            Return False
        End If
...
AE_ChangeRet:
            ...
            DirectCast(Ct, TextBox).SelectionLength = PP.Override
            '2019/03/26 CHG E N D
            'V6.45 で、この上に移動。
        ...
        If wk_Tx < 0 Or wk_Tx >= PP.ControlsC Then
            ...
            If CP.TypeA = Cn_NormalOrV Then DirectCast(Ct, TextBox).SelectionLength = PP.Override
            '2019/03/26 CHG E N D
            Exit Function '--------------------
        End If
        '
        ...
        wk_SSorg = DirectCast(Ct, TextBox).SelectionStart 'V4.30
        '2019/03/26 CHG E N D
            ...
            If wk_AutoEnter = 1 And wk_BeepSw = False Then
                ...
                ElseIf CP.FixedFormat <> 1 And (wk_Ln2 >= wk_MaxLB Or wk_Ln2 >= wk_MaxLB - 1 And (CP.FormatClass = Cn_Snum Or CP.FormatClass = Cn_Schn) And InStr(wk_NewTxt, "-") = 0) And wk_MaxLB > 0 Then  'V6.48 'V6.50N '符数類
                    ...
                    ElseIf Not AE_SSSWin Then  'V4.24
                        ...
                        If (CP.FormatClass <> Cn_Snum And CP.FormatClass <> Cn_Schn) Or wk_MaxLB <> 2 Or ((Ct.Text) <> " -" And (Ct.Text) <> "  -") Then wk_ItemFlag = True 'V6.48 'V6.50N '符数類
                        '2019/03/26 CHG E N D
                    End If
...
AE_ChangeReFormat:
        ...
        Ct.ForeColor = ColorTranslator.FromWin32(AE_Color(Cn_Status1)) 'Incomplete
        '2019/03/26 CHG E N D
        ...
        If CP.TypeA = Cn_NormalOrV Or CP.TypeA = Cn_InputOnly Then Ct.BackColor = ColorTranslator.FromWin32(PP.BrightOnOff)
        '2019/03/26 CHG E N D
        '
    ...
    Public Sub AE_CtSet(ByRef PP As clsPP, ByVal pm_Px As Short, ByVal pm_Txt As String, ByVal pm_TypeA As Short, ByVal pm_DeSetSw As Boolean)
        ...
        Select Case pm_TypeA
            Case Cn_NormalOrV
                ...
                wk_SS = DirectCast(AE_Controls(PP.CtB + wk_Tx), TextBox).SelectionStart
                ...
                DirectCast(AE_Controls(PP.CtB + wk_Tx), TextBox).Text = pm_Txt
                '2019/03/25 CHG E N D
                'UPGRADE_WARNING: オブジェクト AE_Controls().SelStart の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                '2019/03/25 CHG START
                'AE_Controls(PP.CtB + wk_Tx).SelStart = wk_SS
                DirectCast(AE_Controls(PP.CtB + wk_Tx), TextBox).SelectionStart = wk_SS
                '2019/03/25 CHG E N D
            Case Cn_OutputOnly
                ...
                If TypeOf AE_Controls(PP.CtB + wk_Tx) Is System.Windows.Forms.Label Then
                    DirectCast(AE_Controls(PP.CtB + wk_Tx), Label).Text = pm_Txt 'V4.31
                End If
                '2019/03/25 CHG E N D
            Case Cn_OptionButtonH, Cn_OptionButtonC
                If Trim(pm_Txt) = "" Then
                    ...
                    Do While wk_Tx + wk_PxTx < PP.ControlsC 'V4.18
                        ...
                        DirectCast(AE_Controls(PP.CtB + wk_Tx + wk_PxTx), RadioButton).Checked = False
                        '2019/03/25 CHG E N D
                ...
                Else
                    ...
                    DirectCast(AE_Controls(PP.CtB + wk_Tx + CShort(pm_Txt)), RadioButton).Checked = True
                    '2019/03/25 CHG E N D
                End If
            Case Cn_CheckBox
                If Trim(pm_Txt) = "1" Then
                    ...
                    DirectCast(AE_Controls(PP.CtB + wk_Tx), CheckBox).Checked = True
                    '2019/03/25 CHG E N D
                Else
                    'UPGRADE_WARNING: オブジェクト AE_Controls(PP.CtB + wk_Tx) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    '2019/03/25 CHG START
                    'AE_Controls(PP.CtB + wk_Tx) = "0"
                    DirectCast(AE_Controls(PP.CtB + wk_Tx), CheckBox).Checked = False
                    '2019/03/25 CHG E N D
                End If
            Case Else 'Cn_InputOnly, Cn_ListBox 'V4.18
                If Trim(pm_Txt) = "" Then
                    ...
                    DirectCast(AE_Controls(PP.CtB + wk_Tx), ListBox).SelectedIndex = -1 'Null 値の場合の位置。
                    '2019/03/25 CHG E N D
                Else
                    wk_PxTx = 0
                    ...
                    Do While wk_PxTx < DirectCast(AE_Controls(PP.CtB + wk_Tx), ListBox).Items.Count
                        '2019/03/25 CHG E N D
                        ...
                        If Trim(DirectCast(AE_Controls(PP.CtB + wk_Tx), ListBox).Items(wk_PxTx)) = Trim(pm_Txt) Then
                            '2019/03/25 CHG E N D
                            'UPGRADE_WARNING: オブジェクト AE_Controls().ListIndex の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                            '2019/03/25 CHG START
                            'AE_Controls(PP.CtB + wk_Tx).ListIndex = wk_PxTx
                            DirectCast(AE_Controls(PP.CtB + wk_Tx), ListBox).SelectedIndex = wk_PxTx
                            '2019/03/25 CHG E N D
                            GoTo AE_CtSetLabel1 '---------->
                        End If
                        wk_PxTx = wk_PxTx + 1
...
AE_CtSetLabel1:
    ...
    Public Sub AE_EScrlMax(ByRef PP As clsPP)
        ...
        If PP.AllowNullDes Then 'V6.47B
            ...
            AE_EScrlBar(PP.ScX).Maximum = wk_Limit - PP.MaxEDspC 'V6.47B, 'V6.46S
            '2019/03/25 CHG E N D
        ElseIf wk_Max > PP.ReadableMaxEDe - PP.MaxEDspC Then  'V4.28
            'UPGRADE_WARNING: オブジェクト AE_EScrlBar().Max の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '2019/03/25 CHG START
            'AE_EScrlBar(PP.ScX).Max = wk_Max 'V4.28
            AE_EScrlBar(PP.ScX).Maximum = wk_Max 'V4.28
            '2019/03/25 CHG E N D
        Else 'V4.28
            'UPGRADE_WARNING: オブジェクト AE_EScrlBar().Max の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '2019/03/25 CHG START
            'AE_EScrlBar(PP.ScX).Max = PP.ReadableMaxEDe - PP.MaxEDspC 'V4.28
            AE_EScrlBar(PP.ScX).Maximum = PP.ReadableMaxEDe - PP.MaxEDspC 'V4.28
            '2019/03/25 CHG E N D
        End If 'V4.28
    End Sub
...
#Enable Warning BC40000 ' Type or member is obsolete
                    ...
                    ElseIf CP.FixedFormat = 1 And Left(st_Work, 1) >= "1" And Left(st_Work, 1) <= "9" Then  'V4.15
                        ...
                        Else 'V4.22
                            ...
                            'st_Workが時刻の場合の処理追加
                            If IsDate("01/01/01 " + st_Work) = True Then
                                st_Work = st_Work 'V4.22
                            Else
                                wk_FormatDate = CDate(st_Work)
                                If wk_FormatDate < #1/1/1000# Then 'V4.22
                                    st_Work = "0" & st_Work 'V4.22
                                Else 'V4.22
                                    st_Work = st_Work 'V4.22
...
#Disable Warning BC40000 ' Type or member is obsolete
                '20190828 CHG START
                'st_Work = VB6.Format(pm_Value, CP.FormatChr) 'V6.50F
                st_Work = String.Format(pm_Value, CP.FormatChr) 'V6.50F
                '20190828 CHG END
#Enable Warning BC40000 ' Type or member is obsolete
            End If
            'UPGRADE_WARNING: オブジェクト LenWid() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
...
#Enable Warning BC40000 ' Type or member is obsolete
    ...
    Public Function AE_GotFocus(ByRef PP As clsPP, ByRef CP As clsCP, ByRef Ct As Control) As Short
        ...
        If Cn_ai21 And AE_Numerical(CP.FormatClass) And CP.Alignment = 1 And Right(CP.TpStr, 1) = Space(1) Then 'V6.50
            ...
            Ct.Text = AE_Format(CP, AE_Val(CP, CP.TpStr, wk_FractionC), wk_FractionC, False) 'V6.50
            '2019/03/27 CHG E N D
        ...
        Select Case CP.TypeA
            ...
            Case Cn_NormalOrV 'V4.31
                ...
                Else 'If CP.Alignment = 1 Then '右詰め
                    ...
                    If wk_MaxLB > wk_Ln Then Ct.Text = Space(wk_MaxLB - wk_Ln) & Ct.Text
                    '2019/03/27 CHG E N D
                    ...
                    If wk_Ln > 0 Then
                        ...
                        If Cn_ai21 Then 'V6.45
                            If PP.ClickPosition = -1 Then 'And CP.Alignment = 1 Then 'V5.46
                                ...
                                DirectCast(Ct, TextBox).SelectionStart = Len(LeftWid(Ct.Text, CP.MaxLength)) - PP.Override 'V6.45
                                '2019/03/27 CHG E N D
                            Else 'V5.46
                                ...
                                Do While PP.ClickPosition < Len(LeftWid(Ct.Text, CP.MaxLength)) 'V6.45
                                    '2019/03/27 CHG E N D
                                    'UPGRADE_WARNING: オブジェクト Ct の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                                    '2019/03/27 CHG START
                                    'If AE_KeyInOkChar(PP, Mid(Ct, PP.ClickPosition + 1, 1), CP.KeyInOkClass) Then
                                    If AE_KeyInOkChar(PP, Mid(Ct.Text, PP.ClickPosition + 1, 1), CP.KeyInOkClass) Then
                                        '2019/03/27 CHG E N D
                                        'UPGRADE_WARNING: オブジェクト Ct の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                                        '2019/03/27 CHG START
                                        'If Not (AE_Numerical(CP.FormatClass)) Or Mid(Ct, PP.ClickPosition + 1, 1) <> Space(1) Then Exit Do '----------'V6.50
                                        If Not (AE_Numerical(CP.FormatClass)) Or Mid(Ct.Text, PP.ClickPosition + 1, 1) <> Space(1) Then
                                            Exit Do '----------'V6.50
                                        End If
                                        '2019/03/27 CHG E N D
                                    End If
                                ...
                                If PP.ClickPosition >= Len(LeftWid(Ct.Text, CP.MaxLength)) Then PP.ClickPosition = Len(LeftWid(Ct.Text, CP.MaxLength)) - 1 'V6.45
                                '2019/03/27 CHG E N D
                                'UPGRADE_WARNING: オブジェクト Ct.SelStart の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                                '2019/03/27 CHG START
                                'Ct.SelStart = PP.ClickPosition 'V6.45
                                DirectCast(Ct, TextBox).SelectionStart = PP.ClickPosition 'V6.45
                                '2019/03/27 CHG E N D
                        ...
                        ElseIf PP.SetCursorRR = False Then  'V6.46
                            ...
                            Do While wk_P < Len(LeftWid(Ct.Text, CP.MaxLength)) 'V6.45
                                '2019/03/27 CHG E N D
                                'UPGRADE_WARNING: オブジェクト Ct の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                                '2019/03/27 CHG START
                                'If AE_KeyInOkChar(PP, Mid(Ct, wk_P + 1, 1), CP.KeyInOkClass) Then Exit Do '----------
                                If AE_KeyInOkChar(PP, Mid(Ct.Text, wk_P + 1, 1), CP.KeyInOkClass) Then Exit Do '----------
                                '2019/03/27 CHG E N D
                                wk_P = wk_P + 1 'V6.45
                            Loop  'V6.45
                            'UPGRADE_WARNING: オブジェクト Ct の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                            ...
                            If wk_P >= Len(LeftWid(Ct.Text, CP.MaxLength)) Then wk_P = Len(LeftWid(Ct.Text, CP.MaxLength)) - 1 'V6.45
                            '2019/03/27 CHG E N D
                            'UPGRADE_WARNING: オブジェクト Ct.SelStart の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                            '2019/03/27 CHG START
                            'Ct.SelStart = wk_P 'V6.45
                            DirectCast(Ct, TextBox).SelectionStart = wk_P 'V6.45
                            '2019/03/27 CHG E N D
                        Else
                            'UPGRADE_WARNING: オブジェクト Ct.SelStart の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                            'UPGRADE_WARNING: オブジェクト Ct の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    Public Sub AE_KeyPress(ByRef PP As clsPP, ByRef CP As clsCP, ByRef Ct As Control, ByRef pm_KeyAscii As Short)
        'pm_TA$ ----> CP.TpStr
        Static wk_Tx As Short
        ...
        If TypeOf Ct Is System.Windows.Forms.TextBox Then
            ...
            If DirectCast(Ct, TextBox).Multiline Then
                '2019.03.27 CHG END
                PP.MultiLineF = 2
                'UPGRADE_WARNING: オブジェクト Ct.SelStart の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_WARNING: オブジェクト Ct の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                ...
                st_Work = Mid(Ct.Text, DirectCast(Ct, TextBox).SelectionStart + 1, 1)
                '2019.03.27 CHG END
                If st_Work <> "" Then
        ...
        wk_Txt = (Ct.Text) 'V4.33
        wk_SL = DirectCast(Ct, TextBox).SelectionLength 'If CP.TypeA = Cn_NormalOrV Then
        wk_SS = DirectCast(Ct, TextBox).SelectionStart 'wk_SS + 1 文字目がカレント文字。
        '2019.03.27 CHG END
        wk_FlushInput = False
        ...
        If AE_KeyInOkChar(PP, wk_Moji, CP.KeyInOkClass) Then
            ...
            Else
                ...
                If wk_FlushInput = True Then
                    ...
                    DirectCast(Ct, TextBox).Select(wk_SS, PP.Override)
                    '2019.03.27 CHG END
                    PP.MaskMode = wk_SaveMaskMode
                ElseIf PP.Override >= 1 Then  '実際には PP.Override = 1
                    ...
                    If wk_SL > 1 And (CP.FormatClass = Cn_Memo Or CP.FormatClass = Cn_Name) And AE_SSSWin Then 'V6.52
                        If CP.Alignment <> 1 Then 'V6.52
                            ...
                            wk_Txt = Left(wk_Txt, wk_SS) & Chr(pm_KeyAscii) & Mid(wk_Txt, wk_SS + wk_SL + 1) & Space(LenWid(Mid(Ct.Text, wk_SS + 1, wk_SL)) - LenWid(Chr(pm_KeyAscii))) 'V6.52
                            '2019.03.27 CHG END
                        Else 'V6.52
                            'UPGRADE_WARNING: オブジェクト LenWid(Chr$(pm_KeyAscii)) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                            'UPGRADE_WARNING: オブジェクト Ct の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                            ...
                            wk_Txt = Space(LenWid(Mid(Ct.Text, wk_SS + 1, wk_SL)) - LenWid(Chr(pm_KeyAscii))) & Left(wk_Txt, wk_SS) & Chr(pm_KeyAscii) & Mid(wk_Txt, wk_SS + wk_SL + 1) 'V6.52
                            '2019.03.27 CHG END
                            pm_KeyAscii = 0 'V6.52
                        End If 'V6.52
            ...
            Select Case pm_KeyAscii
                ...
                Case System.Windows.Forms.Keys.Back 'Back Space
                    ...
                    ElseIf CP.FixedFormat = 1 Then
                        ...
                        wk_SS = DirectCast(Ct, TextBox).SelectionStart 'もとの SelStart のままにする。
                        '2019.03.27 CHG END
AE_KeyPressSetCt1:
                        CP.TpStr = wk_Txt
                        ...
                        ''UPGRADE_WARNING: オブジェクト Ct.SelLength の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                        'Ct.SelLength = PP.Override 'If CP.TypeA = Cn_NormalOrV Then
                        Ct.Text = CP.TpStr 'ここで、Change イベントが発生する。
                        DirectCast(Ct, TextBox).Select(wk_SS, PP.Override)
                        '2019.03.27 CHG END
                        PP.MaskMode = wk_SaveMaskMode
                        ...
                        '2019.03.27 CHG START
                        'Ct.ForeColor = AE_Color(Cn_Status1) 'Incomplete
                        Ct.ForeColor = ColorTranslator.FromWin32(AE_Color(Cn_Status1))
                        '2019.03.27 CHG END
                        'UPGRADE_WARNING: オブジェクト Ct.BackColor の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                        '2019.03.27 CHG START
                        'If CP.TypeA = Cn_NormalOrV Or CP.TypeA = Cn_InputOnly Then Ct.BackColor = PP.BrightOnOff
...
AE_KeyPressSetCt2:
    ...
    Public Sub AE_ScrlMax(ByRef PP As clsPP)
        ...
        If PP.AllowNullDes Then 'V6.47B
            ...
            AE_ScrlBar(PP.ScX).Maximum = wk_Limit - PP.MaxDspC 'V6.47B, 'V6.46S
            '2019/03/25 CHG E N D
        ElseIf wk_Max > PP.ReadableMaxDe - PP.MaxDspC Then  'V4.28
            'UPGRADE_WARNING: オブジェクト AE_ScrlBar().Max の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '2019/03/25 CHG START
            'AE_ScrlBar(PP.ScX).Max = wk_Max 'V4.28
            AE_ScrlBar(PP.ScX).Maximum = wk_Max 'V4.28
            '2019/03/25 CHG E N D
        Else 'V4.28
            'UPGRADE_WARNING: オブジェクト AE_ScrlBar().Max の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '2019/03/25 CHG START
            'AE_ScrlBar(PP.ScX).Max = PP.ReadableMaxDe - PP.MaxDspC 'V4.28
            AE_ScrlBar(PP.ScX).Maximum = PP.ReadableMaxDe - PP.MaxDspC 'V4.28
            '2019/03/25 CHG E N D
        End If 'V4.28
    End Sub
    ...
    Public Sub AE_SetSel(ByRef PP As clsPP, ByRef CP As clsCP, ByRef Ct As Control)
        '2019.03.27 CHG END
        Static wk_Ln As Integer
        Static wk_MaxLB As Integer
        Static wk_P As Integer
            ...
            Case Cn_NormalOrV 'V4.31
                    ...
                    If Cn_ai21 Then 'V6.45
                        ...
                        Do While PP.ClickPosition > 0 'V6.45
                            ...
                            If AE_KeyInOkChar(PP, Mid(Ct.Text, PP.ClickPosition + 1, 1), CP.KeyInOkClass) Then
                                ...
                                '2019.03.27 CHG START
                                'If Not (AE_Numerical(CP.FormatClass)) Or Mid(Ct, PP.ClickPosition + 1, 1) <> Space(1) Then Exit Do '----------'V6.50
                                If Not (AE_Numerical(CP.FormatClass)) Or Mid(Ct.Text, PP.ClickPosition + 1, 1) <> Space(1) Then Exit Do '----------'V6.50
                                '2019.03.27 CHG END
                            End If
                            PP.ClickPosition = PP.ClickPosition - 1 'V6.45
                        Loop  'V6.45
                    ...
                    If wk_Ln > 0 Then
                        ...
                        If Cn_ai21 Then 'V6.45
                            If PP.ClickPosition = -1 Then 'And CP.Alignment = 1 Then 'V5.46
                                ...
                                DirectCast(Ct, TextBox).SelectionStart = Len(LeftWid(Ct.Text, CP.MaxLength)) - PP.Override 'V6.46
                                '2019.03.27 CHG END
                            Else 'V5.46
                                'If PP.ClickPosition = -1 Then PP.ClickPosition = 0 'V5.46
                                'UPGRADE_WARNING: オブジェクト Ct の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                ...
                If CP.TypeA = Cn_NormalOrV Then
                    If (PP.SelValid Or (PP.SetCursorLF And CP.Alignment <> 1)) And CP.FixedFormat <> 1 Then 'V6.56F
                        ...
                        '    'UPGRADE_WARNING: オブジェクト Ct.SelLength の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                        '    Ct.SelLength = PP.Override
                        DirectCast(Ct, TextBox).SelectionLength = Len(Ct.Text)
                    Else
                        'UPGRADE_WARNING: オブジェクト Ct.SelLength の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                        DirectCast(Ct, TextBox).SelectionLength = PP.Override
                        '2019.03.27 CHG END
    ...
    Public Sub AE_SetSelLen(ByRef PP As clsPP, ByRef CP As clsCP, ByRef Ct As Control, Optional ByVal pm_NeglectSetCursorLF As Object = Nothing)
        If CP.TypeA = Cn_NormalOrV Then
    ...
    Public Sub AE_StatusClear(ByRef PP As clsPP, ByVal pm_ForeColor As Integer)
        ...
        If pm_ForeColor < 0 Or AE_StatusBar(PP.ScX).ForeColor = ColorTranslator.FromWin32(pm_ForeColor) Then
            '2019/03/26 CHG E N D
            ...
            AE_StatusCodeBar(PP.ScX).Text = "" 'V4.24
            '2019/03/26 CHG E N D
...
#Enable Warning BC40000 ' Type or member is obsolete
    ...
    Public Function LeftWid(ByVal pm_Characters As String, ByVal pm_Wid As Integer) As String
        ...
        'bytWrk = System.Text.UnicodeEncoding.Unicode.GetBytes(StrConv(pm_Characters, vbFromUnicode))
        ...
        '    If (lngLength + lngStep) > pm_Wid Then
        '        Exit Do
        '    End If
        ...
        'pm_Characters = StrConv(MidB$(bytWrk, lngLength + 1), vbUnicode)
        ''UPGRADE_ISSUE: 定数 vbUnicode はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="55B59875-9A95-4B71-9D6A-7C294BF7139D"' をクリックしてください。
        ...
        'LeftWid = StrConv(LeftB$(bytWrk, lngLength), vbUnicode)
        Return LeftB(pm_Characters, pm_Wid)

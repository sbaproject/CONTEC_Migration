...
Module UDNTHA_DBM
    ...
    Sub UDNTHA_GetFirstRecByDATNO(ByVal pDATNO As String)
        ...
        Catch ex As Exception
            li_MsgRtn = MsgBox("UDNTHA_GetFirstRecByDATNO" & Constants.vbCrLf & ex.Message.ToString, MsgBoxStyle.Critical, "エラー")
        Finally
    ...
    Sub UDNTHA_GetFirstRecWhere(ByVal pWhere As String, Optional ByVal wColumns As String = "")
        ...
        Catch ex As Exception
            li_MsgRtn = MsgBox("UDNTHA_GetFirstRecWhere" & Constants.vbCrLf & ex.Message.ToString, MsgBoxStyle.Critical, "エラー")
        Finally

...
Module HDNTRA_DBM
	'==========================================================================
	'   HDNTRA.DBM   発注トラン                       UPD.EXE Ver 3, 0, 1, 2  =
	'==========================================================================
	...
	Public DBN_HDNTRA As Short
	' Index1( DATNO + LINNO )
	' Index2( DATKB + DENKB + HDNNO + LINNO )
	' Index3( SMADT )
	' Index4( DATKB + SIRCD + DEFNOKDT + HDNDT + HDNNO + LINNO )
	' Index5( DATKB + HINCD + DEFNOKDT + HDNDT + HDNNO + LINNO )
	' Index6( HDNNO + HDNNOV + LINNO )
	' Index7( DATNO + DATKB + TANCD + HINCD )
	' Index8( DEFNOKDT )
	' Index9( OPEID + WRTDT + WRTTM + HDNNO )
	' Index10( DATKB + DEFNOKDT + HYHDNNO + LINNO )
	' Index11( DATKB + AKAKROKB + DEFNOKDT + HYHDNNO )
	' Index12( DATKB + AKAKROKB + DEFNOKDT + HYHDNNO + LINNO )
	...
	Sub HDNTRA_RClear()
		...
		TmpStat = Dll_RClear(DBN_HDNTRA, G_LB)
		Call ResetBuf(DBN_HDNTRA)
	End Sub
End Module
...
#Region "Windows フォーム デザイナによって生成されたコード "
    ...
    Public WithEvents PNL_DefSize As Label
    'Public WithEvents PNL_DefOrient As SSPanel5
    Public WithEvents PNL_DefOrient As Label
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.PNL_DefSize = New Label
        'Me.PNL_DefOrient = New SSPanel5
        Me.PNL_DefOrient = New Label

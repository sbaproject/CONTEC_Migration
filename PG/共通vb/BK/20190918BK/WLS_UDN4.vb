...
Friend Class WLSUDN4
    ...
    Dim WM_WLS_SFIL2 As Object 'ウィンド表示ｻﾌﾞﾌｧｲﾙ
    Dim WM_WLS_SFIL3 As Object 'ウィンド表示ｻﾌﾞﾌｧｲﾙ
    '20190703 CHG END
    ...
    Private Sub COM_NHSCD_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles COM_NHSCD.Click
        ...
        WLSNHS1.ShowDialog() '0:入力候補一覧は入力後に残す指定。
        WLSNHS1.Close()
        '20190701 CHG END
    ...
    '20190703 ADD START
    Private Sub WLSUDN4_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub WLS_FORM_LOAD()
        ...
        WLSLABEL.Text = "受注番号 売上日付   受注日付   得意先                     納入先                         型式                 品名       数量    受注取区"
        '20190703 CHG END
    ...
    Private Sub btnF2_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnF2.Click
        ...
        Try
            If Me.HD_TOKJDNNO.Focused Then
                Call HD_TOKJDNNO_KeyDown(HD_TOKJDNNO, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ...
            ElseIf Me.WLSNHSCD.Focused Then
                Call WLSNHSCD_KeyDown(WLSNHSCD, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf Me.HD_TEXT.Focused Then
                Call HD_TEXT_KeyDown(HD_TEXT, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf Me.WLSURIKB.Focused Then
                Call WLSURIKB_KeyDown(WLSURIKB, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            Else
    ...
    Private Function WLSSSS_DSP_CHECK() As Object
        ...
        If Not IsDBNull(WM_WLS_ENDKEY) Then
            ...
            '    Exit Function
            'End If
            If LeftWid(UDN4_PARA1, LenWid(WM_WLS_ENDKEY)) > WM_WLS_ENDKEY Then
                'UPGRADE_WARNING: オブジェクト WLSSSS_DSP_CHECK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                WLSSSS_DSP_CHECK = SSS_END
                Exit Function
            End If
...
#End If
    ...
    Sub WLS_BaseSQL(Optional ByVal strKeyBak As String = " ")
        ...
        Else
            ...
            WLSLABEL.Text = "受注番号 出荷日付   受注日付   得意先                     納入先                         型式                 品名       数量    受注取区"
            '20190703 CHG END

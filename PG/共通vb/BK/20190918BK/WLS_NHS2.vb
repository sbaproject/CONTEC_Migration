...
Friend Class WLSNHS2
    ...
    Private Sub WLS_DspNew()
        ...
        For Each row As DataRow In dt.Rows
            DB_NHSMTA.NHSCD = DB_NullReplace(row("NHSCD"), "")
            DB_NHSMTA.NHSRN = DB_NullReplace(row("NHSRN"), "")
            DB_NHSMTA.NHSTL = DB_NullReplace(row("NHSTL"), "")

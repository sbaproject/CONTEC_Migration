...
Friend Class WLS_THS1
    ...
    Dim WM_WLS_MM1 As Object 'ウィンド表示ﾌｧｲﾙ1
    Dim WM_WLS_MM2 As Object 'ウィンド表示ﾌｧｲﾙ2
    '20190620 CHG END
	...
	Private Sub WLS_FORM_INIT()
        ...
        WLSLABEL.Text = "ｺｰﾄﾞ  取引先名                 　　　締  日     税区  電話番号     "
        '20190614 CHG END
	...
	Sub WLS_TextSQL()
		...
		If HD_BUNRUI.Text = "1" Then
            ...
            WlsFromWhere = "From TOKMTA Where TOKCD >= '" & CF_Ora_Sgl(WM_WLS_STTKEY) & "'"
            '20190614 CHG END
	...
	Sub WLS_RnSQL()
		...
		If HD_BUNRUI.Text <> "2" Then
            ...
            WlsFromWhere = "From TOKMTA Where TOKRN Like " & "'%" & CF_Ora_Sgl(WM_WLS_STTKEY) & "%'"
            '20190614 CHG END
	...
	Private Sub WLS_DspNew()
        ...
        For i As Integer = 0 To dt.Rows.Count - 1
            ...
            If HD_BUNRUI.Text <> "2" Then
                DB_TOKMTA.TOKZEIKB = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("TOKZEIKB"), "")
                DB_TOKMTA.TOKSMEKB = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("TOKSMEKB"), "")
                DB_TOKMTA.TOKSMEDD = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("TOKSMEDD"), "")
                DB_TOKMTA.TOKKESCC = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("TOKKESCC"), "")
                DB_TOKMTA.TOKKESDD = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("TOKKESDD"), "")
                DB_TOKMTA.TOKKDWKB = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("TOKKDWKB"), "")
                DB_TOKMTA.TOKCD = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("TOKCD"), "")
                DB_TOKMTA.TOKRN = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("TOKRN"), "")
                DB_TOKMTA.TOKTL = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("TOKTL"), "")
            Else
    ...
    '20190617 ADD START
    Private Sub WLS_THS1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
...
EventExitSub: 
    ...
    Private Sub btnF2_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnF2.Click
        ...
        Try
            ...
            ElseIf Me.HD_rn.Focused Then
                Call HD_Rn_KeyDown(HD_RN, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            Else
                Call HD_BUNRUI_KeyDown(HD_BUNRUI, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            End If

...
Module SDNTRA_DBM
	'==========================================================================
	'   SDNTRA.DBM   仕入トラン                       UPD.EXE Ver 3, 0, 1, 2  =
	'==========================================================================
	...
	Public DBN_SDNTRA As Short
	' Index1( DATNO + LINNO )
	' Index2( DATKB + DENKB + SDNNO + LINNO )
	' Index3( SMADT )
	' Index4( DATKB + SIRCD + SDNDT + SDNNO + LINNO )
	' Index5( DATKB + HINCD + SDNDT + SDNNO + LINNO )
	' Index6( DATKB + RECNO )
	' Index7( DATKB + SIRSHACD + SSADT + SDNDT + DENKB + SDNNO + LINNO )
	' Index8( DATKB + SMADT + SOUCD + HINCD )
	' Index9( DATKB + SIRCD + SDNDT + DENKB + SDNNO + LINNO )
	' Index10( DATNO + HDNNO + HDNLINNO + HINCD )
	' Index11( DATKB + SDNDT + HYHDNNO + SIRCD + HINCD + HDNLINNO )
	' Index12( DATKB + AKAKROKB + SDNDT + HYHDNNO + SIRCD + HINCD + HDNLINNO )
	...
	Sub SDNTRA_RClear()
		...
		TmpStat = Dll_RClear(DBN_SDNTRA, G_LB)
		Call ResetBuf(DBN_SDNTRA)
	End Sub
End Module
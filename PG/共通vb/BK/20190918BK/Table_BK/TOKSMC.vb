...
Module TOKSMC_DBM
    '==========================================================================
    '   TOKSMC.DBM   売上サマリ                       UPD.EXE Ver 3, 0, 1, 2  =
    '==========================================================================
    '20190611 del start
    ...
    '	End Sub
    'End Structure
    ''UPGRADE_WARNING: 構造体 DB_TOKSMC の配列は、使用する前に初期化する必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="814DF224-76BD-4BB4-BFFB-EA359CB9FC48"' をクリックしてください。
    'Public DB_TOKSMC As TYPE_DB_TOKSMC
    'Public DBN_TOKSMC As Short
    '20190611 del end
	...
	Sub TOKSMC_RClear()
        ...
        '2019/03/25　仮
        '      TmpStat = Dll_RClear(DBN_TOKSMC, G_LB)
        'Call ResetBuf(DBN_TOKSMC)
        '2019/03/25　仮
    End Sub
End Module
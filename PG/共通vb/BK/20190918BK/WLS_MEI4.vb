...
Friend Class WLS_MEI4
    ...
    Private DB_MEIMTC_W As TYPE_DB_MEIMTC '検索結果退避

    'ADD 20190404 START saiki
    Private dt As DataTable
    Private PageCount As Integer 'ページ数カウント
    ...
    Private Sub WLS_FORM_INIT()
        ...
        WM_WLS_MEICDALEN = Len(DB_MEIMTC_W.MEICDA) 'LenWid はダメ
        WM_WLS_MEINMALEN = Len(DB_MEIMTC_W.MEINMA) 'LenWid はダメ
	...
	Private Sub WLS_DspNew()
        ...
        '         DB_MEIMTC_W.KEYCD = CF_Ora_GetDyn(Usr_Ody, "KEYCD", "") 'キー
        ''UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'DB_MEIMTC_W.MEIKMKNM = CF_Ora_GetDyn(Usr_Ody, "MEIKMKNM", "") '項目名
        ''UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'DB_MEIMTC_W.MEICDA = CF_Ora_GetDyn(Usr_Ody, "MEICDA", "") 'コード１
        ''UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'DB_MEIMTC_W.MEINMA = CF_Ora_GetDyn(Usr_Ody, "MEINMA", "") '名称１
        ...
        For i As Integer = 0 To dt.Rows.Count - 1
            ...
            '取得内容退避
            DB_MEIMTC_W.KEYCD = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("KEYCD"), "") '納入先コード
            DB_MEIMTC_W.MEIKMKNM = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("MEIKMKNM"), "") '納入先略称
            DB_MEIMTC_W.MEICDA = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("MEICDA"), "") '納入先郵便番号
            DB_MEIMTC_W.MEINMA = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("MEINMA"), "") '納入先郵便番号
	...
	'UPGRADE_WARNING: Form イベント WLS_MEI4.Activate には新しい動作が含まれます。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"' をクリックしてください。

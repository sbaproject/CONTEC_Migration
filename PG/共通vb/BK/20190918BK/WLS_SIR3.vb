...
Friend Class WLSSIR
	...
	Dim WM_WLS_STText As Object '開始キー
	Dim WM_WLS_EDText As Object '終了キー
	Dim WM_WLS_STKana As Object '開始キー
	Dim WM_WLS_EDKana As Object '終了キー
	Dim WM_WLS_STsirn As Object
	Dim WM_WLS_EDsirn As Object
	...
	Private Sub WLS_FORM_INIT()
        ...
        '20190610 CHG START
        'WLSLABEL = "コード" & Space(5) & "仕入先略称名" & Space(31) & "締日" & Space(2) & "税区" & Space(2) & "電話番号"
        WLSLABEL.Text = "コード" & Space(5) & "仕入先略称名" & Space(29) & "締日" & Space(2) & "税区" & Space(2) & "電話番号"
        '20190610 CHG END
	...
	Private Sub WLS_SetArray(ByVal ArrayCnt As Short)
		...
		Select Case SSSVal(DB_SIRMTA.SIRSMEKB)
			...
			Case 2
				...
				WK_SMENM = SSS_WEEKNM(SSSVal(DB_SIRMTA.SIRSDWKB)) & "締     " & "回収"
		End Select
		'WM_WLS_DSPArray(ArrayCnt) = DB_SIRMTA.SIRCD & " " & LeftWid$(DB_SIRMTA.SIRRN, Len(DB_SIRMTA.SIRRN)) & " " & WK_SMENM & WK_KESNM & " " & WK_ZEINM & " " & DB_SIRMTA.SIRTL
	...
	Sub WLS_TextSQL()
        ...
        WlsFromWhere = "From SIRMTA Where SIRCD >= '" & CF_Ora_Sgl(WM_WLS_STTKEY) & "'"
        '20190610 CHG END
        '''' UPD 2009/12/03  FKS) T.Yamamoto    End
        'UPGRADE_WARNING: オブジェクト WM_WLS_STsirn の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        If Len(Trim(WM_WLS_STsirn)) <> 0 Then
            '''' UPD 2009/12/03  FKS) T.Yamamoto    Start    連絡票№661「'」対応修正
            '       WlsFromWhere = WlsFromWhere & " and SIRRN Like '%" & WM_WLS_STsirn & "%'"
            'UPGRADE_WARNING: オブジェクト WM_WLS_STsirn の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '20190610 CHG START
            'WlsFromWhere = WlsFromWhere & " and SIRRN Like '%" & AE_EditSQLText(WM_WLS_STsirn) & "%'"
            WlsFromWhere = WlsFromWhere & " and SIRRN Like '%" & CF_Ora_Sgl(WM_WLS_STsirn) & "%'"
            '20190610 CHG END            '''' UPD 2009/12/03  FKS) T.Yamamoto    End
            'UPGRADE_WARNING: オブジェクト WM_WLS_EDKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'UPGRADE_WARNING: オブジェクト WM_WLS_STKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        ElseIf Len(Trim(WM_WLS_STKana)) <> 0 Or Len(Trim(WM_WLS_EDKana)) <> 0 Then 
			'UPGRADE_WARNING: オブジェクト WM_WLS_EDKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト WM_WLS_STKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WlsFromWhere = WlsFromWhere & " and SIRNK >= '" & WM_WLS_STKana & "' And SIRNK < '" & WM_WLS_EDKana & "'"
		End If
	...
	Sub WLS_SirrnSQL()
		...
		If WM_WLS_STTKEY = "" Then WM_WLS_STTKEY = " "
		'UPGRADE_WARNING: オブジェクト WM_WLS_STTKEY の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		If Len(Trim(WM_WLS_STTKEY)) <> 0 Then
            '''' UPD 2009/12/03  FKS) T.Yamamoto    Start    連絡票№661「'」対応修正
            ...
            WlsFromWhere = "From SIRMTA Where SIRRN Like '%" & CF_Ora_Sgl(WM_WLS_STTKEY) & "%'"
            '20190610 CHG END
            '''' UPD 2009/12/03  FKS) T.Yamamoto    End
        Else
			WlsFromWhere = "From SIRMTA Where SIRRN Like '%'"
		End If
		'UPGRADE_WARNING: オブジェクト WM_WLS_EDKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト WM_WLS_STKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		If Len(Trim(WM_WLS_STKana)) <> 0 Or Len(Trim(WM_WLS_EDKana)) <> 0 Then
			'UPGRADE_WARNING: オブジェクト WM_WLS_EDKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト WM_WLS_STKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WlsFromWhere = WlsFromWhere & " and SIRNK >= '" & WM_WLS_STKana & "' And SIRNK < '" & WM_WLS_EDKana & "'"
			'UPGRADE_WARNING: オブジェクト WM_WLS_STText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		ElseIf Len(Trim(WM_WLS_STText)) <> 0 Then
            '''' UPD 2009/12/03  FKS) T.Yamamoto    Start    連絡票№661「'」対応修正
            '       WlsFromWhere = WlsFromWhere & " and SIRCD >= '" & WM_WLS_STText & "'"
            'UPGRADE_WARNING: オブジェクト WM_WLS_STText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '20190610 CHG START
            'WlsFromWhere = WlsFromWhere & " and SIRCD >= '" & AE_EditSQLText(WM_WLS_STText) & "'"
            WlsFromWhere = WlsFromWhere & " and SIRCD >= '" & CF_Ora_Sgl(WM_WLS_STText) & "'"
            '20190610 CHG END
            '''' UPD 2009/12/03  FKS) T.Yamamoto    End
        End If
		WlsOrderBy = "Order By SIRCD"
	...
	Sub WLS_KanaSQL()
		...
		WlsFromWhere = "From SIRMTA Where SIRNK >= '" & VB.Left(VB.Right(VB6.GetItemString(WLSKANA, WLSKANA.SelectedIndex), 2), 1) & "' And SIRNK < '" & WM_WLS_ENDKEY & "'"
		'UPGRADE_WARNING: オブジェクト WM_WLS_STText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		If Len(Trim(WM_WLS_STText)) <> 0 Then
            '''' UPD 2009/12/03  FKS) T.Yamamoto    Start    連絡票№661「'」対応修正
            '       WlsFromWhere = WlsFromWhere & " and SIRCD >= '" & WM_WLS_STText & "'"
            'UPGRADE_WARNING: オブジェクト WM_WLS_STText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '20190610 CHG START
            ...
            '''' UPD 2009/12/03  FKS) T.Yamamoto    End
            'UPGRADE_WARNING: オブジェクト WM_WLS_STsirn の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        ElseIf Len(Trim(WM_WLS_STsirn)) <> 0 Then
            '''' UPD 2009/12/03  FKS) T.Yamamoto    Start    連絡票№661「'」対応修正
            '       WlsFromWhere = WlsFromWhere & " and SIRRN Like '%" & WM_WLS_STsirn & "%'"
            'UPGRADE_WARNING: オブジェクト WM_WLS_STsirn の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '20190610 CHG START
	...
	Private Sub WLS_DspNew()
        ...
        '	End If
        '	'ADD START FKS)INABA 2008/02/22 ********************************************
        '	System.Windows.Forms.Application.DoEvents()
        '	'ADD  END  FKS)INABA 2008/02/22 ********************************************
        'Loop
        '      If DBSTAT <> 0 Or WL_Mode = SSS_END Then WM_WLS_LastFL = True

        For i As Integer = 0 To dsList.Tables("tableName").Rows.Count - 1

            DB_SIRMTA.SIRZEIKB = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("SIRZEIKB"), "")
            DB_SIRMTA.SIRSMEKB = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("SIRSMEKB"), "")
            DB_SIRMTA.SIRSMEDD = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("SIRSMEDD"), "")
            DB_SIRMTA.SIRKESCC = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("SIRKESCC"), "")
            DB_SIRMTA.SIRKESDD = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("SIRKESDD"), "")
            DB_SIRMTA.SIRSDWKB = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("SIRSDWKB"), "")
            DB_SIRMTA.SIRCD = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("SIRCD"), "")
            DB_SIRMTA.SIRRN = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("SIRRN"), "")
            DB_SIRMTA.SIRTL = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("SIRTL"), "")
	...
	'以下は画面イベント処理
	'
	'UPGRADE_WARNING: Form イベント WLSSIR.Activate には新しい動作が含まれます。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"' をクリックしてください。
	Private Sub WLSSIR_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub WLSSIR_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        'Window初期設定
        Call WLS_FORM_INIT()
        '分類設定
        Call WLS_Kana_Init()
    ...
    '20190611 ADD START
    Private Sub WLSSIR_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub HD_Kana_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_Kana.KeyDown
		...
		If KEYCODE = System.Windows.Forms.Keys.Return Then
			...
			'UPGRADE_WARNING: オブジェクト WM_WLS_STKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WM_WLS_STKana = HD_Kana.Text
			'UPGRADE_WARNING: オブジェクト WM_WLS_EDKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WM_WLS_EDKana = Chr(Asc("ﾝ") + 1)
...
EventExitSub: 
	...
	Private Sub HD_TEXT_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_TEXT.KeyDown
		...
		If KEYCODE = System.Windows.Forms.Keys.Return Then
			...
			WM_WLS_ENDKEY = System.DBNull.Value
			'UPGRADE_WARNING: オブジェクト WM_WLS_STText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WM_WLS_STText = HD_TEXT.Text
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト WM_WLS_EDText の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WM_WLS_EDText = System.DBNull.Value
	...
	Private Sub HD_SIRRN_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_SIRRN.KeyDown
		...
		If KEYCODE = System.Windows.Forms.Keys.Return Then
			...
			'UPGRADE_WARNING: オブジェクト WM_WLS_STsirn の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WM_WLS_STsirn = HD_SIRRN.Text
			'UPGRADE_WARNING: オブジェクト WM_WLS_EDsirn の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WM_WLS_EDsirn = HD_SIRRN.Text
	...
	Private Sub WLSKANA_SelectedIndexChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles WLSKANA.SelectedIndexChanged
		...
		If WLSKANA.SelectedIndex > 0 Then
			...
			'UPGRADE_WARNING: オブジェクト W_BUF の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト WM_WLS_STKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WM_WLS_STKana = VB.Left(W_BUF, 1)
			'UPGRADE_WARNING: オブジェクト W_BUF の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト WM_WLS_EDKana の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			WM_WLS_EDKana = Chr(Asc(VB.Right(W_BUF, 1)) + 1)
    ...
    Private Sub btnF2_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnF2.Click
        ...
        Try
            If Me.HD_SIRRN.Focused Then
                Call HD_SIRRN_KeyDown(HD_SIRRN, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            Else

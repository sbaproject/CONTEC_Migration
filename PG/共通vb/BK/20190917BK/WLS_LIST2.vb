...
Friend Class WLS_LIST2
	...
	Private Sub WLS_DspNew()
        ...
        For i As Integer = 0 To dsList.Tables("tableName").Rows.Count - 1
            ...
            '取得内容退避
            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            DB_SYSMEI_W.MEICDB = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("MEICDB"), "") '勘定口座コード
            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            DB_SYSMEI_W.MEICDA = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("MEICDA"), "") '勘定口座コード
            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            DB_SYSMEI_W.MEINMA = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("MEINMA"), "") '勘定口座名
    ...
    '20190605 ADD START
    Private Sub WLS_LIST2_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown

...
Module TOKMTB_DBM
    '==========================================================================
    '   TOKMTB.DBM   販売単価履歴マスタ               UPD.EXE Ver 3, 0, 1, 2  =
    '==========================================================================
    '20190611 del start
    ...
    '	End Sub
    'End Structure
    ''UPGRADE_WARNING: 構造体 DB_TOKMTB の配列は、使用する前に初期化する必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="814DF224-76BD-4BB4-BFFB-EA359CB9FC48"' をクリックしてください。
    'Public DB_TOKMTB As TYPE_DB_TOKMTB
    'Public DBN_TOKMTB As Short
    '20190611 del end
	...
	Sub TOKMTB_RClear()
        ...
        '2019/03/26　仮
        'TmpStat = Dll_RClear(DBN_TOKMTB, G_LB)
        'Call ResetBuf(DBN_TOKMTB)
        '2019/03/26　仮
	End Sub
End Module
...
Module TOKMTA_DBM
    ...
    '           li_MsgRtn = MsgBox("TOKMTA_GetFirst" & Constants.vbCrLf & ex.Message.ToString, MsgBoxStyle.Critical, "エラー")
    '       Finally
    ...
    '    Catch ex As Exception
    '        li_MsgRtn = MsgBox("TOKMTA_GetFirstRecByDATNO" & Constants.vbCrLf & ex.Message.ToString, MsgBoxStyle.Critical, "エラー")
    '    Finally

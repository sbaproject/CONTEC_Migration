...
Module SRACNTTB_DBM
    '==========================================================================
    '   SRACNTTB.DBM シリアル管理テーブル             UPD.EXE Ver 3, 0, 1, 2  =
    '==========================================================================
    '20190611 del start
    ...
    'Public DBN_SRACNTTB As Short
    '20190611 del end
    
	' Index1( SRANO )
	' Index2( HINCD + SBNNO + RSTDT )
	' Index3( RSTDT + SZTNM + HINCD + SBNNO )
	...
	Sub SRACNTTB_RClear()
        ...
        '2019/03/26　仮
        '      TmpStat = Dll_RClear(DBN_SRACNTTB, G_LB)
        'Call ResetBuf(DBN_SRACNTTB)
        '2019/03/26　仮
    End Sub
End Module
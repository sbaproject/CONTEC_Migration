...
Module AE_CMN
	...
	Structure M_TYPE_EVTTBL_PARA
        ...
        <VBFixedString(10), System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray, SizeConst:=10)> Public IVWRDT As String 'イベント発生日
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
        <VBFixedString(6), System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray, SizeConst:=6)> Public IVWRTM As String 'イベント開始時間
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
        <VBFixedString(10), System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray, SizeConst:=10)> Public PGID As String 'プログラムＩＤ
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
		...
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
        <VBFixedString(3), System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray, SizeConst:=3)> Public IVCLASS As String 'イベント種別
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
        <VBFixedString(10), System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray, SizeConst:=10)> Public IVCODE As String 'イベントコード
		Dim IVMSG As String 'イベント内容
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
        <VBFixedString(30), System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray, SizeConst:=30)> Public IVPOINT As String 'イベント発生箇所
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
        <VBFixedString(1), System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray, SizeConst:=1)> Public SNDPROFLG As String '送信可否フラグ
	End Structure
	' === 20140129 === INSERT E - 両備)Shikichi
	...
	Public Sub CF_Init()
        ...
        '2019/03/11 CHG START
        'Load(ICN_ICON)
        ICN_ICON.Show()
        '2019/03/11 CHG E N D
...
#Enable Warning BC40000 ' Type or member is obsolete
	...
	Public Function AE_SYSTBASaiban(ByRef pot_strDatNo() As String, ByRef pot_strRECNO() As String) As Short
        ...
        '2019/03/18 CHG E N D
        ' === 20061108 === UPDATE E -
        '2019/03/18 DEL START
        'If bolRet = False Then
        '	GoTo ERR_AE_SYSTBASaiban
        '      End If
        '2019/03/18 DEL E N D
        ...
        '2019/03/22 CHG START
        'curDatNo = CDec(CF_Ora_GetDyn(usrOdy, "DATNO", "0")) + 1
        curDatNo = CDec(DB_NullReplace(dt.Rows(0)("DATNO"), 0)) + 1
        '2019/03/22 CHG E N D
        If curDatNo > 9999999999.0# Then
            '9999999999を超えた場合は戻る
            curDatNo = 1
        End If
...
#Enable Warning BC40000 ' Type or member is obsolete
        ...
        curRecNo = CDec(DB_NullReplace(dt.Rows(0)("RECNO"), 0)) + 1
        '2019/03/22 CHG E N D
        If curRecNo > 9999999999.0# Then
            '9999999999を超えた場合は戻る
            curRecNo = 1
        End If
...
#Enable Warning BC40000 ' Type or member is obsolete
        ...
        If Trim(pot_strRECNO(UBound(pot_strRECNO))) = "" Then
            ...
            strRecNo = DB_NullReplace(dt.Rows(0)("RECNO"), "")
            '2019/03/22 CHG E N D
        Else
...
#Enable Warning BC40000 ' Type or member is obsolete
	...
	Public Function AE_Execute_PLSQL_GetTanka(ByVal pin_strHINCD As String, ByVal pin_strTOKCD As String, ByVal pin_strDate As String, ByVal pin_strTUKKB As String, ByVal Pin_lngSU As Integer, ByRef Pot_curTANKA As Decimal, ByRef Pot_curSIKRT As Decimal, Optional ByRef Pin_strJDNKB As String = "", Optional ByRef Pot_curTEITK As Decimal = 0) As Short
        ...
        '20190820 CHG START 山口
        'Dim lngPara5 As Integer 'ﾊﾟﾗﾒｰﾀ5(数量)
        Dim lngPara5 As Decimal 'ﾊﾟﾗﾒｰﾀ5(数量)
        '20190820 CHG E N D 山口
        Dim strPara6 As String 'ﾊﾟﾗﾒｰﾀ6(受注区分)
        '20190820 CHG START 山口
        'Dim lngPara7 As Integer 'ﾊﾟﾗﾒｰﾀ7(復帰ｺｰﾄﾞ)
        'Dim lngPara8 As Integer 'ﾊﾟﾗﾒｰﾀ8(ｴﾗｰｺｰﾄﾞ)
        Dim lngPara7 As Decimal 'ﾊﾟﾗﾒｰﾀ7(復帰ｺｰﾄﾞ)
        Dim lngPara8 As Decimal 'ﾊﾟﾗﾒｰﾀ8(ｴﾗｰｺｰﾄﾞ)
        '20190820 CHG E N D 山口
        ...
        Dim lngPara11 As Decimal 'ﾊﾟﾗﾒｰﾀ11(仕切率)
        Dim lngPara12 As Decimal 'ﾊﾟﾗﾒｰﾀ12(定価)
        '20190820 CHG E N D 山口
        ...
        '20190824 ADD START 山口
        Try
            '20190824 ADD E N D 山口
            ...
            Dim outP10 As OracleParameter = New OracleParameter
            outP10.ParameterName = "P10"
            outP10.Direction = ParameterDirection.Output
            outP10.Value = lngPara10
            cmd.Parameters.Add(outP10)
            Dim outP11 As OracleParameter = New OracleParameter
            outP11.ParameterName = "P11"
            outP11.Direction = ParameterDirection.Output
            outP11.Value = lngPara11
            ...
            inP5.OracleDbType = OracleDbType.Decimal
            ...
            outP10.OracleDbType = OracleDbType.Decimal
            outP11.OracleDbType = OracleDbType.Decimal
            outP12.OracleDbType = OracleDbType.Decimal
            '20190824 CHG E N D

            '20190824 CHG START
            'PL/SQL呼び出しSQL
            'strSQL = "BEGIN PRC_CMNPL90_01(:P1,:P2,:P3,:P4,:P5,:P6,:P7,:P8,:P9,:P10,:P11,:P12); End;"
            cmd.CommandText = "PRC_CMNPL90_01"
            '20190824 CHG E N D
            ...
            'End If
            '20190910 CHG START
            If outP10.Value <> Nothing Then
                If IsDBNull(outP10.Value) = False Then
                    '20190910 CHG END
                    'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    lngPara10 = outP10.Value.ToString
                Else
                    lngPara10 = 0
                End If
            Else
            ...
            '    'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '    lngPara10 = param(11).Value
            'Else
            '    lngPara10 = 0
            'End If
            If IsDBNull(outP11.Value) = False Then
                'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                lngPara11 = outP11.Value.ToString
            Else
                lngPara11 = 0
            End If
            '20190824 CHG E N D 山口
            ...
            '    'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '    lngPara10 = param(12).Value
            'Else
            '    lngPara10 = 0
            'End If
            If IsDBNull(outP12.Value) = False Then
                'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                lngPara12 = outP12.Value.ToString
            Else
                lngPara12 = 0
            End If
            '20190824 CHG E N D 山口

            Pot_curTANKA = lngPara10
            Pot_curSIKRT = lngPara11
            Pot_curTEITK = lngPara12
            ...
            '20190824 DEL START 山口
            'AE_Execute_PLSQL_GetTanka_END:
            '20190824 DEL E N D 山口
            '20190824 CHG START 山口
            ''** パラメタ解消
            ''UPGRADE_WARNING: オブジェクト gv_Odb_USR1.Parameters の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        ...
        Catch ex As Exception
            MsgBox("AE_Execute_PLSQL_GetTanka " & Constants.vbCrLf & ex.Message.ToString, MsgBoxStyle.Critical, "エラー")
        End Try
        '20190824 ADD E N D 山口
...
#Disable Warning BC40000 ' Type or member is obsolete
        ...
        Dim strPara12 As String 'ﾊﾟﾗﾒｰﾀ12(ｴﾗｰ内容)
        '20190904 CHG END
#Enable Warning BC40000 ' Type or member is obsolete
        ...
        outP12.ParameterName = "P12"
        outP12.Direction = ParameterDirection.Output
        outP12.Value = strPara12
        cmd.Parameters.Add(outP12)

        Dim outP13 As OracleParameter = New OracleParameter
        outP13.ParameterName = "P13"
        outP13.Direction = ParameterDirection.Output
        outP13.Value = lngPara13
        cmd.Parameters.Add(outP13)

        Dim outP14 As OracleParameter = New OracleParameter
        outP14.ParameterName = "P14"
        outP14.Direction = ParameterDirection.Output
        outP14.Value = lngPara14
        cmd.Parameters.Add(outP14)
        ...
        inP6.OracleDbType = OracleDbType.Char
        inP7.OracleDbType = OracleDbType.Char
        inP8.OracleDbType = OracleDbType.Decimal
        inP9.OracleDbType = OracleDbType.Decimal

        outP10.OracleDbType = OracleDbType.Decimal
        outP11.OracleDbType = OracleDbType.Decimal
        outP12.OracleDbType = OracleDbType.Varchar2
        outP13.OracleDbType = OracleDbType.Decimal
        outP14.OracleDbType = OracleDbType.Decimal

        'PL/SQL呼び出しSQL
        'strSQL = "BEGIN PRC_UODFP53_01(:P1,:P2,:P3,:P4,:P5,:P6,:P7,:P8,:P9,:P10,:P11,:P12,:P13,:P14); End;"
        cmd.CommandText = "PRC_UODFP53_01"
        ...
        '20190904 CHG START
        'If IsDBNull(outP12.Value) = False Then
        If outP12.Value.isNull = False Then
            'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'strPara12.Value = outP12.Value
            strPara12 = outP12.Value.ToString
            '20190904 CHG END
        End If

        'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'lngPara13 = param(13).Value
        lngPara13 = outP13.Value.ToString

        'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'lngPara14 = param(14).Value
        lngPara14 = outP14.Value.ToString
...
AE_Execute_PLSQL_PRC_UODFP53_END:
    ...
    Function F_Get_INPTANCD_Inf(ByVal pin_strTANCD As String, ByRef pot_Inp_Inf As Cmn_Inp_Inf, Optional ByVal pin_strKJNDT As String = "") As Short
        ...
        ''Call TANMTA_GetFirst(pin_strTANCD)
        pWhere = "where TANCD = '" & pin_strTANCD & "'"
        Call GetRowsCommon("TANMTA", pWhere)

        Mst_Inf_TANMTA = DB_TANMTA
...
#Enable Warning BC40000 ' Type or member is obsolete
            ...
            Select Case Err.Number
                Case 70
                    ...
                    If curRetryCnt < curRetryMax Then
                        ...
                        System.Threading.Thread.Sleep(pin_curWait * 1000)
    ...
    Public Function AE_Execute_PLSQL_EXCTBZ(ByVal Pin_strPRCCASE As String, ByRef pot_strMsg As String) As Short
        ...
        Try
            ...
            Dim outP5 As OracleParameter = New OracleParameter
            outP5.ParameterName = "P5"
            outP5.Direction = ParameterDirection.Output
            outP5.Value = lngPara5
            cmd.Parameters.Add(outP5)

            Dim outP6 As OracleParameter = New OracleParameter
            outP6.ParameterName = "P6"
            outP6.Direction = ParameterDirection.Output
            outP6.Value = lngPara6
            cmd.Parameters.Add(outP6)

            Dim outP7 As OracleParameter = New OracleParameter
            outP7.ParameterName = "P7"
            outP7.Direction = ParameterDirection.Output
            outP7.Value = strPara7
            cmd.Parameters.Add(outP7)
            ...
            'ストアドの中に「MV_VAR_ERRMSG       VARCHAR2(1000);」ですので、1000を設定する。
            '20190827 ADD START
            outP7.Size = 1000
            '20190827 ADD END
            ...
            cmd.CommandText = "CNT_USR1.PRC_EXCTBZ"
            ...
            'End If
            'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            lngPara5 = outP5.Value.ToString
            'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            lngPara6 = outP6.Value.ToString
            'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
            If IsDBNull(outP7.Value.ToString) = False Then
                'UPGRADE_WARNING: オブジェクト param().Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                strPara7 = outP7.Value.ToString
                pot_strMsg = strPara7
            End If
            '20190701 CHG END
            ...
            '20190701 ADD START
        Catch ex As Exception
            MsgBox("AE_Execute_PLSQL_EXCTBZ" & Constants.vbCrLf & ex.Message.ToString, MsgBoxStyle.Critical, "エラー")
        End Try
        '20190701 ADD END
...
CF_Unlock_EXCTBZ2_Err:
    ...
    Public Function CF_Chk_CLMDL(ByRef pin_strCLMDL As String, ByRef pin_strJDNDT As String, ByRef pin_strJDNTRKB As String, Optional ByRef pin_strCMPKTCD As String = " ") As Short
        ...
        If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
            ...
            strRtn = DB_NullReplace(dt.Rows(0)("RTN"), "")
            '2019/03/18 CHG E N D
        End If
...
Err_CF_Chk_CLMDL:
    ...
    Public Function CF_DTLTRA_Update_MainJDN(ByVal pm_strMotoDatNo As String, ByVal pm_strDATNO As String, ByVal pm_strErrCd As String, ByRef pm_All As Cls_All) As Short
        ...
        For k As Integer = 0 To dt.Rows.Count - 1
            ...
            strJDNNO_NEW = DB_NullReplace(dt.Rows(k)("JDNNO_NEW"), "") '受注番号（新）

            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'strLINNO_NEW = Trim(CF_Ora_GetDyn(Usr_Ody, "LINNO_NEW", "")) '行番号（新）
            strLINNO_NEW = DB_NullReplace(dt.Rows(k)("LINNO_NEW"), "") '行番号（新）

            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'strODNYTDT_NEW = Trim(CF_Ora_GetDyn(Usr_Ody, "ODNYTDT_NEW", "")) '出荷予定日（新）
            strODNYTDT_NEW = DB_NullReplace(dt.Rows(k)("ODNYTDT_NEW"), "") '出荷予定日（新）

            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'strJDNNO_OLD = Trim(CF_Ora_GetDyn(Usr_Ody, "JDNNO_OLD", "")) '受注番号（旧）
            strJDNNO_OLD = DB_NullReplace(dt.Rows(k)("JDNNO_OLD"), "") '受注番号（旧）

            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'strLINNO_OLD = Trim(CF_Ora_GetDyn(Usr_Ody, "LINNO_OLD", "")) '行番号（旧）
            strLINNO_OLD = DB_NullReplace(dt.Rows(k)("LINNO_OLD"), "") '行番号（旧）

            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'strODNYTDT_OLD = Trim(CF_Ora_GetDyn(Usr_Ody, "ODNYTDT_OLD", "")) '出荷予定日（旧）
            strODNYTDT_OLD = DB_NullReplace(dt.Rows(k)("ODNYTDT_OLD"), "") '出荷予定日（旧）
...
CF_Chk_INPSU_ZAISU_Err:
    ...
    Public Function CF_Chk_INPSU_ZAISU_2(ByVal pm_strHINCD As String, ByVal pm_curCHKSU As Decimal, ByVal pm_curMNSSU As Decimal, ByVal pm_strJDNINKB As String, ByRef pm_All As Cls_All, Optional ByVal pm_strTHNSOUCD As String = "") As Short
        ...
        Dim curHIKSU As Decimal
        Dim bolDyn_Open As Boolean
        '20190826 ADD START 山口
        Dim dt As DataTable
        Dim dtRow As Short
        '20190826 ADD E N D 山口
        ...
        '20190618 CHG START
        'Call DB_HINMTA_Clear(Mst_Inf_HINMTA)
        '20190826 DEL START 山口
        'Call InitDataCommon("HINMTA")
        '20190826 DEL E N D 山口
        '20190618 CHG END
        If DSPHINCD_SEARCH(pm_strHINCD, Mst_Inf_HINMTA) = 9 Then
            Exit Function
        End If
		...
		Else
            ...
            'SQL実行
            '20190826 CHG START 山口
            'Call CF_Ora_CreateDyn(gv_Odb_USR1, Usr_Ody, strSQL)
            dt = Nothing
            dt = DB_GetTable(strSQL)
            '20190826 CHG E N D 山口
            ...
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                '20190826 CHG START 山口
                'strTHNSOUCD = CF_Ora_GetDyn("SOUCD", "")
                strTHNSOUCD = DB_NullReplace(dt.Rows(0)("SOUCD"), "")
                '20190826 CHG E N D 山口
            End If
            'クローズ
            Call CF_Ora_CloseDyn(Usr_Ody)
        ...
        If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
            ...
            '20190826 CHG START 山口
            'curRELZAISU = CF_Ora_GetDyn(Usr_Ody, "RELZAISU", 0)
            curRELZAISU = DB_NullReplace(dt.Rows(0)("RELZAISU"), 0)
            '20190826 CHG E N D 山口
        End If
		...
		If Trim(pm_strJDNINKB) <> gc_strJDNINKB_ML Then
            ...
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                curHIKSU = curHIKSU + DB_NullReplace(dt.Rows(0)("YTSU"), 0)
                '20190826 CHG E N D 山口
            End If
            'クローズ
            Call CF_Ora_CloseDyn(Usr_Ody)
        ...
        For Each row As DataRow In dt.Rows
            ...
            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            If Trim(DB_NullReplace(dt.Rows(dtRow)("JDNKB"), "")) = "1" Or Trim(DB_NullReplace(dt.Rows(dtRow)("JDNKB"), "")) = "2" Then

                'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                curHIKSU = curHIKSU + DB_NullReplace(dt.Rows(dtRow)("YTSU"), 0)
            End If
            dtRow = dtRow + 1
        Next
        ' === 20081210 === UPDATE E -
...
CF_Chk_INPSU_ZAISU_2_Err: 
	...
	Public Function CF_NYUKN_MAEUKE_CHK(ByRef ps_JDNNO As String, ByRef ps_JDNLINNO As String, Optional ByRef pv_ChkKIN As Object = Nothing) As Short
        ...
        If dt.Rows.Count > 0 Then
            ...
            lv_NYUKN = DB_NullReplace(dt.Rows(0)("NYUKN_SUM"), "")
...
ERR_HANDLE: 
	...
	Public Function CF_Get_UWRTDTTM(ByVal pin_strTBLNM As String, ByRef pot_strUWRTDT As String, ByRef pot_strUWRTTM As String, Optional ByVal pin_strDatNo As String = "", Optional ByVal pin_strRECNO As String = "", Optional ByVal pin_strELSE As String = "") As Short
        ...
        If dt.Rows.Count > 0 Then
            ...
            pot_strUWRTTM = Trim(DB_NullReplace(dt.Rows(0)("UWRTTM"), ""))
        End If
	...
	Private Function AE_URIINF_UDNTRA_UPD_Main(ByRef pin_usrURITHA As Cmn_UDNTHA_Upd, ByRef pin_usrURITRA() As Cmn_UDNTRA_Upd, ByRef pin_Upd_Inf As Cmn_JDNUPDATE_Enable) As Short
        ...
        For intCntH = 1 To UBound(pin_usrURITHA.DATNO)
            ...
            For k As Integer = 1 To dt.Rows.Count - 1
                ...
                curURISU = DB_NullReplace(dt.Rows(k)("URISU"), 0) '売上数量

                'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'usrUDNTRA.URILINNO = CF_Ora_GetDyn(usrOdy_UDNTRA, "LINNO", "") '行番号（売上トラン）
                usrUDNTRA.URILINNO = DB_NullReplace(dt.Rows(k)("LINNO"), "") '行番号（売上トラン）

                'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'strODNNO = CF_Ora_GetDyn(usrOdy_UDNTRA, "ODNNO", "") '出荷伝票番号
                strODNNO = DB_NullReplace(dt.Rows(k)("ODNNO"), "") '出荷伝票番号

                'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'strRecNo = CF_Ora_GetDyn(usrOdy_UDNTRA, "RECNO", "") 'レコード管理番号
                strRecNo = DB_NullReplace(dt.Rows(k)("RECNO"), "") 'レコード管理番号
                ...
                With pin_usrURITHA
                    ...
                    .curUrikn_Old(intCntH) = .curUrikn_Old(intCntH) - curHNPNKN + DB_NullReplace(dt.Rows(k)("URIKN"), 0) '売上金額
                    ...
                    .curFUrikn_Old(intCntH) = .curFUrikn_Old(intCntH) - curHNPNFKN + DB_NullReplace(dt.Rows(k)("FURIKN"), 0) '外貨売上金額
                    ...
                    .curUzeikn_Old(intCntH) = .curUzeikn_Old(intCntH) - curHNPNZKN + DB_NullReplace(dt.Rows(k)("UZEKN"), 0) '消費税金額
                ...
                For intCntR = 1 To UBound(pin_usrURITRA)
                    ...
                    Select Case True
                        ...
                        Case (pin_usrURITHA.JDNTRKB = gc_strJDNTRKB_SYS And pin_usrURITHA.URIKJN = gc_strURIKJN_SYK) Or pin_usrURITHA.JDNTRKB = gc_strJDNTRKB_SET
                            ...
                            If Trim(DB_NullReplace(dt.Rows(k)("JDNLINNO"), "")) = Trim(usrUDNTRA.LINNO) Then
                        ...
                        Case pin_usrURITHA.JDNTRKB = gc_strJDNTRKB_SYS
                            ...
                            If Trim(DB_NullReplace(dt.Rows(k)("RECNO"), "")) = Trim(usrUDNTRA.RECNO) Then
                        ...
                        Case Else
                            ...
                            If Trim(DB_NullReplace(dt.Rows(k)("SBNNO"), "")) = Trim(usrUDNTRA.SBNNO) Then
                ...
                strMRPKB_BFR = DB_NullReplace(dt.Rows(k)("MRPKB"), "") '請求書発行区分

                'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'strSSADT_BFR = CF_Ora_GetDyn(usrOdy_UDNTRA, "SSADT", "") '締日付
                strSSADT_BFR = DB_NullReplace(dt.Rows(k)("SSADT"), "") '締日付
                ...
                For intCntR = 1 To UBound(pin_usrURITHA.usrBodyInf)
                    ...
                    Select Case True
                        ...
                        Case (pin_usrURITHA.JDNTRKB = gc_strJDNTRKB_SYS And pin_usrURITHA.URIKJN = gc_strURIKJN_SYK) Or pin_usrURITHA.JDNTRKB = gc_strJDNTRKB_SET
                            ...
                            If Trim(DB_NullReplace(dt.Rows(k)("JDNLINNO"), "")) = Trim(pin_usrURITHA.usrBodyInf(intCntR).LINNO) Then
                        ...
                        Case pin_usrURITHA.JDNTRKB = gc_strJDNTRKB_SYS
                            ...
                            If Trim(DB_NullReplace(dt.Rows(k)("RECNO"), "")) = Trim(pin_usrURITHA.usrBodyInf(intCntR).RECNO) Then
                        ...
                        Case Else
                            ...
                            If Trim(DB_NullReplace(dt.Rows(k)("SBNNO"), "")) = Trim(pin_usrURITHA.usrBodyInf(intCntR).SBNNO) Then
                ...
                bolRet = AE_Get_MRPKB(strMRPKB_BFR, pin_usrURITHA.bolAKAKRO(intCntH), pin_usrURITHA.DATNO(intCntH), DB_NullReplace(dt.Rows(k)("LINNO"), ""), strSSADT_BFR, pin_usrURITHA.SSADT(intCntH), strMRPKB)
                ...
                If bolUpd = True Then
                    ...
                    With usrUDNTRA
                        ...
                        Else
                            ...
                            .SIKTK = DB_NullReplace(dt.Rows(k)("SIKTK"), 0)


                            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                            '.SIKKN = CF_Ora_GetDyn(usrOdy_UDNTRA, "SIKKN", 0)
                            .SIKKN = DB_NullReplace(dt.Rows(k)("SIKKN"), 0)
                            ...
                            If curHNPNSU > 0 Then
                                ...
                                .SIKKN = CDec(DB_NullReplace(dt.Rows(k)("SIKTK"), 0)) * (curURISU - curHNPNSU)
                        ...
                        .URILINNO = DB_NullReplace(dt.Rows(k)("LINNO"), "")
...
AE_Upd_MRPKB_BfrUDNTRAData_Err: 
	...
	Public Function AE_Execute_PLSQL_TNADL71(ByRef pin_strHINCD As String, ByRef pin_strSOUCD As String, ByRef pin_curRELZAISU As Decimal) As Short
        ...
        Try
            ...
            inP5.OracleDbType = OracleDbType.Decimal
            inP6.OracleDbType = OracleDbType.Char
            inP7.OracleDbType = OracleDbType.Decimal
            outP8.OracleDbType = OracleDbType.Decimal
            outP9.OracleDbType = OracleDbType.Varchar2
            outP10.OracleDbType = OracleDbType.Decimal
            outP11.OracleDbType = OracleDbType.Decimal
            ...
            cmd.CommandText = "PRC_TNADL71_01"
            ...
            '2019/5/6 ADD START
        Catch ex As Exception
            MsgBox("AE_Execute_PLSQL_TNADL71_2 " & Constants.vbCrLf & ex.Message.ToString, MsgBoxStyle.Critical, "エラー")
        End Try
        '2019/5/6 ADD END

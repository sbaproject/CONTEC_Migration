...
Friend Class WLSHIN
	...
	Private Sub WLS_SetArray(ByVal ArrayCnt As Short)
		...
		WM_WLS_DSPArray(ArrayCnt) = LeftWid(DB_HINMTA_W.HINCD, WM_WLS_CODELEN) & Space(1) & LeftWid(DB_HINMTA_W.HINNMA, WM_WLS_HINNMALEN) & Space(1) & LeftWid(DB_HINMTA_W.HINNMB, WM_WLS_HINNMBLEN)
		'''' UPD 2009/02/19  FKS) S.Nakajima    End
	...
	Private Sub WLS_DspNew()
        ...
        For i As Integer = 0 To dsList.Tables("tableName").Rows.Count - 1
            '取得内容退避
            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            DB_HINMTA_W.HINCD = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("HINCD"), "") '製品コード
            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            DB_HINMTA_W.HINNMA = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("HINNMA"), "") '型式
            'UPGRADE_WARNING: オブジェクト CF_Ora_GetDyn() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            DB_HINMTA_W.HINNMB = DB_NullReplace(dsList.Tables("tableName").Rows(i).Item("HINNMB"), "") '商品名
    ...
    Private Sub btnF2_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnF2.Click
        ...
        Try
            If Me.HD_KATA.Focused Then
                Call HD_KATA_KeyDown(HD_KATA, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf Me.HD_CODE.Focused Then
                Call HD_CODE_KeyDown(HD_CODE, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            Else
                Call HD_HINKB_KeyDown(HD_HINKB, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            End If
...
#Enable Warning BC40000 ' Type or member is obsolete
    ...
    '20190626 ADD START
    Private Sub CS_HINKB_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CS_HINKB.Click

...
Module ORA_CMN
    ...
    Public Const ORAPARM_INPUT As Short = ParameterDirection.Input
    Public Const ORAPARM_OUTPUT As Short = ParameterDirection.Output
    Public Const ORAPARM_BOTH As Short = ParameterDirection.InputOutput
    ...
    Public Const ORATYPE_VARCHAR2 As Short = OracleDbType.Varchar2
    '2019/04/24 CHG E N D
    '2019/04/24 CHG START
    'Public Const ORATYPE_NUMBER As Short = 2
    Public Const ORATYPE_NUMBER As Short = OracleDbType.Decimal
    '2019/04/24 CHG E N D
    ...
    Public Const ORATYPE_CHAR As Short = OracleDbType.Char
    '2019/04/24 CHG E N D
...
ERR_HANDLE: 
	...
	Private Function F_Ora_Connect(ByRef pm_Oss As Object, ByRef pm_Odb As Object, ByVal pm_Host As String, ByVal pm_UserID As String, ByVal pm_Password As String, Optional ByVal pm_Option As Integer = 0) As Boolean
        ...
        '// ORACLEﾃﾞｰﾀﾍﾞｰｽに接続
        pm_Oss = CreateObject("OracleInProc.XOraSession")
...
ERR_HANDLE: 
    ...
    Public Function CF_Ora_EOF(ByRef pm_Ody As U_Ody) As Boolean
        ...
        If pm_Ody.dt Is Nothing Then
            'データテーブルはNULL場合：
            Return True
        End If

        If pm_Ody.dt.Rows.Count = 0 Then
            Return True
        End If

        If pm_Ody.rowIndex >= pm_Ody.dt.Rows.Count Then
            'EOFの場合：最後の行を超える。
            Return True
        End If
    ...
    Public Function CF_Ora_CreateDyn(ByRef pm_Odb As Object, ByRef pm_Ody As U_Ody, ByVal pm_SQL As String, Optional ByVal pm_Option As Object = Nothing) As Boolean
        ...
        Try
            ...
            Exit Function
        Catch ex As Exception
            MsgBox("CF_Ora_CreateDyn ERR_HANDLE1" + Err.ToString())
            'データなし
            DBSTAT = 1
            CF_Ora_CreateDyn = False
            Exit Function
        End Try
        '20190901 ADD END
...
ERR_HANDLE: 
    ...
    'Public Function ReplaceDBNullValue(ByVal pVal As Object, ByVal pReplaceString As Object) As Object
    ...
    Public Function CF_Ora_GetDyn(ByRef pm_Ody As U_Ody, ByVal pm_Fld As String, Optional ByVal pm_Default As Object = "", Optional ByVal pm_Format As String = "") As Object
        ...
        If pm_Ody.dt Is Nothing Then
            CF_Ora_GetDyn = pm_Default
            MsgBox("CF_Ora_GetDyn ERROR pm_Ody.dt Is Nothing")
            Exit Function
        End If

        If pm_Ody.dt.Rows.Count = 0 Then
            CF_Ora_GetDyn = pm_Default
            MsgBox("CF_Ora_GetDyn ERROR pm_Ody.dt.Rows.Count = 0")
            Exit Function
        End If

        'Get cell value in a row by its Column's name
        row = pm_Ody.dt.Rows(pm_Ody.rowIndex)
        returnValue = row.Field(Of Object)(pm_Fld)

        If returnValue Is Nothing Then
            returnValue = pm_Default
        End If

        CF_Ora_GetDyn = returnValue
        Exit Function
ERROR_HANDLER:
        MsgBox("CF_Ora_GetDyn ERROR")
...
ERR_HANDLE:
    ...
    Public Function CF_Ora_MoveNext(ByRef pm_Ody As U_Ody) As Boolean
        ...
        pm_Ody.rowIndex = pm_Ody.rowIndex + 1
        '20190901 CHG END
...
ERR_HANDLE:
    ...
    Public Function CF_Ora_USR9_Open_BAT() As Boolean

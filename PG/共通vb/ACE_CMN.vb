...
Module ACE_CMN
	...
	' === 20061127 === INSERT E -
	' === 20070131 === INSERT S - ACE)Nagasawa 仕切率桁数変更対応
	Public Const DSP_FMT_KIN_3 As String = "0" '金額(カンマ編集なし)
	Public Const DSP_FMT_KIN_4 As String = "#" '金額(カンマ編集なし，ゼロ入力なし)
	' === 20070131 === INSERT E -
	Public Const DSP_FMT_TAN_1 As String = "#,##0.00" '単価
	Public Const DSP_FMT_RT_1 As String = "#,##0.0" '率
	' === 20070131 === INSERT S - ACE)Nagasawa 仕切率桁数変更対応
	Public Const DSP_FMT_RT_2 As String = "0.0" '率(カンマ編集なし）
	' === 20070131 === INSERT E -
	...
	Public Const CLR_VALUE_SET As Short = 0
	Public Const CLR_VALUE_CLR As Short = 1
	' === 20060829 === INSERT E
	...
	'// 日付チェックの最小値と最大値
	Private Const CHK_DATE_FIRST As Integer = 19000101
	Private Const CHK_DATE_LAST As Integer = 20501231
...
#Disable Warning BC40000 ' Type or member is obsolete
        If CInt(VB6.Format(pm_str_Date, "YYYYMMDD")) < CHK_DATE_FIRST Or CInt(VB6.Format(pm_str_Date, "YYYYMMDD")) > CHK_DATE_LAST Then
...
ERR_HANDLE:
    ...
    Public Function CF_Clr_Prompt(ByRef pm_All As Cls_All) As String
        ...
        pm_All.Dsp_IM_Denkyu.Image = pm_All.Off_IM_Denkyu.Image
        '2019/03/12 CHG E N D
        'メッセージ
    ...
    Public Function CF_Set_Prompt(ByRef pm_Msg_Inf As String, ByRef pm_ForeColor As Integer, ByRef pm_All As Cls_All) As String
        ...
        pm_All.Dsp_IM_Denkyu.Image = pm_All.On_IM_Denkyu.Image
        '2019/03/12 CHG E N D
        'メッセージ
        Wk_Index = CShort(pm_All.Dsp_TX_Message.Tag)
    ...
    Public Function CF_Init_Item_Property(ByRef pm_All As Cls_All) As Short
        ...
        For Index_Wk = 1 To pm_All.Dsp_Base.Item_Cnt
            ...
            If TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.TextBox Then
                'MaxLengthB設定
                'UPGRADE_WARNING: オブジェクト pm_All.Dsp_Sub_Inf(Index_Wk).Ctl.MaxLength の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                '2019/03/12 CHG START
                'pm_All.Dsp_Sub_Inf(Index_Wk).Ctl.MaxLength = pm_All.Dsp_Sub_Inf(Index_Wk).Detail.Dsp_MaxLengthB
                Dim ctlTxt As TextBox = pm_All.Dsp_Sub_Inf(Index_Wk).Ctl
                ctlTxt.MaxLength = pm_All.Dsp_Sub_Inf(Index_Wk).Detail.Dsp_MaxLengthB
                '2019/03/12 CHG E N D
            ...
            'TabIndex/TabStop設定
            '=====================
            'UPGRADE_ISSUE: OLE オブジェクト はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6B85A2A7-FE9F-4FBE-AA0C-CF11AC86A305"' をクリックしてください。
            'UPGRADE_WARNING: TypeOf に新しい動作が指定されています。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
            '2019/03/12 CHG START
            'If TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.TextBox Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.CheckBox Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.RadioButton Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is SSCommand5 Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is SSPanel5 Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.PictureBox Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.VScrollBar Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.Label Then
            If TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.TextBox _
             Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.CheckBox _
             Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.RadioButton _
             Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is Button _
             Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is Label _
             Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.PictureBox _
             Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.VScrollBar _
             Or TypeOf pm_All.Dsp_Sub_Inf(Index_Wk).Ctl Is System.Windows.Forms.Label Then
                '2019/03/12 CHG E N D
                'TabIndex=Tagを設定
                pm_All.Dsp_Sub_Inf(Index_Wk).Ctl.TabIndex = CShort(pm_All.Dsp_Sub_Inf(Index_Wk).Ctl.Tag)
    ...
    Public Function CF_Init_Set_Body_Inf(ByRef pm_All As Cls_All) As Short
        ...
        '復元行情報初期化
        'UPGRADE_WARNING: オブジェクト pm_All.Dsp_Body_Inf.Rest_Inf.Rest_Row_Inf の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    Public Function CF_Set_Item_Not_Change(ByRef pm_Value As Object, ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All) As Short
        ...
        ' === 20070124 === UPDATE S - ACE)Nagasawa
        ...
        'UPGRADE_WARNING: オブジェクト pm_Dsp_Sub_Inf.Detail.Dsp_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        ...
        Select Case True
            ...
            Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.CheckBox
                ...
                DirectCast(pm_Dsp_Sub_Inf.Ctl, CheckBox).Checked = pm_Value
                '2019/03/12 CHG E N D
            ...
            Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.RadioButton
                ...
                '2019/03/12 CHG START
                'pm_Dsp_Sub_Inf.Ctl.Value = pm_Value
                DirectCast(pm_Dsp_Sub_Inf.Ctl, RadioButton).Checked = pm_Value
                '2019/03/12 CHG E N D
            ...
            Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.VScrollBar
                ...
                '2019/03/12 CHG START
                'pm_Dsp_Sub_Inf.Ctl.Value = pm_Value
                DirectCast(pm_Dsp_Sub_Inf.Ctl, VScrollBar).Value = pm_Value
                '2019/03/12 CHG E N D
            ...
            Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.PictureBox
                ...
                On Error Resume Next
                'UPGRADE_WARNING: オブジェクト pm_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_ISSUE: Control メソッド Ctl.Picture はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
                '2019/03/12 CHG START
                'pm_Dsp_Sub_Inf.Ctl.Image = pm_Value
                DirectCast(pm_Dsp_Sub_Inf.Ctl, PictureBox).Image = pm_Value
                '2019/03/12 CHG E N D
        ...
        If pm_All.Bd_Vs_Scrl Is Nothing = False Then
            ...
            Select Case True
                Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.VScrollBar
                    ...
                    DirectCast(pm_Dsp_Sub_Inf.Ctl, VScrollBar).Maximum = pm_Value
                    '2019/03/12 CHG E N D
                    pm_All.Dsp_Base.VS_Scr_Flg = False
        ...
        If pm_All.Bd_Vs_Scrl Is Nothing = False Then
            ...
            Select Case True
                Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.VScrollBar
                    ...
                    DirectCast(pm_Dsp_Sub_Inf.Ctl, VScrollBar).Minimum = pm_Value
                    '2019/03/12 CHG E N D
                    pm_All.Dsp_Base.VS_Scr_Flg = False
        ...
        If pm_All.Bd_Vs_Scrl Is Nothing = False Then
            ...
            Select Case True
                Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.VScrollBar
                    ...
                    DirectCast(pm_Dsp_Sub_Inf.Ctl, VScrollBar).LargeChange = pm_Value
                    '2019/03/12 CHG E N D
                    pm_All.Dsp_Base.VS_Scr_Flg = False
        ...
        If pm_All.Bd_Vs_Scrl Is Nothing = False Then
            ...
            Select Case True
                Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.VScrollBar
                    ...
                    DirectCast(pm_Dsp_Sub_Inf.Ctl, VScrollBar).SmallChange = pm_Value
                    '2019/03/12 CHG E N D
                    pm_All.Dsp_Base.VS_Scr_Flg = False
    ...
    ' === 20060829 === UPDATE ↓
    Public Function CF_Set_Item_Direct(ByRef pm_Value As Object, ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All, Optional ByRef pm_Set_Flg As Short = SET_FLG_NOMAL, Optional ByRef pm_Def_Set As Boolean = False) As Short
        ' === 20060829 === UPDATE E
    ...
    Public Function CF_Get_Item_Value(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf) As Object
        ...
        CF_Get_Item_Value = System.DBNull.Value
        ...
        Select Case True
            ...
            Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.CheckBox
                ...
                CF_Get_Item_Value = IIf(DirectCast(pm_Dsp_Sub_Inf.Ctl, CheckBox).Checked = True, 1, 0)
                '2019/03/12 CHG E N D
            ...
            Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.RadioButton
                ...
                '2019/03/12 CHG START
                'CF_Get_Item_Value = pm_Dsp_Sub_Inf.Ctl.Value
                CF_Get_Item_Value = DirectCast(pm_Dsp_Sub_Inf.Ctl, RadioButton).Checked
                '2019/03/12 CHG E N D
            ...
            Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.VScrollBar
                ...
                '2019/03/12 CHG START
                'CF_Get_Item_Value = pm_Dsp_Sub_Inf.Ctl.Value
                CF_Get_Item_Value = DirectCast(pm_Dsp_Sub_Inf.Ctl, VScrollBar).Value
                '2019/03/12 CHG E N D
            ...
            Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.PictureBox
                'ｲﾒｰｼﾞ
                'UPGRADE_WARNING: オブジェクト pm_Dsp_Sub_Inf.Ctl.Picture の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_WARNING: オブジェクト CF_Get_Item_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                '2019/03/12 CHG START
                'CF_Get_Item_Value = pm_Dsp_Sub_Inf.Ctl.Picture
                CF_Get_Item_Value = DirectCast(pm_Dsp_Sub_Inf.Ctl, PictureBox).Image
                '2019/03/12 CHG E N D
    ...
    Public Function CF_Set_Item_Focus_Ctl(ByRef pm_Value As Boolean, ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf) As Short
        ...
        'UPGRADE_WARNING: TypeOf に新しい動作が指定されています。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
        '2019/03/12 CHG START
        'If TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.TextBox Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.CheckBox Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.RadioButton Or TypeOf pm_Dsp_Sub_Inf.Ctl Is SSCommand5 Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.VScrollBar Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.PictureBox Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.Label Then
        If TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.TextBox _
         Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.CheckBox _
         Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.RadioButton _
         Or TypeOf pm_Dsp_Sub_Inf.Ctl Is Button _
         Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.VScrollBar _
         Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.PictureBox _
         Or TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.Label Then
            '2019/03/12 CHG E N D

            'TabStop初期化
            pm_Dsp_Sub_Inf.Ctl.TabStop = False
            ' === 20061230 === INSERT S - ACE)Nagasawa 背景色の変更
            'UPGRADE_WARNING: TypeOf に新しい動作が指定されています。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
                ...
                Select Case pm_Dsp_Sub_Inf.Detail.In_Typ
                    Case IN_TYP_NUM
                        ...
                        If CF_Trim_Item(Rtn_Str_Value, pm_Dsp_Sub_Inf) = "" Then
                            '未入力の場合
                            '詰文字ありの場合
                            Rtn_Str_Value = New String(Fil_Space, pm_Dsp_Sub_Inf.Detail.Dsp_MaxLengthB)
                        Else
                            '入力ありの場合
                            If pm_Dsp_Sub_Inf.Detail.Dsp_Fmt <> "" Then
                                ...
                                If pm_InPut_Flg = True Then
                                    '入力中の場合
                                    ' === 20070131 === UPDATE S - ACE)Nagasawa 仕切率桁数変更対応
                                    ...
                                    If InStr(Rtn_Str_Value, "-") = 0 Then
                                        Select Case pm_Dsp_Sub_Inf.Detail.Dsp_Fmt
                                            'カンマ編集あり、ゼロ入力可
                                            Case DSP_FMT_KIN_1, DSP_FMT_RT_1
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = VB6.Format(CF_Get_Num_Int_Part(Rtn_Str_Value), DSP_FMT_KIN_1)
#Enable Warning BC40000 ' Type or member is obsolete
                                                'カンマ編集あり、ゼロ入力不可
                                            Case DSP_FMT_KIN_2
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = VB6.Format(CF_Get_Num_Int_Part(Rtn_Str_Value), DSP_FMT_KIN_2)
#Enable Warning BC40000 ' Type or member is obsolete
                                                'カンマ編集なし、ゼロ入力可
                                            Case DSP_FMT_KIN_3, DSP_FMT_RT_2
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = VB6.Format(CF_Get_Num_Int_Part(Rtn_Str_Value), DSP_FMT_KIN_3)
#Enable Warning BC40000 ' Type or member is obsolete
                                                'カンマ編集なし、ゼロ入力不可
                                            Case DSP_FMT_KIN_4
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = VB6.Format(CF_Get_Num_Int_Part(Rtn_Str_Value), DSP_FMT_KIN_4)
#Enable Warning BC40000 ' Type or member is obsolete
                                            Case Else
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = VB6.Format(CF_Get_Num_Int_Part(Rtn_Str_Value), DSP_FMT_KIN_1)
#Enable Warning BC40000 ' Type or member is obsolete
                                    ...
                                    Else
                                        Select Case pm_Dsp_Sub_Inf.Detail.Dsp_Fmt
                                            Case DSP_FMT_KIN_1, DSP_FMT_RT_1
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = "-" & VB6.Format(Replace(CF_Get_Num_Int_Part(Rtn_Str_Value), "-", ""), DSP_FMT_KIN_1)
#Enable Warning BC40000 ' Type or member is obsolete
                                            Case DSP_FMT_KIN_2
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = "-" & VB6.Format(Replace(CF_Get_Num_Int_Part(Rtn_Str_Value), "-", ""), DSP_FMT_KIN_2)
#Enable Warning BC40000 ' Type or member is obsolete
                                            Case DSP_FMT_KIN_3, DSP_FMT_RT_2
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = "-" & VB6.Format(Replace(CF_Get_Num_Int_Part(Rtn_Str_Value), "-", ""), DSP_FMT_KIN_3)
#Enable Warning BC40000 ' Type or member is obsolete
                                            Case DSP_FMT_KIN_4
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = "-" & VB6.Format(Replace(CF_Get_Num_Int_Part(Rtn_Str_Value), "-", ""), DSP_FMT_KIN_4)
#Enable Warning BC40000 ' Type or member is obsolete
                                            Case Else
#Disable Warning BC40000 ' Type or member is obsolete
                                                Wk_Str = "-" & VB6.Format(Replace(CF_Get_Num_Int_Part(Rtn_Str_Value), "-", ""), DSP_FMT_KIN_1)
#Enable Warning BC40000 ' Type or member is obsolete
                                ...
                                Else
                                    '入力外の場合
#Disable Warning BC40000 ' Type or member is obsolete
                                    Wk_Str = VB6.Format(Rtn_Str_Value, pm_Dsp_Sub_Inf.Detail.Dsp_Fmt)
#Enable Warning BC40000 ' Type or member is obsolete
                                End If
                                ' === 20070131 === UPDATE E -
                            ...
                            If Fil_Chr <> "" Then
                                Select Case pm_Dsp_Sub_Inf.Detail.Fil_Point
                                    Case FIL_POINT_RIGHT
                                        ...
                                        Rtn_Str_Value = Rtn_Str_Value & New String(Fil_Chr, pm_Dsp_Sub_Inf.Detail.Dsp_MaxLengthB)
                                        '左からバイト数分だけ取得
                                        Rtn_Str_Value = CF_Ctr_AnsiLeftB(Rtn_Str_Value, pm_Dsp_Sub_Inf.Detail.Dsp_MaxLengthB)
                                    Case FIL_POINT_LEFT
                                        '詰文字が左詰の場合、、詰文字をバイト数(桁数として使用)を左側に追加
                                        Rtn_Str_Value = New String(Fil_Chr, pm_Dsp_Sub_Inf.Detail.Dsp_MaxLengthB) & Rtn_Str_Value
                                        '右からバイト数分だけ取得
                        ...
                        Else
                            ...
                            Else
                                If pm_Dsp_Sub_Inf.Detail.Dsp_Fmt <> "" Then
                                    '表示形式有
#Disable Warning BC40000 ' Type or member is obsolete
                                    Rtn_Str_Value = VB6.Format(Rtn_Str_Value, pm_Dsp_Sub_Inf.Detail.Dsp_Fmt)
#Enable Warning BC40000 ' Type or member is obsolete
                                End If
                            End If
                        End If
...
#Enable Warning BC40000 ' Type or member is obsolete
    ...
    Public Function CF_Set_Item_Color(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_Item_Status As String, ByRef pm_All As Cls_All, Optional ByRef pm_Color_Mode As Short = ITEM_COLOR_NOMAL) As Short
        ...
        If pm_All.Dsp_Base.Dsp_Ctg = DSP_CTG_REFERENCE Then
            ' === 20070102 === INSERT E -
            '色設定はﾃｷｽﾄﾎﾞｯｸｽのみ
            'UPGRADE_WARNING: TypeOf に新しい動作が指定されています。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
            If TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.TextBox Then
                    ...
                    Select Case pm_Item_Status
                        Case ITEM_NORMAL_STATUS
                            ...
                            Select Case pm_Dsp_Sub_Inf.Detail.Err_Status
                                ...
                                Case ERR_DEF, ERR_NOT
                                    pm_Dsp_Sub_Inf.Ctl.ForeColor = COLOR_BLACK
                                    If pm_Dsp_Sub_Inf.Ctl.TabStop = False Then
                                        '読取専用
                                        pm_Dsp_Sub_Inf.Ctl.BackColor = COLOR_GRAY
                                    Else
                                        pm_Dsp_Sub_Inf.Ctl.BackColor = COLOR_WHITE
    ...
    ' === 20070102 === INSERT S - ACE)Nagasawa 背景色変更
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    '   名称：  Function CF_Set_Item_Color2
    '   概要：  対象項目の状態(ﾌｫｰｶｽ有無、ｴﾗｰ有無)による他の項目の前景/背景色設定
    '   引数：　pm_Dsp_Sub_Inf　      :　状態判定対象項目
    '         　pm_Dsp_Sub_Inf_Color　:　前景/背景色設定項目
    '         　pm_Item_Status      　:　ﾌｫｰｶｽ受取
    '         　pm_All              　:　画面情報
    '         　pm_Item_Status      　:　前景/背景色設定のモード
    '   戻値：　なし
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Set_Item_Color2(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_Dsp_Sub_Inf_Color As Cls_Dsp_Sub_Inf, ByRef pm_Item_Status As String, ByRef pm_All As Cls_All, Optional ByRef pm_Color_Mode As Short = ITEM_COLOR_NOMAL) As Short
        Dim Set_Focus As Boolean
        ...
        If TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.TextBox Then
                ...
                Select Case pm_Item_Status
                    Case ITEM_NORMAL_STATUS
                        ...
                        Select Case pm_Dsp_Sub_Inf.Detail.Err_Status
                            '初期化、エラーなし
                            Case ERR_DEF, ERR_NOT
                                pm_Dsp_Sub_Inf_Color.Ctl.ForeColor = COLOR_BLACK
                                If pm_Dsp_Sub_Inf.Ctl.TabStop = False Then
                                    '読取専用
                                    pm_Dsp_Sub_Inf_Color.Ctl.BackColor = COLOR_GRAY
                                Else
                                    pm_Dsp_Sub_Inf_Color.Ctl.BackColor = COLOR_WHITE
                                End If

                                '必須入力の未入力エラー
                            Case ERR_NOT_INPUT
                                pm_Dsp_Sub_Inf_Color.Ctl.ForeColor = COLOR_BLACK
                                pm_Dsp_Sub_Inf_Color.Ctl.BackColor = COLOR_RED

                                'その他エラー
                            Case ERR_ELSE
                                pm_Dsp_Sub_Inf_Color.Ctl.ForeColor = COLOR_RED
                                If pm_Dsp_Sub_Inf.Ctl.TabStop = False Then
                                    '読取専用
                                    pm_Dsp_Sub_Inf_Color.Ctl.BackColor = COLOR_GRAY
                                Else
                        ...
                        Select Case pm_Dsp_Sub_Inf.Detail.Err_Status
                            ...
                            Case ERR_DEF, ERR_NOT
                                ...
                                If pm_Dsp_Sub_Inf.Ctl.TabStop = False Then
                                    ...
                                    pm_Dsp_Sub_Inf_Color.Ctl.BackColor = COLOR_GRAY
                                Else
                                    pm_Dsp_Sub_Inf_Color.Ctl.BackColor = COLOR_YELLOW
                                End If
            ...
            Else
                'ﾌｫｰｶｽ受取ＮＧ
                If pm_Dsp_Sub_Inf_Color.Ctl.TabStop = False Then
                    '読取専用
                    pm_Dsp_Sub_Inf_Color.Ctl.ForeColor = COLOR_BLACK
                    pm_Dsp_Sub_Inf_Color.Ctl.BackColor = COLOR_GRAY
                Else
            ...
            Select Case pm_Dsp_Sub_Inf.Detail.In_Typ
                            ...
                            If CF_Chk_Date(CF_Trim_Item(CF_Get_Item_Value(pm_Dsp_Sub_Inf), pm_Dsp_Sub_Inf)) = True Then
                                ...
                                Select Case pm_Date_Sel_Kbn
                                    ...
                                    Case SEL_INI_MODE_2
                                       ...
                                       'UPGRADE_WARNING: オブジェクト pm_Dsp_Sub_Inf.Ctl.SelLength の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                                        'pm_Dsp_Sub_Inf.Ctl.SelLength = 1    
                                        DirectCast(pm_Dsp_Sub_Inf.Ctl, TextBox).Select(Len(CF_Get_Item_Value(pm_Dsp_Sub_Inf)) - 2, 1)
                                        '2019/03/15 CHG E N D
                                    Case Else
                                        '定義外はなし！！
                                End Select
                ...
                Case Else
                    If pm_Dsp_Sub_Inf.Detail.Fil_Point = FIL_POINT_LEFT Then
                        ...
                        DirectCast(pm_Dsp_Sub_Inf.Ctl, TextBox).Select(0, Len(CF_Get_Item_Value(pm_Dsp_Sub_Inf)))
                        '2019/03/15 CHG E N D
                    Else
                        '詰文字が左詰以外の場合
                        '１桁
    ...
    Public Function CF_Set_Item_SetFocus(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All) As Short
        ...
        If Trg_Index >= 0 Then
            ...
            Select Case True
                '2019/03/12 CHG START
                'Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.TextBox, TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.CheckBox, TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.Button, TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.RadioButton, TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.PictureBox, TypeOf pm_Dsp_Sub_Inf.Ctl Is SSCommand5, TypeOf pm_Dsp_Sub_Inf.Ctl Is SSPanel5
                Case TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.TextBox _
                , TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.CheckBox _
                , TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.Button _
                , TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.RadioButton _
                , TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.PictureBox _
                , TypeOf pm_Dsp_Sub_Inf.Ctl Is Button _
                , TypeOf pm_Dsp_Sub_Inf.Ctl Is Label
                    '2019/03/12 CHG E N D
    ...
    Public Function CF_Jge_Input_Str(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef Pm_Moji As String) As Short
        ...
        Select Case pm_Dsp_Sub_Inf.Detail.In_Str_Typ
            ...
            Case IN_STR_TYP_X, IN_STR_TYP_XA
                ' === 20061124 === UPDATE E -
                '半角
                '''' UPD 2011/12/02  FKS) T.Yamamoto    Start    連絡票№FC11120201
                '            If Pm_Moji <> Chr$(vbKeyReturn) _
                ''            And Pm_Moji <> Chr$(vbKeyBack) _
                ''            And Pm_Moji <> Chr$(vbKeyEscape) _
                ''            And CF_Ctr_AnsiLenB(Pm_Moji) = 1 Then
                If Pm_Moji <> Chr(System.Windows.Forms.Keys.Return) And Pm_Moji <> Chr(System.Windows.Forms.Keys.Back) And Pm_Moji <> Chr(System.Windows.Forms.Keys.Escape) And Pm_Moji <> vbBack And Pm_Moji <> vbTab And Pm_Moji <> vbLf And Pm_Moji <> vbVerticalTab And Pm_Moji <> vbFormFeed And Pm_Moji <> vbCr And CF_Ctr_AnsiLenB(Pm_Moji) = 1 Then
                    '''' UPD 2011/12/02  FKS) T.Yamamoto    End
                    CF_Jge_Input_Str = 1
                    If Pm_Moji = "　" Then
                        Pm_Moji = Space(1)
                        ' === 20061124 === INSERT S - ACE)Nagasawa コードの大文字変換処理追加
            ...
            Case IN_STR_TYP_N
                ...
                If Pm_Moji <> Chr(System.Windows.Forms.Keys.Return) And Pm_Moji <> Chr(System.Windows.Forms.Keys.Back) And Pm_Moji <> Chr(System.Windows.Forms.Keys.Escape) And Pm_Moji <> vbBack And Pm_Moji <> vbTab And Pm_Moji <> vbLf And Pm_Moji <> vbVerticalTab And Pm_Moji <> vbFormFeed And Pm_Moji <> vbCr And CF_Ctr_AnsiLenB(Pm_Moji) = 2 Then
                    '''' UPD 2011/12/02  FKS) T.Yamamoto    End
                    CF_Jge_Input_Str = 1
                End If
            ...
            Case IN_STR_TYP_NX
                ...
                If Pm_Moji <> Chr(System.Windows.Forms.Keys.Return) And Pm_Moji <> Chr(System.Windows.Forms.Keys.Back) And Pm_Moji <> Chr(System.Windows.Forms.Keys.Escape) And Pm_Moji <> vbBack And Pm_Moji <> vbTab And Pm_Moji <> vbLf And Pm_Moji <> vbVerticalTab And Pm_Moji <> vbFormFeed And Pm_Moji <> vbCr Then
                    '''' UPD 2011/12/02  FKS) T.Yamamoto    End
                    CF_Jge_Input_Str = 1
    ...
    Public Function CF_Init_Clr_Dsp(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_Mode As Short, ByRef pm_All As Cls_All) As Short
        ...
        If pm_Mode = ITM_ALL_CLR Then
            ...
            Call CF_Set_Item_Clr_Value(CShort(pm_Dsp_Sub_Inf.Ctl.Tag), pm_All)
            ' === 20060829 === INSERT E
            'ﾕｰｻﾞｰ入力無
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Init_Clr_Dsp_Body(ByRef pm_Bd_Index As Short, ByRef pm_Mode As Short, ByRef pm_All As Cls_All) As Short
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Copy_Dsp_Body_Row_Inf(ByRef pm_Moto_Body_Row As Cls_Dsp_Body_Row_Inf, ByRef pm_Saki_Body_Row As Cls_Dsp_Body_Row_Inf) As Short

        Dim Max_Col As Short
        Dim Wk_Col As Short

        '１行単位の業務情報
        'UPGRADE_WARNING: オブジェクト pm_Saki_Body_Row.Bus_Inf の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        ...
        For Wk_Col = 1 To Max_Col
            'UPGRADE_WARNING: オブジェクト pm_Saki_Body_Row.Item_Detail(Wk_Col) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
...
#Enable Warning BC40000 ' Type or member is obsolete
    ...
    Public Function CF_Set_Bef_Rest_Value(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, Optional ByRef pm_Set_Flg As Short = SET_FLG_NOMAL) As Short
        ...
        Dim Dsp_Value As Object
            ...
            Select Case pm_Set_Flg
                ...
                'If DB_NullReplace(pm_Dsp_Sub_Inf.Detail.Bef_Value, "") <> IIf(TypeOf DB_NullReplace(Dsp_Value, "") Is String, Trim(DB_NullReplace(Dsp_Value, "")), Dsp_Value) Then

                '20190918 CHG START
                'If DB_NullReplace(pm_Dsp_Sub_Inf.Detail.Bef_Value, "") <> IIf(TypeOf DB_NullReplace(Dsp_Value, "") Is String, Trim(DB_NullReplace(Dsp_Value, "")), Dsp_Value) Then
                If DB_NullReplace(pm_Dsp_Sub_Inf.Detail.Bef_Value, "").ToString <> IIf(TypeOf DB_NullReplace(Dsp_Value, "") Is String, Trim(DB_NullReplace(Dsp_Value, "")), Dsp_Value).ToString Then
                    '20190918 CHG END
    ...
    Public Function CF_Set_Focus_Ctl(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All) As Boolean
        ...
        If pm_Dsp_Sub_Inf.Detail.Body_Index = 0 Then
            'コントロール配列以外の場合
            If pm_Dsp_Sub_Inf.Detail.Focus_Ctl = True Then
                If pm_Dsp_Sub_Inf.Ctl.Enabled = True And pm_Dsp_Sub_Inf.Ctl.Visible = True Then
                    Rtn_Value = True
                End If
            End If
        Else
    ...
    Public Function CF_Set_Body_Row_Status(ByRef pm_All As Cls_All) As Short
        ...
        Dim Wk_Row As Short
        Dim Iput_Wait_Row As Short
        Dim Lst_Row As Short
        Dim Fst_Def_Row As Short
        Dim Iput_Wait_Next_Row As Short
        ...
        For Wk_Row = 1 To UBound(pm_All.Dsp_Body_Inf.Row_Inf)
            ...
            '最初の｢初期状態｣
            If pm_All.Dsp_Body_Inf.Row_Inf(Wk_Row).Status = BODY_ROW_STATE_DEFAULT And Fst_Def_Row = 0 Then
                Fst_Def_Row = Wk_Row
            End If
        ...
        If pm_All.Dsp_Base.Dsp_Body_Cnt > 0 Then
            ...
            If Iput_Wait_Row > 0 Or Lst_Row > 0 Then
                If pm_All.Dsp_Body_Inf.Cur_Top_Index = 1 Then
                    '最上明細ｲﾝﾃﾞｯｸｽ＝１の場合
                    If Iput_Cnt < pm_All.Dsp_Base.Dsp_Body_Cnt And Max_Row > pm_All.Dsp_Base.Dsp_Body_Cnt Then
                        ReDim Preserve pm_All.Dsp_Body_Inf.Row_Inf(pm_All.Dsp_Base.Dsp_Body_Cnt)
                    End If
                Else
                    If Def_Cnt >= pm_All.Dsp_Base.Dsp_Body_Move_Qty And Max_Row > pm_All.Dsp_Base.Dsp_Body_Cnt Then
                        '｢初期状態｣の行が画面移動量以上でかつ
                        '画面表示明細数より配列が多い場合
                        '最大明細行を１行減らす
    ...
    Public Function CF_Set_Bd_Vs_Scrl_Max(ByRef pm_All As Cls_All) As Short
        ...
        If pm_All.Dsp_Base.Dsp_Body_Cnt > 0 Then
            ...
            End If
            If pm_All.Bd_Vs_Scrl Is Nothing = False Then
                Call CF_Set_VScrl_Max(Wk_Value, pm_All.Dsp_Sub_Inf(CShort(pm_All.Bd_Vs_Scrl.Tag)), pm_All)
            End If
        End If
    ...
    Public Function CF_Body_Bkup(ByRef pm_All As Cls_All) As Short
        ...
        If pm_All.Dsp_Base.Dsp_Body_Cnt > 0 Then
            ...
            For Wk_Row = 1 To Max_Row
                ...
                If Wk_Row >= pm_All.Dsp_Body_Inf.Cur_Top_Index And Wk_Row <= pm_All.Dsp_Body_Inf.Cur_Top_Index + pm_All.Dsp_Base.Dsp_Body_Cnt - 1 Then
                    '現在表示されている明細
                    ...
                    For Index_Wk = pm_All.Dsp_Base.Body_Fst_Idx To pm_All.Dsp_Base.Foot_Fst_Idx - 1
                        ...
                        If Wk_Dsp_Row = pm_All.Dsp_Sub_Inf(Index_Wk).Detail.Body_Index Then
                            ...
                            '画面項目詳細情報を設定
                            '条件によって変更される項目のみ
                            Call CF_Dsp_Sub_Inf_To_Dsp_Body_Inf(pm_All.Dsp_Body_Inf.Row_Inf(Wk_Row).Item_Detail(Bd_Col_Index), pm_All.Dsp_Sub_Inf(Index_Wk).Detail)
    ...
    Public Function CF_Dsp_Body_Inf_To_Dsp_Sub_Inf(ByRef pm_Dsp_Sub_Inf_Detail As Cls_Dsp_Sub_Detail_Inf, ByRef pm_Dsp_Body_Row_Inf_Item_Detail As Cls_Dsp_Sub_Detail_Inf) As Short
        ...
        ' === 20060829 === INSERT S - ACE)Sejima ★初期値セット処理★
        'UPGRADE_WARNING: オブジェクト pm_Dsp_Body_Row_Inf_Item_Detail.Def_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'UPGRADE_WARNING: オブジェクト pm_Dsp_Sub_Inf_Detail.Def_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        pm_Dsp_Sub_Inf_Detail.Def_Value = pm_Dsp_Body_Row_Inf_Item_Detail.Def_Value
        'UPGRADE_WARNING: オブジェクト pm_Dsp_Body_Row_Inf_Item_Detail.Clr_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'UPGRADE_WARNING: オブジェクト pm_Dsp_Sub_Inf_Detail.Clr_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    ' === 20090706 === INSERT S - ACE)Nagasawa 行情報にも値を退避させる（チェック前変数が元に戻る場合がある）
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    '   名称：  Function CF_Dsp_Body_Inf_Taihi
    '   概要：  ｢画面項目情報｣⇒｢画面ボディ情報｣に編集する
    '   引数：　なし
    '   戻値：　なし
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Dsp_Body_Inf_Taihi(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All) As Object

        Dim Wk_Row As Short '行
        Dim Wk_Col As Short '列

        '編集対象行取得
        Wk_Row = CF_Bd_Idx_To_Idx(pm_Dsp_Sub_Inf, pm_All)
        '編集対象列取得
        Wk_Col = CF_Get_Col_Same_Bd_Ctl(pm_Dsp_Sub_Inf, Wk_Row, pm_All)

        If Wk_Row <> 0 And Wk_Col <> 0 Then
            '行情報へ画面項目情報を退避
            Call CF_Dsp_Sub_Inf_To_Dsp_Body_Inf(pm_All.Dsp_Body_Inf.Row_Inf(Wk_Row).Item_Detail(Wk_Col), pm_Dsp_Sub_Inf.Detail)
        End If
    ...
    Public Function CF_Body_Dsp_Trg_Row(ByRef pm_All As Cls_All, ByRef pm_Row As Short) As Short
        ...
        If pm_All.Dsp_Base.Dsp_Body_Cnt > 0 Then
            ...
            If pm_All.Dsp_Body_Inf.Cur_Top_Index <= pm_Row And pm_All.Dsp_Body_Inf.Cur_Top_Index + pm_All.Dsp_Base.Dsp_Body_Cnt - 1 >= pm_Row Then
                '現在表示されている場合は、処理なし
            Else
    ...
    ''D                                  , Optional pm_Set_Flg As Integer = SET_FLG_NOMAL) As Integer
    ' === 20060829 === UPDATE ↓
    Public Function CF_Edi_Dsp_Body_Inf(ByRef pm_Value As Object, ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_Bd_Index As Short, ByRef pm_All As Cls_All, Optional ByRef pm_Set_Flg As Short = SET_FLG_NOMAL, Optional ByRef pm_Def_Set As Boolean = False) As Short
        ' === 20060829 === UPDATE E
        ...
        'UPGRADE_WARNING: オブジェクト CF_Cnv_Dsp_Item() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'UPGRADE_WARNING: オブジェクト Wk_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        Wk_Value = CF_Cnv_Dsp_Item(pm_Value, pm_Dsp_Sub_Inf, False)


        '画面項目情報(pm_All.Dsp_Sub_Inf)のの列番号を取得
        Wk_Col = CF_Get_Col_Same_Bd_Ctl(pm_Dsp_Sub_Inf, pm_Bd_Index, pm_All)
        ...
        If pm_Def_Set = True Then
            '初期値内容をセット
            'UPGRADE_WARNING: オブジェクト Wk_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'UPGRADE_WARNING: オブジェクト pm_All.Dsp_Body_Inf.Row_Inf().Item_Detail().Def_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        ...
        Select Case pm_Set_Flg
            Case SET_FLG_NOMAL
                ...
                '前回内容/復元内容を退避する
                'UPGRADE_WARNING: オブジェクト Wk_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_WARNING: オブジェクト pm_All.Dsp_Body_Inf.Row_Inf(pm_Bd_Index).Item_Detail(Wk_Col).Bef_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                If pm_All.Dsp_Body_Inf.Row_Inf(pm_Bd_Index).Item_Detail(Wk_Col).Bef_Value <> Wk_Value Then
                    '前回内容と現在内容が異なる場合
                    '復元内容に前回内容を編集
                    'UPGRADE_WARNING: オブジェクト pm_All.Dsp_Body_Inf.Row_Inf().Item_Detail().Bef_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    'UPGRADE_WARNING: オブジェクト pm_All.Dsp_Body_Inf.Row_Inf().Item_Detail().Rest_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    Public Function CF_Ctl_Input_Aft(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All) As Short
        ...
        '現在内容と復元内容を入れ換える
        ' === 20070124 === INSERT S - ACE)Nagasawa
        'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
        If IsDBNull(Rest_Value) = False Then
            ' === 20070124 === INSERT E -
            '復元内容→前回内容
            'UPGRADE_WARNING: オブジェクト Rest_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'UPGRADE_WARNING: オブジェクト pm_Dsp_Sub_Inf.Detail.Bef_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        ...
        End If
        'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
        If IsDBNull(Bef_Value) = False Then
            ' === 20070124 === INSERT E -
            '前回内容→復元内容
            'UPGRADE_WARNING: オブジェクト Bef_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'UPGRADE_WARNING: オブジェクト pm_Dsp_Sub_Inf.Detail.Rest_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        ...
        If pm_All.Dsp_Base.Dsp_Body_Cnt > 0 Then
            ...
            Select Case pm_All.Dsp_Base.Dsp_Ctg
                ...
                Case DSP_CTG_ENTRY
                    ...
                    '対象項目がボディ部の場合
                    If pm_Dsp_Sub_Inf.Detail.In_Area = IN_AREA_DSP_BD And pm_Dsp_Sub_Inf.Detail.Body_Index > 0 Then
                    ...
                    Case DSP_CTG_ENTRY, DSP_CTG_REVISION
                        ...
                        Select Case pm_All.Dsp_Body_Inf.Rest_Inf.Rest_Flg
                            Case BODY_ROW_REST_FLG_CLR
                                ...
                                If pm_All.Dsp_Body_Inf.Rest_Inf.Rest_Row >= 1 And pm_All.Dsp_Body_Inf.Rest_Inf.Rest_Row <= UBound(pm_All.Dsp_Body_Inf.Row_Inf) Then
                    ...
                    Select Case pm_Dsp_Sub_Inf.Detail.In_Typ
                        ...
                        Case Else
                            ...
                            If CF_Trim_Item(CF_Get_Item_Value(pm_Dsp_Sub_Inf), pm_Dsp_Sub_Inf) <> "" Then
                                ...
                                If DirectCast(pm_Dsp_Sub_Inf.Ctl, TextBox).SelectionLength > 0 Then
    ...
    Public Function CF_Jge_Enabled_SM_AllCopy(ByRef pm_Trg_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_Act_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All) As Boolean
        ...
        Select Case True
            ...
            Case TypeOf pm_Trg_Dsp_Sub_Inf.Ctl Is Label
                '2019/03/12 CHG E N D
                'ﾊﾟﾈﾙ
                Rtn_Value = True
        End Select
    ...
    Public Function CF_Cmn_Ctl_MN_ClearDE(ByRef pm_Bd_Index As Short, ByRef pm_All As Cls_All) As Boolean
        ...
        If Input_Wait_Cnt > 0 Then
            ...
            MsgBox("空白の明細行を先に削除してください。", MsgBoxStyle.Exclamation)
            ' === 20061019 === UPDATE E -
            CF_Cmn_Ctl_MN_ClearDE = False
            Exit Function
        End If
    ...
    Public Function CF_Cmn_Ctl_MN_InsertDE(ByRef pm_Bd_Index As Short, ByRef pm_Ins_Bd_Index As Short, ByRef pm_All As Cls_All) As Boolean
        ...
        If pm_All.Dsp_Base.Max_Body_Cnt > 0 Then
            ...
            If Iput_Cnt >= pm_All.Dsp_Base.Max_Body_Cnt Then
                ...
                MsgBox("明細行はこれ以上挿入できません。", MsgBoxStyle.Exclamation)
                ' === 20061019 === UPDATE E -
                CF_Cmn_Ctl_MN_InsertDE = False
                Exit Function
            End If
    ...
    Public Function CF_Cmn_Ctl_MN_Copy(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All) As Short
        ...
        If TypeOf pm_Dsp_Sub_Inf.Ctl Is System.Windows.Forms.TextBox Then
            ...
            If DirectCast(pm_Dsp_Sub_Inf.Ctl, TextBox).SelectionLength <= 1 Then
                '2019/03/20 CHG E N D
                '対象内容を退避
                On Error Resume Next
                'UPGRADE_WARNING: オブジェクト CF_Get_Item_Value() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            ...
            Else
                ...
                My.Computer.Clipboard.SetText(DirectCast(pm_Dsp_Sub_Inf.Ctl, TextBox).SelectedText)
                '2019/03/20 CHG E N D
                On Error GoTo 0
            End If
    ...
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    '   名称：  Function CF_Get_CcurVariant
    '   概要：  CCur関数拡張版
    '   引数：　pin_Num      : 型変換対象
    '   戻値：　型変換後の値
    '   備考：  数値として正しくない場合、ゼロを返還
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Get_CcurVariant(ByRef pin_Num As Object, Optional ByRef pin_curDefValue As Decimal = 0) As Decimal

        Dim Ret_Value As Decimal

        If IsNumeric(pin_Num) = True Then
            '数値として正しい場合は型変換
            'UPGRADE_WARNING: オブジェクト pin_Num の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            Ret_Value = CDec(pin_Num)
        Else
            '正しくない場合は第２引数の値
            '（渡されない場合はゼロ）
            Ret_Value = pin_curDefValue
    ...
    '   備考：  数値として正しくない場合、ゼロを返還
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Get_CDblString(ByRef pin_strNum As String, Optional ByRef pin_curDefValue As Double = 0) As Double
    ...
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Get_MultiString(ByRef pin_strNum1 As String, ByRef pin_strNum2 As String) As String
        ...
        If IsNumeric(pin_strNum1) = True Then
            If IsNumeric(pin_strNum2) = True Then
                ...
                Ret_Value = CStr(CDec(pin_strNum1) * CDec(pin_strNum2))
            End If
        End If
...
CF_Get_MultiString_Err:
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Set_Item_Def_Value(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, Optional ByRef pin_Def_Value As Object = Nothing) As Short

        Dim Def_Value As Object
        ...
        If IsNothing(pin_Def_Value) = False Then
            '設定値が渡された場合、そのままセット
            'UPGRADE_WARNING: オブジェクト pin_Def_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'UPGRADE_WARNING: オブジェクト Def_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        ...
        'UPGRADE_WARNING: オブジェクト Def_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'UPGRADE_WARNING: オブジェクト pm_Dsp_Sub_Inf.Detail.Def_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    '   備考：  プログラム単位の共通処理
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Set_Item_Clr_Value(ByRef pm_Index As Short, ByRef pm_All As Cls_All, Optional ByRef pm_Mode As Short = CLR_VALUE_CLR) As Short

        Dim Index_Wk As Short
        Dim Wk_Index_S As Short
        Dim Wk_Index_E As Short
        Dim Clr_Value As Object
        ...
        For Index_Wk = Wk_Index_S To Wk_Index_E
            Select Case pm_Mode
                Case CLR_VALUE_SET
                    '初期化内容を設定
                    'UPGRADE_WARNING: オブジェクト pm_All.Dsp_Sub_Inf().Detail.Def_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    'UPGRADE_WARNING: オブジェクト Clr_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    Clr_Value = pm_All.Dsp_Sub_Inf(Index_Wk).Detail.Def_Value
                    'UPGRADE_WARNING: オブジェクト Clr_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    'UPGRADE_WARNING: オブジェクト pm_All.Dsp_Sub_Inf().Detail.Clr_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    pm_All.Dsp_Sub_Inf(Index_Wk).Detail.Clr_Value = Clr_Value

                Case CLR_VALUE_CLR
                    '初期化内容をクリア
                    'UPGRADE_WARNING: オブジェクト CF_Get_Type_Clr_Value() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    'UPGRADE_WARNING: オブジェクト Clr_Value の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Get_Type_Clr_Value(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf) As Object
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Chk_ExistsIn(ByRef pm_Value As String, ByRef pm_Array() As String, Optional ByRef pm_TrimFlg As Boolean = False) As Boolean
    ...
    ' === 20060930 === INSERT S - ACE)Nagasawa
    Public Function CF_FuncKey_Execute(ByVal pm_KeyCode As Short, ByVal pm_Shift As Short) As Short

...
'   備考：
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
Public Function MF_Chk_UWRTDTTM(ByVal pin_strWRTDT As String, _
                                ByVal pin_strWRTTM As String, _
                                ByVal pin_strUWRTDT As String, _
                                ByVal pin_strUWRTTM As String) As Boolean
    ...
    If Trim(pin_strWRTDT) & Trim(pin_strWRTTM) & Trim(pin_strUWRTDT) & Trim(pin_strUWRTTM) <> _
       Trim(M_MOTO_inf.WRTDT) & Trim(M_MOTO_inf.WRTTM) & Trim(M_MOTO_inf.UWRTDT) & Trim(M_MOTO_inf.UWRTTM) Then
...
'   備考：  多明細及び、得意先Ｍ登録用
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
Public Function MF_Chk_UWRTDTTM_T(ByVal pin_strWRTDT As String, _
                                  ByVal pin_strWRTTM As String, _
                                  ByVal pin_strUWRTDT As String, _
                                  ByVal pin_strUWRTTM As String, _
                                  ByVal pin_intIDX As Integer) As Boolean
...
'''    MsgBox "B " & Trim(M_MOTO_A_inf(pin_intIDX).WRTDT) & Trim(M_MOTO_A_inf(pin_intIDX).WRTTM) & _
    ...
    If InStr(Trim(M_MOTO_A_inf(pin_intIDX).WRTDT) & Trim(M_MOTO_A_inf(pin_intIDX).WRTTM) & _
       Trim(M_MOTO_A_inf(pin_intIDX).UWRTDT) & Trim(M_MOTO_A_inf(pin_intIDX).UWRTTM), "0") <> 0 Then
...
'   備考：
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
Public Function MF_DspMsg(ByVal pin_strMsgCode As String) As Integer
...
'   備考：
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
Public Function MF_UpDown_UWRTDTTM(ByVal pin_intIDX As Integer, _
...
'   備考：
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
Public Function MF_SaveRestore_UWRTDTTM(ByVal pin_intIDX As Integer, _
...
'   備考：
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
Public Function MF_Clear_UWRTDTTM(ByVal pin_intIDX As Integer) As Boolean

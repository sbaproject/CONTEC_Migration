...
Module URKPR52_M01
	...
	Sub Loop_Mfil()
		...
		'
		Call Mfil_FromSCR(-1)
		DB_URKPR52.STTWRTDT = DeCNV_DATE((FR_SSSMAIN.HD_STTWRTDT).Text)
		DB_URKPR52.ENDWRTDT = DeCNV_DATE((FR_SSSMAIN.HD_ENDWRTDT).Text)
		DB_URKPR52.STTWRTTM = Mid(FR_SSSMAIN.HD_STTWRTTM.Text, 1, 2) & Mid(FR_SSSMAIN.HD_STTWRTTM.Text, 4, 2) & Mid(FR_SSSMAIN.HD_STTWRTTM.Text, 7, 2)
		DB_URKPR52.ENDWRTTM = Mid(FR_SSSMAIN.HD_ENDWRTTM.Text, 1, 2) & Mid(FR_SSSMAIN.HD_ENDWRTTM.Text, 4, 2) & Mid(FR_SSSMAIN.HD_ENDWRTTM.Text, 7, 2)
		DB_URKPR52.STTKSIDT = DeCNV_DATE((FR_SSSMAIN.HD_STTKSIDT).Text)
		DB_URKPR52.ENDKSIDT = DeCNV_DATE((FR_SSSMAIN.HD_ENDKSIDT).Text)
		'
		PlStat = DB_PlStart
		PlStat = DB_PlCndSet

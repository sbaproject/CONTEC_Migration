...
Module BNKPR51_M01
	...
	Sub Loop_Mfil()
		...
		G_PlCnd.sCndStr(1) = FR_SSSMAIN.HD_STTBNKCD.Text
		G_PlCnd.sCndStr(2) = FR_SSSMAIN.HD_STTBNKNM.Text
		G_PlCnd.sCndStr(3) = FR_SSSMAIN.HD_ENDBNKCD.Text
		G_PlCnd.sCndStr(4) = FR_SSSMAIN.HD_ENDBNKNM.Text

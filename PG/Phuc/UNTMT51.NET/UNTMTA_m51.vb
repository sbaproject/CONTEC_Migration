...
Module UNTMTA_M51
	...
	Sub UPDMST()
		...
		Do While I < PP_SSSMAIN.LastDe
            ...
            pWhere = "WHERE UNTCD = '" & DB_UNTMTA.UNTCD & "'"
            GetRowsCommon(DBN_UNTMTA, pWhere)
            '2019/10/11 CHG END
            ...
            If DBSTAT = 0 Then
				...
				If updkb = "削除" Then
                    ...
                    If Not dt Is Nothing Then
                        DB_UNTMTA.OPEID = DB_NullReplace(dt.Rows(0)("OPEID"), "")
                        DB_UNTMTA.CLTID = DB_NullReplace(dt.Rows(0)("CLTID"), "")
                        DB_UNTMTA.WRTDT = DB_NullReplace(dt.Rows(0)("WRTDT"), "")
                        DB_UNTMTA.WRTTM = DB_NullReplace(dt.Rows(0)("WRTTM"), "")
                    End If
                    '2019/10/11 CHG END
		...
		Do While I < PP_SSSMAIN.LastDe
            ...
            If DBSTAT = 0 Then
				...
				If updkb = "削除" Then
                    ...
                    updSQL = updSQL & "        UNTMTA "
                    updSQL = updSQL & " SET "

                    updSQL = updSQL & "UNTNM		=	'" & DB_UNTMTA.UNTNM & "' "
                    updSQL = updSQL & ",DATKB		=	'" & DB_UNTMTA.DATKB & "' "
                    updSQL = updSQL & ",RELFL		=	'" & DB_UNTMTA.RELFL & "' "
                    updSQL = updSQL & ",OPEID		=	'" & DB_UNTMTA.OPEID & "' "
                    updSQL = updSQL & ",CLTID		=	'" & DB_UNTMTA.CLTID & "' "
                    updSQL = updSQL & ",WRTTM		=	'" & DB_UNTMTA.WRTTM & "' "
                    updSQL = updSQL & ",WRTDT		=	'" & DB_UNTMTA.WRTDT & "' "

                    updSQL = updSQL & "  WHERE "
                    updSQL = updSQL & "        UNTCD     = '" & DB_UNTMTA.UNTCD & "' "
			...
			Else
                ...
                updSQL = ""
                updSQL = updSQL & " '" & DB_UNTMTA.DATKB & "' "
                updSQL = updSQL & ",'" & DB_UNTMTA.UNTCD & "' "
                updSQL = updSQL & ",'" & DB_UNTMTA.UNTNM & "' "
                updSQL = updSQL & ",'" & DB_UNTMTA.RELFL & "' "
                updSQL = updSQL & ",'" & DB_UNTMTA.OPEID & "' "
                updSQL = updSQL & ",'" & DB_UNTMTA.CLTID & "' "
                updSQL = updSQL & ",'" & DB_UNTMTA.WRTTM & "' "
                updSQL = updSQL & ",'" & DB_UNTMTA.WRTDT & "' "
                updSQL = updSQL & ",'" & DB_UNTMTA.WRTFSTTM & "' "
                updSQL = updSQL & ",'" & DB_UNTMTA.WRTFSTDT & "' "

                updSQL = DB_InsertSQL(DBN_UNTMTA, updSQL)
                DB_Execute(updSQL)
                '2019/10/11 CHG END

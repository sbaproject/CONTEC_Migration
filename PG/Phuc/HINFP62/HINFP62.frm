...
Private Sub CM_EndCm_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    CF_Set_Prompt objp_msg.Dsp_Message_Prompt(gc_strMsgHINFP62_I_007), vbBlack, pm_All
...
Private Sub CM_Execute_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    Dim objp_msg As New P_Mes
    CF_Set_Prompt objp_msg.Dsp_Message_Prompt(gc_strMsgHINFP62_I_006), vbBlack, pm_All
    Set objp_msg = Nothing
End Sub

Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    Dim I As Integer
    If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgHINFP62_I_002, pm_All) = vbNo Then
        Cancel = 1
    Else
...
Private Sub MN_EXECUTE_Click()
    ...
    Dim lngParam10          As Long
    Dim strParam11          As String * 3000
    ...
    If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgHINFP62_I_001, pm_All) = vbNo Then
...
'    End If
    ...
    '
        ...
        strParam3 = objfso.GetFile(strfile).ParentFolder
    ...
    'PL/SQLを実行する。
        ...
        gv_Odb_USR1.Parameters.Add "P11", strParam11, ORAPARM_OUTPUT
        ...
        If Not IsNull(param(11).Value) Then
            strParam11 = param(11).Value
        Else
            strParam11 = ""
        End If
        ...
        If InStr(strParam11, ":") <> 0 Then
            strlogfile = Trim(Mid(strParam11, InStr(strParam11, ":") + 1))
            strERR_CODE = Left(strParam11, InStr(strParam11, ":") - 1)
        Else
            strERR_CODE = strParam11
        End If

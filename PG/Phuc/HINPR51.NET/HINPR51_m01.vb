...
Module HINPR51_M01
	...
	Sub Loop_Mfil()
		...
		G_PlCnd.sCndStr(1) = FR_SSSMAIN.HD_KHNKB.Text
		G_PlCnd.sCndStr(2) = FR_SSSMAIN.HD_STTHINCD.Text
		G_PlCnd.sCndStr(3) = FR_SSSMAIN.HD_STTHINNM.Text
		G_PlCnd.sCndStr(4) = FR_SSSMAIN.HD_ENDHINCD.Text
		G_PlCnd.sCndStr(5) = FR_SSSMAIN.HD_ENDHINNM.Text
		'ADD START FKS)INABA 2007/06/08 *******************************
		G_PlCnd.sCndStr(6) = FR_SSSMAIN.HD_HINKB.Text
		'ADD  END  FKS)INABA 2007/06/08 *******************************
		G_PlCnd.sCltID = SSS_CLTID.Value
		G_PlInfo.FCnt = 1
		G_PlInfo.Fno(0) = DBN_HINPR51
		G_PlInfo.RCnt(0) = 1

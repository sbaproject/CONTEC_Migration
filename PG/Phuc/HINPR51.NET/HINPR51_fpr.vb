...
Module SSSMAIN0001
	...
	Sub AE_Check_SSSMAIN_ENDHINCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean)
		Dim Cn_Status7 As Object
		Dim wk_Bool As Object
		Dim Cn_Status6 As Object
		Dim AE_ColorSub As Object
		Dim Cn_Direction1 As Object
		Dim AE_SetInitValStatus As Object
		Dim AE_CtSet As Object
		Dim AE_Format As String
		Dim AE_ErrorToInteger As Object
		Dim Ck_Error As Object
		Dim AE_StatusCodeBar As Object
		Dim AE_StatusBar As Object
		Dim LenWid As Object
		Dim Cn_Code As Object
		Dim AE_FormatC As String 'Generated.
		...
		With CP_SSSMAIN(5)
			...
			If Not PP_SSSMAIN.RecalcMode Then
				...
				'UPGRADE_WARNING: オブジェクト AE_StatusBar() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				AE_StatusBar(PP_SSSMAIN.ScX) = ""
				'UPGRADE_WARNING: オブジェクト PP_SSSMAIN.ScX の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト AE_StatusCodeBar() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Sub AE_CheckSub2_SSSMAIN(ByVal pm_Tx As Short, ByVal pm_Px As Short, ByVal pm_Sw As Boolean)
		Dim AE_Controls As Object
		Dim Cn_InputOnly As Object
		Dim Cn_NormalOrV As Object
		Dim AE_ColorSub As Object
		Dim Cn_Status2 As Object 'Generated.
	...
	Sub AE_ClearDe_SSSMAIN()
		Dim Cn_ModeDataChanged As Object
	...
	Private Sub AE_CompleteCheckSub_SSSMAIN(ByVal pm_Px1 As Short, ByVal pm_Px2 As Short, ByRef pm_IncompletionC As Short, ByRef pm_IncompletionC2 As Short)
		Dim Cn_CheckBox As Object
		Dim Cn_OptionButtonC As Object
		Dim AE_GetInOutMode As Object
		Dim AE_IsNullZero As Object
		Dim Cn_Status5 As Object
	...
	Function AE_CursorCheck_SSSMAIN(ByVal pm_TypeA As Short, ByVal pm_Tx As Short) As Boolean
		...
		Dim Cn_CheckBox As Object
		Dim Cn_OutputOnly As Object 'Generated.
		If pm_Tx = -2 Then
	...
	Sub AE_CursorRestSub_SSSMAIN(ByVal pm_CurSorTo As Short)
		...
		Dim AE_CursorRest As Object 'Generated.
		'UPGRADE_WARNING: オブジェクト PP_SSSMAIN.ScX の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Sub AE_CursorRivise_SSSMAIN()
		Dim Cn_NormalOrV As Object 'Generated.
	...
	Function AE_CursorSkip_SSSMAIN() As Boolean
		Dim AE_Controls As Object
		Dim Cn_Dest0 As Object
		Dim Cn_Dest1 As Object
		Dim Cn_Direction4 As Object
		Dim Cn_Direction3 As Object
		Dim Cn_Direction2 As Object
		Dim Cn_Direction1 As Object
		Dim Cn_Direction0 As Object
		Dim Cn_DestBySkip As Object
		Dim Cn_Dest7 As Object
		Dim Cn_Dest6 As Object
		Dim Cn_Dest5 As Object
		Dim Cn_Dest4 As Object
		Dim Cn_Dest3 As Object
		Dim Cn_CursorToRest As Object
		Dim Cn_Dest2 As Object 'Generated.
	...
	Sub AE_CursorSub_SSSMAIN(ByVal pm_CurSor As Short)
		...
		Dim Cn_CuExTx As Object
		Dim Cn_CuCursorRest As Object
		Dim Cn_CursorToRest As Object
		Dim Cn_CuInit As Object
		...
		Dim Cn_OptionButtonH As Object
		Dim wk_Bool As Object
		Dim Cn_Direction2 As Object 'Generated.
		Dim wk_Tx As Short
	...
	Sub AE_Derived_SSSMAIN_hd_ENDHINNM(ByVal De_Index As Object)
		...
		Dim Cn_Status6 As Object
		Dim AE_ColorSub As Object
		Dim AE_NormData As Object 'Generated.
...
#End If
	...
	Function AE_Execute_SSSMAIN() As Short
		...
		Dim Cn_Status1 As Object
		Dim Cn_Status6 As Object
		Dim AE_Val2 As Object 'Generated.
	...
	Function AE_FuncKey_SSSMAIN(ByVal pm_KeyCode As Short, ByVal pm_Shift As Short) As Short
		Static Cn_CuCurrent As Object 'Generated.
	...
	Sub AE_InitValAll_SSSMAIN()
		...
		Dim Cn_Status0 As Object 'Generated.
		Dim wk_Px As Short
		Dim wk_De As Short
		...
		PP_SSSMAIN.MaskMode = False
		Call AE_ClearInitValStatus_SSSMAIN()
		Call AE_StatusClear(PP_SSSMAIN, SSSMSG_BAS.Cn_ClErrorStatus)
	...
	Sub AE_InitValBd_SSSMAIN()
		Dim Cn_ModeDataChanged As Object 'Generated.
		Dim wk_Px As Short
		Dim wk_InOutMode As Integer
		Dim wk_De As Short
		wk_Px = 8
	...
	Sub AE_InitVal_SSSMAIN(ByRef CP As clsCP, ByVal pm_Value As Object, ByVal pm_Status As Short)
		...
		Dim AE_CtSet As Object
		Dim AE_Tx As Object
		Dim AE_InitValSubNorm As Object 'Generated.
		Dim wk_Tx As Short
	...
	Sub AE_InOutModeM_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String)
		Static Cn_OutputOnly As Object
		Static AE_IsEnable As Object
		Static Cn_CheckBox As Object
		Static Cn_OptionButtonC As Object
		Static Cn_OptionButtonH As Object
		Static AE_Controls As Object
		Static Cn_InOutMode2 As Object
		Static AE_GetInOutMode As Object
		Static AE_Tx As Object
		Static AE_SystemError As Object
		Static Cn_AfterPrfx As Object 'Generated.
	...
	Function AE_KeyDown_SSSMAIN(ByRef Ct As System.Windows.Forms.Control, ByRef pm_KeyCode As Short, ByVal pm_Shift As Short, ByRef pm_TA As String) As Short
		Static wk_Bool As Object
		Static wk_Int As Object
		Static Cn_NormalOrV As Object
		Static AE_Color As Object
		Static Cn_Status1 As Object
		Static AE_SetInitValStatus As Object
		Static AE_SetSelLen As Object
		Static Cn_Schn As Object
		Static Cn_Snum As Object
		Static AE_Format As String
		Static AE_Numerical As Object
		Static AE_Val As Object
		Static AE_SSSWin As Object
		Static Cn_Name As Object
		Static Cn_Memo As Object
		Static LenWid As Object
		Static AE_IsEnable As Object
		Static AE_IsWritableInOutMode As Object
		Static Cn_Dest7 As Object
		Static Cn_Mode3 As Object
		Static Cn_Dest6 As Object
		Static Cn_Dest3 As Object
		Static Cn_Direction2 As Object
		Static Cn_Dest5 As Object
		Static Cn_Direction3 As Object
		Static Cn_Dest2 As Object
		Static Cn_Direction1 As Object
		Static Cn_Dest4 As Object
		Static Cn_Direction4 As Object
		Static Cn_Dest0 As Object
		Static Cn_OutputOnly As Object
		Static Cn_ListBox As Object
		Static Cn_InputOnly As Object 'Generated.
...
CheckOrSkip: 
	...
	Sub AE_Later_SSSMAIN()
		Dim Cn_Mode4 As Object
		Dim Cn_Mode3 As Object
		Dim Cn_Mode25 As Object
		Dim Cn_Mode2 As Object
		Dim Cn_Mode16 As Object
		Dim Cn_Mode15 As Object
		Dim wk_Int As Object
		Dim Cn_Mode1 As Object 'Generated.
		'UPGRADE_WARNING: オブジェクト Cn_Mode4 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト Cn_Mode3 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト Cn_Mode25 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト Cn_Mode2 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト Cn_Mode16 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト Cn_Mode15 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト Cn_Mode1 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト PP_SSSMAIN.ChOprtMode の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Sub AE_ModeChange_SSSMAIN(ByVal pm_NewMode As Short)
		Static AE_SystemError As Object
		Static Cn_Mode4 As Object
		Static Cn_Mode3 As Object
		Static Cn_Mode2 As Object
		Static AE_CursorRest As Object
		Static AE_ModeBar As Object
		Static Cn_Mode1 As Object 'Generated.
		'UPGRADE_WARNING: オブジェクト Cn_Mode4 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト Cn_Mode3 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト Cn_Mode2 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト Cn_Mode1 の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Sub AE_SetCheck_SSSMAIN(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_HandIn As Boolean)
		Dim Ck_Error As Object
		Dim AE_ErrorToInteger As Object 'Generated.
	...
	Sub AE_TabStop_SSSMAIN(ByVal pm_FromTx As Short, ByVal pm_ToTx As Short, ByVal pm_SetInOut As Boolean)
		...
		Static AE_GetInOutMode As Object
		Static AE_Controls As Object
		Static AE_Px As Object 'Generated.
		Static wk_Tx As Short
		Static wk_Px As Short

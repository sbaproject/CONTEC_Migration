...
Module SSSMAIN0001
	...
	Sub AE_Check_SSSMAIN_HINKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_KHNKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_CursorMove_SSSMAIN(ByVal pm_Tx As Short) 'Generated.
		...
		If wk_Tx < 0 Or wk_Tx >= 8 Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest) : Exit Sub
	...
	Sub AE_Derived_SSSMAIN_hd_ENDHINNM(ByVal De_Index As Object) 'Generated.
        ...
        If DB_NullReplace(CC_NewVal, "").ToString = DB_NullReplace(CP_SSSMAIN(6).CuVal, "").ToString And CP_SSSMAIN(6).StatusC >= Cn_Status6 Then
            '2019/10/07 CHG END
            Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(6), CL_SSSMAIN(6))
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
	...
	Sub AE_Derived_SSSMAIN_hd_STTHINNM(ByVal De_Index As Object) 'Generated.
        ...
        If DB_NullReplace(CC_NewVal, "").ToString = DB_NullReplace(CP_SSSMAIN(4).CuVal, "").ToString And CP_SSSMAIN(4).StatusC >= Cn_Status6 Then
            '2019/10/07 CHG END
            Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(4), CL_SSSMAIN(4))
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
...
CheckOrSkip: 
		...
		ElseIf PP_SSSMAIN.Tx = 5 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    AE_Controls(PP_SSSMAIN.CtB + 5).Text = wk_Slisted
                    Call AE_Check_SSSMAIN_ENDHINCD(AE_Val3(CP_SSSMAIN(5), AE_Controls(PP_SSSMAIN.CtB + 5).Text), Cn_Status6, True, True)
                    '2019/10/07 CHG END
                End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
	...
	Sub DP_SSSMAIN_HINKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		wk_SaveMask = PP_SSSMAIN.MaskMode
		PP_SSSMAIN.MaskMode = True
	...
	Sub DP_SSSMAIN_KHNKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		wk_SaveMask = PP_SSSMAIN.MaskMode
		PP_SSSMAIN.MaskMode = True
	...
	Function RD_SSSMAIN_HINKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
	...
	Function RD_SSSMAIN_KHNKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。

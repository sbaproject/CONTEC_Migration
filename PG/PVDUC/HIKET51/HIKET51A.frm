...
'=== 当画面の全情報を格納 =================
Private Const FM_PANEL3D1_CNT       As Integer = 21 'パネルコントロール数
...
' === 20060802 === UPDATE E -
    ...
    Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = HD_LINNO
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_CODE
...
' === 20061105 === INSERT E -
    ...
    If gv_bolHIKET51_INIT = False Then
        '終了しますか？
        If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgHIKET51_A_001, Main_Inf) = vbNo Then
            Cancel = vbCancel
            Exit Sub
        End If
    Else
        '未登録のまま終了しますか？
        If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgHIKET51_A_013, Main_Inf) = vbNo Then
            Cancel = vbCancel
            Exit Sub
        End If
    End If
...
Private Sub HD_LINNO_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
...
Private Sub HD_LINNO_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
...
Private Sub HD_LINNO_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub HD_LINNO_KeyPress(KeyAscii As Integer)
...
Private Sub HD_LINNO_LostFocus()
...
Private Sub HD_LINNO_KeyUp(KeyCode As Integer, Shift As Integer)

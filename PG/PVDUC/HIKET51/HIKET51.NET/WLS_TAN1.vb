...
Friend Class WLSTAN
	...
	Private Sub WLS_SetArray(ByVal ArrayCnt As Short)
		...
		WM_WLS_DSPArray(ArrayCnt) = LeftWid(DB_TANMTA_W.WK_DB_TANMTA.TANCD, WM_WLS_CODELEN) & Space(12) & LeftWid(DB_TANMTA_W.WK_DB_TANMTA.TANNM, WM_WLS_NAMELEN) & Space(8) & strBMNNM
		' === 20060830 === UPDATE E

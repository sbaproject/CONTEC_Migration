...
#End If
            ...
            .TimerStartUp = True
            '2019/10/15 ADD START
            SYSDT.Text = CNV_DATE(DB_UNYMTA.UNYDT)
            '2019/10/15 ADD END
        End With
...
#End If
	...
	Private Sub HD_ENDTOKCD_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_ENDTOKCD.TextChanged 'Generated.
		...
		If PP_SSSMAIN.MaskMode = False Then
            ...
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(HD_ENDTOKCD.TabIndex), HD_ENDTOKCD, FORM_LOAD_FLG) Then
                '2019/10/15 CHG END
                ' === 20110216 === UPDATE E
...
EventExitSub: 
	...
	Private Sub HD_ENDTOKNM_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_ENDTOKNM.TextChanged 'Generated.
		...
		If PP_SSSMAIN.MaskMode = False Then
            ...
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(HD_ENDTOKCD.TabIndex), HD_ENDTOKNM, FORM_LOAD_FLG) Then
                '2019/10/15 CHG END
                ' === 20110216 === UPDATE E
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
...
EventExitSub: 
	...
	Private Sub HD_FRNKB_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_FRNKB.TextChanged
		...
		If PP_SSSMAIN.MaskMode = False Then
            ...
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(HD_FRNKB.TabIndex), HD_FRNKB, FORM_LOAD_FLG) Then
                '2019/10/15 CHG END
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
...
EventExitSub: 
	...
	Private Sub HD_STTTOKCD_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_STTTOKCD.TextChanged 'Generated.
		...
		If PP_SSSMAIN.MaskMode = False Then
            ...
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(HD_STTTOKCD.TabIndex), HD_STTTOKCD, FORM_LOAD_FLG) Then
                '2019/10/15 CHG END
                ' === 20110216 === UPDATE E
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
...
EventExitSub: 
	...
	Private Sub HD_STTTOKNM_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_STTTOKNM.TextChanged 'Generated.
		...
		If PP_SSSMAIN.MaskMode = False Then
            ...
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(HD_STTTOKNM.TabIndex), HD_STTTOKNM, FORM_LOAD_FLG) Then
                '2019/10/15 CHG END
                ' === 20110216 === UPDATE E
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
...
EventExitSub: 
	...
	Private Sub HD_THSCD_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_THSCD.TextChanged 'Generated.
        ...
        If PP_SSSMAIN.MaskMode = False Then
            ...
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(2), HD_THSCD, FORM_LOAD_FLG) Then
                '2019/10/15 CHG END
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
...
EventExitSub: 
	...
	Public Function selectFile(ByRef strFile As String) As Boolean
        ...
        If CMDialogL.ShowDialog() = DialogResult.OK Then
            strFile = CMDialogL.FileName
            selectFile = True
...
err_selectFile:
	...
	Public Sub formenabled(ByVal flg As Boolean)
        ...
        '2019/10/15 ADD START                
        For Each ctrl As Control In Frame3D1.Controls
    ...
    Private Sub btnF5_Click(sender As Object, e As EventArgs) Handles btnF5.Click
        Call CM_Slist_Click(New Object, New EventArgs)
    End Sub

    Private Sub btnF9_Click(sender As Object, e As EventArgs) Handles btnF9.Click
        Call MN_AppendC_Click(New Object, New EventArgs)
    End Sub
    ...
    Private Sub btnF12_Click(sender As Object, e As EventArgs) Handles btnF12.Click
        Call CM_EndCm_Click(New Object, New EventArgs)
    End Sub

...
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function DSPMEINMA_SEARCH_A1(ByVal pin_strKEYCD As String, _
                                        ...
                                        ByRef pot_DB_MEIMTA() As TYPE_DB_MEIMTA, Optional pin_strMEICDA) As Integer
...
'ADD START FKS)INABA 2009/07/17 ****************************************************************************
'連絡票№FC09071701
        If IsNull(pin_strMEICDA) = True Or Trim$(pin_strMEICDA) = "" Then
        Else
            strSQL = strSQL & "   and  MEICDA = '" & pin_strMEICDA & "' "
        End If
...
'   備考：
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function DSPMEINMA_SEARCH_A2(ByVal pin_strKEYCD As String, _
                                        ByVal pin_strMEINMA As String) As Integer
...
'   備考：  区分での検索
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function DSPMEIKB_SEARCH(ByVal pin_strKEYCD As String, _
                                    ByRef pot_DB_MEIMTA As TYPE_DB_MEIMTA, _
                           Optional ByVal pin_strMEIKBA As String = "", _
                           Optional ByVal pin_strMEIKBB As String = "", _
                           Optional ByVal pin_strMEIKBC As String = "") As Integer
...
'   備考：
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function ENDUSRNM_SEARCH(ByVal pin_strKEYCD As String, _
                                   ByVal pin_strMEICDA As String, _
                                   ByRef pot_strENDUSRNM As String) As Integer
...
'   備考：
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function ENDUSRNM_SEARCH2(ByVal pin_strKEYCD As String, _
                                   ByVal pin_strMEINM As String) As Integer
...
'   備考：
' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function RPTTKA_CHK_SEARCH(ByVal pin_strMEINM As String) As Integer

...
Module TOKPR55_M01
	...
	Sub Loop_Mfil()
		...
		G_PlCnd.sCndStr(1) = FR_SSSMAIN.HD_STTSKCD.Text
		G_PlCnd.sCndStr(2) = FR_SSSMAIN.HD_STTSKNM.Text
		G_PlCnd.sCndStr(3) = FR_SSSMAIN.HD_ENDSKCD.Text
		G_PlCnd.sCndStr(4) = FR_SSSMAIN.HD_ENDSKNM.Text
		
		G_PlCnd.sCltID = SSS_CLTID.Value
		G_PlInfo.FCnt = 1
		G_PlInfo.Fno(0) = DBN_TOKPR55
		G_PlInfo.RCnt(0) = 1

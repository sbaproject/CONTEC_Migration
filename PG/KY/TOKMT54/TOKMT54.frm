...
Begin VB.Form FR_SSSMAIN 
   ...
   Begin VB.TextBox BD_UPDATE 
      ...
      Width           =   210
   End
   Begin Threed5.SSCommand5 CS_STTKSTDT 
      Height          =   330
      Left            =   4725
      TabIndex        =   21
      TabStop         =   0   'False
   ...
   Begin Threed5.SSCommand5 CS_TOKCD 
      ...
      RoundedCorners  =   0   'False
   End
   Begin Threed5.SSCommand5 CS_TRKRNK 
      Height          =   330
      Left            =   6060
      TabIndex        =   19
      TabStop         =   0   'False
...
' 2006/11/28  CHG END
    ...
    Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = CS_STTKSTDT
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_BD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_ELSE
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_ELSE
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 0
    ...
    Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = CS_TRKRNK
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_BD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_ELSE
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_ELSE
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 0
    ...
    Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = BD_SKHINGRP(0)
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_BD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_CODE
' 2006/11/28  CHG START  KUMEDA
'    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_X
...
' 2006/11/28  CHG END
    ...
    Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = BD_STTKSTDT(0)
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_BD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_DATE
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_NUM
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 10
    ...
    Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = BD_TRKRNK(0)
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_BD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_STR
' 2006/11/28  CHG START  KUMEDA
'    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_X
...
' 2006/11/15  ADD END
    ...
    For BD_Cnt = 1 To Main_Inf.Dsp_Base.Dsp_Body_Cnt
        ...
        Load BD_SKHINGRP(BD_Cnt)        '仕切用商品群
        Load BD_STTKSTDT(BD_Cnt)        '適用日
        Load BD_TRKRNK(BD_Cnt)          'ランク
' 2006/11/15  ADD START  KUMEDA
...
' 2006/11/15  ADD END
        ...
        Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = BD_SKHINGRP(BD_Cnt)
        Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.Body_Index = BD_Cnt
        '明細部の１行上の情報を設定
        Call CF_Copy_Def_Dsp_Body(Index_Wk, Main_Inf.Dsp_Base.Body_Col_Cnt, Main_Inf)
        ...
        Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = BD_STTKSTDT(BD_Cnt)
        Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.Body_Index = BD_Cnt
        '明細部の１行上の情報を設定
        Call CF_Copy_Def_Dsp_Body(Index_Wk, Main_Inf.Dsp_Base.Body_Col_Cnt, Main_Inf)
        ...
        Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = BD_TRKRNK(BD_Cnt)
        Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.Body_Index = BD_Cnt
        '明細部の１行上の情報を設定
        Call CF_Copy_Def_Dsp_Body(Index_Wk, Main_Inf.Dsp_Base.Body_Col_Cnt, Main_Inf)
        Index_Wk = Index_Wk + 1
...
' === 20060825 === INSERT S
    With Main_Inf.Dsp_Sub_Inf(Trg_Index)
        '対象項目が代表会社コードの場合
        If Move_Flg = False And .Ctl.NAME = FR_SSSMAIN.HD_TOKCD.NAME Then
            '入力位置が最大バイト数と同じ場合
...
' === 20060801 === INSERT S
    With Main_Inf.Dsp_Sub_Inf(Trg_Index)
        '対象項目が仕切用商品群の場合
        If Move_Flg = False And .Ctl.NAME = FR_SSSMAIN.BD_SKHINGRP(1).NAME Then
            '入力位置が最大バイト数と同じ場合
            If .Ctl.SelStart = .Detail.MaxLengthB Then
                '次の項目へ移動する処理を行う
                Move_Flg = True
...
' === 20060801 === INSERT S
    With Main_Inf.Dsp_Sub_Inf(Trg_Index)
        '対象項目がランクの場合
        If Move_Flg = False And .Ctl.NAME = FR_SSSMAIN.BD_TRKRNK(1).NAME Then
            '入力位置が最大バイト数と同じ場合
            If .Ctl.SelStart = .Detail.MaxLengthB Then
                '次の項目へ移動する処理を行う
                Move_Flg = True
...
Private Function Ctl_MN_Execute_Click() As Integer
    ...
    '代表会社コードの取得
    pv_TOKMT54_TOKCD = Trim(FR_SSSMAIN.HD_TOKCD.Text)
...
'Ｓ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｓ
    ...
    '１番目の仕切用商品群の取得
    pv_TOKMT54_SKHINGRP = Trim(FR_SSSMAIN.BD_SKHINGRP(1).Text)
    
    '１番目の適用日の取得
    pv_TOKMT54_STTKSTDT = Trim(FR_SSSMAIN.BD_STTKSTDT(1).Text)
    
    If gv_bolTOKMT54_INIT = True Then
        If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgTOKMT54_A_020, Main_Inf) = vbNo Then
            Exit Function
        End If
    End If
...
Private Function Set_Body_Location() As Integer
    ...
    For Bd_Index = 1 To Main_Inf.Dsp_Base.Dsp_Body_Cnt
        ...
        '２行目以降から
            ...
            '仕切用商品群
            BD_SKHINGRP(Bd_Index).Top = BD_UPDKB_Top + BD_UPDKB_Height * (Bd_Index - 1)
            '適用日
            BD_STTKSTDT(Bd_Index).Top = BD_UPDKB_Top + BD_UPDKB_Height * (Bd_Index - 1)
            'ランク
            BD_TRKRNK(Bd_Index).Top = BD_UPDKB_Top + BD_UPDKB_Height * (Bd_Index - 1)
' 2006/11/15  ADD START  KUMEDA
            '更新フラグ
...
Private Sub CS_STTKSTDT_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    Debug.Print "CS_STTKSTDT_MouseUp"
    Call Ctl_Item_MouseUp(CS_STTKSTDT, Button, Shift, X, Y)
End Sub

Private Sub CS_TRKRNK_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
...
Private Sub CS_STTKSTDT_KeyUp(KEYCODE As Integer, Shift As Integer)
    Debug.Print "CS_STTKSTDT_KeyUp"
    Call Ctl_Item_KeyUp(CS_STTKSTDT)
End Sub

Private Sub CS_TRKRNK_KeyUp(KEYCODE As Integer, Shift As Integer)
...
Private Sub BD_SKHINGRP_Change(Index As Integer)
    Debug.Print "BD_SKHINGRP_Change"
    Call Ctl_Item_Change(BD_SKHINGRP(Index))
End Sub

Private Sub BD_STTKSTDT_Change(Index As Integer)
    Debug.Print "BD_STTKSTDT_Change"
    Call Ctl_Item_Change(BD_STTKSTDT(Index))
End Sub

Private Sub BD_TRKRNK_Change(Index As Integer)
...
Private Sub BD_SKHINGRP_GotFocus(Index As Integer)
...
Private Sub BD_STTKSTDT_GotFocus(Index As Integer)
...
Private Sub BD_TRKRNK_GotFocus(Index As Integer)
...
Private Sub BD_SKHINGRP_KeyDown(Index As Integer, KEYCODE As Integer, Shift As Integer)
    Debug.Print "BD_SKHINGRP_KeyDown"
    Call Ctl_Item_KeyDown(BD_SKHINGRP(Index), KEYCODE, Shift)
End Sub

Private Sub BD_STTKSTDT_KeyDown(Index As Integer, KEYCODE As Integer, Shift As Integer)
    Debug.Print "BD_STTKSTDT_KeyDown"
    Call Ctl_Item_KeyDown(BD_STTKSTDT(Index), KEYCODE, Shift)
End Sub

Private Sub BD_TRKRNK_KeyDown(Index As Integer, KEYCODE As Integer, Shift As Integer)
...
Private Sub BD_SKHINGRP_KeyPress(Index As Integer, KeyAscii As Integer)
    Debug.Print "BD_SKHINGRP_KeyPress"
    Call Ctl_Item_KeyPress(BD_SKHINGRP(Index), KeyAscii)
End Sub

Private Sub BD_STTKSTDT_KeyPress(Index As Integer, KeyAscii As Integer)
    Debug.Print "BD_STTKSTDT_KeyPress"
    Call Ctl_Item_KeyPress(BD_STTKSTDT(Index), KeyAscii)
End Sub

Private Sub BD_TRKRNK_KeyPress(Index As Integer, KeyAscii As Integer)
...
Private Sub BD_SKHINGRP_KeyUp(Index As Integer, KEYCODE As Integer, Shift As Integer)
    Debug.Print "BD_SKHINGRP_KeyUp"
    Call Ctl_Item_KeyUp(BD_SKHINGRP(Index))
End Sub

Private Sub BD_STTKSTDT_KeyUp(Index As Integer, KEYCODE As Integer, Shift As Integer)
    Debug.Print "BD_STTKSTDT_KeyUp"
    Call Ctl_Item_KeyUp(BD_STTKSTDT(Index))
End Sub

Private Sub BD_TRKRNK_KeyUp(Index As Integer, KEYCODE As Integer, Shift As Integer)
...
Private Sub BD_SKHINGRP_LostFocus(Index As Integer)
    Debug.Print "BD_SKHINGRP_LostFocus"
    Call Ctl_Item_LostFocus(BD_SKHINGRP(Index))
End Sub

Private Sub BD_STTKSTDT_LostFocus(Index As Integer)
    Debug.Print "BD_STTKSTDT_LostFocus"
    Call Ctl_Item_LostFocus(BD_STTKSTDT(Index))
End Sub

Private Sub BD_TRKRNK_LostFocus(Index As Integer)
...
Private Sub BD_SKHINGRP_MouseDown(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    Debug.Print "BD_SKHINGRP_MouseDown"
    Call Ctl_Item_MouseDown(BD_SKHINGRP(Index), Button, Shift, X, Y)
End Sub

Private Sub BD_STTKSTDT_MouseDown(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    Debug.Print "BD_STTKSTDT_MouseDown"
    Call Ctl_Item_MouseDown(BD_STTKSTDT(Index), Button, Shift, X, Y)
End Sub

Private Sub BD_TRKRNK_MouseDown(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
...
Private Sub BD_SKHINGRP_MouseUp(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    Debug.Print "BD_SKHINGRP_MouseUp"
    Call Ctl_Item_MouseUp(BD_SKHINGRP(Index), Button, Shift, X, Y)
End Sub

Private Sub BD_STTKSTDT_MouseUp(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    Debug.Print "BD_STTKSTDT_MouseUp"
    Call Ctl_Item_MouseUp(BD_STTKSTDT(Index), Button, Shift, X, Y)
End Sub

Private Sub BD_TRKRNK_MouseUp(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)

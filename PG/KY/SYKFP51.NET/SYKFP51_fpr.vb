...
Module SSSMAIN0001
	...
	Sub AE_Check_SSSMAIN_ODNYTDT(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(0)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ODNYTDT_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal))
			Else
				'UPGRADE_WARNING: オブジェクト ODNYTDT_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ODNYTDT_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal))
	...
	Sub AE_Check_SSSMAIN_SOUCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(1)
			...
			If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト SOUCD_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_WRTFSTDT(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_WRTFSTTM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
...
#End If
	...
	Sub AE_InitValHd_SSSMAIN(ByVal pm_Px As Short, ByVal pm_SetInOut As Short, ByVal pm_Status As Short) 'Generated.
		...
		End If
		If pm_Px = -2 Or pm_Px = 0 Then 'ODNYTDT
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(0), ODNYTDT_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(0).CuVal)), pm_Status)
		End If
		...
		End If
		If pm_Px = -2 Or pm_Px = 3 Then 'OPEID
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(3), OPEID_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3).CuVal), PP_SSSMAIN, CP_SSSMAIN(3)), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 4 Then 'OPENM
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(4), OPENM_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(4).CuVal), PP_SSSMAIN, CP_SSSMAIN(4)), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 5 Then 'WRTFSTDT
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(5), WRTFSTDT_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5).CuVal), PP_SSSMAIN, CP_SSSMAIN(5)), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 6 Then 'WRTFSTTM
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(6), WRTFSTTM_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(6).CuVal), PP_SSSMAIN, CP_SSSMAIN(6)), pm_Status)
		End If
	End Sub
...
CheckOrSkip: 
	...
	Sub AE_RecalcHd_SSSMAIN() 'Generated.
		...
		If AE_GetInOutMode(CP_SSSMAIN(0).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(0).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(0).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_ODNYTDT(AE_Val2(CP_SSSMAIN(0)), CP_SSSMAIN(0).StatusF, False, False)
		End If
		...
		If AE_GetInOutMode(CP_SSSMAIN(3).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(3).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(3).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_OPEID(AE_Val2(CP_SSSMAIN(3)), CP_SSSMAIN(3).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(4).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(4).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(4).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_OPENM(AE_Val2(CP_SSSMAIN(4)), CP_SSSMAIN(4).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(5).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(5).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(5).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_WRTFSTDT(AE_Val2(CP_SSSMAIN(5)), CP_SSSMAIN(5).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(6).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(6).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(6).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_WRTFSTTM(AE_Val2(CP_SSSMAIN(6)), CP_SSSMAIN(6).StatusF, False, False)
		End If
		...
		ElseIf PP_SSSMAIN.Tx < 7 Then 
			Select Case PP_SSSMAIN.Px
				...
				Case 4
					...
					End If
				Case 5
					Call AE_Check_SSSMAIN_WRTFSTDT(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 6
					Call AE_Check_SSSMAIN_WRTFSTTM(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
			End Select
		End If
		...
		ElseIf PP_SSSMAIN.Tx = 0 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    'Call AE_Check_SSSMAIN_ODNYTDT(AE_Val3(CP_SSSMAIN(0), AE_Controls(PP_SSSMAIN.CtB + 0).ToString()), Cn_Status6, True, True)
                    Call AE_Check_SSSMAIN_ODNYTDT(AE_Val3(CP_SSSMAIN(0), AE_Controls(PP_SSSMAIN.CtB + 0).Text), Cn_Status6, True, True)
	...
	Sub DP_SSSMAIN_WRTFSTDT(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		wk_SaveMask = PP_SSSMAIN.MaskMode
		PP_SSSMAIN.MaskMode = True
	...
	Sub DP_SSSMAIN_WRTFSTTM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		wk_SaveMask = PP_SSSMAIN.MaskMode
		PP_SSSMAIN.MaskMode = True
	...
	Function RD_SSSMAIN_ODNYTDT(ByVal De As Short) As Object 'Generated.
		...
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_ODNYTDT = VB6.Format(CP_SSSMAIN(0).CuVal, "YYYYMMDD")
		End If
	End Function
	...
	Function RD_SSSMAIN_OPEID(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 6 Then
				...
				RD_SSSMAIN_OPEID = CStr(CP_SSSMAIN(3).CuVal) & Space(6 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_OPEID の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_OPEID = CStr(CP_SSSMAIN(3).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_OPENM(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_OPENM = CStr(CP_SSSMAIN(4).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_OPENM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_OPENM = CStr(CP_SSSMAIN(4).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_WRTFSTDT(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(5).CuVal) Then
			RD_SSSMAIN_WRTFSTDT = Space(8)
		ElseIf Not IsDate(CP_SSSMAIN(5).CuVal) Then 
			RD_SSSMAIN_WRTFSTDT = Space(8)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_WRTFSTDT = VB6.Format(CP_SSSMAIN(5).CuVal, "YYYYMMDD")
		End If
	End Function
	
	Function RD_SSSMAIN_WRTFSTTM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(6).CuVal) Then
			RD_SSSMAIN_WRTFSTTM = Space(8)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 8 Then
				...
				RD_SSSMAIN_WRTFSTTM = CStr(CP_SSSMAIN(6).CuVal) & Space(8 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_WRTFSTTM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_WRTFSTTM = CStr(CP_SSSMAIN(6).CuVal)
			End If
		End If
	End Function
End Module
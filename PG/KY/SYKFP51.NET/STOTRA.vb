...
Module STOTRA_DBM
	'==========================================================================
	'   STOTRA.DBM   欠品ファイル                     UPD.EXE Ver 3, 0, 1, 2  =
	'==========================================================================
	Structure TYPE_DB_STOTRA
		...
		Dim ZAISU As Decimal '在庫数                                    
		Dim OTPSU As Decimal '出荷実績数量          #,###,##0.00;;#     
		Dim HIKSU As Decimal '引当数                #,###,##0.00;;#     
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
		<VBFixedString(8),System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray,SizeConst:=8)> Public NXTINDT() As Char '次回入庫日                                
		Dim NXTINSU As Decimal '次回入庫数                                
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
		<VBFixedString(1),System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray,SizeConst:=1)> Public MORDKB() As Char '通販出荷区分                              
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
	...
	End Structure
	Public DB_STOTRA As TYPE_DB_STOTRA
	Public DBN_STOTRA As Short
	' Index1( SOUCD + ODNYTDT + HINCD )
	...
	Sub STOTRA_RClear()
        ...
        'TmpStat = Dll_RClear(DBN_STOTRA, G_LB)
        'Call ResetBuf(DBN_STOTRA)

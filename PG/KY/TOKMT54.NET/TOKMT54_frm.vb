...
Friend Class FR_SSSMAIN
    ...
    Private Function Ctl_MN_APPENDC_Click() As Short
        ...
        Call CF_Set_Frm_IN_TOKMT54(Me, Main_Inf)
        '2019/10/21 CHG E N D
        '初期フォーカス位置設定
    ...
    'add start 20190910 kuwa 入力担当者名が表示されない不具合を修正
    '2019/10/21 ADD START
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Set_Frm_IN_TOKMT54(ByRef pm_Form As FR_SSSMAIN, ByRef pm_All As Cls_All) As Short

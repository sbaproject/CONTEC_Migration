...
Module ADNTRA_DBM
	'==========================================================================
	'   ADNTRA.DBM   入荷予定トラン                   UPD.EXE Ver 3, 0, 1, 2  =
	'==========================================================================
	Structure TYPE_DB_ADNTRA
		...
		Dim ARVTK As Decimal '入荷予定単価          ##,###,##0.00;;#    
		Dim ARVKN As Decimal '入荷予定金額          #,###,###,###       
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
	...
	End Structure
	Public DB_ADNTRA As TYPE_DB_ADNTRA
	Public DBN_ADNTRA As Short
	' Index1( DATNO + LINNO )

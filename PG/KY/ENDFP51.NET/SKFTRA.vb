...
Module SKFTRA_DBM
	'==========================================================================
	'   SKFTRA.DBM   初期不良トラン                   UPD.EXE Ver 3, 0, 1, 2  =
	'==========================================================================
	Structure TYPE_DB_SKFTRA
	...
	End Structure
	Public DB_SKFTRA As TYPE_DB_SKFTRA
	Public DBN_SKFTRA As Short
	' Index1( DATNO + LINNO )
	...
	Sub SKFTRA_RClear()
        ...
        'TmpStat = Dll_RClear(DBN_SKFTRA, G_LB)
        'Call ResetBuf(DBN_SKFTRA)

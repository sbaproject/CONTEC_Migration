...
Module IDNTRA_DBM
	'==========================================================================
	'   IDNTRA.DBM   入荷トラン                       UPD.EXE Ver 3, 0, 1, 2  =
	'==========================================================================
	Structure TYPE_DB_IDNTRA
		...
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
		<VBFixedString(3),System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray,SizeConst:=3)> Public ADNLINNO() As Char '行番号                ##                  
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
		...
		Dim INPTK As Decimal '入荷単価              ###,###,##0.0000;;# 
		Dim INPKN As Decimal '入荷金額              ###,###,##0.0000;;# 
	...
	End Structure
	Public DB_IDNTRA As TYPE_DB_IDNTRA
	Public DBN_IDNTRA As Short
	' Index1( DATNO + LINNO )

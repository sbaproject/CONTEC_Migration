...
Module SSSMAIN0001
	...
	Public CP_SSSMAIN(182 + 12 + 0 + 1) As clsCP
	Public CL_SSSMAIN(182) As Short
	Public CQ_SSSMAIN(14) As String
	...
	Sub AE_Check_SSSMAIN_HINCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = HINCD_CheckC(CC_NewVal, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(8 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト HINCD_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = HINCD_CheckC(CC_NewVal, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(8 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			...
			If AE_ErrorToInteger(Ck_Error) = 0 Or (pm_Status >= Cn_Status7 And PP_SSSMAIN.CheckErrNglct) Then
				...
				Else
					...
					If Not PP_SSSMAIN.RecalcMode Then
						...
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(10 + 12 * PP_SSSMAIN.De).ExVal = CP_SSSMAIN(10 + 12 * PP_SSSMAIN.De).CuVal 'ULTTKKB
						CP_SSSMAIN(10 + 12 * PP_SSSMAIN.De).ExStatus = CP_SSSMAIN(10 + 12 * PP_SSSMAIN.De).StatusC
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).ExVal = CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal 'URITKDT
						CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).ExStatus = CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).StatusC
						If Not wk_Equal Or ex_CheckRtnCode <> 0 Then Call AE_Derived_SSSMAIN_bd_ULTTKKB(PP_SSSMAIN.De2)
						If Not wk_Equal Or ex_CheckRtnCode <> 0 Then Call AE_Derived_SSSMAIN_bd_URITKDT(PP_SSSMAIN.De2)
						...
						End If
					End If
					' === 20080904 === INSERT S - RISE)Izumi
					
					wk_PxBase = 12 * PP_SSSMAIN.De2
					If CP_SSSMAIN(2 + wk_PxBase).TpStr = "更新" Or CP_SSSMAIN(2 + wk_PxBase).TpStr = "削除" Then
						M_TOKMT_A_inf(PP_SSSMAIN.De2).OPEID = DB_TOKMTC.OPEID '最終作業者コード
						M_TOKMT_A_inf(PP_SSSMAIN.De2).CLTID = DB_TOKMTC.CLTID 'クライアントＩＤ
						M_TOKMT_A_inf(PP_SSSMAIN.De2).UOPEID = DB_TOKMTC.UOPEID '最終作業者コード（バッチ）
						M_TOKMT_A_inf(PP_SSSMAIN.De2).UCLTID = DB_TOKMTC.UCLTID 'クライントＩＤ（バッチ）
						M_TOKMT_A_inf(PP_SSSMAIN.De2).WRTDT = DB_TOKMTC.WRTDT '更新日付
						M_TOKMT_A_inf(PP_SSSMAIN.De2).WRTTM = DB_TOKMTC.WRTTM '更新時刻
						M_TOKMT_A_inf(PP_SSSMAIN.De2).UWRTDT = DB_TOKMTC.UWRTDT 'バッチ更新日付
						M_TOKMT_A_inf(PP_SSSMAIN.De2).UWRTTM = DB_TOKMTC.UWRTTM 'バッチ更新時刻
					Else
						M_TOKMT_A_inf(PP_SSSMAIN.De2).OPEID = "" '最終作業者コード
						M_TOKMT_A_inf(PP_SSSMAIN.De2).CLTID = "" 'クライアントＩＤ
						M_TOKMT_A_inf(PP_SSSMAIN.De2).UOPEID = "" '最終作業者コード（バッチ）
						M_TOKMT_A_inf(PP_SSSMAIN.De2).UCLTID = "" 'クライントＩＤ（バッチ）
						M_TOKMT_A_inf(PP_SSSMAIN.De2).WRTDT = "" '更新日付
						M_TOKMT_A_inf(PP_SSSMAIN.De2).WRTTM = "" '更新時刻
						M_TOKMT_A_inf(PP_SSSMAIN.De2).UWRTDT = "" 'バッチ更新日付
						M_TOKMT_A_inf(PP_SSSMAIN.De2).UWRTTM = "" 'バッチ更新時刻
					End If
					' === 20080904 === INSERT E - RISE)Izumi
				End If
			Else
				Call AE_SetInitValStatus(PP_SSSMAIN, CP_SSSMAIN(wk_Px))
	...
	Sub AE_Check_SSSMAIN_TOKCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(wk_Px)
            ...
            If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = TOKCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(8 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト TOKCD_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = TOKCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(8 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_TUKKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
            ...
            If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = TUKKB_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト TUKKB_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = TUKKB_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_ULTTKKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		Dim wk_Tx As Short
		Dim wk_Px As Short
		wk_Px = 10 + 12 * PP_SSSMAIN.De
		wk_Tx = AE_Tx(PP_SSSMAIN, wk_Px)
		Dim ex_CheckRtnCode As Short
		Dim wk_SaveVal As Object
		With CP_SSSMAIN(wk_Px)
			ex_CheckRtnCode = .CheckRtnCode
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            ...
            End If
            'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            'UPGRADE_WARNING: オブジェクト wk_SaveVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            wk_SaveVal = CC_NewVal
			...
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CC_NewVal = AE_NullCnv1_SSSMAIN(CC_NewVal)
			If PP_SSSMAIN.RecalcMode Then
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = .CheckRtnCode
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ULTTKKB_CheckC(CC_NewVal, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト ULTTKKB_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ULTTKKB_CheckC(CC_NewVal, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			...
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			If IsDbNull(wk_SaveVal) And CC_NewVal = 0 Then CC_NewVal = System.DBNull.Value
			wk_SaveMask = PP_SSSMAIN.MaskMode
			PP_SSSMAIN.MaskMode = True
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Sub AE_Check_SSSMAIN_URITK(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = URITK_CheckC(AE_NullCnv1_SSSMAIN(CC_NewVal))
			Else
				'UPGRADE_WARNING: オブジェクト URITK_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = URITK_CheckC(AE_NullCnv1_SSSMAIN(CC_NewVal))
	...
	Sub AE_Check_SSSMAIN_URITKDT(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = URITKDT_CheckC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト URITKDT_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = URITKDT_CheckC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
	...
	Sub AE_ClearItm_SSSMAIN(ByVal pm_HandIn As Boolean) 'Generated.
		...
		If PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 137 Then
	...
	Function AE_CompleteCheck_SSSMAIN(ByVal pm_HeadCheck As Boolean) As Short 'Generated.
		...
		Do While Wk_De < PP_SSSMAIN.LastDe And PP_SSSMAIN.InCompletePx = -1
			wk_Px = 2 + 12 * Wk_De
			Call AE_CompleteCheckSub_SSSMAIN(wk_Px, wk_Px + 12, wk_IncompletionC, wk_IncompletionC2)
			Wk_De = Wk_De + 1
		Loop 
	...
	Sub AE_CursorCurrent_SSSMAIN() 'Generated.
		...
		If PP_SSSMAIN.Tx >= 0 And PP_SSSMAIN.Tx < 137 Then
	...
	Function AE_CursorDown_SSSMAIN(ByVal pm_Tx As Short, Optional ByVal pm_Int As Object = Nothing) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx < 137
			If wk_Tx < 1 Or wk_Tx >= 137 Then
				wk_Tx = wk_Tx + 1
			ElseIf wk_Tx = 1 Then 
				If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 1) >= 0 Then
					Do 
						wk_Tx = wk_Tx + 1
						If ((wk_Tx - 2) \ 9) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then Exit Do
						...
						If wk_Tx = PP_SSSMAIN.NrBodyTx - 1 Then
							If PP_SSSMAIN.TopDe < 14 - PP_SSSMAIN.MaxDspC Then
								...
								If PP_SSSMAIN.TopDe = wk_ExTopDe + 1 Then wk_Tx = wk_Tx - 9
							End If
						End If
					Loop Until wk_Tx >= PP_SSSMAIN.NrBodyTx - 1
				End If
				wk_Tx = 137
			ElseIf wk_Tx + 9 < PP_SSSMAIN.NrBodyTx Then 
				wk_Tx = wk_Tx + 9
				If ((wk_Tx - 2) \ 9) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 137
				'     以降は (wk_Tx + 9 >= PP_SSSMAIN.NrBodyTx) の場合
			ElseIf PP_SSSMAIN.TopDe < 14 - PP_SSSMAIN.MaxDspC Then 
				If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 12) >= 0 Then
					wk_Tx = wk_Tx + 9
					If ((wk_Tx - 2) \ 9) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then
						wk_Tx = 137
					Else
						wk_ExTopDe = PP_SSSMAIN.TopDe
						Call AE_Scrl_SSSMAIN(PP_SSSMAIN.TopDe + 1, False)
	...
	Sub AE_CursorMove_SSSMAIN(ByVal pm_Tx As Short) 'Generated.
		...
		If wk_Tx < 0 Or wk_Tx >= 137 Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest) : Exit Sub
	...
	Function AE_CursorNext_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx < 137
			...
			If wk_Tx = PP_SSSMAIN.NrBodyTx Then
				...
				End If
			End If
			If wk_Tx >= 2 And wk_Tx < 137 Then 'AE_BodyN > 0
				If ((wk_Tx - 2) \ 9) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 137
			End If
			If wk_Tx < 137 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
	...
	Function AE_CursorNextDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx < 136
			wk_Tx = wk_Tx + 1
			If wk_Tx = PP_SSSMAIN.NrBodyTx Then wk_Tx = 137
			If wk_Tx < 137 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
					Call AE_CursorMove_SSSMAIN(wk_Tx)
	...
	Function AE_CursorPrev_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx >= 0
			If wk_Tx = 137 Then
				wk_Tx = PP_SSSMAIN.NrBodyTx - 9
				wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 9
				...
				If wk_Tx >= 2 Then
					Do 
						...
						End If
						wk_Tx = wk_Tx + 1
						If (wk_Tx - 2) Mod 9 = 0 Then wk_Tx = wk_Tx - 9 - 9
						If wk_Tx < 2 Then
	...
	Function AE_CursorPrevDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx >= 0
			If wk_Tx = 137 Then wk_Tx = PP_SSSMAIN.NrBodyTx
			wk_Tx = wk_Tx - 1
			If wk_Tx >= 0 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
					Call AE_CursorMove_SSSMAIN(wk_Tx)
	...
	Function AE_CursorSkip_SSSMAIN() As Boolean 'Generated.
		...
		Select Case PP_SSSMAIN.CursorDest
			...
			Case Cn_Dest3
				If Not AE_CursorPrev_SSSMAIN(137) Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest)
			Case Cn_Dest4
			...
			Case Else
				Select Case PP_SSSMAIN.CursorDirection
					...
					Case Cn_Direction2
						...
						If PP_SSSMAIN.CursorDest = Cn_Dest1 And wk_Bool = False Then wk_Bool = AE_CursorPrev_SSSMAIN(137)
						PP_SSSMAIN.CursorDirection = wk_CursorDirection
					Case Cn_Direction3
	...
	Function AE_CursorUp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx >= 0
			If wk_Tx < 2 Or wk_Tx > 137 Then
				wk_Tx = wk_Tx - 1
			ElseIf wk_Tx = 137 Then 
				wk_Tx = PP_SSSMAIN.NrBodyTx - 9
				wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 9
				If wk_LastTx < wk_Tx Then wk_Tx = wk_LastTx
				Do While wk_Tx >= 2
	...
	Sub AE_DeRestore_SSSMAIN(ByVal pm_De As Short) 'Generated.
		...
		wk_SaveDe = PP_SSSMAIN.De : wk_SaveDe2 = PP_SSSMAIN.De2
		PP_SSSMAIN.MaskMode = True
		wk_PxBaseTarget = 2 + 12 * pm_De
		wk_ww = 0
		PP_SSSMAIN.SuppressMultiTlDerived = True
		' === 20080904 === UPDATE S - RISE)Izumi チェック項目追加
		''2007/12/26 add-str T.KAWAMUKAI
		'      bolRet = MF_SaveRestore_UWRTDTTM(pm_De, 1)      '復元
		''2007/12/26 add-end T.KAWAMUKAI
		bolRet = TOKMT52_MF_SaveRestore_UWRTDTTM(pm_De, 1) '復元
		' === 20080904 === UPDATE E - RISE)Izumi
		Do While wk_ww < 12
			If wk_ww + 1 = 12 Then PP_SSSMAIN.SuppressMultiTlDerived = False
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			If CP_SSSMAIN(183 + wk_ww).StatusC <> Cn_Status8 Or IsDbNull(CP_SSSMAIN(183 + wk_ww).CuVal) Then
                ...
                If wk_Tx >= 0 Then AE_Controls(PP_SSSMAIN.CtB + wk_Tx).Text = AE_Tpstr(CP_SSSMAIN(183 + wk_ww).TpStr, CP_SSSMAIN(183 + wk_ww).TypeA)
                '2019/10/18 CHG E N D
	...
	Sub AE_Derived_SSSMAIN_bd_ULTTKKB(ByVal De_Index As Object) 'Generated.
		...
		If PP_SSSMAIN.DerivedOrigin <> "" Then
			...
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CC_NewVal = ULTTKKB_DerivedC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv1_SSSMAIN(CP_SSSMAIN(10 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
	...
	Sub AE_Derived_SSSMAIN_bd_URITKDT(ByVal De_Index As Object) 'Generated.
		Dim CC_NewVal As Object
		Dim wk_SaveMask As Boolean
		Dim wk_Px As Short
		wk_Px = 7 + 12 * PP_SSSMAIN.De
		If PP_SSSMAIN.DerivedOrigin <> "" Then
			...
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CC_NewVal = URITKDT_DerivedC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
			If IsNothing(CC_NewVal) Then Exit Sub
			CP_SSSMAIN(wk_Px).CheckRtnCode = 0
			'UPGRADE_WARNING: オブジェクト AE_NormData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Sub AE_DeSave_SSSMAIN(ByVal pm_De As Short) 'Generated.
		...
		'      bolRet = TOKMT52_MF_SaveRestore_UWRTDTTM(pm_De, 1)      '復元
		bolRet = TOKMT52_MF_SaveRestore_UWRTDTTM(pm_De, 0) '退避
	...
	Sub AE_DeSub_SSSMAIN(ByVal pm_UD As Short) 'Generated.
		...
		'2007/12/26 add-end T.KAWAMUKAI
		wk_SaveDe = PP_SSSMAIN.De : wk_SaveDe2 = PP_SSSMAIN.De2
		wk_PxBaseTarget = 2 + 12 * PP_SSSMAIN.De
		wk_PxBaseSource = wk_PxBaseTarget + pm_UD * 12
		wk_ww = 0
		' === 20080904 === UPDATE S - RISE)Izumi チェック項目の追加
		''2007/12/26 add-str T.KAWAMUKAI
		'       bolRet = MF_UpDown_UWRTDTTM(PP_SSSMAIN.De, pm_UD)      '明細　削除・挿入
		''2007/12/26 add-end T.KAWAMUKAI
		bolRet = TOKMT52_MF_UpDown_UWRTDTTM(PP_SSSMAIN.De, pm_UD) '明細　削除・挿入
		' === 20080904 === UPDATE E - RISE)Izumi
		Do While wk_ww < 12
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
...
#End If
	...
	Sub AE_InitValBdDe_SSSMAIN(ByVal pm_Px As Short, ByVal pm_SetInOut As Short, ByVal pm_Status As Short) 'Generated.
		...
		Dim RC_ErrorC As Short
		Dim wk_ww As Short
		wk_PxBase = 12 * PP_SSSMAIN.De
		If pm_Px = -2 Then
			wk_Tx = AE_Tx(PP_SSSMAIN, 2 + wk_PxBase)
			If wk_Tx >= 0 Then
				Call AE_TabStop_SSSMAIN(wk_Tx, wk_Tx + 8, pm_SetInOut)
			End If
		ElseIf pm_Px >= 0 Then 
		...
		End If
		If pm_Px = -2 Or pm_Px = 3 + wk_PxBase Then 'HINCD
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		...
		End If
		If pm_Px = -2 Or pm_Px = 4 + wk_PxBase Then 'HINNMA
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(4 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 5 + wk_PxBase Then 'TOKCD
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(5 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 6 + wk_PxBase Then 'TOKRN
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(6 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 7 + wk_PxBase Then 'URITKDT
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(7 + wk_PxBase), URITKDT_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 8 + wk_PxBase Then 'TUKKB
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(8 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 9 + wk_PxBase Then 'URITK
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(9 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 10 + wk_PxBase Then 'ULTTKKB
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(10 + wk_PxBase), ULTTKKB_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal), AE_NullCnv1_SSSMAIN(CP_SSSMAIN(10 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 11 + wk_PxBase Then 'V_DATKB
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(11 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 12 + wk_PxBase Then 'V_URITK
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(12 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 13 + wk_PxBase Then 'V_ULTTKK
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
	...
	Sub AE_InitValBdDe_SSSMAIN_HINCD(ByVal pm_Px As Short, ByVal wk_PxBase As Short) 'Generated.
		...
		'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CC_NewVal = CP_SSSMAIN(13 + wk_PxBase).CuVal
		PP_SSSMAIN.DerivedOrigin = "BD_HINCD"
		If pm_Px >= 0 And Not PP_SSSMAIN.SuppressMultiTlDerived Then Call AE_Derived_SSSMAIN_bd_ULTTKKB(PP_SSSMAIN.De2)
		If pm_Px >= 0 And Not PP_SSSMAIN.SuppressMultiTlDerived Then Call AE_Derived_SSSMAIN_bd_URITKDT(PP_SSSMAIN.De2)
	End Sub
	...
	Sub AE_InOutModeM_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String) 'Generated.
		...
		wk_Qx = 0
		Do While wk_Qx < 14 And UCase(Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx)) <> wk_UCaseObjA
			wk_Qx = wk_Qx + 1
		Loop 
	...
	Sub AE_InOutModeN_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String, Optional ByVal pm_De As Object = Nothing) 'Generated.
		...
		wk_UCaseObjA = UCase(pm_ItemName)
		wk_Qx = 0
		Do While wk_Qx < 14 And Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx) <> wk_UCaseObjA
			wk_Qx = wk_Qx + 1
		Loop 
		If UCase(Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx)) <> wk_UCaseObjA Then
		...
		ElseIf wk_Qx < 14 Then 
			...
			If IsNothing(pm_De) Then
				If PP_SSSMAIN.De2 < 0 Or (Not PP_SSSMAIN.RecalcMode And PP_SSSMAIN.Tx >= 137) Then Exit Sub
				wk_Px = wk_Qx + 12 * PP_SSSMAIN.De
			Else
				'UPGRADE_WARNING: オブジェクト pm_De の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				wk_Px = wk_Qx + 12 * pm_De
			End If
		End If
...
CheckOrSkip: 
		...
		Select Case pm_NewMode
			Case Cn_Mode1
				If PP_SSSMAIN.Mode <> Cn_Mode1 Then
					...
					Call AE_TabStop_SSSMAIN(0, 136, False)
					AE_CursorRest(PP_SSSMAIN.ScX).TabStop = False
				End If
			Case Cn_Mode2
	...
	Sub AE_RecalcBdDe_SSSMAIN() 'Generated.
		...
		If PP_SSSMAIN.LastDe > 0 Then
			...
			If AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(3 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_HINCD(AE_Val2(CP_SSSMAIN(3 + wk_PxBase)), CP_SSSMAIN(3 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(4 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(4 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(4 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_HINNMA(AE_Val2(CP_SSSMAIN(4 + wk_PxBase)), CP_SSSMAIN(4 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(5 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(5 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(5 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_TOKCD(AE_Val2(CP_SSSMAIN(5 + wk_PxBase)), CP_SSSMAIN(5 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(6 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(6 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(6 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_TOKRN(AE_Val2(CP_SSSMAIN(6 + wk_PxBase)), CP_SSSMAIN(6 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(7 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(7 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(7 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_URITKDT(AE_Val2(CP_SSSMAIN(7 + wk_PxBase)), CP_SSSMAIN(7 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(8 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(8 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(8 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_TUKKB(AE_Val2(CP_SSSMAIN(8 + wk_PxBase)), CP_SSSMAIN(8 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(9 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(9 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(9 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_URITK(AE_Val2(CP_SSSMAIN(9 + wk_PxBase)), CP_SSSMAIN(9 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(10 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(10 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(10 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_ULTTKKB(AE_Val2(CP_SSSMAIN(10 + wk_PxBase)), CP_SSSMAIN(10 + wk_PxBase).StatusF, False, False)
			End If
		End If
	...
	Sub AE_RecalcBdDeSub_SSSMAIN() 'Generated.
		Call AE_Derived_SSSMAIN_bd_ULTTKKB(PP_SSSMAIN.De2)
		Call AE_Derived_SSSMAIN_bd_URITKDT(PP_SSSMAIN.De2)
	End Sub
	...
	Sub AE_Scrl_SSSMAIN(ByVal pm_DeNo As Short, ByVal pm_SetFocusOk As Short) 'Generated.
		...
		Do While Wk_De <= PP_SSSMAIN.MaxDspC
			wk_NewPxBase = 2 + 12 * (Wk_De + PP_SSSMAIN.TopDe) : wk_OutOfDe = False
			If wk_NewPxBase >= PP_SSSMAIN.EBodyPx Then wk_NewPxBase = 2 + 12 * (PP_SSSMAIN.MaxDe) : wk_OutOfDe = True
			wk_ExPxBase = 2 + 12 * (Wk_De + wk_ExTopDe)
			If wk_ExPxBase >= PP_SSSMAIN.EBodyPx Then wk_ExPxBase = 2 + 12 * (PP_SSSMAIN.MaxDe)
			wk_TxBase = 2 + 9 * Wk_De
			wk_ww = 0
			Do While wk_ww < 9
		...
		wk_NewTx = wk_ExTx - 9 * (PP_SSSMAIN.TopDe - wk_ExTopDe)
		If wk_ExTx < 0 Then
		ElseIf wk_NewTx < 2 Then 
			wk_NewTx = 2 + (wk_ExTx - 2) Mod 9
		ElseIf wk_NewTx >= PP_SSSMAIN.NrBodyTx Then 
			wk_NewTx = 2 + 9 * PP_SSSMAIN.MaxDspC + (wk_ExTx - 2) Mod 9
		End If
		Call AE_ScrlMax(PP_SSSMAIN)
		If wk_Displacement > 0 Then
			...
			ElseIf wk_ExTx >= 0 Then 
				...
				Do While wk_NewTx2 < PP_SSSMAIN.NrBodyTx
					If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_NewTx2)).TypeA, wk_NewTx2) Then
						...
						Exit Sub
					End If
					wk_NewTx2 = wk_NewTx2 + 9
				Loop 
				PP_SSSMAIN.CursorDirection = Cn_Direction1
				Do While wk_NewTx < 137
			...
			wk_NewTx = 2
			PP_SSSMAIN.CursorDirection = Cn_Direction1
			Do While wk_NewTx < 137 And PP_SSSMAIN.TopDe >= 0 And PP_SSSMAIN.TopDe < PP_SSSMAIN.MaxDe
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_NewTx)).TypeA, wk_NewTx) Then
					If pm_SetFocusOk Then Call AE_CursorMove_SSSMAIN(wk_NewTx)
					Exit Sub
				End If
		...
		ElseIf PP_SSSMAIN.Tx < 137 Then 
			...
			Select Case PP_SSSMAIN.Px
				...
				Case 6 + wk_PxBase
					...
					End If
				Case 7 + wk_PxBase
					Call AE_Check_SSSMAIN_URITKDT(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 8 + wk_PxBase
					Call AE_Check_SSSMAIN_TUKKB(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 9 + wk_PxBase
					Call AE_Check_SSSMAIN_URITK(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 10 + wk_PxBase
					Call AE_Check_SSSMAIN_ULTTKKB(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
			End Select
		End If
	...
	Sub AE_Slist_SSSMAIN() 'Generated.
		...
		Dim wk_TxBase As Short
		wk_PxBase = 12 * PP_SSSMAIN.De
		wk_TxBase = 9 * (PP_SSSMAIN.De - PP_SSSMAIN.TopDe)
		If False Then
		ElseIf ((PP_SSSMAIN.Tx - 2) Mod 9 = 1) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 137 Then 
			If ((PP_SSSMAIN.Tx - 2) \ 9) <> (PP_SSSMAIN.De - PP_SSSMAIN.TopDe) Then
			...
			wk_Slisted = HINCD_Slist(PP_SSSMAIN, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 12 * PP_SSSMAIN.De).CuVal))
			PP_SSSMAIN.NeglectLostFocusCheck = False
			'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
					...
					Call AE_Check_SSSMAIN_HINCD(AE_Val3(CP_SSSMAIN(3 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 3 + wk_TxBase).ToString()), Cn_Status6, True, True)
				End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
				PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
			End If
		ElseIf ((PP_SSSMAIN.Tx - 2) Mod 9 = 3) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 137 Then 
			If ((PP_SSSMAIN.Tx - 2) \ 9) <> (PP_SSSMAIN.De - PP_SSSMAIN.TopDe) Then
				Call AE_SystemError("AE_Slist に", 600)
			End If
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			...
			'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			wk_Slisted = TOKCD_Slist(PP_SSSMAIN, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 12 * PP_SSSMAIN.De).CuVal))
			PP_SSSMAIN.NeglectLostFocusCheck = False
			'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
					...
					Call AE_Check_SSSMAIN_TOKCD(AE_Val3(CP_SSSMAIN(5 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 5 + wk_TxBase).ToString()), Cn_Status6, True, True)
				End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
				PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
			End If
		ElseIf ((PP_SSSMAIN.Tx - 2) Mod 9 = 5) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 137 Then 
			If ((PP_SSSMAIN.Tx - 2) \ 9) <> (PP_SSSMAIN.De - PP_SSSMAIN.TopDe) Then
				Call AE_SystemError("AE_Slist に", 600)
			End If
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			...
			'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			wk_Slisted = URITKDT_Slist(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 12 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN, PP_SSSMAIN.De2)
			PP_SSSMAIN.NeglectLostFocusCheck = False
			'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
					...
					Call AE_Check_SSSMAIN_URITKDT(AE_Val3(CP_SSSMAIN(7 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 7 + wk_TxBase).ToString()), Cn_Status6, True, True)
				End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
				PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
			End If
		ElseIf ((PP_SSSMAIN.Tx - 2) Mod 9 = 6) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 137 Then 
			If ((PP_SSSMAIN.Tx - 2) \ 9) <> (PP_SSSMAIN.De - PP_SSSMAIN.TopDe) Then
				Call AE_SystemError("AE_Slist に", 600)
			End If
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			...
			'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			wk_Slisted = TUKKB_Slist(PP_SSSMAIN)
			PP_SSSMAIN.NeglectLostFocusCheck = False
			'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
					'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					CP_SSSMAIN(8 + wk_PxBase).TpStr = wk_Slisted
					CP_SSSMAIN(8 + wk_PxBase).CIn = Cn_ChrInput
					'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					'UPGRADE_WARNING: オブジェクト AE_Controls(PP_SSSMAIN.CtB + 8 + wk_TxBase) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
					AE_Controls(PP_SSSMAIN.CtB + 8 + wk_TxBase) = wk_Slisted
					Call AE_Check_SSSMAIN_TUKKB(AE_Val3(CP_SSSMAIN(8 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 8 + wk_TxBase).ToString()), Cn_Status6, True, True)
				End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
				PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
	...
	Sub AE_TabStop_SSSMAIN(ByVal pm_FromTx As Short, ByVal pm_ToTx As Short, ByVal pm_SetInOut As Boolean) 'Generated.
		...
		Do While wk_Tx <= pm_ToTx
			If wk_Tx >= PP_SSSMAIN.NrBodyTx And wk_Tx < 137 Then
			Else
				wk_Px = AE_Px(PP_SSSMAIN, wk_Tx)
				wk_InOutMode = (CP_SSSMAIN(wk_Px).InOutMode \ 256) And &HFFs
	...
	Sub DP_SSSMAIN_ULTTKKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_URITKDT(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_V_ULTTKK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_V_URITK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Function RD_SSSMAIN_HINCD(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 8 Then
				...
				RD_SSSMAIN_HINCD = CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal) & Space(8 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_HINCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_HINCD = CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_HINNMA(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_HINNMA = CStr(CP_SSSMAIN(4 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_HINNMA の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_HINNMA = CStr(CP_SSSMAIN(4 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_TOKCD(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 5 Then
				...
				RD_SSSMAIN_TOKCD = CStr(CP_SSSMAIN(5 + wk_PxBase).CuVal) & Space(5 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_TOKCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_TOKCD = CStr(CP_SSSMAIN(5 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_TOKRN(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 40 Then
				...
				RD_SSSMAIN_TOKRN = CStr(CP_SSSMAIN(6 + wk_PxBase).CuVal) & Space(40 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_TOKRN の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_TOKRN = CStr(CP_SSSMAIN(6 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_TUKKB(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 3 Then
				...
				RD_SSSMAIN_TUKKB = CStr(CP_SSSMAIN(8 + wk_PxBase).CuVal) & Space(3 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_TUKKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_TUKKB = CStr(CP_SSSMAIN(8 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_ULTTKKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 12 * De
		'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
		...
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_ULTTKKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_ULTTKKB = CP_SSSMAIN(10 + wk_PxBase).CuVal
		End If
	End Function
	...
	Function RD_SSSMAIN_URITK(ByVal De As Short) As Object 'Generated.
		...
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_URITK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_URITK = CP_SSSMAIN(9 + wk_PxBase).CuVal
		End If
	End Function
	
	Function RD_SSSMAIN_URITKDT(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 12 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(7 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_URITKDT = Space(8)
		ElseIf Not IsDate(CP_SSSMAIN(7 + wk_PxBase).CuVal) Then 
			RD_SSSMAIN_URITKDT = Space(8)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_URITKDT = VB6.Format(CP_SSSMAIN(7 + wk_PxBase).CuVal, "YYYYMMDD")
		End If
	End Function
	...
	Function RD_SSSMAIN_V_DATKB(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_V_DATKB = CStr(CP_SSSMAIN(11 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_DATKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_DATKB = CStr(CP_SSSMAIN(11 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_ULTTKK(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 12 * De
		'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
		...
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_ULTTKK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_V_ULTTKK = CP_SSSMAIN(13 + wk_PxBase).CuVal
		End If
	End Function
	
	Function RD_SSSMAIN_V_URITK(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 12 * De
		'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
		...
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_URITK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_V_URITK = CP_SSSMAIN(12 + wk_PxBase).CuVal
		End If
	End Function

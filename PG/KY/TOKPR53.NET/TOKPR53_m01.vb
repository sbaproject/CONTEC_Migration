...
Module TOKPR53_M01
	...
	Sub Loop_Mfil()
		...
		G_PlCnd.sCndStr(1) = FR_SSSMAIN.HD_STTHINCD.Text
		G_PlCnd.sCndStr(2) = FR_SSSMAIN.HD_STTHINNM.Text
		G_PlCnd.sCndStr(3) = FR_SSSMAIN.HD_ENDHINCD.Text
		G_PlCnd.sCndStr(4) = FR_SSSMAIN.HD_ENDHINNM.Text
		G_PlCnd.sCndStr(5) = FR_SSSMAIN.HD_STTTOKCD.Text
		G_PlCnd.sCndStr(6) = FR_SSSMAIN.HD_STTTOKNM.Text
		G_PlCnd.sCndStr(7) = FR_SSSMAIN.HD_ENDTOKCD.Text
		G_PlCnd.sCndStr(8) = FR_SSSMAIN.HD_ENDTOKNM.Text
		
		G_PlCnd.sCltID = SSS_CLTID.Value
		G_PlInfo.FCnt = 1
		G_PlInfo.Fno(0) = DBN_TOKPR53
		G_PlInfo.RCnt(0) = 1

...
Module SSSMAIN0001
	...
	Sub AE_Check_SSSMAIN_ENDHINCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(4)
			...
			If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ENDHINCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(2).CuVal))
			Else
				'UPGRADE_WARNING: オブジェクト ENDHINCD_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ENDHINCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(2).CuVal))
			...
			If AE_ErrorToInteger(Ck_Error) = 0 Or (pm_Status >= Cn_Status7 And PP_SSSMAIN.CheckErrNglct) Then
				...
				Else
					...
					If Not PP_SSSMAIN.RecalcMode Then
						...
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(5).ExVal = CP_SSSMAIN(5).CuVal 'ENDHINNM
	...
	Sub AE_Check_SSSMAIN_ENDHINNM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_ENDTOKCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(8)
            ...
            If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ENDTOKCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(6).CuVal))
			Else
				'UPGRADE_WARNING: オブジェクト ENDTOKCD_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ENDTOKCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(6).CuVal))
			...
			If AE_ErrorToInteger(Ck_Error) = 0 Or (pm_Status >= Cn_Status7 And PP_SSSMAIN.CheckErrNglct) Then
				...
				Else
					...
					If Not PP_SSSMAIN.RecalcMode Then
						...
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(9).ExVal = CP_SSSMAIN(9).CuVal 'ENDTOKNM
						CP_SSSMAIN(9).ExStatus = CP_SSSMAIN(9).StatusC
			...
			If AE_ErrorToInteger(Ck_Error) = 0 Or (pm_Status >= Cn_Status7 And PP_SSSMAIN.CheckErrNglct) Then
				...
				Else
					...
					If Not PP_SSSMAIN.RecalcMode Then
						...
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(3).ExVal = CP_SSSMAIN(3).CuVal 'STTHINNM
	...
	Sub AE_Check_SSSMAIN_STTHINNM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
			...
			If AE_ErrorToInteger(Ck_Error) = 0 Or (pm_Status >= Cn_Status7 And PP_SSSMAIN.CheckErrNglct) Then
				...
				Else
					...
					If Not PP_SSSMAIN.RecalcMode Then
						...
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(7).ExVal = CP_SSSMAIN(7).CuVal 'STTTOKNM
						CP_SSSMAIN(7).ExStatus = CP_SSSMAIN(7).StatusC
	...
	Sub AE_Derived_SSSMAIN_hd_ENDHINNM(ByVal De_Index As Object) 'Generated.
		...
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CC_NewVal = ENDHINNM_Derived(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(4).CuVal), PP_SSSMAIN.De2)
	...
	Sub AE_Derived_SSSMAIN_hd_ENDTOKNM(ByVal De_Index As Object) 'Generated.
		...
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CC_NewVal = ENDTOKNM_Derived(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(9).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(8).CuVal), PP_SSSMAIN.De2)
		'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
		If IsNothing(CC_NewVal) Then Exit Sub
		CP_SSSMAIN(9).CheckRtnCode = 0
		'UPGRADE_WARNING: オブジェクト AE_NormData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CC_NewVal = AE_NormData(CP_SSSMAIN(9), CC_NewVal)
		...
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		If CC_NewVal = CP_SSSMAIN(9).CuVal And CP_SSSMAIN(9).StatusC >= Cn_Status6 Then
			Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(9), CL_SSSMAIN(9))
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		ElseIf IsDbNull(CC_NewVal) And IsDbNull(CP_SSSMAIN(9).CuVal) And CP_SSSMAIN(9).StatusC >= Cn_Status6 Then 
		Else
			wk_SaveMask = PP_SSSMAIN.MaskMode
			PP_SSSMAIN.MaskMode = True
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CP_SSSMAIN(9).CuVal = CC_NewVal
			...
			PP_SSSMAIN.MaskMode = wk_SaveMask
			Call AE_SetInitValStatus(PP_SSSMAIN, CP_SSSMAIN(9))
			If CP_SSSMAIN(9).StatusC = Cn_StatusError Then
				CP_SSSMAIN(9).StatusC = Cn_Status2
				CP_SSSMAIN(9).StatusF = Cn_Status2
				Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(9), CL_SSSMAIN(9))
			ElseIf CP_SSSMAIN(9).StatusC <> Cn_Status6 Then 
				CP_SSSMAIN(9).StatusC = Cn_Status7
				CP_SSSMAIN(9).StatusF = Cn_Status7
				Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(9), CL_SSSMAIN(9))
			Else
				Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(9), CL_SSSMAIN(9))
			End If
	...
	Sub AE_Derived_SSSMAIN_hd_STTHINNM(ByVal De_Index As Object) 'Generated.
		Dim CC_NewVal As Object
		Dim wk_SaveMask As Boolean
		...
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CC_NewVal = STTHINNM_Derived(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(2).CuVal), PP_SSSMAIN.De2)
		'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
		If IsNothing(CC_NewVal) Then Exit Sub
	...
	Sub AE_Derived_SSSMAIN_hd_STTTOKNM(ByVal De_Index As Object) 'Generated.
		...
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CC_NewVal = STTTOKNM_Derived(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(6).CuVal), PP_SSSMAIN.De2)
		'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
		If IsNothing(CC_NewVal) Then Exit Sub
		CP_SSSMAIN(7).CheckRtnCode = 0
		'UPGRADE_WARNING: オブジェクト AE_NormData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CC_NewVal = AE_NormData(CP_SSSMAIN(7), CC_NewVal)
		...
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		If CC_NewVal = CP_SSSMAIN(7).CuVal And CP_SSSMAIN(7).StatusC >= Cn_Status6 Then
			Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(7), CL_SSSMAIN(7))
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		ElseIf IsDbNull(CC_NewVal) And IsDbNull(CP_SSSMAIN(7).CuVal) And CP_SSSMAIN(7).StatusC >= Cn_Status6 Then 
		Else
			wk_SaveMask = PP_SSSMAIN.MaskMode
			PP_SSSMAIN.MaskMode = True
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CP_SSSMAIN(7).CuVal = CC_NewVal
			...
			PP_SSSMAIN.MaskMode = wk_SaveMask
			Call AE_SetInitValStatus(PP_SSSMAIN, CP_SSSMAIN(7))
			If CP_SSSMAIN(7).StatusC = Cn_StatusError Then
				CP_SSSMAIN(7).StatusC = Cn_Status2
				CP_SSSMAIN(7).StatusF = Cn_Status2
				Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(7), CL_SSSMAIN(7))
			ElseIf CP_SSSMAIN(7).StatusC <> Cn_Status6 Then 
				CP_SSSMAIN(7).StatusC = Cn_Status7
				CP_SSSMAIN(7).StatusF = Cn_Status7
				Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(7), CL_SSSMAIN(7))
			Else
				Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(7), CL_SSSMAIN(7))
			End If
...
#End If
	...
	Sub AE_InitValHd_SSSMAIN(ByVal pm_Px As Short, ByVal pm_SetInOut As Short, ByVal pm_Status As Short) 'Generated.
		...
		End If
		If pm_Px = -2 Or pm_Px = 2 Then 'STTHINCD
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(2), STTHINCD_InitVal(), pm_Status)
			Call AE_InitValHd_SSSMAIN_STTHINCD(pm_Px)
		End If
		If pm_Px = -2 Or pm_Px = 3 Then 'STTHINNM
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(3), STTHINNM_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(2).CuVal), PP_SSSMAIN.De2), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 4 Then 'ENDHINCD
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(4), ENDHINCD_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(4).CuVal)), pm_Status)
			Call AE_InitValHd_SSSMAIN_ENDHINCD(pm_Px)
		End If
		If pm_Px = -2 Or pm_Px = 5 Then 'ENDHINNM
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(5), ENDHINNM_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(4).CuVal), PP_SSSMAIN.De2), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 6 Then 'STTTOKCD
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(6), STTTOKCD_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(6).CuVal)), pm_Status)
			Call AE_InitValHd_SSSMAIN_STTTOKCD(pm_Px)
		End If
		If pm_Px = -2 Or pm_Px = 7 Then 'STTTOKNM
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(7), STTTOKNM_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(6).CuVal), PP_SSSMAIN.De2), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 8 Then 'ENDTOKCD
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(8), ENDTOKCD_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(8).CuVal)), pm_Status)
			Call AE_InitValHd_SSSMAIN_ENDTOKCD(pm_Px)
		End If
		If pm_Px = -2 Or pm_Px = 9 Then 'ENDTOKNM
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(9), ENDTOKNM_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(9).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(8).CuVal), PP_SSSMAIN.De2), pm_Status)
		End If
		If pm_Px = -2 Then
...
CheckOrSkip: 
	...
	Sub AE_RecalcHd_SSSMAIN() 'Generated.
		...
		If AE_GetInOutMode(CP_SSSMAIN(2).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(2).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(2).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_STTHINCD(AE_Val2(CP_SSSMAIN(2)), CP_SSSMAIN(2).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(3).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(3).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(3).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_STTHINNM(AE_Val2(CP_SSSMAIN(3)), CP_SSSMAIN(3).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(4).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(4).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(4).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_ENDHINCD(AE_Val2(CP_SSSMAIN(4)), CP_SSSMAIN(4).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(5).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(5).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(5).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_ENDHINNM(AE_Val2(CP_SSSMAIN(5)), CP_SSSMAIN(5).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(6).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(6).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(6).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_STTTOKCD(AE_Val2(CP_SSSMAIN(6)), CP_SSSMAIN(6).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(7).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(7).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(7).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_STTTOKNM(AE_Val2(CP_SSSMAIN(7)), CP_SSSMAIN(7).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(8).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(8).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(8).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_ENDTOKCD(AE_Val2(CP_SSSMAIN(8)), CP_SSSMAIN(8).StatusF, False, False)
		End If
		If AE_GetInOutMode(CP_SSSMAIN(9).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(9).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
			If CP_SSSMAIN(9).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_ENDTOKNM(AE_Val2(CP_SSSMAIN(9)), CP_SSSMAIN(9).StatusF, False, False)
		End If
		...
		ElseIf PP_SSSMAIN.Tx = 2 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
					...
					Call AE_Check_SSSMAIN_STTHINCD(AE_Val3(CP_SSSMAIN(2), AE_Controls(PP_SSSMAIN.CtB + 2).ToString()), Cn_Status6, True, True)
				End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
		...
		ElseIf PP_SSSMAIN.Tx = 4 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
					...
					Call AE_Check_SSSMAIN_ENDHINCD(AE_Val3(CP_SSSMAIN(4), AE_Controls(PP_SSSMAIN.CtB + 4).ToString()), Cn_Status6, True, True)
				End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
				PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
		...
		ElseIf PP_SSSMAIN.Tx = 6 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
					...
					Call AE_Check_SSSMAIN_STTTOKCD(AE_Val3(CP_SSSMAIN(6), AE_Controls(PP_SSSMAIN.CtB + 6).ToString()), Cn_Status6, True, True)
				End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
				PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
		...
		ElseIf PP_SSSMAIN.Tx = 8 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
					...
					Call AE_Check_SSSMAIN_ENDTOKCD(AE_Val3(CP_SSSMAIN(8), AE_Controls(PP_SSSMAIN.CtB + 8).ToString()), Cn_Status6, True, True)
				End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
				PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
	...
	Sub DP_SSSMAIN_ENDHINCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		wk_SaveMask = PP_SSSMAIN.MaskMode
		PP_SSSMAIN.MaskMode = True
	...
	Sub DP_SSSMAIN_ENDHINNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		wk_SaveMask = PP_SSSMAIN.MaskMode
		PP_SSSMAIN.MaskMode = True
	...
	Sub DP_SSSMAIN_STTHINNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		wk_SaveMask = PP_SSSMAIN.MaskMode
		PP_SSSMAIN.MaskMode = True
	...
	Function RD_SSSMAIN_ENDHINCD(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 8 Then
				...
				RD_SSSMAIN_ENDHINCD = CStr(CP_SSSMAIN(4).CuVal) & Space(8 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_ENDHINCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_ENDHINCD = CStr(CP_SSSMAIN(4).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_ENDHINNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		...
		Else
			...
			If LenWid(st_Work) < 30 Then
				...
				RD_SSSMAIN_ENDHINNM = CStr(CP_SSSMAIN(5).CuVal) & Space(30 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_ENDHINNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_ENDHINNM = CStr(CP_SSSMAIN(5).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_ENDTOKCD(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 5 Then
				...
				RD_SSSMAIN_ENDTOKCD = CStr(CP_SSSMAIN(8).CuVal) & Space(5 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_ENDTOKCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_ENDTOKCD = CStr(CP_SSSMAIN(8).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_ENDTOKNM(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 40 Then
				...
				RD_SSSMAIN_ENDTOKNM = CStr(CP_SSSMAIN(9).CuVal) & Space(40 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_ENDTOKNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_ENDTOKNM = CStr(CP_SSSMAIN(9).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_STTHINCD(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 8 Then
				...
				RD_SSSMAIN_STTHINCD = CStr(CP_SSSMAIN(2).CuVal) & Space(8 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_STTHINCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_STTHINCD = CStr(CP_SSSMAIN(2).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_STTHINNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		...
		Else
			...
			If LenWid(st_Work) < 30 Then
				...
				RD_SSSMAIN_STTHINNM = CStr(CP_SSSMAIN(3).CuVal) & Space(30 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_STTHINNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_STTHINNM = CStr(CP_SSSMAIN(3).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_STTTOKCD(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 5 Then
				...
				RD_SSSMAIN_STTTOKCD = CStr(CP_SSSMAIN(6).CuVal) & Space(5 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_STTTOKCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_STTTOKCD = CStr(CP_SSSMAIN(6).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_STTTOKNM(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 40 Then
				...
				RD_SSSMAIN_STTTOKNM = CStr(CP_SSSMAIN(7).CuVal) & Space(40 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_STTTOKNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_STTTOKNM = CStr(CP_SSSMAIN(7).CuVal)
			End If
		End If
	End Function
End Module
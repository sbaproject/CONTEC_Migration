...
Begin VB.Form WLS_LIST1 
   ...
   Begin VB.Image WLSMAE 
      ...
      Height          =   330
      Left            =   420
      Picture         =   "WLS_LIST1.frx":1F9A
      Top             =   3870
      Visible         =   0   'False
      Width           =   360
   End
End
Attribute VB_Name = "WLS_LIST1"
...
'        '====================================
        ...
        WM_WLS_DSPArray(ArrayCnt) = LeftWid$(DB_SYSTBD_W.DKBID, 2) & Space(1) _
                                  & LeftWid$(DB_SYSTBD_W.DKBNM, 6)
    End Sub
...
Private Sub LST_DblClick()
    ...
    DblClickFl = True
    WLSTBD_RTNCODE = LeftWid$(LST.List(LST.ListIndex), WM_WLS_CODELEN)

...
Module ORA_CMN
	...
	'// 採番テーブル用セッション
	Public gv_Oss_USR_SAIBAN As Object '//ORACLEセッション
	Public gv_Odb_USR_SAIBAN As Object '//ORACLEデータベース
	...
	Public Function CF_Ora_USR1_Open() As Boolean
		...
		If lRet > 0 Then
			...
			'//接続(採番テーブル用)
			If F_Ora_Connect(gv_Oss_USR_SAIBAN, gv_Odb_USR_SAIBAN, sHost, sUserID, ORA_MAX_PASS) = False Then
				GoTo ERR_HANDLE
			End If

...
Module NHSPR51_M01
	...
	Sub Loop_Mfil()
		...
		G_PlCnd.sCndStr(1) = FR_SSSMAIN.HD_STTNHSCD.Text
		G_PlCnd.sCndStr(2) = FR_SSSMAIN.HD_STTNHSNM.Text
		G_PlCnd.sCndStr(3) = FR_SSSMAIN.HD_ENDNHSCD.Text
		G_PlCnd.sCndStr(4) = FR_SSSMAIN.HD_ENDNHSNM.Text
		
		G_PlCnd.sCltID = SSS_CLTID.Value
		G_PlInfo.FCnt = 1
		G_PlInfo.Fno(0) = DBN_NHSPR51
		G_PlInfo.RCnt(0) = 1

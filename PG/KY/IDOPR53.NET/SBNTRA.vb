...
Module SBNTRA_DBM
	'==========================================================================
	'   SBNTRA.DBM   製番出庫ファイル                 UPD.EXE Ver 3, 0, 1, 2  =
	'==========================================================================
	Structure TYPE_DB_SBNTRA
	...
	End Structure
	Public DB_SBNTRA As TYPE_DB_SBNTRA
	Public DBN_SBNTRA As Short
	' Index1( DATNO )
	...
	Sub SBNTRA_RClear()
        ...
        'TmpStat = Dll_RClear(DBN_SBNTRA, G_LB)
        'Call ResetBuf(DBN_SBNTRA)

...
Module URKPR62_IEV
	...
	Public Const SSS_PrgId As String = "URKPR62"
	Public Const SSS_PrgNm As String = "入金消込日記帳（外貨）        "
	...
	Sub Init_Fil() 'Generated.
		'
		DBN_URKPR62 = 0
		DB_PARA(DBN_URKPR62).TBLID = "URKPR62"
		DB_PARA(DBN_URKPR62).DBID = "USR9"
		SSS_MFIL = DBN_URKPR62
		'
		DBN_SYSTBA = 1
		...
		SSS_LSTMFIL = DBN_URKPR62
	End Sub
	
	Sub SCR_FromMfil(ByVal De As Short) 'Generated.
		Call DP_SSSMAIN_ENDKSIDT(De, DB_URKPR62.ENDKSIDT)
		Call DP_SSSMAIN_ENDWRTDT(De, DB_URKPR62.ENDWRTDT)
		Call DP_SSSMAIN_ENDWRTTM(De, DB_URKPR62.ENDWRTTM)
		Call DP_SSSMAIN_STTKSIDT(De, DB_URKPR62.STTKSIDT)
		Call DP_SSSMAIN_STTTANCD(De, DB_URKPR62.STTTANCD)
		Call DP_SSSMAIN_STTTANNM(De, DB_URKPR62.STTTANNM)
		Call DP_SSSMAIN_STTTOKCD(De, DB_URKPR62.STTTOKCD)
		Call DP_SSSMAIN_STTTOKRN(De, DB_URKPR62.STTTOKRN)
		Call DP_SSSMAIN_STTWRTDT(De, DB_URKPR62.STTWRTDT)
		Call DP_SSSMAIN_STTWRTTM(De, DB_URKPR62.STTWRTTM)
	End Sub
	...
	Sub Mfil_FromSCR(ByVal De As Short) 'Generated.
		...
		DB_URKPR62.ENDKSIDT = RD_SSSMAIN_ENDKSIDT(De)
		...
		DB_URKPR62.ENDWRTDT = RD_SSSMAIN_ENDWRTDT(De)
		...
		DB_URKPR62.ENDWRTTM = RD_SSSMAIN_ENDWRTTM(De)
		...
		DB_URKPR62.STTKSIDT = RD_SSSMAIN_STTKSIDT(De)
		...
		DB_URKPR62.STTTANCD = RD_SSSMAIN_STTTANCD(De)
		...
		DB_URKPR62.STTTANNM = RD_SSSMAIN_STTTANNM(De)
		...
		DB_URKPR62.STTTOKCD = RD_SSSMAIN_STTTOKCD(De)
		...
		DB_URKPR62.STTTOKRN = RD_SSSMAIN_STTTOKRN(De)
		...
		DB_URKPR62.STTWRTDT = RD_SSSMAIN_STTWRTDT(De)
		...
		DB_URKPR62.STTWRTTM = RD_SSSMAIN_STTWRTTM(De)
		If Trim(DB_ORATM) = "" Or Trim(DB_ORADT) = "" Then
			DB_URKPR62.WRTTM = VB6.Format(Now, "hhmmss")
			DB_URKPR62.WRTDT = VB6.Format(Now, "YYYYMMDD")
		Else
			DB_URKPR62.WRTTM = DB_ORATM
			DB_URKPR62.WRTDT = DB_ORADT
		End If
	End Sub
	
	Sub URKPR62_FromTANMTA() 'Generated.
		Dim i As Short
		
		DB_URKPR62.TANNM = DB_TANMTA.TANNM
		If Trim(DB_ORATM) = "" Or Trim(DB_ORADT) = "" Then
		Else
		End If
	End Sub
	
	Sub URKPR62_FromTOKMTA() 'Generated.
		Dim i As Short
		
		DB_URKPR62.TOKSEIRN = DB_TOKMTA.TOKRN
		If Trim(DB_ORATM) = "" Or Trim(DB_ORADT) = "" Then
		Else
		End If
	End Sub

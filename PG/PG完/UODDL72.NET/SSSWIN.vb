...
ErrDate: 
	...
	Function Link_Modal(ByVal EXE_NM As String) As Short
        ...
        'delete 20190710 START hou
        'Link_Clr = LSet(Link_OUT)
        'delete 20190710 END hou

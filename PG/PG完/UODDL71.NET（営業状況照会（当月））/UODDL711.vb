...
Friend Class FR_SSSMAIN1
	...
	Private Function Init_Def_Dsp() As Short
		...
		Index_Wk = Index_Wk + 1
        '機種明細表ボタン
        'UPGRADE_WARNING: オブジェクト CS_MEISAI.Tag の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'change 20190402 START saiki
        'CS_MEISAI.Tag = Index_Wk
        'Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = CS_MEISAI
        btnF10.Tag = Index_Wk
   ...
   '             Call F_Ctl_CS_EIGCD(Main_Inf.Dsp_Sub_Inf(Trg_Index), Main_Inf)
                ...
                ''受注／売上画面呼出
                'Call F_Ctl_CS_JUC_URI_KIS(Main_Inf.Dsp_Sub_Inf(Trg_Index), Main_Inf)

'            Case CShort(CS_GETU_KI.Tag)
'                Call Ctl_MN_APPENDC_Click()
'                '当月／当期画面呼出
'                Call F_Ctl_CS_GETU_KI_KIS(Main_Inf.Dsp_Sub_Inf(Trg_Index), Main_Inf)

'            Case CShort(CS_BMNSOU.Tag)
'                '部門別総括表画面呼出
'                Call F_Ctl_CS_BMNSOU_KIS(Main_Inf.Dsp_Sub_Inf(Trg_Index), Main_Inf)

'            Case CShort(CS_MEISAI.Tag)
'                '機種明細表画面呼出
'                Call F_Ctl_CS_MEISAI_KIS(Main_Inf.Dsp_Sub_Inf(Trg_Index), Main_Inf)

'                ' 2007/01/12  ADD START  KUMEDA
'            Case CShort(CS_SAIYOMI.Tag)
'                Call Ctl_MN_APPENDC_Click()
'                '再読込
'                Call F_Ctl_CS_SAIYOMI_KSY(Main_Inf.Dsp_Sub_Inf(Trg_Index), Main_Inf)
''2007/01/12  ADD END
 ...
 'change 20190402 END saiki
    ...
    Private Function Edi_Dsp_Def() As Short
        ...
        'Ｓ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｓ
        'フォームタイトル
        Me.Text = RTrim(SSS_PrgNm) & "　－機種別総括表－"
    ...
    'UPGRADE_WARNING: Form イベント FR_SSSMAIN1.Activate には新しい動作が含まれます。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"' をクリックしてください。
    Private Sub FR_SSSMAIN1_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
        ...
        If gv_bolUODDL71_Active = True Then
            ...
            If gv_UODDL71_GETU_KI = "1" Then
                ...
                'delete start 20190805 kuwahara
                'btnF7.Text = "(F7)" & vbCrLf & "累　計"
                'delete end 20190805 kuwahara
                'change 20190402  END saiki
                ' 2007/01/16  CHG START  KUMEDA
                '            Wk_GetuKi = "当月"
            ...
            If gv_UODDL71_JUC_URI = "1" Then
                ...
                RtnCode = F_GET_BD_DATA_KIS_SOUKATU_JUC(gv_UODDL71_GETU_KI, Main_Inf)
            Else
                'change 20190325 START saiki
                ''売上
                ''キャプション変更
                ...
                RtnCode = F_GET_BD_DATA_KIS_SOUKATU_URI(gv_UODDL71_GETU_KI, Main_Inf)
            End If
        ...
        Else
            ...
            '部門or地区or営業所 設定
            gv_UODDL71_BMNCD = Trim(HD_BMNCD.Text)
            gv_UODDL71_TIKCD = Trim(HD_TIKCD.Text)
            gv_UODDL71_EIGCD = Trim(HD_EIGCD.Text)
            ' 2007/01/17  ADD START  KUMEDA
            If Trim(gv_UODDL71_BMNCD) = "9" Then
                gv_UODDL71_BMNCD = " "
            End If
    ...
    Private Sub FR_SSSMAIN1_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub FR_SSSMAIN1_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    'Private Sub CS_MEISAI_Click()
    '	Debug.Print("CS_MEISAI_Click")
    '	'UPGRADE_WARNING: オブジェクト CS_MEISAI の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    '	Call Ctl_Item_Click(CS_MEISAI)
    'End Sub
    ...
    'Private Sub CS_MEISAI_MouseUp(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single)
    '	Debug.Print("CS_MEISAI_MouseUp")
    '	'UPGRADE_WARNING: オブジェクト CS_MEISAI の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    '	Call Ctl_Item_MouseUp(CS_MEISAI, Button, Shift, X, Y)
    'End Sub
    ...
    'Private Sub CS_MEISAI_KeyUp(ByRef KEYCODE As Short, ByRef Shift As Short)
    '	Debug.Print("CS_MEISAI_KeyUp")
    '	'UPGRADE_WARNING: オブジェクト CS_MEISAI の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    '	Call Ctl_Item_KeyUp(CS_MEISAI)
    'End Sub
    ...
    'Private Sub CS_MEISAI_GotFocus()
    '	Debug.Print("CS_MEISAI_GotFocus")
    '	'UPGRADE_WARNING: オブジェクト CS_MEISAI の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    '	Call Ctl_Item_GotFocus(CS_MEISAI)
    'End Sub
    ...
    Private Sub FR_SSSMAIN1_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown

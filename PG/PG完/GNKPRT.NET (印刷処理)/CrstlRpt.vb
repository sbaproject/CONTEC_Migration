...
EndLabel:
    ...
    Public Sub SetDatabase(ByVal Server As String, ByVal Password As String, ByVal username As String,
        ...
        Try
            ...
            connectionInfo.ServerName = "DEV02" '"CNJ_ODBC" 'Server
...
EndLabel:
    ...
    Public Sub ReportPrint(ByVal CRReport As ReportDocument, ByVal inTYPE As Integer)
        ...
        '2019/05/21 DEL START
        'If wPrintFlg = "01" Then
        '2019/05/21 DEL E N D
        ...
        '2019/05/21 DEL START 仮：ファイル選択をするとバッチが止まる
        ...
        'change start 20190821 kuwa
        '2019/05/21 ADD START 仮：出力先不明のため、デスクトップに出力する
        'wFileName = "C:\Users\nb003674.CONTEC\Desktop\" & wFileName
        '2019/05/21 ADD E N D 
        wFileName = "C:\Users\nb003380.CONTEC\Desktop\" & wFileName
        'change end 20190821 kuwa
...
ExitLabel:
    ...
    Public Sub ReportPreview(ByVal CRReport As ReportDocument, ByVal Query As String, ByVal PrinterOrient As String)
        Try
            ...
            End If
            If CRReport.RecordSelectionFormula.Trim.Length = 0 Then
                Frm.CRViewer91.SelectionFormula = QueryToSelectionFormula(Query)
            Else
                Frm.CRViewer91.SelectionFormula = CRReport.RecordSelectionFormula
            End If
            Frm.CRViewer91.ReportSource = CRReport

...
Friend Class FR_SSSMAIN
	...
	'=== 当画面の全情報を格納 =================
	Private Const FM_Panel3D1_CNT As Short = 16 'パネルコントロール数
	...
	Private Function Init_Def_Dsp() As Short
        ...
        'Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = MN_EdMN_OprtitMn
        dummyCtl.Tag = CStr(Index_Wk)
        Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = dummyCtl
        '2019/04/03 CHG E N D
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_MN
		...
		Index_Wk = Index_Wk + 1
		'FBデータ取込(データ退避用)
		HD_FBRFNO.Tag = Index_Wk
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = HD_FBRFNO
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_CODE
		...
		Index_Wk = Index_Wk + 1
        'FBデータ取込ボタン
        'UPGRADE_WARNING: オブジェクト CS_FBRFNO.Tag の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        CS_FBRFNO.Tag = Index_Wk
        Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = CS_FBRFNO
        Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_ELSE
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_ELSE
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 0
		...
		Index_Wk = Index_Wk + 1
		'通貨区分ボタン
		'UPGRADE_WARNING: オブジェクト CS_TUKKB.Tag の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CS_TUKKB.Tag = Index_Wk
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = CS_TUKKB
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_ELSE
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_ELSE
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 0
	...
	Private Function Ctl_Item_MouseDown(ByRef pm_Ctl As System.Windows.Forms.Control, ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single) As Short
        ...
        '			Case CShort(Me.HD_FBRFNO.Tag), CShort(Me.HD_NYUDT.Tag), CShort(Me.HD_TOKCD.Tag), CShort(Me.HD_TUKKB.Tag), CShort(Me.HD_KNJKOZ.Tag), CShort(Me.BD_DKBID(1).Tag), CShort(Me.BD_DKBID(2).Tag), CShort(Me.BD_DKBID(3).Tag), CShort(Me.BD_DKBID(4).Tag), CShort(Me.BD_DKBID(5).Tag), CShort(Me.BD_DKBID(6).Tag), CShort(Me.BD_KANKOZ(1).Tag), CShort(Me.BD_KANKOZ(2).Tag), CShort(Me.BD_KANKOZ(3).Tag), CShort(Me.BD_KANKOZ(4).Tag), CShort(Me.BD_KANKOZ(5).Tag), CShort(Me.BD_KANKOZ(6).Tag), CShort(Me.BD_BNKCD(1).Tag), CShort(Me.BD_BNKCD(2).Tag), CShort(Me.BD_BNKCD(3).Tag), CShort(Me.BD_BNKCD(4).Tag), CShort(Me.BD_BNKCD(5).Tag), CShort(Me.BD_BNKCD(6).Tag), CShort(Me.BD_TEGDT(1).Tag), CShort(Me.BD_TEGDT(2).Tag), CShort(Me.BD_TEGDT(3).Tag), CShort(Me.BD_TEGDT(4).Tag), CShort(Me.BD_TEGDT(5).Tag), CShort(Me.BD_TEGDT(6).Tag)
	...
	Private Function Ctl_Item_Click(ByRef pm_Ctl As System.Windows.Forms.Control) As Short
        ...
        'UPGRADE_WARNING: オブジェクト CS_FBRFNO.Tag の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        Select Case Trg_Index
            'change 201908070 START hou
            'Case CShort(CS_FBRFNO.Tag)
            Case CShort(CS_FBRFNO.Tag), CShort(btnF10.Tag)
                'change 20190807 END hou
                'FBデータ取込画面呼出
                Call SSSMAIN0001.F_Ctl_CS_FBRFNO(Main_Inf.Dsp_Sub_Inf(Trg_Index), Main_Inf)
            ...
            Case CShort(CS_TUKKB.Tag)
                '通貨
                Call SSSMAIN0001.F_Ctl_CS_TUKKB(Main_Inf.Dsp_Sub_Inf(Trg_Index), Main_Inf)
        ...
        '''' ADD 2011/07/03  FKS) T.Yamamoto    Start    入金改善
        '画面の終了処理に入ってしまった場合は以下の処理は行わない
        If Main_Inf.Dsp_Base.IsUnload = True Then
		Else
			'''' ADD 2011/07/03  FKS) T.Yamamoto    End
			'ステータスバー初期化
			Call CF_Clr_Prompt(Main_Inf)
			'''' ADD 2011/07/03  FKS) T.Yamamoto    Start    入金改善
		End If
    ...
    '	'FBデータ取込は、切り取り・コピー・貼り付けはできない
    '	If Me.ActiveControl Is Me.HD_FBRFNO Then
    ...
    '		Case HD_FBRFNO.Name, HD_NYUDT.Name, HD_TOKCD.Name, HD_TUKKB.Name, HD_KNJKOZ.Name, BD_DKBID(0).Name, BD_KANKOZ(0).Name, BD_BNKCD(0).Name, BD_TEGDT(0).Name
    '			'検索機能のある入力項目の場合
	...
	Private Function Ctl_MN_Execute_Click() As Short
		...
		If intRet = 0 Then
			'=== 20110703 === INSERT S TOM)Morimoto
    ...
    Private Function Ctl_MN_Slist_Click(ByRef pm_Ctl As Cls_All) As Short
        ...
        Select Case Act_Index
            '見出：FBデータ取出
            Case CShort(Me.HD_FBRFNO.Tag)
                Call CS_FBRFNO_Click()
	...
	Private Sub FR_SSSMAIN_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
		...
		' === 20110703 === INSERT S TOM)Morimoto
		If strCallMode = SUB_MODE And UPD_flg = True Then
		Else
			' === 20110703 === INSERT E
			'終了メッセージの出力
			If gv_bolURKET51_INIT = False Then
				'終了しますか？
				If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgURKET51_A_001, Main_Inf) = MsgBoxResult.No Then
			...
			Else
				'未登録のまま終了しますか？
				If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgURKET51_A_002, Main_Inf) = MsgBoxResult.No Then
                    Cancel = MsgBoxResult.Cancel
                    '2019/04/05 ADD START
                    eventArgs.Cancel = Cancel
                    '2019/04/05 ADD E N D
    ...
    '	'既存と付加機能の分岐処理
    '	If InStr(VB.Command(), ":") <> 0 Then
    '		'FB自動入金処理から来た時の処理
    '		Link_Clr.FILLER = MidWid(VB.Command(), 16, Len(VB.Command()) - 15) ' 1997/04/17
    ...
    '		Call set_DSP(VB.Left(Link_IN.HINCD, 10), Main_Inf)
    '		strCallMode = SUB_MODE
    '		UPD_flg = False

    '		Call CF_Set_Item_Focus_Ctl(False, Main_Inf.Dsp_Sub_Inf(CInt(HD_FBRFNO.Tag)))
    '		Call CF_Set_Item_SetFocus(Main_Inf.Dsp_Sub_Inf(CInt(HD_NYUKB.Tag)), Main_Inf)
    '		'UPGRADE_WARNING: オブジェクト CS_FBRFNO.Visible の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    '		CS_FBRFNO.Visible = False
    '		HD_FBRFNO.Visible = False
    '	Else
    '		strCallMode = MAIN_MODE
    '		'=== 20110509 === INSERT E
    '		'初期ﾌｫｰｶｽ位置設定
	...
	'**************************************************
	'見出：FBデータ取込
	Private Sub CS_FBRFNO_Click()
		Debug.Print("CS_FBRFNO_Click")
		'UPGRADE_WARNING: オブジェクト CS_FBRFNO の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_Click(CS_FBRFNO)
	End Sub
	
	Private Sub CS_FBRFNO_GotFocus()
		Debug.Print("CS_FBRFNO_GotFocus")
		'UPGRADE_WARNING: オブジェクト CS_FBRFNO の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_GotFocus(CS_FBRFNO)
	End Sub
	
	Private Sub CS_FBRFNO_MouseDown(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single)
		Debug.Print("CS_FBRFNO_MouseDown")
		'UPGRADE_WARNING: オブジェクト CS_FBRFNO の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_MouseDown(CS_FBRFNO, Button, Shift, X, Y)
	End Sub
	
	Private Sub CS_FBRFNO_MouseUp(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single)
		Debug.Print("CS_FBRFNO_MouseUp")
		'UPGRADE_WARNING: オブジェクト CS_FBRFNO の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_MouseUp(CS_FBRFNO, Button, Shift, X, Y)
	End Sub
	
	'UPGRADE_WARNING: イベント HD_FBRFNO.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
	Private Sub HD_FBRFNO_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_FBRFNO.TextChanged
		Debug.Print("HD_FBRFNO_Change")
		Call Ctl_Item_Change(HD_FBRFNO)
	End Sub
	
	Private Sub HD_FBRFNO_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_FBRFNO.Enter
		Debug.Print("HD_FBRFNO_GotFocus")
		Call Ctl_Item_GotFocus(HD_FBRFNO)
	End Sub
	
	Private Sub HD_FBRFNO_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_FBRFNO.Leave
		Debug.Print("HD_FBRFNO_LostFocus")
		Call Ctl_Item_LostFocus(HD_FBRFNO)
	End Sub
	
	Private Sub HD_FBRFNO_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_FBRFNO.KeyDown
		Dim KeyCode As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
		Debug.Print("HD_FBRFNO_KeyDown")
		...
		Call Ctl_Item_KeyDown(HD_FBRFNO, KeyCode, Shift)
	End Sub
	
	Private Sub HD_FBRFNO_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles HD_FBRFNO.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
		Debug.Print("HD_FBRFNO_KeyPress")
		
		'検索画面から入力するので手入力はできなくする
		KeyAscii = 0
		
		'Call Ctl_Item_KeyPress(HD_FBRFNO, KeyAscii)
	...
	Private Sub HD_FBRFNO_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_FBRFNO.KeyUp
		Dim KeyCode As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
		Debug.Print("HD_FBRFNO_KeyUp")
		Call Ctl_Item_KeyUp(HD_FBRFNO)
	End Sub
	
	Private Sub HD_FBRFNO_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_FBRFNO.MouseDown
		Dim Button As Short = eventArgs.Button \ &H100000
		Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
		Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
		Debug.Print("HD_FBRFNO_MouseDown")
		Call Ctl_Item_MouseDown(HD_FBRFNO, Button, Shift, X, Y)
	End Sub
	
	Private Sub HD_FBRFNO_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_FBRFNO.MouseUp
		Dim Button As Short = eventArgs.Button \ &H100000
		Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
		Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
		Debug.Print("HD_FBRFNO_MouseUp")
		Call Ctl_Item_MouseUp(HD_FBRFNO, Button, Shift, X, Y)
	End Sub
	...
	Private Sub CS_TOKCD_MouseDown(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single)
		Debug.Print("CS_TOKCD_MouseDown")
		'UPGRADE_WARNING: オブジェクト CS_TOKCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_MouseDown(CS_TOKCD, Button, Shift, X, Y)
	End Sub
	...
	'**************************************************
	'見出：通貨
	Private Sub CS_TUKKB_Click()
		Debug.Print("CS_TUKKB_Click")
		'UPGRADE_WARNING: オブジェクト CS_TUKKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_Click(CS_TUKKB)
	End Sub
	
	Private Sub CS_TUKKB_GotFocus()
		Debug.Print("CS_TUKKB_GotFocus")
		'UPGRADE_WARNING: オブジェクト CS_TUKKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_GotFocus(CS_TUKKB)
	End Sub
	
	Private Sub CS_TUKKB_MouseDown(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single)
		Debug.Print("CS_TUKKB_MouseDown")
		'UPGRADE_WARNING: オブジェクト CS_TUKKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_MouseDown(CS_TUKKB, Button, Shift, X, Y)
	End Sub
	
	Private Sub CS_TUKKB_MouseUp(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single)
		Debug.Print("CS_TUKKB_MouseUp")
		'UPGRADE_WARNING: オブジェクト CS_TUKKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_MouseUp(CS_TUKKB, Button, Shift, X, Y)
	End Sub
    ...
    Private Sub CS_FBRFNO_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CS_FBRFNO.Click
        Call Ctl_Item_Click(CS_FBRFNO)
    End Sub
    ...
    '*************************************************
    '　明細部ボタン
    Private Sub CS_DKBID_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CS_DKBID.Click
        '入金種別
        Call Ctl_Item_Click(CS_DKBID)
    End Sub

    Private Sub CS_KANKOZ_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CS_KANKOZ.Click
        '勘定口座
        Call Ctl_Item_Click(CS_KANKOZ)
    End Sub

    Private Sub CS_BNKCD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CS_BNKCD.Click
        '銀行コード
        Call Ctl_Item_Click(CS_BNKCD)
    End Sub

    Private Sub CS_TEGDT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CS_TEGDT.Click
        '決済日
        Call Ctl_Item_Click(CS_TEGDT)
    End Sub
    '*************************************************

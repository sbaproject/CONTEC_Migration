...
Module SSSMAIN0002
	...
	' === 20080815 === INSERT S - RISE)Izumi 排他処理のエラーメッセージ
	Public Const gc_strMsgIDOET52_E_901 As String = "2IDOET52_901" '他のプログラムで更新されたため、登録できません。
    '''    Public Const gc_strMsgIDOET52_E_902         As String = "2IDOET52_902"  '他のプログラムで更新されたため、削除できません。
    ' === 20080815 === INSERT E - RISE)Izumi
    '2019/06/13 ADD START <C2-20190528-02> CIS)山口
    Public Const gc_strMsgIDOET52_E_105 As String = "2IDOET52_105" '自動採番の無償サービス製番の戻しが超過します。

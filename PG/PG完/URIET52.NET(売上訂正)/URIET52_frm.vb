...
EventExitSub:
    ...
    Private Sub CS_URISU_Click(sender As Object, e As EventArgs) Handles CS_URISU.Click 'Generated.
        Dim wk_Slisted As Object
        Dim wk_SaveTx As Short
        Dim wk_TxBase As Short
        Dim wk_PxBase As Short
    ...
    End Sub
    'add end 20190730 kuwahara
    'add start 20190828 kuwahara

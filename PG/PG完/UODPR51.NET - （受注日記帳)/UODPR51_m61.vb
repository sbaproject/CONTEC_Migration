...
Module UODPR51_M61
	'
	' スロット名        : ｸﾗｲｱﾝﾄ別受注日記帳・メインファイル更新スロット
	' ユニット名        : UODPR51.M61
	' 記述者            : Muratani
	' 作成日付          : 2006/09/28
	' 使用プログラム名  : UODPR51
	...
	Sub Loop_Mfil()
		...
		G_PlInfo.FCnt = 1
		G_PlInfo.Fno(0) = DBN_UODPR51
		G_PlInfo.RCnt(0) = 1
		G_PlInfo.ArrayFlg(0) = 0
		'
		Call Mfil_FromSCR(-1)
		DB_UODPR51.STTWRTTM = Mid(FR_SSSMAIN.HD_STTWRTTM.Text, 1, 2) & Mid(FR_SSSMAIN.HD_STTWRTTM.Text, 4, 2) & Mid(FR_SSSMAIN.HD_STTWRTTM.Text, 7, 2)
		DB_UODPR51.ENDWRTTM = Mid(FR_SSSMAIN.HD_ENDWRTTM.Text, 1, 2) & Mid(FR_SSSMAIN.HD_ENDWRTTM.Text, 4, 2) & Mid(FR_SSSMAIN.HD_ENDWRTTM.Text, 7, 2)
		'
		PlStat = DB_PlStart
		PlStat = DB_PlCndSet
		PlStat = DB_PlSet(DBN_UODPR51, 0)
		'

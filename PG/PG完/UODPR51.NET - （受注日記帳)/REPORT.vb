...
Module REPORT_BAS
    ...
    'Declare Function PESelectPrinter Lib "crpe32.dll" Alias "PESelectPrinterW" (ByVal printJob As Short, ByRef PriterDriver As Integer, ByRef PrinterName As Any, ByRef PortName As Any, ByVal DEVMODE As Integer) As Short

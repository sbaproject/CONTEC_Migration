...
Module SSSMAIN0001
	...
	Public CP_SSSMAIN(13 + 0 + 0 + 1) As clsCP
	Public CL_SSSMAIN(13) As Short
	...
	Sub AE_Check_SSSMAIN_ENDJDNNO(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(9)
			...
			If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ENDJDNNO_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(8).CuVal))
			Else
				'UPGRADE_WARNING: オブジェクト ENDJDNNO_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = ENDJDNNO_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(8).CuVal))
	...
	Sub AE_Check_SSSMAIN_SJDNINKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(12)
            ...
            If (.CheckRtnCode = 0) _
                And pm_HandIn _
                And ((AE_IsNull_SSSMAIN(CC_NewVal) And AE_IsNull_SSSMAIN(.CuVal)) _
                Or IIf(IsDBNull(CC_NewVal), Space(1), CC_NewVal) = IIf(IsDBNull(.CuVal), Space(1), .CuVal)) Then
                '2019.03.29 CHG END
                If Not PP_SSSMAIN.RecalcMode Then
                    wk_SaveMask = PP_SSSMAIN.MaskMode
                    PP_SSSMAIN.MaskMode = True
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SJDNINKB_CheckC(CC_NewVal)
			Else
				'UPGRADE_WARNING: オブジェクト SJDNINKB_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SJDNINKB_CheckC(CC_NewVal)
	...
	Sub AE_Check_SSSMAIN_STTJDNNO(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_STTTOKCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(10)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = STTTOKCD_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト STTTOKCD_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = STTTOKCD_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
	...
	Sub AE_ClearItm_SSSMAIN(ByVal pm_HandIn As Boolean) 'Generated.
		...
		If PP_SSSMAIN.Tx < 0 Or PP_SSSMAIN.Tx >= 13 Then Exit Sub
		PP_SSSMAIN.MaskMode = True
		If PP_SSSMAIN.Tx < 13 Then
			Call AE_InitValHd_SSSMAIN(PP_SSSMAIN.Tx, False, CP_SSSMAIN(PP_SSSMAIN.Px).StatusF)
		ElseIf PP_SSSMAIN.Tx < 13 Then 
		ElseIf PP_SSSMAIN.Tx < 13 Then 
		ElseIf PP_SSSMAIN.Tx < 13 Then 
		End If
		'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
	...
	Sub AE_CursorCurrent_SSSMAIN() 'Generated.
		...
		If PP_SSSMAIN.Tx >= 0 And PP_SSSMAIN.Tx < 13 Then
	...
	Sub AE_CursorMove_SSSMAIN(ByVal pm_Tx As Short) 'Generated.
		...
		If wk_Tx < 0 Or wk_Tx >= 13 Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest) : Exit Sub
	...
	Function AE_CursorSkip_SSSMAIN() As Boolean 'Generated.
		...
		Select Case PP_SSSMAIN.CursorDest
			...
			Case Cn_Dest3
				If Not AE_CursorPrev_SSSMAIN(13) Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest)
			Case Cn_Dest4
			...
			Case Else
				Select Case PP_SSSMAIN.CursorDirection
					...
					Case Cn_Direction2
						...
						If PP_SSSMAIN.CursorDest = Cn_Dest1 And wk_Bool = False Then wk_Bool = AE_CursorPrev_SSSMAIN(13)
						PP_SSSMAIN.CursorDirection = wk_CursorDirection
					Case Cn_Direction3
...
#End If
	...
	Sub AE_InitValHd_SSSMAIN(ByVal pm_Px As Short, ByVal pm_SetInOut As Short, ByVal pm_Status As Short) 'Generated.
		...
		Dim wk_ww As Short
		If pm_Px = -2 Then
			Call AE_TabStop_SSSMAIN(0, 12, pm_SetInOut)
		ElseIf pm_Px >= 0 Then 
        ...
        If pm_Px = -2 Or pm_Px = 7 Then 'ENDWRTTM
            '2019.03.28 CHG START
            Call AE_InitVal_SSSMAIN(CP_SSSMAIN(7), ENDWRTTM_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7).CuVal)), pm_Status)
            '2019.03.28 CHG END
        End If
		If pm_Px = -2 Or pm_Px = 8 Then 'STTJDNNO
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(8), STTJDNNO_InitVal(), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 9 Then 'ENDJDNNO
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(9), ENDJDNNO_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(9).CuVal)), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 10 Then 'STTTOKCD
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(10), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 11 Then 'STTTOKRN
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(11), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 12 Then 'SJDNINKB
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(12), SJDNINKB_InitVal(), pm_Status)
		End If
	End Sub
    '2019.03.28 CHG START
...
CheckOrSkip:
        ...
        Select Case pm_NewMode
            Case Cn_Mode1
                If PP_SSSMAIN.Mode <> Cn_Mode1 Then
                    PP_SSSMAIN.Mode = Cn_Mode1  '2019.04.09 del  : AE_ModeBar(PP_SSSMAIN.ScX).Text = "追加"
                    Call AE_TabStop_SSSMAIN(0, 12, False)
                    AE_CursorRest(PP_SSSMAIN.ScX).TabStop = False
                End If
            Case Cn_Mode2
                If PP_SSSMAIN.Mode <> Cn_Mode2 Then
                    PP_SSSMAIN.Mode = Cn_Mode2 '2019.04.09 del  : AE_ModeBar(PP_SSSMAIN.ScX).Text = "選択"
                    Call AE_TabStop_SSSMAIN(0, 12, False)
                    AE_CursorRest(PP_SSSMAIN.ScX).TabStop = False
                End If
            Case Cn_Mode3
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    PP_SSSMAIN.Mode = Cn_Mode3 '2019.04.09 del  : AE_ModeBar(PP_SSSMAIN.ScX).Text = "表示"
                    Call AE_TabStop_SSSMAIN(0, 12, False)
                    AE_CursorRest(PP_SSSMAIN.ScX).TabStop = True
                End If
            Case Cn_Mode4
                If PP_SSSMAIN.Mode <> Cn_Mode4 Then
                    PP_SSSMAIN.Mode = Cn_Mode4 '2019.04.09 del  : AE_ModeBar(PP_SSSMAIN.ScX).Text = "更新"
                    Call AE_TabStop_SSSMAIN(0, 12, False)
                    AE_CursorRest(PP_SSSMAIN.ScX).TabStop = False
                End If
            Case Else
    ...
    Sub AE_RecalcHd_SSSMAIN() 'Generated.
        ...
        If AE_GetInOutMode(CP_SSSMAIN(8).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(8).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
            If CP_SSSMAIN(8).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_STTJDNNO(AE_Val2(CP_SSSMAIN(8)), CP_SSSMAIN(8).StatusF, False, False)
        End If
        If AE_GetInOutMode(CP_SSSMAIN(9).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(9).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
            If CP_SSSMAIN(9).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_ENDJDNNO(AE_Val2(CP_SSSMAIN(9)), CP_SSSMAIN(9).StatusF, False, False)
        End If
        If AE_GetInOutMode(CP_SSSMAIN(10).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(10).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
            If CP_SSSMAIN(10).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_STTTOKCD(AE_Val2(CP_SSSMAIN(10)), CP_SSSMAIN(10).StatusF, False, False)
        End If
        If AE_GetInOutMode(CP_SSSMAIN(11).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(11).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
            If CP_SSSMAIN(11).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_STTTOKRN(AE_Val2(CP_SSSMAIN(11)), CP_SSSMAIN(11).StatusF, False, False)
        End If
        If AE_GetInOutMode(CP_SSSMAIN(12).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(12).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
            If CP_SSSMAIN(12).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SJDNINKB(AE_Val2(CP_SSSMAIN(12)), CP_SSSMAIN(12).StatusF, False, False)
        End If
        ...
        ElseIf PP_SSSMAIN.Tx < 13 Then
            Select Case PP_SSSMAIN.Px
                ...
                Case 7
                    ...
                    End If
                Case 8
                    Call AE_Check_SSSMAIN_STTJDNNO(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 9
                    Call AE_Check_SSSMAIN_ENDJDNNO(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 10
                ...
                Case 11
                    ...
                    End If
                Case 12
                    Call AE_Check_SSSMAIN_SJDNINKB(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
            End Select
        End If
        ...
        ElseIf PP_SSSMAIN.Tx = 2 Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + 2), TextBox).Text = wk_Slisted

                    'change start 20190807 kuwahara
                    'Call AE_Check_SSSMAIN_INPTANCD(AE_Val3(CP_SSSMAIN(2), AE_Controls(PP_SSSMAIN.CtB + 2).ToString()), Cn_Status6, True, True)
                    Call AE_Check_SSSMAIN_INPTANCD(AE_Val3(CP_SSSMAIN(2), AE_Controls(PP_SSSMAIN.CtB + 2).Text), Cn_Status6, True, True)
                    'change end 20190807 kuwahara
        ...
        ElseIf PP_SSSMAIN.Tx = 4 Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    Call AE_Check_SSSMAIN_STTWRTDT(AE_Val3(CP_SSSMAIN(4), AE_Controls(PP_SSSMAIN.CtB + 4).Text), Cn_Status6, True, True)
        ...
        ElseIf PP_SSSMAIN.Tx = 5 Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + 5), TextBox).Text = wk_Slisted
                    Call AE_Check_SSSMAIN_ENDWRTDT(AE_Val3(CP_SSSMAIN(5), AE_Controls(PP_SSSMAIN.CtB + 5).Text), Cn_Status6, True, True)
                    'change end 20190808 kuwahara
        ...
        ElseIf PP_SSSMAIN.Tx = 8 Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    'JDNNOは6桁であるが、空白を含む10桁を取得するため、トリミングをする
                    wk_Slisted = Mid(wk_Slisted, 1, 6)
                    'add end 20190808 kuwahara

                    'change start 20190808 kuwahara
                    'AE_Controls(PP_SSSMAIN.CtB + 8) = wk_Slisted
                    'Call AE_Check_SSSMAIN_STTJDNNO(AE_Val3(CP_SSSMAIN(8), AE_Controls(PP_SSSMAIN.CtB + 8).ToString()), Cn_Status6, True, True)
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + 8), TextBox).Text = wk_Slisted
                    Call AE_Check_SSSMAIN_STTJDNNO(AE_Val3(CP_SSSMAIN(8), AE_Controls(PP_SSSMAIN.CtB + 8).Text), Cn_Status6, True, True)
                    'change end 20190808 kuwahara
        ...
        ElseIf PP_SSSMAIN.Tx = 9 Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    'Call AE_Check_SSSMAIN_ENDJDNNO(AE_Val3(CP_SSSMAIN(9), AE_Controls(PP_SSSMAIN.CtB + 9).ToString()), Cn_Status6, True, True)
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + 9), TextBox).Text = wk_Slisted
                    Call AE_Check_SSSMAIN_ENDJDNNO(AE_Val3(CP_SSSMAIN(9), AE_Controls(PP_SSSMAIN.CtB + 9).Text), Cn_Status6, True, True)
                    'change end 20190808 kuwahara
        ...
        ElseIf PP_SSSMAIN.Tx = 10 Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    'Call AE_Check_SSSMAIN_STTTOKCD(AE_Val3(CP_SSSMAIN(10), AE_Controls(PP_SSSMAIN.CtB + 10).ToString()), Cn_Status6, True, True)
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + 10), TextBox).Text = wk_Slisted
                    Call AE_Check_SSSMAIN_STTTOKCD(AE_Val3(CP_SSSMAIN(10), AE_Controls(PP_SSSMAIN.CtB + 10).Text), Cn_Status6, True, True)
                    'change end 20190808 kuwahara
    ...
    Sub AE_TabStop_SSSMAIN(ByVal pm_FromTx As Short, ByVal pm_ToTx As Short, ByVal pm_SetInOut As Boolean) 'Generated.
        ...
        Do While wk_Tx <= pm_ToTx
            If wk_Tx >= PP_SSSMAIN.NrBodyTx And wk_Tx < 13 Then
            Else
                wk_Px = AE_Px(PP_SSSMAIN, wk_Tx)
                wk_InOutMode = (CP_SSSMAIN(wk_Px).InOutMode \ 256) And &HFFS
    ...
    Sub DP_SSSMAIN_ENDJDNNO(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        wk_SaveMask = PP_SSSMAIN.MaskMode
        PP_SSSMAIN.MaskMode = True
    ...
    Sub DP_SSSMAIN_INPTANNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        '    CP_SSSMAIN(3).StatusC = Cn_Status6 : CP_SSSMAIN(3).StatusF = Cn_Status6 
        If (IsDBNull(CP_SSSMAIN(3).CuVal) Xor IsDBNull(V)) Or CP_SSSMAIN(3).StatusC <> Cn_Status8 Then
            CP_SSSMAIN(3).StatusC = Cn_Status6 : CP_SSSMAIN(3).StatusF = Cn_Status6
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
            '2019.04.02 CHG START
            'ElseIf CP_SSSMAIN(3).CuVal <> V Or CP_SSSMAIN(3).StatusC <> Cn_Status8 Then
        ElseIf iif(isdbnull(CP_SSSMAIN(3).CuVal), "", CP_SSSMAIN(3)) <> iif(IsDBNull(V), "", V) Or CP_SSSMAIN(3).StatusC <> Cn_Status8 Then
            '2019.04.02 CHG END
            CP_SSSMAIN(3).StatusC = Cn_Status6 : CP_SSSMAIN(3).StatusF = Cn_Status6
        End If
        '2019.03.28 CHG END
    ...
    Sub DP_SSSMAIN_OPENM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        '    CP_SSSMAIN(1).StatusC = Cn_Status6 : CP_SSSMAIN(1).StatusF = Cn_Status6
        'End If
        If (IsDBNull(CP_SSSMAIN(1).CuVal) Xor IsDBNull(V)) Or CP_SSSMAIN(1).StatusC <> Cn_Status8 Then
            CP_SSSMAIN(1).StatusC = Cn_Status6 : CP_SSSMAIN(1).StatusF = Cn_Status6
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
        ElseIf CP_SSSMAIN(1).CuVal <> V Or CP_SSSMAIN(1).StatusC <> Cn_Status8 Then
            CP_SSSMAIN(1).StatusC = Cn_Status6 : CP_SSSMAIN(1).StatusF = Cn_Status6
        End If
        '2019.03.29 CHG END
    ...
    Sub DP_SSSMAIN_SJDNINKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        wk_SaveMask = PP_SSSMAIN.MaskMode
        PP_SSSMAIN.MaskMode = True
    ...
    Sub DP_SSSMAIN_STTJDNNO(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        wk_SaveMask = PP_SSSMAIN.MaskMode
        PP_SSSMAIN.MaskMode = True
    ...
    Sub DP_SSSMAIN_STTTOKCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If (IsDBNull(CP_SSSMAIN(10).CuVal) Xor IsDBNull(V)) Or CP_SSSMAIN(10).StatusC <> Cn_Status8 Then
            CP_SSSMAIN(10).StatusC = Cn_Status6 : CP_SSSMAIN(10).StatusF = Cn_Status6
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
        ElseIf CP_SSSMAIN(10).CuVal <> V Or CP_SSSMAIN(10).StatusC <> Cn_Status8 Then
            CP_SSSMAIN(10).StatusC = Cn_Status6 : CP_SSSMAIN(10).StatusF = Cn_Status6
        End If
        '2019.03.29 CHG END
    ...
    Sub DP_SSSMAIN_STTTOKRN(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If (IsDBNull(CP_SSSMAIN(11).CuVal) Xor IsDBNull(V)) Or CP_SSSMAIN(11).StatusC <> Cn_Status8 Then
            CP_SSSMAIN(11).StatusC = Cn_Status6 : CP_SSSMAIN(11).StatusF = Cn_Status6
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
        ElseIf iif(isdbnull(CP_SSSMAIN(11).CuVal), space(1), cp_sssmain(11)) <> iif(isdbnull(V), space(1), V) Or CP_SSSMAIN(11).StatusC <> Cn_Status8 Then
            CP_SSSMAIN(11).StatusC = Cn_Status6 : CP_SSSMAIN(11).StatusF = Cn_Status6
        End If
        '2019.03.29 CHG END
    ...
    Function RD_SSSMAIN_ENDJDNNO(ByVal De As Short) As Object 'Generated.
        Dim st_Work As String
        'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
        If IsDBNull(CP_SSSMAIN(9).CuVal) Then
            RD_SSSMAIN_ENDJDNNO = Space(6)
        Else
            'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            ...
            If LenWid(st_Work) < 6 Then
                ...
                RD_SSSMAIN_ENDJDNNO = CStr(CP_SSSMAIN(9).CuVal) & Space(6 - LenWid(st_Work))
            Else
                'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_ENDJDNNO の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                RD_SSSMAIN_ENDJDNNO = CStr(CP_SSSMAIN(9).CuVal)
            End If
        End If
    End Function
    ...
    Function RD_SSSMAIN_SJDNINKB(ByVal De As Short) As Object 'Generated.
        Dim st_Work As String
        'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
        If IsDBNull(CP_SSSMAIN(12).CuVal) Then
            RD_SSSMAIN_SJDNINKB = Space(1)
        Else
            'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            ...
            If LenWid(st_Work) < 1 Then
                ...
                RD_SSSMAIN_SJDNINKB = Space(1 - LenWid(st_Work)) & CStr(CP_SSSMAIN(12).CuVal)
            Else
                'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SJDNINKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                RD_SSSMAIN_SJDNINKB = CStr(CP_SSSMAIN(12).CuVal)
            End If
        End If
    End Function

    Function RD_SSSMAIN_STTJDNNO(ByVal De As Short) As Object 'Generated.
        Dim st_Work As String
        'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
        If IsDBNull(CP_SSSMAIN(8).CuVal) Then
            RD_SSSMAIN_STTJDNNO = Space(6)
        Else
            'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            ...
            If LenWid(st_Work) < 6 Then
                ...
                RD_SSSMAIN_STTJDNNO = CStr(CP_SSSMAIN(8).CuVal) & Space(6 - LenWid(st_Work))
            Else
                'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_STTJDNNO の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                RD_SSSMAIN_STTJDNNO = CStr(CP_SSSMAIN(8).CuVal)
            End If
        End If
    End Function
    ...
    Function RD_SSSMAIN_STTTOKCD(ByVal De As Short) As Object 'Generated.
        ...
        Else
            ...
            If LenWid(st_Work) < 5 Then
                ...
                RD_SSSMAIN_STTTOKCD = CStr(CP_SSSMAIN(10).CuVal) & Space(5 - LenWid(st_Work))
            Else
                'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_STTTOKCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                RD_SSSMAIN_STTTOKCD = CStr(CP_SSSMAIN(10).CuVal)
            End If
        End If
    End Function
    ...
    Function RD_SSSMAIN_STTTOKRN(ByVal De As Short) As Object 'Generated.
        ...
        Else
            ...
            If LenWid(st_Work) < 40 Then
                ...
                RD_SSSMAIN_STTTOKRN = CStr(CP_SSSMAIN(11).CuVal) & Space(40 - LenWid(st_Work))
            Else
                'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_STTTOKRN の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                RD_SSSMAIN_STTTOKRN = CStr(CP_SSSMAIN(11).CuVal)
            End If
        End If
    End Function

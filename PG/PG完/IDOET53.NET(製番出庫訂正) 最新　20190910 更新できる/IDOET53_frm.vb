...
Friend Class FR_SSSMAIN
	...
	Private Const FM_PANEL3D1_CNT As Short = 33 'パネルコントロール数
    ...
    'add 20190826 start hou
    Private PREVIOUS_CTL As Control = Nothing
    'add 20190826 end hou
    ...
    Private Function Init_Def_Dsp() As Short
		...
		Index_Wk = Index_Wk + 1
		'出庫日ボタン
		'UPGRADE_WARNING: オブジェクト CS_REF_SBN.Tag の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CS_REF_SBN.Tag = Index_Wk
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = CS_REF_SBN
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_ELSE
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_ELSE
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 0
		...
		'    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_X
		'CHG START FKS)INABA 2006/11/27 ***************************************
		'''' UPD 2009/02/21  FKS) S.Nakajima    Start
		'    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 8
		'    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.Dsp_MaxLengthB = 8
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 10
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.Dsp_MaxLengthB = 10
		'''' UPD 2009/02/21  FKS) S.Nakajima    End
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.Num_Int_Fig = 0
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.Num_Fra_Fig = 0
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.Num_Sign_Fig = IN_NUM_ELSE
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.Fil_Chr = Space(1)
	...
	Private Function Ctl_Item_GotFocus(ByRef pm_Ctl As System.Windows.Forms.Control) As Short
		...
		If Main_Inf.Dsp_Sub_Inf(Trg_Index).Detail.In_Area = IN_AREA_DSP_BD And Main_Inf.Dsp_Sub_Inf(Trg_Index).Detail.In_Area <> Main_Inf.Dsp_Sub_Inf(Main_Inf.Dsp_Base.Cursor_Idx).Detail.In_Area Then
			...
			' 訂正のときは明細行を最初から入力済みとする(H.Y. 9/29)
			If SSS_PrgId = "IDOET53" Then
				Main_Inf.Dsp_Body_Inf.Row_Inf(1).Status = BODY_ROW_STATE_INPUT
			End If
		End If
		...
		Select Case Trg_Index
			Case CShort(HD_Cursol_Wk_1.Tag)
				...
				Call SSSMAIN0001.F_Set_Befe_Focus(Main_Inf.Dsp_Sub_Inf(Trg_Index), Move_Flg, Main_Inf)
				''H.Y.(9/24)S            If Trg_Index > Main_Inf.Dsp_Base.Cursor_Idx Then
				''                '次のﾌｫｰｶｽに移動
	...
	Private Function Ctl_Item_Click(ByRef pm_Ctl As System.Windows.Forms.Control) As Short
		...
		'UPGRADE_WARNING: オブジェクト CS_REF_SBN.Tag の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Select Case Trg_Index
			Case CShort(CS_REF_SBN.Tag)
				'出庫訂正対象
				Call SSSMAIN0001.F_Ctl_CS_REF_SBN(Main_Inf.Dsp_Sub_Inf(Trg_Index), Main_Inf)
	...
	Private Sub CS_REF_SBN_Click()
		Debug.Print("CS_REF_JDNNO_Click")
        'UPGRADE_WARNING: オブジェクト CS_REF_SBN.SetFocus の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        '2019/06/18 CHG START
        'CS_REF_SBN.SetFocus()
        CS_REF_SBN.Select()
        '2019/06/18 CHG END
        'UPGRADE_WARNING: オブジェクト CS_REF_SBN の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        Call Ctl_Item_Click(CS_REF_SBN)
	End Sub
	
	Private Sub CS_REF_SBN_GotFocus()
		Debug.Print("CS_REF_SBN_GotFocus")
		'UPGRADE_WARNING: オブジェクト CS_REF_SBN の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_GotFocus(CS_REF_SBN)
	End Sub
	
	Private Sub CS_REF_SBN_KeyUp(ByRef KeyCode As Short, ByRef Shift As Short)
		Debug.Print("CS_REF_SBN_KeyUp")
		'UPGRADE_WARNING: オブジェクト CS_REF_SBN の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_KeyUp(CS_REF_SBN)
	End Sub
	
	Private Sub CS_REF_SBN_MouseUp(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single)
		Debug.Print("CS_REF_SBN_MouseUp")
		'UPGRADE_WARNING: オブジェクト CS_REF_SBN の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Call Ctl_Item_MouseUp(CS_REF_SBN, Button, Shift, X, Y)
	End Sub
	...
	Private Sub HD_NHSADA_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_NHSADA.MouseDown
		...
		''H.Y.(9/20)    Call Ctl_Item_MouseDown(HD_NHSADA, Button, Shift, X, Y)
		'ADD  END  FKS)INABA 2006/11/27 **********************************************
	End Sub
	...
	Private Sub HD_NHSADB_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_NHSADB.MouseDown
		...
		''H.Y.(9/20)    Call Ctl_Item_MouseDown(HD_NHSADB, Button, Shift, X, Y)
		'ADD  END  FKS)INABA 2006/11/27 **********************************************
	End Sub
	...
	Private Sub HD_NHSADC_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_NHSADC.MouseDown
		...
		''H.Y.(9/20)    Call Ctl_Item_MouseDown(HD_NHSADC, Button, Shift, X, Y)
		'ADD  END  FKS)INABA 2006/11/27 ****************************************
	End Sub
	...
	Private Sub FR_SSSMAIN_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        ' SSSMAIN0001をIDOET53用に使う
        Call SSSMAIN0001.F_Set_IDOET53()
        ...
        '入力担当者編集
        'change start 20190910 kuwa 入力担当者が表示されない不具合を修正
        'Call CF_Set_Frm_IN_TANCD(Me, Main_Inf)
        Call CF_Set_Frm_IN_TANCD_IDOET53(Me, Main_Inf)
	...
	Private Sub BD_HINCD_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_HINCD.Enter
		Dim Index As Short = BD_HINCD.GetIndex(eventSender)
		Debug.Print("BD_HINCD_GotFocus" & " " & Main_Inf.Dsp_Body_Inf.Row_Inf(1).Status)
	...
	Private Sub BD_HINCD_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles BD_HINCD.KeyDown
		...
		Dim Shift As Short = eventArgs.KeyData \ &H10000
		Dim Index As Short = BD_HINCD.GetIndex(eventSender)
		Debug.Print("BD_HINCD_KeyDown" & " " & Main_Inf.Dsp_Body_Inf.Row_Inf(1).Status)
	...
	Private Sub BD_HINCD_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles BD_HINCD.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
		Dim Index As Short = BD_HINCD.GetIndex(eventSender)
		Debug.Print("BD_HINCD_KeyPress" & " " & Main_Inf.Dsp_Body_Inf.Row_Inf(1).Status)
	...
	Private Sub BD_HINCD_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_HINCD.Leave
		Dim Index As Short = BD_HINCD.GetIndex(eventSender)
		Debug.Print("BD_HINCD_LostFocus" & " " & Main_Inf.Dsp_Body_Inf.Row_Inf(1).Status)
	...
	Private Sub BD_HINCD_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_HINCD.MouseDown
		...
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
		Dim Index As Short = BD_HINCD.GetIndex(eventSender)
		Debug.Print("BD_HINCD_MouseDown" & " " & Main_Inf.Dsp_Body_Inf.Row_Inf(1).Status)
	...
	Private Sub BD_HINCD_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_HINCD.MouseUp
		...
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
		Dim Index As Short = BD_HINCD.GetIndex(eventSender)
		Debug.Print("BD_HINCD_MouseUp" & " " & Main_Inf.Dsp_Body_Inf.Row_Inf(1).Status)
	...
	Private Sub BD_LINCMA_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_LINCMA.MouseDown
		...
		''H.Y.(9/20)    Call Ctl_Item_MouseDown(BD_ODNYTDT(Index), Button, Shift, X, Y)
		'ADD  END  FKS)INABA 2006/11/27************************************************
	End Sub
	...
	Private Sub HD_NHSCD_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_NHSCD.Leave
		Debug.Print("HD_NHSCD_LostFocus" & " " & Main_Inf.Dsp_Body_Inf.Row_Inf(1).Status)
	...
	Private Sub BD_HINCD_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles BD_HINCD.KeyUp
		...
		Dim Shift As Short = eventArgs.KeyData \ &H10000
		Dim Index As Short = BD_HINCD.GetIndex(eventSender)
		Debug.Print("BD_HINCD_KeyUp" & " " & Main_Inf.Dsp_Body_Inf.Row_Inf(1).Status)
	...
	Private Sub HD_DENDT_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_DENDT.KeyDown
        ...
        'add start  20190910 kuwa 'DELETEキー制御　且つ 日付の選択状態を維持。
        If KeyCode = 0 Then
            eventArgs.Handled = True
        End If
    ...
    Private Sub btnF2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnF2.Click
        ...
        Dim li_MsgRtn As Integer
        'Dim Index As Short = BD_UODSU.GetIndex(sender)

        Try

            If HD_SOUCD.Focused Then
                '倉庫コード
                Call HD_SOUCD_KeyDown(HD_SOUCD, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf HD_DENDT.Focused Then
                '出庫日
                Call HD_DENDT_KeyDown(HD_DENDT, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf HD_NHSCD.Focused Then
                '納入先 
                Call HD_NHSCD_KeyDown(HD_NHSCD, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf HD_TANCD.Focused Then
                '送り先担当者
                Call HD_TANCD_KeyDown(HD_TANCD, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf HD_BUMCD.Focused Then
                '送り先部門 
                Call HD_BUMCD_KeyDown(HD_BUMCD, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf HD_TOKCD.Focused Then
                '得意先
                Call HD_TOKCD_KeyDown(HD_TOKCD, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf HD_BINCD.Focused Then
                '便名
                Call HD_BINCD_KeyDown(HD_BINCD, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf HD_NHSTL.Focused Then
                '電話番号
                Call HD_NHSTL_KeyDown(HD_NHSTL, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf HD_NHSZIPCD.Focused Then
                '郵便番号
                Call HD_NHSZIPCD_KeyDown(HD_NHSZIPCD, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf HD_NHSFAX.Focused Then
                'FAX
                Call HD_NHSFAX_KeyDown(HD_NHSFAX, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            ElseIf BD_UODSU(0).Focused Then
                '数量
                Call BD_UODSU_KeyDown(BD_UODSU, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            Else
                '製品コード
                Call BD_HINCD_KeyDown(BD_HINCD, New System.Windows.Forms.KeyEventArgs(Keys.Return))
            End If
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    Public Function CF_Set_Frm_IN_TANCD_IDOET53(ByRef pm_Form As FR_SSSMAIN, ByRef pm_All As Cls_All) As Short

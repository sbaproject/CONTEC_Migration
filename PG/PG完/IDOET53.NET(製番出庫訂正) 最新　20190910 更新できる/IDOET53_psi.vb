...
Module SSSMAIN0002
	...
	'ADD START FWEST)KOROYASU 2015/12/24 C2-20151214-03 ***************************************************************************
	Public Const gc_strMsgIDOET52_A_104 As String = "1IDOET52_104" '完了もしくは取消された製番ですが、よろしいですか？
	'ADD  END  FWEST)KOROYASU 2015/12/24 C2-20151214-03 ***************************************************************************
	...
	'ADD START FKS)INABA 2008/08/20 ***************************************************************************************
	Public Const gc_strMsgIDOET52_E_019 As String = "2IDOET52_019" '出荷指示及び引当中です。
	
	'ADD  END  FKS)INABA 2008/08/20 ***************************************************************************************
	
	'20080919 ADD START RISE)Tanimura '排他処理
	Public Const gc_strMsgIDOET52_E_903 As String = "2IDOET52_903" '他のプログラムで更新されたため、訂正できません。

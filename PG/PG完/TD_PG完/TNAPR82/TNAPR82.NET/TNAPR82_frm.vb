...
Friend Class FR_SSSMAIN
    ...
    Private mv_bolTNAPR82_GF_Flg As Boolean
    '20190625 ADD START
    ...
    Private Function Init_Def_Dsp() As Short
		...
		Index_Wk = Index_Wk + 1
		'経理締日付
		HD_TEISYOYM.Tag = Index_Wk
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = HD_TEISYOYM
		'UPGRADE_WARNING: オブジェクト Main_Inf.Dsp_Sub_Inf().Detail.In_Area の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
		'UPGRADE_WARNING: オブジェクト Main_Inf.Dsp_Sub_Inf().Detail.In_Typ の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_DATE
		...
		Index_Wk = Index_Wk + 1
		'場所ｺｰﾄﾞ
		HD_SOUBSCD.Tag = Index_Wk
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = HD_SOUBSCD
		'UPGRADE_WARNING: オブジェクト Main_Inf.Dsp_Sub_Inf().Detail.In_Area の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
		'UPGRADE_WARNING: オブジェクト Main_Inf.Dsp_Sub_Inf().Detail.In_Typ の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_CODE
		...
		Index_Wk = Index_Wk + 1
		'場所名称
		HD_SOUBSNM.Tag = Index_Wk
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = HD_SOUBSNM
		'UPGRADE_WARNING: オブジェクト Main_Inf.Dsp_Sub_Inf().Detail.In_Area の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
		'UPGRADE_WARNING: オブジェクト Main_Inf.Dsp_Sub_Inf().Detail.In_Typ の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_STR
	...
	Private Function Ctl_Item_LostFocus(ByRef pm_Ctl As System.Windows.Forms.Control) As Short
		...
		If gv_bolTNAPR82_LF_Enable = False Then
			Exit Function
		End If
		'ﾛｽﾄﾌｫｰｶｽ実行判定
	...
	Private Function Ctl_Item_GotFocus(ByRef pm_Ctl As System.Windows.Forms.Control) As Short
		...
		Select Case Trg_Index
			Case CShort(HD_Cursol_Wk.Tag)
				...
				'帳票出力処理
				Call HD_TEISYOYM.Focus()
				If mv_bolTNAPR82_GF_Flg Then
					
					Call PrintTNAPR82_Main(Main_Inf, -1)
					'キーフラグを元に戻す
					gv_bolKeyFlg = False
				End If
				mv_bolTNAPR82_GF_Flg = False
			...
			Case Else
				If Trg_Index = CShort(HD_TEISYOYM.Tag) Then
					mv_bolTNAPR82_GF_Flg = True
				End If
	...
	Private Function Ctl_MN_Slist_Click() As Short
        ...
        Select Case Act_Index
			'経理締日付
			Case CShort(Me.HD_TEISYOYM.Tag)
				Call SListOpen_TEISYOYM(Main_Inf.Dsp_Sub_Inf(Act_Index), Main_Inf, CStr(1))
				'場所コード
			Case CShort(Me.HD_SOUBSCD.Tag)
				Call SListOpen_SOUBSCD(Main_Inf.Dsp_Sub_Inf(Act_Index), Main_Inf)
				'担当者コード
	...
	' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
	'   名称：  Function SListOpen_SOUBSCD
	'   概要：  対象項目の名称マスタ検索ﾎﾞﾀﾝの制御
	'   引数：  pm_Mode : 呼出元項目判定用コード
	'   戻値：　なし
	'   備考：
	' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
	Private Function SListOpen_SOUBSCD(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All) As Short
		...
		End If
		'割当ｲﾝﾃﾞｯｸｽ取得
		Trg_Index = CShort(Me.HD_SOUBSCD.Tag) ' 出庫理由コード欄
		WLSMEI_KEYCD = "015" ' AE_CONSTで定義されている定数を指定すること(H.Y. 9/24)
	...
	' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
	'   名称：  Function SListOpen_TEISYOYM
	'   概要：  基準日取得画面表示
	'   引数：　なし
	'   戻値：　なし
	'   備考：
	' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
	Private Sub SListOpen_TEISYOYM(ByRef pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, ByRef pm_All As Cls_All, ByRef pm_Mode As String)
		...
		'割当ｲﾝﾃﾞｯｸｽ取得
		Select Case pm_Mode
			Case mc_strCalMode_INPDATEF
				'基準日
				Trg_Index = CShort(Me.HD_TEISYOYM.Tag)
			Case Else
				Exit Sub
		End Select
	...
	Private Function Ctl_MN_LSTART_Click() As Short
		...
		'印刷処理
		Call PrintTNAPR82_Main(Main_Inf, SSS_PRINTER)
		'    End If
	...
	Private Function Ctl_MN_VSTART_Click() As Short
		'Ｓ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｓ
		Call PrintTNAPR82_Main(Main_Inf, SSS_VIEW)
		'キーフラグを元に戻す
		gv_bolKeyFlg = False
		'Ｅ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｅ
	End Function
	...
	Private Function Ctl_MN_FSTART_Click() As Short
		'Ｓ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｓ
		Call PrintTNAPR82_Main(Main_Inf, SSS_FILE)
		'キーフラグを元に戻す
		gv_bolKeyFlg = False
		'Ｅ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｅ
	End Function
	...
	Private Sub FR_SSSMAIN_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
		...
		'終了メッセージの出力
		If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgTNAPR82_I_002, Main_Inf) = MsgBoxResult.No Then
            Cancel = MsgBoxResult.Cancel
            '20190626 ADD START
            eventArgs.Cancel = Cancel
            '20190626 ADD END
	...
	'UPGRADE_WARNING: イベント HD_SOUBSCD.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
	Private Sub HD_SOUBSCD_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_SOUBSCD.TextChanged
		Debug.Print("HD_SOUBSCD_Change")
		Call Ctl_Item_Change(HD_SOUBSCD)
	End Sub
	
	Private Sub HD_SOUBSCD_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_SOUBSCD.Enter
		Debug.Print("HD_SOUBSCD_GotFocus")
		Call Ctl_Item_GotFocus(HD_SOUBSCD)
	End Sub
	
	
	Private Sub HD_SOUBSCD_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_SOUBSCD.KeyDown
		Dim KEYCODE As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
		Debug.Print("HD_SOUBSCD_KeyDown")
		Call Ctl_Item_KeyDown(HD_SOUBSCD, KEYCODE, Shift)
	End Sub
	
	
	Private Sub HD_SOUBSCD_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles HD_SOUBSCD.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
		Debug.Print("HD_SOUBSCD_KeyPress")
		Call Ctl_Item_KeyPress(HD_SOUBSCD, KeyAscii)
	...
	Private Sub HD_SOUBSCD_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_SOUBSCD.KeyUp
		Dim KEYCODE As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
		Debug.Print("HD_SOUBSCD_KeyUp")
		Call Ctl_Item_KeyUp(HD_SOUBSCD)
		
	End Sub
	
	
	Private Sub HD_SOUBSCD_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_SOUBSCD.Leave
		Debug.Print("HD_SOUBSCD_LostFocus")
		Call Ctl_Item_LostFocus(HD_SOUBSCD)
	End Sub
	
	
	Private Sub HD_SOUBSCD_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_SOUBSCD.MouseDown
		Dim Button As Short = eventArgs.Button \ &H100000
		Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
		Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
		Debug.Print("HD_SOUBSCD_MouseDown")
		Call Ctl_Item_MouseDown(HD_SOUBSCD, Button, Shift, X, Y)
	End Sub
	
	
	Private Sub HD_SOUBSCD_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_SOUBSCD.MouseUp
		Dim Button As Short = eventArgs.Button \ &H100000
		Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
		Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
		Debug.Print("HD_SOUBSCD_MouseUp")
		Call Ctl_Item_MouseUp(HD_SOUBSCD, Button, Shift, X, Y)
	End Sub
	...
	'UPGRADE_WARNING: イベント HD_TEISYOYM.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
	Private Sub HD_TEISYOYM_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_TEISYOYM.TextChanged
		Debug.Print("HD_TEISYOYM_Change")
		Call Ctl_Item_Change(HD_TEISYOYM)
	End Sub
	
	Private Sub HD_TEISYOYM_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_TEISYOYM.Enter
		Debug.Print("HD_TEISYOYM_GotFocus")
		Call Ctl_Item_GotFocus(HD_TEISYOYM)
	End Sub
	
	
	Private Sub HD_TEISYOYM_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_TEISYOYM.KeyDown
		Dim KEYCODE As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
		Debug.Print("HD_TEISYOYM_KeyDown")
		Call Ctl_Item_KeyDown(HD_TEISYOYM, KEYCODE, Shift)
	End Sub
	
	
	Private Sub HD_TEISYOYM_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles HD_TEISYOYM.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
		Debug.Print("HD_TEISYOYM_KeyPress")
		Call Ctl_Item_KeyPress(HD_TEISYOYM, KeyAscii)
	...
	Private Sub HD_TEISYOYM_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_TEISYOYM.KeyUp
		Dim KEYCODE As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
		Debug.Print("HD_TEISYOYM_KeyUp")
		Call Ctl_Item_KeyUp(HD_TEISYOYM)
	End Sub
	
	
	Private Sub HD_TEISYOYM_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_TEISYOYM.Leave
		Debug.Print("HD_TEISYOYM_LostFocus")
		Call Ctl_Item_LostFocus(HD_TEISYOYM)
	End Sub
	
	
	Private Sub HD_TEISYOYM_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_TEISYOYM.MouseDown
		Dim Button As Short = eventArgs.Button \ &H100000
		Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
		Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
		Debug.Print("HD_TEISYOYM_MouseDown")
		Call Ctl_Item_MouseDown(HD_TEISYOYM, Button, Shift, X, Y)
	End Sub
	
	Private Sub HD_TEISYOYM_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_TEISYOYM.MouseUp
		Dim Button As Short = eventArgs.Button \ &H100000
		Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
		Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
		Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
		Debug.Print("HD_TEISYOYM_MouseUp")
		Call Ctl_Item_MouseUp(HD_TEISYOYM, Button, Shift, X, Y)
	End Sub

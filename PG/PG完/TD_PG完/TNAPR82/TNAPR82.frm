...
'Ｓ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｓ
    ...
    Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = HD_TEISYOYM
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_DATE
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_NUM
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 10
    ...
    Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = HD_SOUBSCD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_CODE
    ...
    Set Main_Inf.Dsp_Sub_Inf(Index_Wk).Ctl = HD_SOUBSNM
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Area = IN_AREA_DSP_HD
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Typ = IN_TYP_STR
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.In_Str_Typ = IN_STR_TYP_NX
    Main_Inf.Dsp_Sub_Inf(Index_Wk).Detail.MaxLengthB = 20
...
'Ｓ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｓ
    ...
    On Error Resume Next
        ...
        Case Else
            If Trg_Index = CInt(HD_TEISYOYM.Tag) Then
                mv_bolTNAPR82_GF_Flg = True
            End If
...
'Ｓ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｓ
    ...
    Select Case Act_Index
        '経理締日付
        Case CInt(Me.HD_TEISYOYM.Tag)
            Call SListOpen_TEISYOYM(Main_Inf.Dsp_Sub_Inf(Act_Index), Main_Inf, 1)
        '場所コード
        Case CInt(Me.HD_SOUBSCD.Tag)
...
End Sub
   ...
   ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
Private Function SListOpen_SOUBSCD(pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, _
    ...
    End If
    '割当ｲﾝﾃﾞｯｸｽ取得
    Trg_Index = CInt(FR_SSSMAIN.HD_SOUBSCD.Tag)        ' 出庫理由コード欄
...
End Function
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
Private Sub SListOpen_TEISYOYM(pm_Dsp_Sub_Inf As Cls_Dsp_Sub_Inf, pm_All As Cls_All, pm_Mode As String)
    ...
    If CF_Set_Focus_Ctl(pm_All.Dsp_Sub_Inf(Trg_Index), pm_All) = True Then
        ...
        Set_date = Trim(CF_Get_Item_Value(pm_All.Dsp_Sub_Inf(Trg_Index)))
        'カレンダ検索画面を呼び出す
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    '終了メッセージの出力
    If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgTNAPR82_I_002, Main_Inf) = vbNo Then
        Cancel = vbCancel
        Exit Sub
    End If
...
Private Sub HD_SOUBSCD_LostFocus()
    Debug.Print "HD_SOUBSCD_LostFocus"
    Call Ctl_Item_LostFocus(HD_SOUBSCD)
End Sub


Private Sub HD_SOUBSCD_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    Debug.Print "HD_SOUBSCD_MouseDown"
    Call Ctl_Item_MouseDown(HD_SOUBSCD, Button, Shift, X, Y)
End Sub


Private Sub HD_SOUBSCD_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
...
Private Sub HD_TEISYOYM_KeyUp(KEYCODE As Integer, Shift As Integer)
    Debug.Print "HD_TEISYOYM_KeyUp"
    Call Ctl_Item_KeyUp(HD_TEISYOYM)
End Sub


Private Sub HD_TEISYOYM_LostFocus()
    Debug.Print "HD_TEISYOYM_LostFocus"
    Call Ctl_Item_LostFocus(HD_TEISYOYM)
End Sub


Private Sub HD_TEISYOYM_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    Debug.Print "HD_TEISYOYM_MouseDown"
    Call Ctl_Item_MouseDown(HD_TEISYOYM, Button, Shift, X, Y)
End Sub

Private Sub HD_TEISYOYM_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)

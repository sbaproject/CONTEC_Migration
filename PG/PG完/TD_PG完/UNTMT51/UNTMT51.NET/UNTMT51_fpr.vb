...
Module SSSMAIN0001
	...
	Sub AE_Check_SSSMAIN_UNTCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(wk_Px)
            ...
            ElseIf (.CheckRtnCode <> 0) Then
                ...
                'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                Ck_Error = UNTCD_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
            Else
                'UPGRADE_WARNING: オブジェクト UNTCD_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                Ck_Error = UNTCD_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
    ...
    Sub AE_CursorCurrent_SSSMAIN() 'Generated.
        ...
        If PP_SSSMAIN.Tx >= 0 And PP_SSSMAIN.Tx < 47 Then
    ...
    Function AE_CursorDown_SSSMAIN(ByVal pm_Tx As Short, Optional ByVal pm_Int As Object = Nothing) As Boolean 'Generated.
        ...
        wk_Tx = pm_Tx
        Do While wk_Tx < 47
            If wk_Tx < 1 Or wk_Tx >= 47 Then
                wk_Tx = wk_Tx + 1
            ElseIf wk_Tx = 1 Then
                If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 1) >= 0 Then
                    Do
                        wk_Tx = wk_Tx + 1
                        If ((wk_Tx - 2) \ 3) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then Exit Do
                        ...
                        If wk_Tx = PP_SSSMAIN.NrBodyTx - 1 Then
                            If PP_SSSMAIN.TopDe < 14 - PP_SSSMAIN.MaxDspC Then
                                ...
                                If PP_SSSMAIN.TopDe = wk_ExTopDe + 1 Then wk_Tx = wk_Tx - 3
                            End If
                        End If
                    Loop Until wk_Tx >= PP_SSSMAIN.NrBodyTx - 1
                End If
                wk_Tx = 47
            ElseIf wk_Tx + 3 < PP_SSSMAIN.NrBodyTx Then
                wk_Tx = wk_Tx + 3
                If ((wk_Tx - 2) \ 3) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 47
                '     以降は (wk_Tx + 3 >= PP_SSSMAIN.NrBodyTx) の場合
            ElseIf PP_SSSMAIN.TopDe < 14 - PP_SSSMAIN.MaxDspC Then
                If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 5) >= 0 Then
                    wk_Tx = wk_Tx + 3
                    If ((wk_Tx - 2) \ 3) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then
                        wk_Tx = 47
                    Else
                        wk_ExTopDe = PP_SSSMAIN.TopDe
                        Call AE_Scrl_SSSMAIN(PP_SSSMAIN.TopDe + 1, False)
    ...
    Sub AE_CursorMove_SSSMAIN(ByVal pm_Tx As Short) 'Generated.
        ...
        If wk_Tx < 0 Or wk_Tx >= 47 Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest) : Exit Sub
    ...
    Function AE_CursorNext_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
        ...
        Do While wk_Tx < 47
            ...
            If wk_Tx = PP_SSSMAIN.NrBodyTx Then
                ...
                End If
            End If
            If wk_Tx >= 2 And wk_Tx < 47 Then 'AE_BodyN > 0
                If ((wk_Tx - 2) \ 3) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 47
            End If
            If wk_Tx < 47 Then
                If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
    ...
    Function AE_CursorNextDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
        ...
        Do While wk_Tx < 46
            wk_Tx = wk_Tx + 1
            If wk_Tx = PP_SSSMAIN.NrBodyTx Then wk_Tx = 47
            If wk_Tx < 47 Then
                If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
                    Call AE_CursorMove_SSSMAIN(wk_Tx)
    ...
    Function AE_CursorPrev_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
        ...
        Do While wk_Tx >= 0
            If wk_Tx = 47 Then
                wk_Tx = PP_SSSMAIN.NrBodyTx - 3
                wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 3
                ...
                If wk_Tx >= 2 Then
                    Do
                        ...
                        End If
                        wk_Tx = wk_Tx + 1
                        If (wk_Tx - 2) Mod 3 = 0 Then wk_Tx = wk_Tx - 3 - 3
                        If wk_Tx < 2 Then
    ...
    Function AE_CursorPrevDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
        ...
        wk_Tx = pm_Tx
        Do While wk_Tx >= 0
            If wk_Tx = 47 Then wk_Tx = PP_SSSMAIN.NrBodyTx
            wk_Tx = wk_Tx - 1
            If wk_Tx >= 0 Then
                If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
                    Call AE_CursorMove_SSSMAIN(wk_Tx)
    ...
    Function AE_CursorSkip_SSSMAIN() As Boolean 'Generated.
        ...
        Select Case PP_SSSMAIN.CursorDest
            ...
            Case Cn_Dest3
                If Not AE_CursorPrev_SSSMAIN(47) Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest)
            Case Cn_Dest4
            ...
            Case Else
                Select Case PP_SSSMAIN.CursorDirection
                    ...
                    Case Cn_Direction2
                        ...
                        If PP_SSSMAIN.CursorDest = Cn_Dest1 And wk_Bool = False Then wk_Bool = AE_CursorPrev_SSSMAIN(47)
                        PP_SSSMAIN.CursorDirection = wk_CursorDirection
                    Case Cn_Direction3
    ...
    Function AE_CursorUp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
        ...
        wk_Tx = pm_Tx
        Do While wk_Tx >= 0
            If wk_Tx < 2 Or wk_Tx > 47 Then
                wk_Tx = wk_Tx - 1
            ElseIf wk_Tx = 47 Then
                wk_Tx = PP_SSSMAIN.NrBodyTx - 3
                wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 3
                If wk_LastTx < wk_Tx Then wk_Tx = wk_LastTx
                Do While wk_Tx >= 2
    ...
    Sub AE_DeRestore_SSSMAIN(ByVal pm_De As Short) 'Generated.
        ...
        bolRet = UNTMT_MF_SaveRestore_UWRTDTTM(pm_De, 1) ' 復元
        ...
        Do While wk_ww < 5
            ...
            If CP_SSSMAIN(78 + wk_ww).StatusC <> Cn_Status8 Or IsDBNull(CP_SSSMAIN(78 + wk_ww).CuVal) Then
                ...
                If wk_Tx >= 0 Then AE_Controls(PP_SSSMAIN.CtB + wk_Tx).Text = AE_Tpstr(CP_SSSMAIN(78 + wk_ww).TpStr, CP_SSSMAIN(78 + wk_ww).TypeA)
                '20190729 CHG END
    ...
    Sub AE_DeSave_SSSMAIN(ByVal pm_De As Short) 'Generated.
        ...
        bolRet = UNTMT_MF_SaveRestore_UWRTDTTM(pm_De, 0) ' 退避
        '20080929 CHG END   RISE)Tanimura
        Do While wk_ww < 5
    ...
    Sub AE_DeSub_SSSMAIN(ByVal pm_UD As Short) 'Generated.
        ...
        bolRet = UNTMT51_MF_UpDown_UWRTDTTM(PP_SSSMAIN.De, pm_UD) ' 明細　削除・挿入
...
#End If
    ...
    Sub AE_InitValBdDe_SSSMAIN(ByVal pm_Px As Short, ByVal pm_SetInOut As Short, ByVal pm_Status As Short) 'Generated.
        ...
        End If
        If pm_Px = -2 Or pm_Px = 5 + wk_PxBase Then 'V_DATKB
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
            Call AE_InitVal_SSSMAIN(CP_SSSMAIN(5 + wk_PxBase), System.DBNull.Value, pm_Status)
        End If
        If pm_Px = -2 Or pm_Px = 6 + wk_PxBase Then 'V_UNTNM
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
    ...
    Sub AE_InOutModeN_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String, Optional ByVal pm_De As Object = Nothing) 'Generated.
        ...
        ElseIf wk_Qx < 7 Then
            ...
            If IsNothing(pm_De) Then
                If PP_SSSMAIN.De2 < 0 Or (Not PP_SSSMAIN.RecalcMode And PP_SSSMAIN.Tx >= 47) Then Exit Sub
...
CheckOrSkip:
        ...
        Select Case pm_NewMode
            Case Cn_Mode1
                If PP_SSSMAIN.Mode <> Cn_Mode1 Then
                    ...
                    Call AE_TabStop_SSSMAIN(0, 46, False)
                    AE_CursorRest(PP_SSSMAIN.ScX).TabStop = False
                End If
            Case Cn_Mode2
    ...
    Sub AE_RecalcBdDe_SSSMAIN() 'Generated.
        ...
        If PP_SSSMAIN.LastDe > 0 Then
            If AE_GetInOutMode(CP_SSSMAIN(2 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(2 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(2 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_UNTCD(AE_Val2(CP_SSSMAIN(2 + wk_PxBase)), CP_SSSMAIN(2 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(3 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_UNTNM(AE_Val2(CP_SSSMAIN(3 + wk_PxBase)), CP_SSSMAIN(3 + wk_PxBase).StatusF, False, False)
            End If
    ...
    Sub AE_Scrl_SSSMAIN(ByVal pm_DeNo As Short, ByVal pm_SetFocusOk As Short) 'Generated.
        ...
        Do While Wk_De <= PP_SSSMAIN.MaxDspC
            ...
            Do While wk_ww < 3
                ...
                ElseIf wk_OutOfDe Then
                    ...
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + wk_TxBase + wk_ww), TextBox).Text = AE_Format(CP_SSSMAIN(wk_NewPxBase + wk_ww), System.DBNull.Value, 0, True)
                    '20190729 CHG END
                Else
                    'UPGRADE_WARNING: オブジェクト AE_Controls(PP_SSSMAIN.CtB + wk_TxBase + wk_ww) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    '20190729 CHG START
                    'AE_Controls(PP_SSSMAIN.CtB + wk_TxBase + wk_ww) = CP_SSSMAIN(wk_NewPxBase + wk_ww).TpStr
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + wk_TxBase + wk_ww), TextBox).Text = CP_SSSMAIN(wk_NewPxBase + wk_ww).TpStr
                    '20190729 CHG END
                End If
        ...
        wk_NewTx = wk_ExTx - 3 * (PP_SSSMAIN.TopDe - wk_ExTopDe)
        If wk_ExTx < 0 Then
        ElseIf wk_NewTx < 2 Then
            wk_NewTx = 2 + (wk_ExTx - 2) Mod 3
        ElseIf wk_NewTx >= PP_SSSMAIN.NrBodyTx Then
            wk_NewTx = 2 + 3 * PP_SSSMAIN.MaxDspC + (wk_ExTx - 2) Mod 3
        End If
        Call AE_ScrlMax(PP_SSSMAIN)
        If wk_Displacement > 0 Then
            ...
            ElseIf wk_ExTx >= 0 Then
                ...
                Do While wk_NewTx2 < PP_SSSMAIN.NrBodyTx
                    If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_NewTx2)).TypeA, wk_NewTx2) Then
                        ...
                        Exit Sub
                    End If
                    wk_NewTx2 = wk_NewTx2 + 3
                Loop
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                Do While wk_NewTx < 47
            ...
            wk_NewTx = 2
            PP_SSSMAIN.CursorDirection = Cn_Direction1
            Do While wk_NewTx < 47 And PP_SSSMAIN.TopDe >= 0 And PP_SSSMAIN.TopDe < PP_SSSMAIN.MaxDe
                If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_NewTx)).TypeA, wk_NewTx) Then
                    If pm_SetFocusOk Then Call AE_CursorMove_SSSMAIN(wk_NewTx)
                    Exit Sub
                End If
    ...
    Sub AE_SetCheck_SSSMAIN(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_HandIn As Boolean) 'Generated.
        ...
        ElseIf PP_SSSMAIN.Tx < 47 Then
            ...
            Select Case PP_SSSMAIN.Px
                Case 2 + wk_PxBase
                    Call AE_Check_SSSMAIN_UNTCD(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 3 + wk_PxBase
    ...
    Sub AE_Slist_SSSMAIN() 'Generated.
        ...
        Dim wk_TxBase As Short
        wk_PxBase = 5 * PP_SSSMAIN.De
        wk_TxBase = 3 * (PP_SSSMAIN.De - PP_SSSMAIN.TopDe)
        If False Then
        ElseIf ((PP_SSSMAIN.Tx - 2) Mod 3 = 0) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 47 Then
            If ((PP_SSSMAIN.Tx - 2) \ 3) <> (PP_SSSMAIN.De - PP_SSSMAIN.TopDe) Then
            ...
            wk_Slisted = UNTCD_Slist(PP_SSSMAIN, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(2 + 5 * PP_SSSMAIN.De).CuVal))
            PP_SSSMAIN.NeglectLostFocusCheck = False
            'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
            'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    CP_SSSMAIN(2 + wk_PxBase).TpStr = wk_Slisted
                    CP_SSSMAIN(2 + wk_PxBase).CIn = Cn_ChrInput
                    'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    'UPGRADE_WARNING: オブジェクト AE_Controls(PP_SSSMAIN.CtB + 2 + wk_TxBase) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    '20910730 CHG START
                    'AE_Controls(PP_SSSMAIN.CtB + 2 + wk_TxBase) = wk_Slisted
                    AE_Controls(PP_SSSMAIN.CtB + 2 + wk_TxBase).Text = wk_Slisted
                    '20190730 CHG END
                    '20190729 CHG START
                    'Call AE_Check_SSSMAIN_UNTCD(AE_Val3(CP_SSSMAIN(2 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 2 + wk_TxBase).ToString()), Cn_Status6, True, True)
                    Call AE_Check_SSSMAIN_UNTCD(AE_Val3(CP_SSSMAIN(2 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 2 + wk_TxBase).Text), Cn_Status6, True, True)
                    '20190729 CHG END
                End If
            Else
                PP_SSSMAIN.CursorDest = Cn_Dest0
    ...
    Sub AE_TabStop_SSSMAIN(ByVal pm_FromTx As Short, ByVal pm_ToTx As Short, ByVal pm_SetInOut As Boolean) 'Generated.
        ...
        Do While wk_Tx <= pm_ToTx
            If wk_Tx >= PP_SSSMAIN.NrBodyTx And wk_Tx < 47 Then
            Else
                wk_Px = AE_Px(PP_SSSMAIN, wk_Tx)
                wk_InOutMode = (CP_SSSMAIN(wk_Px).InOutMode \ 256) And &HFFS
	...
	Sub DP_SSSMAIN_UNTCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_V_UNTNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Function RD_SSSMAIN_UNTCD(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 5 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(2 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_UNTCD = Space(2)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 2 Then
				...
				RD_SSSMAIN_UNTCD = Space(2 - LenWid(st_Work)) & CStr(CP_SSSMAIN(2 + wk_PxBase).CuVal)
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_UNTCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_UNTCD = CStr(CP_SSSMAIN(2 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_UNTNM(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 4 Then
				...
				RD_SSSMAIN_UNTNM = CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal) & Space(4 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_UNTNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_UNTNM = CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_V_DATKB(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_V_DATKB = CStr(CP_SSSMAIN(5 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_DATKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_DATKB = CStr(CP_SSSMAIN(5 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_UNTNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 5 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(6 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_UNTNM = Space(4)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 4 Then
				...
				RD_SSSMAIN_V_UNTNM = CStr(CP_SSSMAIN(6 + wk_PxBase).CuVal) & Space(4 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_UNTNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_UNTNM = CStr(CP_SSSMAIN(6 + wk_PxBase).CuVal)
			End If
		End If
	End Function

...
Friend Class FR_SSSMAIN
	...
	'UPGRADE_WARNING: イベント BD_UNTCD.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
	Private Sub BD_UNTCD_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_UNTCD.TextChanged
		Dim Index As Short = BD_UNTCD.GetIndex(eventSender) 'Generated.
		...
		If PP_SSSMAIN.MaskMode = False Then
            '20190729 CHG START
            'If AE_Change(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_UNTCD(Index)) Then
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_UNTCD(Index), FORM_LOAD_FLG) Then
                '20190729 CHG END
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
                Call AE_Check_SSSMAIN_UNTCD(PP_SSSMAIN.NewVal, Cn_Status6, True, True)
            End If
        End If
    End Sub

    Private Sub BD_UNTCD_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_UNTCD.Enter
        Dim Index As Short = BD_UNTCD.GetIndex(eventSender) 'Generated.
        ...
        PP_SSSMAIN.Tx = BD_UNTCD(Index).TabIndex
        PP_SSSMAIN.De = Index + PP_SSSMAIN.TopDe
        PP_SSSMAIN.Px = 2 + 5 * PP_SSSMAIN.De
        If Not PP_SSSMAIN.Operable Then Exit Sub
        wk_Int = AE_GotFocus(PP_SSSMAIN, CP_SSSMAIN(2 + 5 * PP_SSSMAIN.De), BD_UNTCD(Index))
        ...
        Call AE_SetSelLen(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_UNTCD(Index))
        BD_UNTCD(Index).BackColor = SSSMSG_BAS.Cn_ClBrightON
        ...
        If Not IsDBNull(wk_Slisted) And PP_SSSMAIN.Px = PP_SSSMAIN.SlistPx Then
            ...
            If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                ...
                'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                BD_UNTCD(Index).Text = wk_Slisted
                Call AE_Check_SSSMAIN_UNTCD(AE_Val2(CP_SSSMAIN(PP_SSSMAIN.Px)), Cn_Status6, True, True)
            End If
        End If
        CM_SLIST.Enabled = True
    End Sub

    Private Sub BD_UNTCD_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles BD_UNTCD.KeyDown
        Dim KEYCODE As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000
        Dim Index As Short = BD_UNTCD.GetIndex(eventSender) 'Generated.
        If AE_KeyDown_SSSMAIN(BD_UNTCD(Index), KEYCODE, Shift, CP_SSSMAIN(PP_SSSMAIN.Px).TpStr) Then
            ...
            Else
                '20190729 CHG START
                'If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_UNTCD(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).ToString()), Cn_Status6, True, True)
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_UNTCD(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).Text), Cn_Status6, True, True)
                '201920729 CHG END
    ...
    Private Sub BD_UNTCD_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles BD_UNTCD.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
        Dim Index As Short = BD_UNTCD.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.Tx <> 2 + 3 * Index Then Beep() : KeyAscii = 0 : GoTo EventExitSub
        Call AE_KeyPress(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_UNTCD(Index), KeyAscii)
EventExitSub:
    ...
    Private Sub BD_UNTCD_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_UNTCD.Leave
        Dim Index As Short = BD_UNTCD.GetIndex(eventSender) 'Generated.
        ...
        Else
            If CP_SSSMAIN(PP_SSSMAIN.Px).StatusC = Cn_Status1 And PP_SSSMAIN.ModalFlag = False Then
                '20190729 CHG START
                'If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_UNTCD(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).ToString()), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
                If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_UNTCD(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).Text), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
                '20190729 CHG END
                ...
                If Not PP_SSSMAIN.NeglectLostFocusCheck And Ck_Error <> 0 Then
                    ...
                    BD_UNTCD(Index).Focus()
                End If
            End If
        End If
        If System.Drawing.ColorTranslator.ToOle(BD_UNTCD(Index).BackColor) = System.Drawing.ColorTranslator.ToOle(SSSMSG_BAS.Cn_ClBrightON) Then Call AE_ColorSub2(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), CL_SSSMAIN(PP_SSSMAIN.Px), PP_SSSMAIN.Tx)
        Call AE_CursorRivise_SSSMAIN()
    End Sub

    Private Sub BD_UNTCD_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_UNTCD.MouseDown
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        ...
        If PP_SSSMAIN.Operable Then
            If (Button And VB6.MouseButtonConstants.RightButton) = VB6.MouseButtonConstants.RightButton Then
                SM_FullPast.Enabled = AE_PopupMenu(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_UNTCD(Index))
                ...
                wk_Tx = PP_SSSMAIN.Tx
                If PP_SSSMAIN.PopupTx = BD_UNTCD(Index).TabIndex Then wk_Tx = PP_SSSMAIN.PopupTx
                System.Windows.Forms.Application.DoEvents()
                BD_UNTCD(Index).Enabled = True
                Call AE_CursorMove_SSSMAIN(wk_Tx)
            End If
            PP_SSSMAIN.MouseDownTx = BD_UNTCD(Index).TabIndex
        End If
    End Sub

    Private Sub BD_UNTCD_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_UNTCD.MouseUp
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
        Dim Index As Short = BD_UNTCD.GetIndex(eventSender) 'Generated.
        BD_UNTCD(Index).ReadOnly = False
        Call AE_SetSel(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_UNTCD(Index))
    End Sub
    ...
    Private Sub BD_UNTNM_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_UNTNM.Enter
        ...
        If Not PP_SSSMAIN.Operable Then Exit Sub
        wk_Int = AE_GotFocus(PP_SSSMAIN, CP_SSSMAIN(3 + 5 * PP_SSSMAIN.De), BD_UNTNM(Index))
        If wk_Int >= 0 Then Call AE_CursorSub_SSSMAIN(wk_Int) : Exit Sub
        If PP_SSSMAIN.ExTx < 2 Then
            If AE_CompleteCheck_SSSMAIN(True) > 0 Then
                If PP_SSSMAIN.InCompletePx >= 0 Then
    ...
    Private Sub BD_UNTNM_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles BD_UNTNM.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
        Dim Index As Short = BD_UNTNM.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.Tx <> 3 + 3 * Index Then Beep() : KeyAscii = 0 : GoTo EventExitSub
...
EventExitSub:
    ...
    Private Sub BD_UPDKB_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_UPDKB.Enter
        ...
        If Not PP_SSSMAIN.Operable Then Exit Sub
        wk_Int = AE_GotFocus(PP_SSSMAIN, CP_SSSMAIN(4 + 5 * PP_SSSMAIN.De), BD_UPDKB(Index))
        If wk_Int >= 0 Then Call AE_CursorSub_SSSMAIN(wk_Int) : Exit Sub
        If PP_SSSMAIN.ExTx < 2 Then
            If AE_CompleteCheck_SSSMAIN(True) > 0 Then
                If PP_SSSMAIN.InCompletePx >= 0 Then
    ...
    Private Sub BD_UPDKB_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles BD_UPDKB.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
        Dim Index As Short = BD_UPDKB.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.Tx <> 4 + 3 * Index Then Beep() : KeyAscii = 0 : GoTo EventExitSub
...
EventExitSub:
    ...
    End Sub
    '20190729 CHG START
    'Private Sub CS_UNTCD_Click() 'Generated.
    Private Sub CS_UNTCD_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CS_UNTCD.Click 'Generated.
        '20190729 CHG END
        Dim wk_Slisted As Object
        ...
        PP_SSSMAIN.ButtonClick = True
        If Not PP_SSSMAIN.Operable Then Exit Sub
        If PP_SSSMAIN.De2 >= 0 And PP_SSSMAIN.Tx < 47 Then
        ...
        Else
            ...
            wk_TxBase = 0
        End If
        If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(2 + wk_PxBase).TypeA, 2 + wk_TxBase) Then
            PP_SSSMAIN.SlistCall = True
            PP_SSSMAIN.CursorDirection = Cn_Direction1 '1: Next
            Call AE_CursorMove_SSSMAIN(2 + wk_TxBase)
            If PP_SSSMAIN.Tx <> 2 + wk_TxBase Then PP_SSSMAIN.SSCommand5Ajst = True
        Else
            Beep()
            Call AE_CursorCurrent_SSSMAIN()
        End If
    ...
    Private Sub CS_UNTCD_GotFocus() 'Generated.
        PP_SSSMAIN.ButtonClick = False
    End Sub

    Private Sub CS_UNTCD_KeyUp(ByRef KEYCODE As Short, ByRef Shift As Short) 'Generated.
        If PP_SSSMAIN.ButtonClick = False Then
            If KEYCODE = System.Windows.Forms.Keys.Select Then Call AE_CursorCurrent_SSSMAIN()
        End If
    End Sub

    Private Sub CS_UNTCD_MouseUp(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single) 'Generated.
    ...
    Private Sub FR_SSSMAIN_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        With PP_SSSMAIN
            ...
            If .MainForm = "" Then
                ...
                .CtB = AE_CtB
                AE_CtB = AE_CtB + 47
                ReDim Preserve AE_Controls(.CtB + 46)
                .MainFormFile = "UNTMT51.FRM"
...
#End If
            ...
            For Wk_De = 0 To 14
                wk_TxBase = 3 * Wk_De
                BD_UNTCD(Wk_De).TabIndex = 2 + wk_TxBase
                AE_Controls(.CtB + 2 + wk_TxBase) = BD_UNTCD(Wk_De)
                BD_UNTNM(Wk_De).TabIndex = 3 + wk_TxBase
                AE_Controls(.CtB + 3 + wk_TxBase) = BD_UNTNM(Wk_De)
                BD_UPDKB(Wk_De).TabIndex = 4 + wk_TxBase
                AE_Controls(.CtB + 4 + wk_TxBase) = BD_UPDKB(Wk_De)
            Next Wk_De
            TX_CursorRest.TabIndex = 47
            ...
            .NrEBodyTx = 47
            .EScrlMaxL = 1
            Call AE_TabStop_SSSMAIN(0, 46, True)
...
EventExitSub:
	...
	Public Sub MN_EditMn_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MN_EditMn.Click 'Generated.
		...
		If PP_SSSMAIN.OnFocus And PP_SSSMAIN.Tx >= 0 And PP_SSSMAIN.Tx < 47 Then
		...
		If PP_SSSMAIN.OnFocus And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 47 And PP_SSSMAIN.Mode <> Cn_Mode3 Then
			If (PP_SSSMAIN.Tx - 2) \ 3 + PP_SSSMAIN.TopDe < PP_SSSMAIN.LastDe Then
				If PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 47 Then
	...
	Public Sub MN_Paste_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MN_Paste.Click 'Generated.
		...
		If TypeOf VB6.GetActiveControl() Is System.Windows.Forms.TextBox Then
			If AE_IsWritableInOutMode(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px)) And AE_IsEnable(CP_SSSMAIN(PP_SSSMAIN.Px).BlockNo, PP_SSSMAIN.ActiveBlockNo) Then
				...
				If VB6.GetActiveControl().TabIndex >= 47 Then
                    'UPGRADE_ISSUE: Control SelText は、汎用名前空間 ActiveControl 内にあるため、解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"' をクリックしてください。
	...
	Private Sub TX_CursorRest_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles TX_CursorRest.KeyDown
		...
		If KEYCODE = System.Windows.Forms.Keys.Up And Shift = 0 Then
			...
			Else
				...
				wk_Bool = AE_CursorUp_SSSMAIN(47)
			End If
		...
		ElseIf KEYCODE = System.Windows.Forms.Keys.Left And Shift = 0 Then 
			...
			Else
				PP_SSSMAIN.CursorDirection = Cn_Direction2 '2: Prev
				wk_Bool = AE_CursorPrev_SSSMAIN(47)
			End If
		...
		ElseIf KEYCODE = System.Windows.Forms.Keys.End And Shift = 0 Then 
			...
			If PP_SSSMAIN.Mode <> Cn_Mode3 Then
				If AE_CursorPrevDsp_SSSMAIN(47) Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest)
			End If

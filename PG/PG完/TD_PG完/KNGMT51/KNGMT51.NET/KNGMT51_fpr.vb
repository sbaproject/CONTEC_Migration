...
F_Delete_Main_ERR: 
	...
	Public Function F_GET_BD_DATA(ByRef pm_All As Cls_All, Optional ByRef ps_Syori As String = "") As Short
        ...
        Else
            ...
            '	Call AE_CmnMsgLibrary(SSS_PrgNm, Err_Cd, pm_All)
            'End If
            If ls_syori = "F_Set_Next_Focus" And DB_NullReplace(dt.Rows(0)("KNGGRCD"), "") = "" Then
                Err_Cd = gc_strMsgKNGMT51_E_020
                Call AE_CmnMsgLibrary(SSS_PrgNm, Err_Cd, pm_All)
            End If
            '20190819 CHG END
            ...
            For i As Integer = 0 To dsList.Tables("tableName").Rows.Count - 1
                ...
                With pm_All.Dsp_Body_Inf.Row_Inf(intCnt)
                    ...
                    .Bus_Inf.DATKB = DB_NullReplace(dt.Rows(i)("DATKB"), "")
                    .Bus_Inf.KNGGRCD = DB_NullReplace(dt.Rows(i)("KNGGRCD"), "")
                    .Bus_Inf.PGID = DB_NullReplace(dt.Rows(i)("PGID"), "")
                    .Bus_Inf.MEINMA = DB_NullReplace(dt.Rows(i)("MEINMA"), "")
                    .Bus_Inf.UPDFLG = DB_NullReplace(dt.Rows(i)("UPDFLG"), "")
                    .Bus_Inf.UPDAUTH = DB_NullReplace(dt.Rows(i)("UPDAUTH"), "")
                    .Bus_Inf.PRTFLG = DB_NullReplace(dt.Rows(i)("PRTFLG"), "")
                    .Bus_Inf.PRTAUTH = DB_NullReplace(dt.Rows(i)("PRTAUTH"), "")
                    .Bus_Inf.FILEFLG = DB_NullReplace(dt.Rows(i)("FILEFLG"), "")
                    .Bus_Inf.FILEAUTH = DB_NullReplace(dt.Rows(i)("FILEAUTH"), "")
                    .Bus_Inf.SALTFLG = DB_NullReplace(dt.Rows(i)("SALTFLG"), "")
                    .Bus_Inf.SALTAUTH = DB_NullReplace(dt.Rows(i)("SALTAUTH"), "")
                    .Bus_Inf.HDNTFLG = DB_NullReplace(dt.Rows(i)("HDNTFLG"), "")
                    .Bus_Inf.HDNTAUTH = DB_NullReplace(dt.Rows(i)("HDNTAUTH"), "")
                    .Bus_Inf.SAPMFLG = DB_NullReplace(dt.Rows(i)("SAPMFLG"), "")
                    .Bus_Inf.SAPMAUTH = DB_NullReplace(dt.Rows(i)("SAPMAUTH"), "")
                    ...
                    .Bus_Inf.MOTO_WRTDT = DB_NullReplace(dt.Rows(i)("WRTDT"), "")
                    .Bus_Inf.MOTO_WRTTM = DB_NullReplace(dt.Rows(i)("WRTTM"), "")
                    .Bus_Inf.MOTO_UWRTDT = DB_NullReplace(dt.Rows(i)("UWRTDT"), "")
                    .Bus_Inf.MOTO_UWRTTM = DB_NullReplace(dt.Rows(i)("UWRTTM"), "")

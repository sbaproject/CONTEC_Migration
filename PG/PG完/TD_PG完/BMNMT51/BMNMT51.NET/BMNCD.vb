		...
		Else
            ...
            If DBSTAT = 0 Then
                ...
                Do While (DBSTAT = 0)
                    ...
                    If (DB_BMNMTA2.BMNCD = RD_SSSMAIN_BMNCDUP(De_Index)) And (DB_BMNMTA2.STTTKDT <= RD_SSSMAIN_STTTKDT(De_Index)) And (DB_BMNMTA2.ENDTKDT >= RD_SSSMAIN_ENDTKDT(De_Index)) Then
                        '20190807 CHG END
                        'UPGRADE_WARNING: オブジェクト De_Index の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                        'Call DP_SSSMAIN_BMNNMUP(De_Index, DB_BMNMTA.BMNNM)
            ...
            Else
				...
				If STTTKDT <> "" Then
                    ...
                    If (DBSTAT = 0) And (DB_BMNMTA2.BMNCD = BMNCD) Then
                        '20190807 CHG END

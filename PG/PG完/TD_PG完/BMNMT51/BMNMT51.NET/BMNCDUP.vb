...
Module BMNCDUP_F51
	...
	Function BMNCDUP_CheckC(ByVal BMNCDUP As Object, ByVal De_Index As Object, ByVal BMNCD As Object, ByVal Ex_BMNCDUP As Object) As Object
		...
		If LenWid(Trim(BMNCDUP)) <> 0 Then
			...
			Do While (DBSTAT = 0) And (BMNCDUP_CheckC = "")
                ...
                If (DB_BMNMTA2.BMNCD = BMNCDUP) And (DB_BMNMTA2.STTTKDT <= RD_SSSMAIN_STTTKDT(De_Index)) And (DB_BMNMTA2.ENDTKDT >= RD_SSSMAIN_ENDTKDT(De_Index)) Then
	...
	Function BMNCDUP_Slist(ByRef PP As clsPP, ByVal BMNCDUP As Object) As Object
		...
		Do While (DBSTAT = 0)
            ...
            If (DB_BMNMTA2.DATKB = "1") And (DB_BMNMTA2.STTTKDT <= DB_UNYMTA.UNYDT) And (DB_BMNMTA2.ENDTKDT >= DB_UNYMTA.UNYDT) Then
                CType(WLS_BMN1.Controls("LST"), Object).Items.Add(DB_BMNMTA2.BMNCD & "   " & LeftWid(DB_BMNMTA2.BMNNM, 40) & " " & CNV_DATE(DB_BMNMTA2.STTTKDT) & " " & CNV_DATE(DB_BMNMTA2.ENDTKDT))
            End If
            Call DB_GetNext(DBN_BMNMTA, BtrNormal)
		Loop
        'UPGRADE_WARNING: オブジェクト LenWid() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'SSS_WLSLIST_KETA = LenWid(DB_BMNMTA.BMNCD)
        SSS_WLSLIST_KETA = LenWid(DB_BMNMTA2.BMNCD)
        '20190807 CHG END
        WLS_BMN1.ShowDialog()
		WLS_BMN1.Close()
	...
	Sub BMNCDUP_Move(ByVal BMNCDUP As Object, ByVal De_Index As Short)
        ...
        If Trim(BMNCDUP) <> "" Then
            ...
            Call DP_SSSMAIN_BMNCDUP(De_Index, DB_BMNMTA2.BMNCD)
            Call DP_SSSMAIN_BMNNMUP(De_Index, DB_BMNMTA2.BMNNM)
            '2090807 CHG END
        Else

...
Module BMNMTA_M51
	...
	Sub UPDMST()
		...
		Do While I < PP_SSSMAIN.LastDe
            ...
            DB_BMNMTA2.BMNCD = RD_SSSMAIN_BMNCD(I)
            ...
            DB_BMNMTA2.STTTKDT = RD_SSSMAIN_STTTKDT(I)
            '20190807CHG END
            ...
            Call DB_GetEq(DBN_BMNMTA, 1, DB_BMNMTA2.BMNCD & DB_BMNMTA2.STTTKDT, BtrNormal)
            '20190807 CHG END
            ...
            If DBSTAT = 0 Then
                ...
                strOPEID = DB_BMNMTA2.OPEID '最終作業者コード
                strCLTID = DB_BMNMTA2.CLTID 'クライアントＩＤ
                strUOPEID = DB_BMNMTA2.UOPEID '最終作業者コード（バッチ）
                strUCLTID = DB_BMNMTA2.UCLTID 'クライアントＩＤ（バッチ）
                ' === 20080929 === INSERT E - RISE)Izumi
                strWRTDT = DB_BMNMTA2.WRTDT '更新日付
                strWRTTM = DB_BMNMTA2.WRTTM '更新時刻
                strUWRTDT = DB_BMNMTA2.UWRTDT 'バッチ更新日付
                strUWRTTM = DB_BMNMTA2.UWRTTM 'バッチ更新時刻
                '20190807 CHG END
		...
		Do While I < PP_SSSMAIN.LastDe
            ...
            DB_BMNMTA2.STTTKDT = RD_SSSMAIN_STTTKDT(I)
            'Call DB_GetEq(DBN_BMNMTA, 1, DB_BMNMTA.BMNCD & DB_BMNMTA.STTTKDT, BtrLock)
            Call DB_GetEq(DBN_BMNMTA, 1, DB_BMNMTA2.BMNCD & DB_BMNMTA2.STTTKDT, BtrLock)
            '20190807 CHG END
            If DBSTAT = 0 Then
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_UPDKB() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				updkb = RD_SSSMAIN_UPDKB(I)
                If updkb = "削除" Then
                    ...
                    DB_BMNMTA2.DATKB = "9"
                    DB_BMNMTA2.WRTTM = wkWRTTM 'Format(Now, "hhmmss")
                    DB_BMNMTA2.WRTDT = wkWRTDT 'Format(Now, "YYYYMMDD")
                    DB_BMNMTA2.UOPEID = SSS_OPEID.Value
                    DB_BMNMTA2.UCLTID = SSS_CLTID.Value
                    DB_BMNMTA2.UWRTTM = wkWRTTM ' Format(Now, "hhmmss")
                    DB_BMNMTA2.UWRTDT = wkWRTDT ' Format(Now, "YYYYMMDD")
                    DB_BMNMTA2.PGID = SSS_PrgId
                    '20190807 CHG END
			...
			Else
                ...
                '            DB_BMNMTA.PGID = SSS_PrgId
                DB_BMNMTA2.DATKB = "1"
                DB_BMNMTA2.WRTFSTTM = wkWRTTM ' Format$(Now, "hhnnss")
                DB_BMNMTA2.WRTFSTDT = wkWRTDT ' Format$(Now, "YYYYMMDD")
                DB_BMNMTA2.FOPEID = SSS_OPEID.Value
                DB_BMNMTA2.FCLTID = SSS_CLTID.Value
                DB_BMNMTA2.WRTFSTTM = wkWRTTM ' Format(Now, "hhmmss")
                DB_BMNMTA2.WRTFSTDT = wkWRTDT ' Format(Now, "YYYYMMDD")
                DB_BMNMTA2.WRTTM = wkWRTTM ' Format(Now, "hhmmss")
                DB_BMNMTA2.WRTDT = wkWRTDT ' Format(Now, "YYYYMMDD")
                DB_BMNMTA2.UOPEID = SSS_OPEID.Value

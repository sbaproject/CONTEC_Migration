...
Module ENDTKDT_F51
	...
	Function ENDTKDT_CheckC(ByVal ENDTKDT As Object, ByVal BMNCD As Object, ByVal STTTKDT As Object, ByVal De_Index As Object) As Object
		...
		If rtn Then
			...
			If ENDTKDT_CheckC = 0 Then
                ...
                If AE_Val2(CP_SSSMAIN(11 + wk_PxBase)).ToString <> "" Then
                ...
                If AE_Val2(CP_SSSMAIN(13 + wk_PxBase)).ToString <> "" Then
                ...
                If AE_Val2(CP_SSSMAIN(14 + wk_PxBase)).ToString <> "" Then
                ...
                If AE_Val2(CP_SSSMAIN(22 + wk_PxBase)).ToString <> "" Then
                ...
                If AE_Val2(CP_SSSMAIN(10 + wk_PxBase)).ToString <> "" Then
	...
	Function ENDTKDT_Skip(ByRef CT_ENDTKDT As System.Windows.Forms.Control, ByVal ENDTKDT As Object) As Object
		...
		If Trim(ENDTKDT) <> "" Then
            ...
            DirectCast(CT_ENDTKDT, TextBox).SelectionStart = 0
            '20190807 CHG END
        End If

	...
	Sub AE_DeRestore_SSSMAIN(ByVal pm_De As Short) 'Generated.
		...
		Do While wk_ww < 42
			...
			If CP_SSSMAIN(213 + wk_ww).StatusC <> Cn_Status8 Or IsDbNull(CP_SSSMAIN(213 + wk_ww).CuVal) Then
                ...
                '20190806 CHG START
                'If wk_Tx >= 0 Then AE_Controls(PP_SSSMAIN.CtB + wk_Tx) = AE_Tpstr(CP_SSSMAIN(213 + wk_ww).TpStr, CP_SSSMAIN(213 + wk_ww).TypeA)
                If wk_Tx > 0 Then
...
CheckOrSkip: 
		...
		ElseIf ((PP_SSSMAIN.Tx - 2) Mod 23 = 2) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 117 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    AE_Controls(PP_SSSMAIN.CtB + 4 + wk_TxBase).Text = wk_Slisted
                    '20190809 chg end
                    Call AE_Check_SSSMAIN_STTTKDT(AE_Val3(CP_SSSMAIN(4 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 4 + wk_TxBase).Text), Cn_Status6, True, True)
                End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
				PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
		...
		ElseIf ((PP_SSSMAIN.Tx - 2) Mod 23 = 20) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 117 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    AE_Controls(PP_SSSMAIN.CtB + 22 + wk_TxBase).Text = wk_Slisted
                    Call AE_Check_SSSMAIN_BMNCDUP(AE_Val3(CP_SSSMAIN(22 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 22 + wk_TxBase).Text), Cn_Status6, True, True)
                End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
				PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
	...
	Sub DP_SSSMAIN_V_ENDTKD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(37 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(37 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(37 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190808 CHG END
	...
	Sub DP_SSSMAIN_V_HTANCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(38 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(38 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(38 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190808 CHG END
	...
	Sub DP_SSSMAIN_V_STANCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(39 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(39 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(39 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190808 CHG END
	...
	Sub DP_SSSMAIN_V_TIKKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(40 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(40 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(40 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190808 CHG END
	...
	Sub DP_SSSMAIN_V_ZMBMNC(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(41 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(41 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(41 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190808 CHG END
	...
	Sub DP_SSSMAIN_V_ZMCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(42 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(42 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(42 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190808 CHG END
	...
	Sub DP_SSSMAIN_V_ZMJGYC(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(43 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(43 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(43 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190808 CHG END

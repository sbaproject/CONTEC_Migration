...
Error_Handler: 
	...
	Private Function F_Execute_PLSQL() As Short
		...
		Dim lngPara5 As Integer 'ﾊﾟﾗﾒｰﾀ3(ﾘﾀｰﾝｺｰﾄﾞ)
		Dim lngPara6 As Integer 'ﾊﾟﾗﾒｰﾀ5(ｴﾗｰｺｰﾄﾞ)
		Dim strPara7 As String 'ﾊﾟﾗﾒｰﾀ6(ｴﾗｰ内容)
		Dim lngPara8 As Integer 'ﾊﾟﾗﾒｰﾀ7(読込件数)
		Dim lngPara9 As Integer 'ﾊﾟﾗﾒｰﾀ8(登録件数)

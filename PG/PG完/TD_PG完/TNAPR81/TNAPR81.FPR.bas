...
'Ｓ★★★★★★★★★★★★★★★★★★★★★★★★★★★★Ｓ
Public Type TNAPR81_TYPE_INPUT
...
End Function
    ...
    '   備考：
    ' ======+=======+=======+=======+=======+=======+=======+=======+=======+=======+
Public Function PrintTNAPR81_Main(pm_All As Cls_All, pm_intMode As Integer) As Integer
...
Private Function F_Execute_PLSQL() As Integer
    ...
    Dim lngPara4    As Long             'ﾊﾟﾗﾒｰﾀ3(ﾘﾀｰﾝｺｰﾄﾞ)
    Dim lngPara5    As Long             'ﾊﾟﾗﾒｰﾀ5(ｴﾗｰｺｰﾄﾞ)
    Dim strPara6    As String           'ﾊﾟﾗﾒｰﾀ6(ｴﾗｰ内容)
    Dim lngPara7    As Long             'ﾊﾟﾗﾒｰﾀ7(読込件数)
    Dim lngPara8    As Long             'ﾊﾟﾗﾒｰﾀ8(登録件数)
    ...
    If IsNull(param(6).Value) = False Then

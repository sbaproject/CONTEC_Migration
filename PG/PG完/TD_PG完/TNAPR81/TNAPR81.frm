...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    '終了メッセージの出力
    If AE_CmnMsgLibrary(SSS_PrgNm, gc_strMsgTNAPR81_I_002, Main_Inf) = vbNo Then
        Cancel = vbCancel
        Exit Sub
    End If

...
Module SSSMAIN0001
    ...
    End Structure
    Public LV_Col_Order(0) As Integer
	...
	Sub AE_DeRestore_SSSMAIN(ByVal pm_De As Short) 'Generated.
		...
		Do While wk_ww < 6
			...
			If CP_SSSMAIN(95 + wk_ww).StatusC <> Cn_Status8 Or IsDbNull(CP_SSSMAIN(95 + wk_ww).CuVal) Then
                ...
                If wk_Tx > 0 Then
                    AE_Controls(PP_SSSMAIN.CtB + wk_Tx).Text = AE_Tpstr(CP_SSSMAIN(95 + wk_ww).TpStr, CP_SSSMAIN(95 + wk_ww).TypeA)
                End If
                '20190717 CHG END
		...
		ElseIf PP_SSSMAIN.Tx = 2 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    Call AE_Check_SSSMAIN_SKHINGRP(AE_Val3(CP_SSSMAIN(2), AE_Controls(PP_SSSMAIN.CtB + 2).Text), Cn_Status6, True, True)
                    '20190717 CHG END
                End If
            Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
		...
		ElseIf ((PP_SSSMAIN.Tx - 4) Mod 4 = 1) And PP_SSSMAIN.Tx >= 4 And PP_SSSMAIN.Tx < 64 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    Call AE_Check_SSSMAIN_RNKCD(AE_Val3(CP_SSSMAIN(5 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 5 + wk_TxBase).Text), Cn_Status6, True, True)
                    '20190718 CHG END
                End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
		...
		ElseIf ((PP_SSSMAIN.Tx - 4) Mod 4 = 2) And PP_SSSMAIN.Tx >= 4 And PP_SSSMAIN.Tx < 64 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    Call AE_Check_SSSMAIN_URISETDT(AE_Val3(CP_SSSMAIN(6 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 6 + wk_TxBase).Text), Cn_Status6, True, True)
                    '20190718 CHG END
                End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0

...
Friend Class FR_SSSMAIN
	...
	'UPGRADE_WARNING: イベント BD_RNKCD.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
	Private Sub BD_RNKCD_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_RNKCD.TextChanged
		Dim Index As Short = BD_RNKCD.GetIndex(eventSender) 'Generated.
		...
		If PP_SSSMAIN.MaskMode = False Then
            '20190718 CHG START'
            'If AE_Change(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_RNKCD(Index)) Then
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_RNKCD(Index), FORM_LOAD_FLG) Then
                '20190718 CHG END'
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
                Call AE_Check_SSSMAIN_RNKCD(PP_SSSMAIN.NewVal, Cn_Status6, True, True)
            End If
        End If
    End Sub

    Private Sub BD_RNKCD_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_RNKCD.Enter
        Dim Index As Short = BD_RNKCD.GetIndex(eventSender) 'Generated.
        ...
        PP_SSSMAIN.Tx = BD_RNKCD(Index).TabIndex
        PP_SSSMAIN.De = Index + PP_SSSMAIN.TopDe
        PP_SSSMAIN.Px = 5 + 6 * PP_SSSMAIN.De
        If Not PP_SSSMAIN.Operable Then Exit Sub
        wk_Int = AE_GotFocus(PP_SSSMAIN, CP_SSSMAIN(5 + 6 * PP_SSSMAIN.De), BD_RNKCD(Index))
        ...
        Call AE_SetSelLen(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_RNKCD(Index))
        BD_RNKCD(Index).BackColor = SSSMSG_BAS.Cn_ClBrightON
        ...
        If Not IsDBNull(wk_Slisted) And PP_SSSMAIN.Px = PP_SSSMAIN.SlistPx Then
            ...
            If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                ...
                'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                BD_RNKCD(Index).Text = wk_Slisted
                Call AE_Check_SSSMAIN_RNKCD(AE_Val2(CP_SSSMAIN(PP_SSSMAIN.Px)), Cn_Status6, True, True)
            End If
        End If
        '20190719 CHG  START
    ...
    Private Sub BD_RNKCD_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles BD_RNKCD.KeyDown
        Dim KEYCODE As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000
        Dim Index As Short = BD_RNKCD.GetIndex(eventSender) 'Generated.
        If AE_KeyDown_SSSMAIN(BD_RNKCD(Index), KEYCODE, Shift, CP_SSSMAIN(PP_SSSMAIN.Px).TpStr) Then
            ...
            Else
                '20190718 CHG START
                'If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_RNKCD(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).ToString()), Cn_Status6, True, True)
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_RNKCD(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).Text), Cn_Status6, True, True)
                '20190718 CHG END
    ...
    Private Sub BD_RNKCD_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles BD_RNKCD.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
        Dim Index As Short = BD_RNKCD.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.Tx <> 5 + 4 * Index Then Beep() : KeyAscii = 0 : GoTo EventExitSub
        Call AE_KeyPress(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_RNKCD(Index), KeyAscii)
EventExitSub:
    ...
    Private Sub BD_RNKCD_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_RNKCD.Leave
        Dim Index As Short = BD_RNKCD.GetIndex(eventSender) 'Generated.
        ...
        Else
            If CP_SSSMAIN(PP_SSSMAIN.Px).StatusC = Cn_Status1 And PP_SSSMAIN.ModalFlag = False Then
                '20190718 CHG START
                'If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_RNKCD(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).ToString()), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
                If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_RNKCD(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).Text), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
                '20190718 CHG END
                ...
                If Not PP_SSSMAIN.NeglectLostFocusCheck And Ck_Error <> 0 Then
                    ...
                    BD_RNKCD(Index).Focus()
                End If
            End If
        End If
        If System.Drawing.ColorTranslator.ToOle(BD_RNKCD(Index).BackColor) = System.Drawing.ColorTranslator.ToOle(SSSMSG_BAS.Cn_ClBrightON) Then Call AE_ColorSub2(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), CL_SSSMAIN(PP_SSSMAIN.Px), PP_SSSMAIN.Tx)
        Call AE_CursorRivise_SSSMAIN()
    End Sub

    Private Sub BD_RNKCD_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_RNKCD.MouseDown
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        ...
        If PP_SSSMAIN.Operable Then
            If (Button And VB6.MouseButtonConstants.RightButton) = VB6.MouseButtonConstants.RightButton Then
                SM_FullPast.Enabled = AE_PopupMenu(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_RNKCD(Index))
                ...
                wk_Tx = PP_SSSMAIN.Tx
                If PP_SSSMAIN.PopupTx = BD_RNKCD(Index).TabIndex Then wk_Tx = PP_SSSMAIN.PopupTx
                System.Windows.Forms.Application.DoEvents()
                BD_RNKCD(Index).Enabled = True
                Call AE_CursorMove_SSSMAIN(wk_Tx)
            End If
            PP_SSSMAIN.MouseDownTx = BD_RNKCD(Index).TabIndex
        End If
    End Sub

    Private Sub BD_RNKCD_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_RNKCD.MouseUp
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
        Dim Index As Short = BD_RNKCD.GetIndex(eventSender) 'Generated.
        BD_RNKCD(Index).ReadOnly = False
        Call AE_SetSel(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_RNKCD(Index))
    End Sub
    ...
    Private Sub BD_SIKRT_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_SIKRT.TextChanged
        Dim Index As Short = BD_SIKRT.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.MultiLineF > 0 Then
            PP_SSSMAIN.MultiLineF = PP_SSSMAIN.MultiLineF - 1
            If PP_SSSMAIN.MultiLineF = 0 Then Exit Sub
        End If
        If PP_SSSMAIN.MaskMode = False Then
            '20190718 CHG START'
            'If AE_Change(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_SIKRT(Index)) Then
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_SIKRT(Index), FORM_LOAD_FLG) Then
                '20190718 CHG END'
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
                Call AE_Check_SSSMAIN_SIKRT(PP_SSSMAIN.NewVal, Cn_Status6, True, True)
            End If
        End If
    End Sub
    ...
    Private Sub BD_SIKRT_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_SIKRT.Enter
        ...
        PP_SSSMAIN.ExTx = PP_SSSMAIN.Tx
        If PP_SSSMAIN.ExTx = -1 Then TX_CursorRest.TabStop = False
        PP_SSSMAIN.Tx = BD_SIKRT(Index).TabIndex
        PP_SSSMAIN.De = Index + PP_SSSMAIN.TopDe
        PP_SSSMAIN.Px = 7 + 6 * PP_SSSMAIN.De
        If Not PP_SSSMAIN.Operable Then Exit Sub
        wk_Int = AE_GotFocus(PP_SSSMAIN, CP_SSSMAIN(7 + 6 * PP_SSSMAIN.De), BD_SIKRT(Index))
        If wk_Int >= 0 Then Call AE_CursorSub_SSSMAIN(wk_Int) : Exit Sub
        If PP_SSSMAIN.ExTx < 4 Then
            If AE_CompleteCheck_SSSMAIN(True) > 0 Then
                If PP_SSSMAIN.InCompletePx >= 0 Then
        ...
        End If
        PP_SSSMAIN.De2 = PP_SSSMAIN.De
        Call AE_SetSelLen(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_SIKRT(Index))
        BD_SIKRT(Index).BackColor = SSSMSG_BAS.Cn_ClBrightON
        '20190719 CHG START
    ...
    Private Sub BD_SIKRT_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles BD_SIKRT.KeyDown
        ...
        Dim Shift As Short = eventArgs.KeyData \ &H10000
        Dim Index As Short = BD_SIKRT.GetIndex(eventSender) 'Generated.
        If AE_KeyDown_SSSMAIN(BD_SIKRT(Index), KEYCODE, Shift, CP_SSSMAIN(PP_SSSMAIN.Px).TpStr) Then
            If RTrim(CP_SSSMAIN(PP_SSSMAIN.Px).TpStr) = RTrim(CP_SSSMAIN(PP_SSSMAIN.Px).IniStr) And CP_SSSMAIN(PP_SSSMAIN.Px).StatusC <> Cn_Status8 And AE_IsClearedDe_SSSMAIN(PP_SSSMAIN.De) Then
                Call AE_ClearItm_SSSMAIN(True)
                wk_Bool = AE_CursorSkip_SSSMAIN()
            Else
                '20190718 CHG START
                'If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_SIKRT(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).ToString()), Cn_Status6, True, True)
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_SIKRT(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).Text), Cn_Status6, True, True)
                '20190718 CHG END
                If PP_SSSMAIN.Mode = Cn_Mode3 Then AE_CursorNext_SSSMAIN(PP_SSSMAIN.Tx)
            End If
        End If
    ...
    Private Sub BD_SIKRT_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles BD_SIKRT.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
        Dim Index As Short = BD_SIKRT.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.Tx <> 7 + 4 * Index Then Beep() : KeyAscii = 0 : GoTo EventExitSub
        Call AE_KeyPress(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_SIKRT(Index), KeyAscii)
EventExitSub:
        eventArgs.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
            eventArgs.Handled = True
    ...
    Private Sub BD_SIKRT_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_SIKRT.Leave
        ...
        Else
            If CP_SSSMAIN(PP_SSSMAIN.Px).StatusC = Cn_Status1 And PP_SSSMAIN.ModalFlag = False Then
                '20190718 CHG START
                'If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_SIKRT(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).ToString()), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
                If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_SIKRT(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).Text), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
                '20190718 CHG END
                'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                If Not PP_SSSMAIN.NeglectLostFocusCheck And Ck_Error <> 0 Then
                    On Error Resume Next
                    BD_SIKRT(Index).Focus()
                End If
            End If
        End If
        If System.Drawing.ColorTranslator.ToOle(BD_SIKRT(Index).BackColor) = System.Drawing.ColorTranslator.ToOle(SSSMSG_BAS.Cn_ClBrightON) Then Call AE_ColorSub2(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), CL_SSSMAIN(PP_SSSMAIN.Px), PP_SSSMAIN.Tx)
        Call AE_CursorRivise_SSSMAIN()
    End Sub
    ...
    Private Sub BD_SIKRT_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_SIKRT.MouseDown
        ...
        If PP_SSSMAIN.Operable Then
            If (Button And VB6.MouseButtonConstants.RightButton) = VB6.MouseButtonConstants.RightButton Then
                SM_FullPast.Enabled = AE_PopupMenu(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_SIKRT(Index))
                'UPGRADE_ISSUE: 定数 vbPopupMenuLeftButton はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="55B59875-9A95-4B71-9D6A-7C294BF7139D"' をクリックしてください。
                'UPGRADE_ISSUE: Form メソッド FR_SSSMAIN.PopupMenu はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
                '20190718 CHG START
                'PopupMenu(SM_ShortCut, vbPopupMenuLeftButton)
                ...
                PP_SSSMAIN.NeglectPopupFocus = False
                wk_Tx = PP_SSSMAIN.Tx
                If PP_SSSMAIN.PopupTx = BD_SIKRT(Index).TabIndex Then wk_Tx = PP_SSSMAIN.PopupTx
                System.Windows.Forms.Application.DoEvents()
                BD_SIKRT(Index).Enabled = True
                Call AE_CursorMove_SSSMAIN(wk_Tx)
            End If
            PP_SSSMAIN.MouseDownTx = BD_SIKRT(Index).TabIndex
        End If
    End Sub
    ...
    Private Sub BD_SIKRT_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_SIKRT.MouseUp
        ...
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
        Dim Index As Short = BD_SIKRT.GetIndex(eventSender) 'Generated.
        BD_SIKRT(Index).ReadOnly = False
        Call AE_SetSel(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_SIKRT(Index))
    End Sub
    ...
    Private Sub BD_UPDKB_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_UPDKB.Enter
        ...
        PP_SSSMAIN.De = Index + PP_SSSMAIN.TopDe
        PP_SSSMAIN.Px = 4 + 6 * PP_SSSMAIN.De
        If Not PP_SSSMAIN.Operable Then Exit Sub
        wk_Int = AE_GotFocus(PP_SSSMAIN, CP_SSSMAIN(4 + 6 * PP_SSSMAIN.De), BD_UPDKB(Index))
        If wk_Int >= 0 Then Call AE_CursorSub_SSSMAIN(wk_Int) : Exit Sub
        If PP_SSSMAIN.ExTx < 4 Then
            If AE_CompleteCheck_SSSMAIN(True) > 0 Then
                If PP_SSSMAIN.InCompletePx >= 0 Then
    ...
    Private Sub BD_UPDKB_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles BD_UPDKB.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
        Dim Index As Short = BD_UPDKB.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.Tx <> 4 + 4 * Index Then Beep() : KeyAscii = 0 : GoTo EventExitSub
...
EventExitSub:
    ...
    'UPGRADE_WARNING: イベント BD_URISETDT.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
    Private Sub BD_URISETDT_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_URISETDT.TextChanged
        Dim Index As Short = BD_URISETDT.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.MultiLineF > 0 Then
            PP_SSSMAIN.MultiLineF = PP_SSSMAIN.MultiLineF - 1
            If PP_SSSMAIN.MultiLineF = 0 Then Exit Sub
        End If
        If PP_SSSMAIN.MaskMode = False Then
            '20190718 CHG START'
            'If AE_Change(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_URISETDT(Index)) Then
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_URISETDT(Index), FORM_LOAD_FLG) Then
                '20190718 CHG END'
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
                Call AE_Check_SSSMAIN_URISETDT(PP_SSSMAIN.NewVal, Cn_Status6, True, True)
            End If
        End If
    End Sub

    Private Sub BD_URISETDT_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_URISETDT.Enter
        Dim Index As Short = BD_URISETDT.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.NeglectPopupFocus Then Exit Sub
        Dim wk_Slisted As Object
        PP_SSSMAIN.ExTx = PP_SSSMAIN.Tx
        If PP_SSSMAIN.ExTx = -1 Then TX_CursorRest.TabStop = False
        PP_SSSMAIN.Tx = BD_URISETDT(Index).TabIndex
        PP_SSSMAIN.De = Index + PP_SSSMAIN.TopDe
        PP_SSSMAIN.Px = 6 + 6 * PP_SSSMAIN.De
        If Not PP_SSSMAIN.Operable Then Exit Sub
        wk_Int = AE_GotFocus(PP_SSSMAIN, CP_SSSMAIN(6 + 6 * PP_SSSMAIN.De), BD_URISETDT(Index))
        If wk_Int >= 0 Then Call AE_CursorSub_SSSMAIN(wk_Int) : Exit Sub
        If PP_SSSMAIN.ExTx < 4 Then
            If AE_CompleteCheck_SSSMAIN(True) > 0 Then
                If PP_SSSMAIN.InCompletePx >= 0 Then
        ...
        End If
        PP_SSSMAIN.De2 = PP_SSSMAIN.De
        'UPGRADE_WARNING: オブジェクト URISETDT_Skip(AE_Controls(PP_SSSMAIN.CtB + 6 + 4 * PP_SSSMAIN.De - PP_SSSMAIN.TopDe), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(6 + 6 * PP_SSSMAIN.De).CuVal)) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        If URISETDT_Skip(AE_Controls(PP_SSSMAIN.CtB + 6 + 4 * (PP_SSSMAIN.De - PP_SSSMAIN.TopDe)), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(6 + 6 * PP_SSSMAIN.De).CuVal)) Then
            ...
            End If
        End If
        Call AE_SetSelLen(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_URISETDT(Index))
        BD_URISETDT(Index).BackColor = SSSMSG_BAS.Cn_ClBrightON
        If PP_SSSMAIN.SlistCall Then
            PP_SSSMAIN.SlistCall = False
            PP_SSSMAIN.SlistPx = PP_SSSMAIN.Px
            PP_SSSMAIN.KeyDownMode = PP_SSSMAIN.Mode
        ...
        If Not IsDBNull(wk_Slisted) And PP_SSSMAIN.Px = PP_SSSMAIN.SlistPx Then
            ...
            If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                ...
                CP_SSSMAIN(PP_SSSMAIN.Px).CIn = Cn_ChrInput
                'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                BD_URISETDT(Index).Text = wk_Slisted
                Call AE_Check_SSSMAIN_URISETDT(AE_Val2(CP_SSSMAIN(PP_SSSMAIN.Px)), Cn_Status6, True, True)
            End If
        End If
        '20190719 CHG START
        'CM_SLIST.Enabled = True
    ...
    Private Sub BD_URISETDT_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles BD_URISETDT.KeyDown
        Dim KEYCODE As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000
        Dim Index As Short = BD_URISETDT.GetIndex(eventSender) 'Generated.
        If AE_KeyDown_SSSMAIN(BD_URISETDT(Index), KEYCODE, Shift, CP_SSSMAIN(PP_SSSMAIN.Px).TpStr) Then
            If RTrim(CP_SSSMAIN(PP_SSSMAIN.Px).TpStr) = RTrim(CP_SSSMAIN(PP_SSSMAIN.Px).IniStr) And CP_SSSMAIN(PP_SSSMAIN.Px).StatusC <> Cn_Status8 And AE_IsClearedDe_SSSMAIN(PP_SSSMAIN.De) Then
                Call AE_ClearItm_SSSMAIN(True)
                wk_Bool = AE_CursorSkip_SSSMAIN()
            Else
                '20190718 CHG START
                'If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_URISETDT(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).ToString()), Cn_Status6, True, True)
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_URISETDT(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).Text), Cn_Status6, True, True)
                '20190718 CHG END
                If PP_SSSMAIN.Mode = Cn_Mode3 Then AE_CursorNext_SSSMAIN(PP_SSSMAIN.Tx)
            End If
        End If
    ...
    Private Sub BD_URISETDT_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles BD_URISETDT.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
        Dim Index As Short = BD_URISETDT.GetIndex(eventSender) 'Generated.
        If PP_SSSMAIN.Tx <> 6 + 4 * Index Then Beep() : KeyAscii = 0 : GoTo EventExitSub
        Call AE_KeyPress(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_URISETDT(Index), KeyAscii)
EventExitSub:
        eventArgs.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
            eventArgs.Handled = True
    ...
    Private Sub BD_URISETDT_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_URISETDT.Leave
        Dim Index As Short = BD_URISETDT.GetIndex(eventSender) 'Generated.
        PP_SSSMAIN.OnFocus = False
        If PP_SSSMAIN.SuppressGotLostFocus = 2 Then PP_SSSMAIN.SuppressGotLostFocus = 0 : Exit Sub
        PP_SSSMAIN.SuppressGotLostFocus = 0
        ...
        Else
            If CP_SSSMAIN(PP_SSSMAIN.Px).StatusC = Cn_Status1 And PP_SSSMAIN.ModalFlag = False Then
                '20190718 CHG START
                'If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_URISETDT(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).ToString()), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
                If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_URISETDT(AE_Val3(CP_SSSMAIN(PP_SSSMAIN.Px), AE_Controls(PP_SSSMAIN.CtB + AE_Tx(PP_SSSMAIN, PP_SSSMAIN.Px)).Text), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
                '20190718 CHG END
                'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                If Not PP_SSSMAIN.NeglectLostFocusCheck And Ck_Error <> 0 Then
                    On Error Resume Next
                    BD_URISETDT(Index).Focus()
                End If
            End If
        End If
        If System.Drawing.ColorTranslator.ToOle(BD_URISETDT(Index).BackColor) = System.Drawing.ColorTranslator.ToOle(SSSMSG_BAS.Cn_ClBrightON) Then Call AE_ColorSub2(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), CL_SSSMAIN(PP_SSSMAIN.Px), PP_SSSMAIN.Tx)
        Call AE_CursorRivise_SSSMAIN()
    End Sub

    Private Sub BD_URISETDT_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_URISETDT.MouseDown
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
        ...
        If PP_SSSMAIN.Operable Then
            If (Button And VB6.MouseButtonConstants.RightButton) = VB6.MouseButtonConstants.RightButton Then
                SM_FullPast.Enabled = AE_PopupMenu(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_URISETDT(Index))
                'UPGRADE_ISSUE: 定数 vbPopupMenuLeftButton はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="55B59875-9A95-4B71-9D6A-7C294BF7139D"' をクリックしてください。
                'UPGRADE_ISSUE: Form メソッド FR_SSSMAIN.PopupMenu はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
                '20190718 CHG START
                'PopupMenu(SM_ShortCut, vbPopupMenuLeftButton)
                ...
                PP_SSSMAIN.NeglectPopupFocus = False
                wk_Tx = PP_SSSMAIN.Tx
                If PP_SSSMAIN.PopupTx = BD_URISETDT(Index).TabIndex Then wk_Tx = PP_SSSMAIN.PopupTx
                System.Windows.Forms.Application.DoEvents()
                BD_URISETDT(Index).Enabled = True
                Call AE_CursorMove_SSSMAIN(wk_Tx)
            End If
            PP_SSSMAIN.MouseDownTx = BD_URISETDT(Index).TabIndex
        End If
    End Sub

    Private Sub BD_URISETDT_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles BD_URISETDT.MouseUp
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y)
        Dim Index As Short = BD_URISETDT.GetIndex(eventSender) 'Generated.
        BD_URISETDT(Index).ReadOnly = False
        Call AE_SetSel(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), BD_URISETDT(Index))
    End Sub
    ...
    Private Sub CM_DeleteDe_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CM_DELETEDE.Click 'Generated.
        ...
        If PP_SSSMAIN.Tx >= 4 And PP_SSSMAIN.Tx < 64 Then
            If (PP_SSSMAIN.Tx - 4) \ 4 + PP_SSSMAIN.TopDe < PP_SSSMAIN.LastDe Then
    ...
    Private Sub CM_UPDKB_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles CM_UPDKB.Click  'Generated.
        '20190718 CHG END
        PP_SSSMAIN.ButtonClick = True
        If Not PP_SSSMAIN.Operable Then Exit Sub
        PP_SSSMAIN.NeglectLostFocusCheck = True
    ...
    End Sub
    '20190718 CHG START
    'Private Sub CS_RNKCD_Click() 'Generated.
    Private Sub CS_RNKCD_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CS_RNKCD.Click 'Generated.
        '20190178 CHG END
        Dim wk_Slisted As Object
        ...
        PP_SSSMAIN.ButtonClick = True
        If Not PP_SSSMAIN.Operable Then Exit Sub
        If PP_SSSMAIN.De2 >= 0 And PP_SSSMAIN.Tx < 64 Then
            wk_PxBase = 6 * PP_SSSMAIN.De
            wk_TxBase = 4 * (PP_SSSMAIN.De - PP_SSSMAIN.TopDe)
        Else
            wk_PxBase = 6 * PP_SSSMAIN.TopDe
            wk_TxBase = 0
        End If
    ...
    Private Sub CS_RNKCD_GotFocus() 'Generated.
        PP_SSSMAIN.ButtonClick = False
    End Sub

    Private Sub CS_RNKCD_KeyUp(ByRef KEYCODE As Short, ByRef Shift As Short) 'Generated.
        If PP_SSSMAIN.ButtonClick = False Then
            If KEYCODE = System.Windows.Forms.Keys.Select Then Call AE_CursorCurrent_SSSMAIN()
        End If
    End Sub

    Private Sub CS_RNKCD_MouseUp(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single) 'Generated.
    ...
    End Sub
    '20190718 chg start
    'Private Sub CS_SKHINGRP_Click() 'Generated.
    Private Sub CS_SKHINGRP_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CS_SKHINGRP.Click 'Generated.
        '20190718 chg end
        Dim wk_Slisted As Object
        Dim wk_SaveTx As Short
        PP_SSSMAIN.ButtonClick = True
    ...
    Private Sub CS_SKHINGRP_GotFocus() 'Generated.
        PP_SSSMAIN.ButtonClick = False
    End Sub

    Private Sub CS_SKHINGRP_KeyUp(ByRef KEYCODE As Short, ByRef Shift As Short) 'Generated.
        If PP_SSSMAIN.ButtonClick = False Then
            If KEYCODE = System.Windows.Forms.Keys.Select Then Call AE_CursorCurrent_SSSMAIN()
        End If
    End Sub

    Private Sub CS_SKHINGRP_MouseUp(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single) 'Generated.
        If Not PP_SSSMAIN.ButtonClick Then
            Call AE_CursorCurrent_SSSMAIN()
        Else
            PP_SSSMAIN.SSCommand5Ajst = False
    ...
    End Sub
    '20190718 CHG START
    'Private Sub CS_URISETDT_Click() 'Generated.
    Private Sub CS_URISETDT_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CS_URISETDT.Click 'Generated. 'Generated.
        '20190718 CHG END
        Dim wk_Slisted As Object
        Dim wk_SaveTx As Short
        Dim wk_TxBase As Short
        ...
        Else
            ...
            wk_TxBase = 0
        End If
        If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(6 + wk_PxBase).TypeA, 6 + wk_TxBase) Then
            PP_SSSMAIN.SlistCall = True
            PP_SSSMAIN.CursorDirection = Cn_Direction1 '1: Next
            Call AE_CursorMove_SSSMAIN(6 + wk_TxBase)
            'If PP_SSSMAIN.Tx <> 6 + wk_TxBase Then PP_SSSMAIN.SSCommand5Ajst = True
        Else
            Beep()
            Call AE_CursorCurrent_SSSMAIN()
        End If
    ...
    Private Sub CS_URISETDT_GotFocus() 'Generated.
        PP_SSSMAIN.ButtonClick = False
    End Sub

    Private Sub CS_URISETDT_KeyUp(ByRef KEYCODE As Short, ByRef Shift As Short) 'Generated.
        If PP_SSSMAIN.ButtonClick = False Then
            If KEYCODE = System.Windows.Forms.Keys.Select Then Call AE_CursorCurrent_SSSMAIN()
        End If
    End Sub

    Private Sub CS_URISETDT_MouseUp(ByRef Button As Short, ByRef Shift As Short, ByRef X As Single, ByRef Y As Single) 'Generated.
        If Not PP_SSSMAIN.ButtonClick Then
            Call AE_CursorCurrent_SSSMAIN()
        Else
            PP_SSSMAIN.SSCommand5Ajst = False
    ...
    Private Sub FR_SSSMAIN_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        With PP_SSSMAIN
            ...
            If .MainForm = "" Then
                ...
                .CtB = AE_CtB
                AE_CtB = AE_CtB + 64
                ReDim Preserve AE_Controls(.CtB + 63)
                .MainFormFile = "TOKMT55.FRM"
...
#End If
            ...
            If .MainForm = "" Then
                ...
                Do While Wk_De <= 14
                    wk_PxBase = 4
                    Do While wk_PxBase < 10
                        wk_Px = wk_PxBase + 6 * Wk_De
            ...
            HD_SKHINGRP.TabIndex = 2
            AE_Controls(.CtB + 2) = HD_SKHINGRP
            HD_SKHINGNM.TabIndex = 3
            AE_Controls(.CtB + 3) = HD_SKHINGNM
            For Wk_De = 0 To 14
                wk_TxBase = 4 * Wk_De
                BD_UPDKB(Wk_De).TabIndex = 4 + wk_TxBase
                AE_Controls(.CtB + 4 + wk_TxBase) = BD_UPDKB(Wk_De)
                BD_RNKCD(Wk_De).TabIndex = 5 + wk_TxBase
                AE_Controls(.CtB + 5 + wk_TxBase) = BD_RNKCD(Wk_De)
                BD_URISETDT(Wk_De).TabIndex = 6 + wk_TxBase
                AE_Controls(.CtB + 6 + wk_TxBase) = BD_URISETDT(Wk_De)
                BD_SIKRT(Wk_De).TabIndex = 7 + wk_TxBase
                AE_Controls(.CtB + 7 + wk_TxBase) = BD_SIKRT(Wk_De)
            Next Wk_De
            TX_CursorRest.TabIndex = 64
            ...
            .NrEBodyTx = 64
            .EScrlMaxL = 1
            Call AE_TabStop_SSSMAIN(0, 63, True)
...
EventExitSub:
    ...
    'UPGRADE_WARNING: イベント HD_SKHINGNM.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
    Private Sub HD_SKHINGNM_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_SKHINGNM.TextChanged 'Generated.
        If PP_SSSMAIN.MultiLineF > 0 Then
            PP_SSSMAIN.MultiLineF = PP_SSSMAIN.MultiLineF - 1
            If PP_SSSMAIN.MultiLineF = 0 Then Exit Sub
        End If
        If PP_SSSMAIN.MaskMode = False Then
            '20190718 CHG START'
            'If AE_Change(PP_SSSMAIN, CP_SSSMAIN(3), HD_SKHINGNM) Then
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(3), HD_SKHINGNM, FORM_LOAD_FLG) Then
                '20190718 CHG END'
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
                Call AE_Check_SSSMAIN_SKHINGNM(PP_SSSMAIN.NewVal, Cn_Status6, True, True)
            End If
        End If
    End Sub

    Private Sub HD_SKHINGNM_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_SKHINGNM.Enter 'Generated.
        If PP_SSSMAIN.NeglectPopupFocus Then Exit Sub
        PP_SSSMAIN.ExTx = PP_SSSMAIN.Tx
        If PP_SSSMAIN.ExTx = -1 Then TX_CursorRest.TabStop = False
        PP_SSSMAIN.Tx = 3
        ...
        PP_SSSMAIN.Px = 3
        If Not PP_SSSMAIN.Operable Then Exit Sub
        wk_Int = AE_GotFocus(PP_SSSMAIN, CP_SSSMAIN(3), HD_SKHINGNM)
        If wk_Int >= 0 Then Call AE_CursorSub_SSSMAIN(wk_Int) : Exit Sub
        Call AE_SetSelLen(PP_SSSMAIN, CP_SSSMAIN(3), HD_SKHINGNM)
        HD_SKHINGNM.BackColor = SSSMSG_BAS.Cn_ClBrightON
        '20190719 CHG START
        'CM_SLIST.Enabled = False
        'btnF5.Enabled = False
        '20190719 CHG END
    ...
    Private Sub HD_SKHINGNM_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_SKHINGNM.KeyDown
        Dim KEYCODE As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000 'Generated.
        If AE_KeyDown_SSSMAIN(HD_SKHINGNM, KEYCODE, Shift, CP_SSSMAIN(3).TpStr) Then
            If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_SKHINGNM(AE_Val3(CP_SSSMAIN(3), HD_SKHINGNM.Text), Cn_Status6, True, True)
            If PP_SSSMAIN.Mode = Cn_Mode3 Then AE_CursorNext_SSSMAIN(3)
        End If
    End Sub

    Private Sub HD_SKHINGNM_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles HD_SKHINGNM.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar) 'Generated.
        If PP_SSSMAIN.Tx <> 3 Then Beep() : KeyAscii = 0 : GoTo EventExitSub
        Call AE_KeyPress(PP_SSSMAIN, CP_SSSMAIN(3), HD_SKHINGNM, KeyAscii)
EventExitSub:
        eventArgs.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
            eventArgs.Handled = True
    ...
    Private Sub HD_SKHINGNM_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_SKHINGNM.Leave 'Generated.
        PP_SSSMAIN.OnFocus = False
        If PP_SSSMAIN.SuppressGotLostFocus = 2 Then PP_SSSMAIN.SuppressGotLostFocus = 0 : Exit Sub
        PP_SSSMAIN.SuppressGotLostFocus = 0
        If PP_SSSMAIN.NeglectPopupFocus Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest) : Exit Sub
        ...
        If CP_SSSMAIN(3).StatusC = Cn_Status1 And PP_SSSMAIN.ModalFlag = False Then
            If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_SKHINGNM(AE_Val3(CP_SSSMAIN(3), HD_SKHINGNM.Text), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
            'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            If Not PP_SSSMAIN.NeglectLostFocusCheck And Ck_Error <> 0 Then
                On Error Resume Next
                HD_SKHINGNM.Focus()
            End If
        End If
        If System.Drawing.ColorTranslator.ToOle(HD_SKHINGNM.BackColor) = System.Drawing.ColorTranslator.ToOle(SSSMSG_BAS.Cn_ClBrightON) Then Call AE_ColorSub2(PP_SSSMAIN, CP_SSSMAIN(3), CL_SSSMAIN(3), PP_SSSMAIN.Tx)
        Call AE_CursorRivise_SSSMAIN()
    End Sub

    Private Sub HD_SKHINGNM_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_SKHINGNM.MouseDown
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y) 'Generated.
        ...
        If PP_SSSMAIN.Operable Then
            If (Button And VB6.MouseButtonConstants.RightButton) = VB6.MouseButtonConstants.RightButton Then
                SM_FullPast.Enabled = AE_PopupMenu(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), HD_SKHINGNM)
                'UPGRADE_ISSUE: 定数 vbPopupMenuLeftButton はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="55B59875-9A95-4B71-9D6A-7C294BF7139D"' をクリックしてください。
                'UPGRADE_ISSUE: Form メソッド FR_SSSMAIN.PopupMenu はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
                '20190718 CHG START
                'PopupMenu(SM_ShortCut, vbPopupMenuLeftButton)
                ...
                PP_SSSMAIN.NeglectPopupFocus = False
                wk_Tx = PP_SSSMAIN.Tx
                If PP_SSSMAIN.PopupTx = HD_SKHINGNM.TabIndex Then wk_Tx = PP_SSSMAIN.PopupTx
                System.Windows.Forms.Application.DoEvents()
                HD_SKHINGNM.Enabled = True
                Call AE_CursorMove_SSSMAIN(wk_Tx)
            End If
    ...
    Private Sub HD_SKHINGNM_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_SKHINGNM.MouseUp
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y) 'Generated.
        HD_SKHINGNM.ReadOnly = False
    End Sub

    'UPGRADE_WARNING: イベント HD_SKHINGRP.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
    Private Sub HD_SKHINGRP_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_SKHINGRP.TextChanged 'Generated.
        If PP_SSSMAIN.MultiLineF > 0 Then
            PP_SSSMAIN.MultiLineF = PP_SSSMAIN.MultiLineF - 1
            If PP_SSSMAIN.MultiLineF = 0 Then Exit Sub
        End If
        If PP_SSSMAIN.MaskMode = False Then
            '20190718 CHG START'
            'If AE_Change(PP_SSSMAIN, CP_SSSMAIN(2), HD_SKHINGRP) Then
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(2), HD_SKHINGRP, FORM_LOAD_FLG) Then
                '20190718 CHG END'
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
                Call AE_Check_SSSMAIN_SKHINGRP(PP_SSSMAIN.NewVal, Cn_Status6, True, True)
            End If
        End If
    End Sub

    Private Sub HD_SKHINGRP_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_SKHINGRP.Enter 'Generated.
        If PP_SSSMAIN.NeglectPopupFocus Then Exit Sub
        Dim wk_Slisted As Object
        PP_SSSMAIN.ExTx = PP_SSSMAIN.Tx
        If PP_SSSMAIN.ExTx = -1 Then TX_CursorRest.TabStop = False
        ...
        PP_SSSMAIN.Px = 2
        If Not PP_SSSMAIN.Operable Then Exit Sub
        wk_Int = AE_GotFocus(PP_SSSMAIN, CP_SSSMAIN(2), HD_SKHINGRP)
        If wk_Int >= 0 Then Call AE_CursorSub_SSSMAIN(wk_Int) : Exit Sub
        Call AE_SetSelLen(PP_SSSMAIN, CP_SSSMAIN(2), HD_SKHINGRP)
        HD_SKHINGRP.BackColor = SSSMSG_BAS.Cn_ClBrightON
        If PP_SSSMAIN.SlistCall Then
            PP_SSSMAIN.SlistCall = False
            PP_SSSMAIN.SlistPx = PP_SSSMAIN.Px
            PP_SSSMAIN.KeyDownMode = PP_SSSMAIN.Mode
        ...
        If Not IsDBNull(wk_Slisted) And PP_SSSMAIN.Px = PP_SSSMAIN.SlistPx Then
            ...
            If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                ...
                'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                HD_SKHINGRP.Text = wk_Slisted
                Call AE_Check_SSSMAIN_SKHINGRP(AE_Val3(CP_SSSMAIN(2), HD_SKHINGRP.Text), Cn_Status6, True, True)
            End If
        End If
        '20190719 CHG START
        'CM_SLIST.Enabled = True
    ...
    Private Sub HD_SKHINGRP_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles HD_SKHINGRP.KeyDown
        Dim KEYCODE As Short = eventArgs.KeyCode
        Dim Shift As Short = eventArgs.KeyData \ &H10000 'Generated.
        If AE_KeyDown_SSSMAIN(HD_SKHINGRP, KEYCODE, Shift, CP_SSSMAIN(2).TpStr) Then
            If PP_SSSMAIN.Mode <> Cn_Mode3 Then Call AE_Check_SSSMAIN_SKHINGRP(AE_Val3(CP_SSSMAIN(2), HD_SKHINGRP.Text), Cn_Status6, True, True)
            If PP_SSSMAIN.Mode = Cn_Mode3 Then AE_CursorNext_SSSMAIN(2)
        End If
    End Sub

    Private Sub HD_SKHINGRP_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles HD_SKHINGRP.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar) 'Generated.
        If PP_SSSMAIN.Tx <> 2 Then Beep() : KeyAscii = 0 : GoTo EventExitSub
        Call AE_KeyPress(PP_SSSMAIN, CP_SSSMAIN(2), HD_SKHINGRP, KeyAscii)
EventExitSub:
        eventArgs.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
            eventArgs.Handled = True
    ...
    Private Sub HD_SKHINGRP_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_SKHINGRP.Leave 'Generated.
        PP_SSSMAIN.OnFocus = False
        If PP_SSSMAIN.SuppressGotLostFocus = 2 Then PP_SSSMAIN.SuppressGotLostFocus = 0 : Exit Sub
        PP_SSSMAIN.SuppressGotLostFocus = 0
        If PP_SSSMAIN.NeglectPopupFocus Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest) : Exit Sub
        ...
        If CP_SSSMAIN(2).StatusC = Cn_Status1 And PP_SSSMAIN.ModalFlag = False Then
            If Not PP_SSSMAIN.NeglectLostFocusCheck Then Call AE_Check_SSSMAIN_SKHINGRP(AE_Val3(CP_SSSMAIN(2), HD_SKHINGRP.Text), Cn_Status6, False, True) : PP_SSSMAIN.LostFocusCheck = True
            'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            If Not PP_SSSMAIN.NeglectLostFocusCheck And Ck_Error <> 0 Then
                On Error Resume Next
                HD_SKHINGRP.Focus()
            End If
        End If
        If System.Drawing.ColorTranslator.ToOle(HD_SKHINGRP.BackColor) = System.Drawing.ColorTranslator.ToOle(SSSMSG_BAS.Cn_ClBrightON) Then Call AE_ColorSub2(PP_SSSMAIN, CP_SSSMAIN(2), CL_SSSMAIN(2), PP_SSSMAIN.Tx)
        Call AE_CursorRivise_SSSMAIN()
    End Sub

    Private Sub HD_SKHINGRP_MouseDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_SKHINGRP.MouseDown
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y) 'Generated.
        ...
        If PP_SSSMAIN.Operable Then
            If (Button And VB6.MouseButtonConstants.RightButton) = VB6.MouseButtonConstants.RightButton Then
                SM_FullPast.Enabled = AE_PopupMenu(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px), HD_SKHINGRP)
                'UPGRADE_ISSUE: 定数 vbPopupMenuLeftButton はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="55B59875-9A95-4B71-9D6A-7C294BF7139D"' をクリックしてください。
                'UPGRADE_ISSUE: Form メソッド FR_SSSMAIN.PopupMenu はアップグレードされませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"' をクリックしてください。
                '20190718 CHG START
                'PopupMenu(SM_ShortCut, vbPopupMenuLeftButton)
                ...
                PP_SSSMAIN.NeglectPopupFocus = False
                wk_Tx = PP_SSSMAIN.Tx
                If PP_SSSMAIN.PopupTx = HD_SKHINGRP.TabIndex Then wk_Tx = PP_SSSMAIN.PopupTx
                System.Windows.Forms.Application.DoEvents()
                HD_SKHINGRP.Enabled = True
                Call AE_CursorMove_SSSMAIN(wk_Tx)
            End If
    ...
    Private Sub HD_SKHINGRP_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles HD_SKHINGRP.MouseUp
        Dim Button As Short = eventArgs.Button \ &H100000
        Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
        Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
        Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y) 'Generated.
        HD_SKHINGRP.ReadOnly = False
        Call AE_SetSel(PP_SSSMAIN, CP_SSSMAIN(2), HD_SKHINGRP)
    End Sub
    ...
    Public Sub MN_EditMn_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MN_EditMn.Click 'Generated.
        ...
        If PP_SSSMAIN.OnFocus And PP_SSSMAIN.Tx >= 0 And PP_SSSMAIN.Tx < 64 Then
        ...
        If PP_SSSMAIN.OnFocus And PP_SSSMAIN.Tx >= 4 And PP_SSSMAIN.Tx < 64 And PP_SSSMAIN.Mode <> Cn_Mode3 Then
            If (PP_SSSMAIN.Tx - 4) \ 4 + PP_SSSMAIN.TopDe < PP_SSSMAIN.LastDe Then
                If PP_SSSMAIN.Tx >= 4 And PP_SSSMAIN.Tx < 64 Then
    ...
    Public Sub MN_Paste_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MN_Paste.Click 'Generated.
        ...
        If TypeOf VB6.GetActiveControl() Is System.Windows.Forms.TextBox Then
            If AE_IsWritableInOutMode(PP_SSSMAIN, CP_SSSMAIN(PP_SSSMAIN.Px)) And AE_IsEnable(CP_SSSMAIN(PP_SSSMAIN.Px).BlockNo, PP_SSSMAIN.ActiveBlockNo) Then
                ...
                If VB6.GetActiveControl().TabIndex >= 64 Then
                    'UPGRADE_ISSUE: Control SelText は、汎用名前空間 ActiveControl 内にあるため、解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"' をクリックしてください。
    ...
    Private Sub TX_CursorRest_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles TX_CursorRest.KeyDown
		...
		If KEYCODE = System.Windows.Forms.Keys.Up And Shift = 0 Then
			...
			Else
				...
				wk_Bool = AE_CursorUp_SSSMAIN(64)
			End If
		...
		ElseIf KEYCODE = System.Windows.Forms.Keys.Left And Shift = 0 Then 
			...
			Else
				PP_SSSMAIN.CursorDirection = Cn_Direction2 '2: Prev
				wk_Bool = AE_CursorPrev_SSSMAIN(64)
			End If
		...
		ElseIf KEYCODE = System.Windows.Forms.Keys.End And Shift = 0 Then 
			...
			If PP_SSSMAIN.Mode <> Cn_Mode3 Then
				If AE_CursorPrevDsp_SSSMAIN(64) Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest)
			End If
    ...
    End Sub
    '20910719 ADD START
    Private Sub btnF12_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnF12.Click 'Generated.
        PP_SSSMAIN.ButtonClick = True
        If Not PP_SSSMAIN.Operable Then Exit Sub
        PP_SSSMAIN.NeglectLostFocusCheck = True
        PP_SSSMAIN.CloseCode = 1

...
Module SSSMAIN0001
    ...
    Public CP_SSSMAIN(107 + 7 + 0 + 1) As clsCP
    Public CL_SSSMAIN(107) As Short
    Public CQ_SSSMAIN(9) As String
    '20190806 ADD START
	...
	Sub AE_Check_SSSMAIN_RATERT(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
	...
	Sub AE_Check_SSSMAIN_TEKIDT(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = TEKIDT_Check(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 7 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト TEKIDT_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = TEKIDT_Check(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 7 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_TUKKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = TUKKB_CheckC(PP_SSSMAIN, CP_SSSMAIN(3 + 7 * PP_SSSMAIN.De), CC_NewVal, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 7 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト TUKKB_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = TUKKB_CheckC(PP_SSSMAIN, CP_SSSMAIN(3 + 7 * PP_SSSMAIN.De), CC_NewVal, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 7 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			...
			If AE_ErrorToInteger(Ck_Error) = 0 Or (pm_Status >= Cn_Status7 And PP_SSSMAIN.CheckErrNglct) Then
				...
				Else
					...
					Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(wk_Px), CL_SSSMAIN(wk_Px))
					If Not PP_SSSMAIN.RecalcMode Then
						PP_SSSMAIN.DerivedOrigin = "BD_TUKKB"
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(5 + 7 * PP_SSSMAIN.De).ExVal = CP_SSSMAIN(5 + 7 * PP_SSSMAIN.De).CuVal 'TEKIDT
						CP_SSSMAIN(5 + 7 * PP_SSSMAIN.De).ExStatus = CP_SSSMAIN(5 + 7 * PP_SSSMAIN.De).StatusC
						If Not wk_Equal Or ex_CheckRtnCode <> 0 Then Call AE_Derived_SSSMAIN_bd_TEKIDT(PP_SSSMAIN.De2)
						If PP_SSSMAIN.ErrorC = 0 Or wk_RecalcSw = False Then
							Call AE_Later_SSSMAIN()
							If pm_MoveCursor Then
								If AE_CursorSkip_SSSMAIN() = False And PP_SSSMAIN.CursorDirection = Cn_Direction1 Then Call AE_CursorSub_SSSMAIN(AE_ExecuteX_SSSMAIN())
	...
	Sub AE_Check_SSSMAIN_TUKNM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		If pm_Tx >= 0 Then
			If CP_SSSMAIN(pm_Px).TypeA = Cn_NormalOrV Then
				If PP_SSSMAIN.SelValid And CP_SSSMAIN(pm_Px).FixedFormat <> 1 Then
                    ...
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + pm_Tx), TextBox).Select(0, Len(AE_Controls(PP_SSSMAIN.CtB + pm_Tx).Text))
                    '20190806 CHG END
                Else
                    'UPGRADE_WARNING: オブジェクト AE_Controls().SelStart の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    '20190806 CHG START
	...
	Sub AE_ClearDe2_SSSMAIN() 'Generated.
		...
		'20081002 ADD START RISE)Tanimura '排他処理
		Call RATMT51_MF_Clear_UWRTDTTM(PP_SSSMAIN.De)
		'20081002 ADD END   RISE)Tanimura
	...
	Function AE_CompleteCheck_SSSMAIN(ByVal pm_HeadCheck As Boolean) As Short 'Generated.
		...
		Do While Wk_De < PP_SSSMAIN.LastDe And PP_SSSMAIN.InCompletePx = -1
			wk_Px = 2 + 7 * Wk_De
			Call AE_CompleteCheckSub_SSSMAIN(wk_Px, wk_Px + 7, wk_IncompletionC, wk_IncompletionC2)
			Wk_De = Wk_De + 1
		Loop 
	...
	Sub AE_CursorCurrent_SSSMAIN() 'Generated.
		...
		If PP_SSSMAIN.Tx >= 0 And PP_SSSMAIN.Tx < 77 Then
	...
	Function AE_CursorDown_SSSMAIN(ByVal pm_Tx As Short, Optional ByVal pm_Int As Object = Nothing) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx < 77
			If wk_Tx < 1 Or wk_Tx >= 77 Then
				wk_Tx = wk_Tx + 1
			ElseIf wk_Tx = 1 Then 
				If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 1) >= 0 Then
					Do 
						wk_Tx = wk_Tx + 1
						If ((wk_Tx - 2) \ 5) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then Exit Do
						...
						If wk_Tx = PP_SSSMAIN.NrBodyTx - 1 Then
							If PP_SSSMAIN.TopDe < 14 - PP_SSSMAIN.MaxDspC Then
								...
								If PP_SSSMAIN.TopDe = wk_ExTopDe + 1 Then wk_Tx = wk_Tx - 5
							End If
						End If
					Loop Until wk_Tx >= PP_SSSMAIN.NrBodyTx - 1
				End If
				wk_Tx = 77
			ElseIf wk_Tx + 5 < PP_SSSMAIN.NrBodyTx Then 
				wk_Tx = wk_Tx + 5
				If ((wk_Tx - 2) \ 5) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 77
				'     以降は (wk_Tx + 5 >= PP_SSSMAIN.NrBodyTx) の場合
			ElseIf PP_SSSMAIN.TopDe < 14 - PP_SSSMAIN.MaxDspC Then 
				If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 7) >= 0 Then
					wk_Tx = wk_Tx + 5
					If ((wk_Tx - 2) \ 5) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then
						wk_Tx = 77
					Else
						wk_ExTopDe = PP_SSSMAIN.TopDe
						Call AE_Scrl_SSSMAIN(PP_SSSMAIN.TopDe + 1, False)
	...
	Sub AE_CursorMove_SSSMAIN(ByVal pm_Tx As Short) 'Generated.
		...
		If wk_Tx < 0 Or wk_Tx >= 77 Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest) : Exit Sub
	...
	Function AE_CursorNext_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx < 77
			...
			If wk_Tx = PP_SSSMAIN.NrBodyTx Then
				...
				End If
			End If
			If wk_Tx >= 2 And wk_Tx < 77 Then 'AE_BodyN > 0
				If ((wk_Tx - 2) \ 5) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 77
			End If
			If wk_Tx < 77 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
	...
	Function AE_CursorNextDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx < 76
			wk_Tx = wk_Tx + 1
			If wk_Tx = PP_SSSMAIN.NrBodyTx Then wk_Tx = 77
			If wk_Tx < 77 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
					Call AE_CursorMove_SSSMAIN(wk_Tx)
	...
	Function AE_CursorPrev_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx >= 0
			If wk_Tx = 77 Then
				wk_Tx = PP_SSSMAIN.NrBodyTx - 5
				wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 5
				...
				If wk_Tx >= 2 Then
					Do 
						...
						End If
						wk_Tx = wk_Tx + 1
						If (wk_Tx - 2) Mod 5 = 0 Then wk_Tx = wk_Tx - 5 - 5
						If wk_Tx < 2 Then
	...
	Function AE_CursorPrevDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx >= 0
			If wk_Tx = 77 Then wk_Tx = PP_SSSMAIN.NrBodyTx
			wk_Tx = wk_Tx - 1
			If wk_Tx >= 0 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
					Call AE_CursorMove_SSSMAIN(wk_Tx)
	...
	Function AE_CursorSkip_SSSMAIN() As Boolean 'Generated.
		...
		Select Case PP_SSSMAIN.CursorDest
			...
			Case Cn_Dest3
				If Not AE_CursorPrev_SSSMAIN(77) Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest)
			Case Cn_Dest4
			...
			Case Else
				Select Case PP_SSSMAIN.CursorDirection
					...
					Case Cn_Direction2
						...
						If PP_SSSMAIN.CursorDest = Cn_Dest1 And wk_Bool = False Then wk_Bool = AE_CursorPrev_SSSMAIN(77)
						PP_SSSMAIN.CursorDirection = wk_CursorDirection
					Case Cn_Direction3
	...
	Sub AE_CursorSub_SSSMAIN(ByVal pm_CurSor As Short) 'Generated.
		...
		If pm_CurSor = Cn_CuInCompletePx Then
			...
			If wk_Tx >= 0 Then
				Call AE_CursorMove_SSSMAIN(wk_Tx)
			ElseIf PP_SSSMAIN.InCompletePx < 107 Then 
	...
	Function AE_CursorUp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx >= 0
			If wk_Tx < 2 Or wk_Tx > 77 Then
				wk_Tx = wk_Tx - 1
			ElseIf wk_Tx = 77 Then 
				wk_Tx = PP_SSSMAIN.NrBodyTx - 5
				wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 5
				If wk_LastTx < wk_Tx Then wk_Tx = wk_LastTx
				Do While wk_Tx >= 2
	...
	Sub AE_DeRestore_SSSMAIN(ByVal pm_De As Short) 'Generated.
		...
		bolRet = RATMT51_MF_SaveRestore_UWRTDTTM(pm_De, 1) ' 復元
		'20081002 CHG END   RISE)Tanimura
		Do While wk_ww < 7
			If wk_ww + 1 = 7 Then PP_SSSMAIN.SuppressMultiTlDerived = False
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			If CP_SSSMAIN(108 + wk_ww).StatusC <> Cn_Status8 Or IsDbNull(CP_SSSMAIN(108 + wk_ww).CuVal) Then
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).TpStr = CP_SSSMAIN(108 + wk_ww).TpStr
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).CuVal = CP_SSSMAIN(108 + wk_ww).CuVal
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).ExVal = CP_SSSMAIN(108 + wk_ww).ExVal
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).FractionC = CP_SSSMAIN(108 + wk_ww).FractionC
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).StatusC = CP_SSSMAIN(108 + wk_ww).StatusC
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).StatusF = CP_SSSMAIN(108 + wk_ww).StatusF
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).ExStatus = CP_SSSMAIN(108 + wk_ww).ExStatus
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).InOutMode = CP_SSSMAIN(108 + wk_ww).InOutMode
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).CheckRtnCode = CP_SSSMAIN(108 + wk_ww).CheckRtnCode
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).Modified = CP_SSSMAIN(108 + wk_ww).Modified
                ...
                '20190806 CHG START
                'If wk_Tx >= 0 Then AE_Controls(PP_SSSMAIN.CtB + wk_Tx) = AE_Tpstr(CP_SSSMAIN(108 + wk_ww).TpStr, CP_SSSMAIN(108 + wk_ww).TypeA)
                If wk_Tx >= 0 Then AE_Controls(PP_SSSMAIN.CtB + wk_Tx).Text = AE_Tpstr(CP_SSSMAIN(108 + wk_ww).TpStr, CP_SSSMAIN(108 + wk_ww).TypeA)
                '20190806 CHG END
                If CP_SSSMAIN(wk_PxBaseTarget + wk_ww).StatusC <= Cn_Status5 And CP_SSSMAIN(108 + wk_ww).StatusC <= Cn_Status5 Then
			...
			Else
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).InOutMode = CP_SSSMAIN(108 + wk_ww).InOutMode
				Call AE_InitValBdDe_SSSMAIN(wk_PxBaseTarget + wk_ww, False, CP_SSSMAIN(108 + wk_ww).StatusF) ', PP_SSSMAIN.De
			End If
			wk_ww = wk_ww + 1
		Loop 
		PP_SSSMAIN.SuppressMultiTlDerived = False
	...
	Sub AE_Derived_SSSMAIN_bd_TEKIDT(ByVal De_Index As Short) 'Generated.
		...
		If PP_SSSMAIN.DerivedOrigin <> "" Then
			...
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CC_NewVal = TEKIDT_DerivedC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 7 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 7 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
	...
	Sub AE_DeSave_SSSMAIN(ByVal pm_De As Short) 'Generated.
		...
		bolRet = RATMT51_MF_SaveRestore_UWRTDTTM(pm_De, 0) ' 退避
		'20081002 CHG END   RISE)Tanimura
		Do While wk_ww < 7
			CP_SSSMAIN(108 + wk_ww).TpStr = CP_SSSMAIN(wk_PxBaseSource + wk_ww).TpStr
			CP_SSSMAIN(108 + wk_ww).CheckRtnCode = CP_SSSMAIN(wk_PxBaseSource + wk_ww).CheckRtnCode
			CP_SSSMAIN(108 + wk_ww).Modified = CP_SSSMAIN(wk_PxBaseSource + wk_ww).Modified
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CP_SSSMAIN(108 + wk_ww).CuVal = CP_SSSMAIN(wk_PxBaseSource + wk_ww).CuVal
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CP_SSSMAIN(108 + wk_ww).ExVal = CP_SSSMAIN(wk_PxBaseSource + wk_ww).ExVal
			CP_SSSMAIN(108 + wk_ww).FractionC = CP_SSSMAIN(wk_PxBaseSource + wk_ww).FractionC
			CP_SSSMAIN(108 + wk_ww).StatusC = CP_SSSMAIN(wk_PxBaseSource + wk_ww).StatusC
			CP_SSSMAIN(108 + wk_ww).StatusF = CP_SSSMAIN(wk_PxBaseSource + wk_ww).StatusF
			CP_SSSMAIN(108 + wk_ww).ExStatus = CP_SSSMAIN(wk_PxBaseSource + wk_ww).ExStatus
			CP_SSSMAIN(108 + wk_ww).InOutMode = CP_SSSMAIN(wk_PxBaseSource + wk_ww).InOutMode
			CP_SSSMAIN(108 + wk_ww).TypeA = CP_SSSMAIN(wk_PxBaseSource + wk_ww).TypeA
			wk_ww = wk_ww + 1
		Loop 
	End Sub
	...
	Sub AE_DeSub_SSSMAIN(ByVal pm_UD As Short) 'Generated.
		...
		'2007/12/26 add-end T.KAWAMUKAI
		wk_SaveDe = PP_SSSMAIN.De : wk_SaveDe2 = PP_SSSMAIN.De2
		wk_PxBaseTarget = 2 + 7 * PP_SSSMAIN.De
		wk_PxBaseSource = wk_PxBaseTarget + pm_UD * 7
		wk_ww = 0
		'20081002 ADD START RISE)Tanimura '排他処理
		''2007/12/26 add-str T.KAWAMUKAI
		...
		bolRet = RATMT51_MF_UpDown_UWRTDTTM(PP_SSSMAIN.De, pm_UD) ' 明細　削除・挿入
		'20081002 ADD END   RISE)Tanimura
		Do While wk_ww < 7
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
...
#End If
	...
	Sub AE_InitValBdDe_SSSMAIN(ByVal pm_Px As Short, ByVal pm_SetInOut As Short, ByVal pm_Status As Short) 'Generated.
		...
		If pm_Px = -2 Then
			...
			If wk_Tx >= 0 Then
				Call AE_TabStop_SSSMAIN(wk_Tx, wk_Tx + 4, pm_SetInOut)
			End If
		ElseIf pm_Px >= 0 Then 
		...
		End If
		If pm_Px = -2 Or pm_Px = 3 + wk_PxBase Then 'TUKKB
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(3 + wk_PxBase), System.DBNull.Value, pm_Status)
			Call AE_InitValBdDe_SSSMAIN_TUKKB(pm_Px, wk_PxBase)
		End If
		If pm_Px = -2 Or pm_Px = 4 + wk_PxBase Then 'TUKNM
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(4 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 5 + wk_PxBase Then 'TEKIDT
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(5 + wk_PxBase), TEKIDT_InitVal(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 7 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 7 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2), pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 6 + wk_PxBase Then 'RATERT
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(6 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 7 + wk_PxBase Then 'V_DATKB
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			Call AE_InitVal_SSSMAIN(CP_SSSMAIN(7 + wk_PxBase), System.DBNull.Value, pm_Status)
		End If
		If pm_Px = -2 Or pm_Px = 8 + wk_PxBase Then 'V_RATERT
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
	...
	Sub AE_InitValBdDe_SSSMAIN_TUKKB(ByVal pm_Px As Short, ByVal wk_PxBase As Short) 'Generated.
		Dim CC_NewVal As Object
		'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
		CC_NewVal = CP_SSSMAIN(8 + wk_PxBase).CuVal
		PP_SSSMAIN.DerivedOrigin = "BD_TUKKB"
		If pm_Px >= 0 And Not PP_SSSMAIN.SuppressMultiTlDerived Then Call AE_Derived_SSSMAIN_bd_TEKIDT(PP_SSSMAIN.De2)
	End Sub
	...
	Sub AE_InOutModeM_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String) 'Generated.
		...
		wk_Qx = 0
		Do While wk_Qx < 9 And UCase(Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx)) <> wk_UCaseObjA
			wk_Qx = wk_Qx + 1
		Loop 
	...
	Sub AE_InOutModeN_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String, Optional ByVal pm_De As Object = Nothing) 'Generated.
		...
		wk_UCaseObjA = UCase(pm_ItemName)
		wk_Qx = 0
		Do While wk_Qx < 9 And Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx) <> wk_UCaseObjA
			wk_Qx = wk_Qx + 1
		Loop 
		If UCase(Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx)) <> wk_UCaseObjA Then
		...
		ElseIf wk_Qx < 9 Then 
			...
			If IsNothing(pm_De) Then
				If PP_SSSMAIN.De2 < 0 Or (Not PP_SSSMAIN.RecalcMode And PP_SSSMAIN.Tx >= 77) Then Exit Sub
				wk_Px = wk_Qx + 7 * PP_SSSMAIN.De
			Else
				'UPGRADE_WARNING: オブジェクト pm_De の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				wk_Px = wk_Qx + 7 * pm_De
			End If
...
CheckOrSkip: 
		...
		Select Case pm_NewMode
			Case Cn_Mode1
				If PP_SSSMAIN.Mode <> Cn_Mode1 Then
					...
					Call AE_TabStop_SSSMAIN(0, 76, False)
					AE_CursorRest(PP_SSSMAIN.ScX).TabStop = False
				End If
			Case Cn_Mode2
	...
	Sub AE_RecalcBdDe_SSSMAIN() 'Generated.
		...
		If PP_SSSMAIN.LastDe > 0 Then
			...
			If AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(3 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_TUKKB(AE_Val2(CP_SSSMAIN(3 + wk_PxBase)), CP_SSSMAIN(3 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(4 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(4 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(4 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_TUKNM(AE_Val2(CP_SSSMAIN(4 + wk_PxBase)), CP_SSSMAIN(4 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(5 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(5 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(5 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_TEKIDT(AE_Val2(CP_SSSMAIN(5 + wk_PxBase)), CP_SSSMAIN(5 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(6 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(6 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(6 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_RATERT(AE_Val2(CP_SSSMAIN(6 + wk_PxBase)), CP_SSSMAIN(6 + wk_PxBase).StatusF, False, False)
			End If
		End If
	...
	Sub AE_RecalcBdDeSub_SSSMAIN() 'Generated.
		Call AE_Derived_SSSMAIN_bd_TEKIDT(PP_SSSMAIN.De2)
	End Sub
	...
	Sub AE_Scrl_SSSMAIN(ByVal pm_DeNo As Short, ByVal pm_SetFocusOk As Short) 'Generated.
		...
		Do While Wk_De <= PP_SSSMAIN.MaxDspC
			wk_NewPxBase = 2 + 7 * (Wk_De + PP_SSSMAIN.TopDe) : wk_OutOfDe = False
			If wk_NewPxBase >= PP_SSSMAIN.EBodyPx Then wk_NewPxBase = 2 + 7 * (PP_SSSMAIN.MaxDe) : wk_OutOfDe = True
			wk_ExPxBase = 2 + 7 * (Wk_De + wk_ExTopDe)
			If wk_ExPxBase >= PP_SSSMAIN.EBodyPx Then wk_ExPxBase = 2 + 7 * (PP_SSSMAIN.MaxDe)
			wk_TxBase = 2 + 5 * Wk_De
			wk_ww = 0
			Do While wk_ww < 5
		...
		wk_NewTx = wk_ExTx - 5 * (PP_SSSMAIN.TopDe - wk_ExTopDe)
		If wk_ExTx < 0 Then
		ElseIf wk_NewTx < 2 Then 
			wk_NewTx = 2 + (wk_ExTx - 2) Mod 5
		ElseIf wk_NewTx >= PP_SSSMAIN.NrBodyTx Then 
			wk_NewTx = 2 + 5 * PP_SSSMAIN.MaxDspC + (wk_ExTx - 2) Mod 5
		End If
		Call AE_ScrlMax(PP_SSSMAIN)
		If wk_Displacement > 0 Then
			...
			ElseIf wk_ExTx >= 0 Then 
				...
				Do While wk_NewTx2 < PP_SSSMAIN.NrBodyTx
					If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_NewTx2)).TypeA, wk_NewTx2) Then
						...
						Exit Sub
					End If
					wk_NewTx2 = wk_NewTx2 + 5
				Loop 
				PP_SSSMAIN.CursorDirection = Cn_Direction1
				Do While wk_NewTx < 77
			...
			wk_NewTx = 2
			PP_SSSMAIN.CursorDirection = Cn_Direction1
			Do While wk_NewTx < 77 And PP_SSSMAIN.TopDe >= 0 And PP_SSSMAIN.TopDe < PP_SSSMAIN.MaxDe
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_NewTx)).TypeA, wk_NewTx) Then
					If pm_SetFocusOk Then Call AE_CursorMove_SSSMAIN(wk_NewTx)
					Exit Sub
				End If
		...
		ElseIf PP_SSSMAIN.Tx < 77 Then 
			...
			Select Case PP_SSSMAIN.Px
				...
				Case 3 + wk_PxBase
					...
					End If
				Case 4 + wk_PxBase
					Call AE_Check_SSSMAIN_TUKNM(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 5 + wk_PxBase
					Call AE_Check_SSSMAIN_TEKIDT(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 6 + wk_PxBase
					Call AE_Check_SSSMAIN_RATERT(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
			End Select
		End If
	...
	Sub AE_Slist_SSSMAIN() 'Generated.
		...
		ElseIf ((PP_SSSMAIN.Tx - 2) Mod 5 = 1) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 77 Then 
			If ((PP_SSSMAIN.Tx - 2) \ 5) <> (PP_SSSMAIN.De - PP_SSSMAIN.TopDe) Then
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    '20190807 CHG END
                    '20190806 CHG START
                    'Call AE_Check_SSSMAIN_TUKKB(AE_Val3(CP_SSSMAIN(3 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 3 + wk_TxBase).ToString()), Cn_Status6, True, True)
                    Call AE_Check_SSSMAIN_TUKKB(AE_Val3(CP_SSSMAIN(3 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 3 + wk_TxBase).Text), Cn_Status6, True, True)
                    '20190806 CHG END
                End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
		...
		ElseIf ((PP_SSSMAIN.Tx - 2) Mod 5 = 3) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 77 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    '20190807 CHG END
                    '20190806 CHG START
                    'Call AE_Check_SSSMAIN_TEKIDT(AE_Val3(CP_SSSMAIN(5 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 5 + wk_TxBase).ToString()), Cn_Status6, True, True)
                    Call AE_Check_SSSMAIN_TEKIDT(AE_Val3(CP_SSSMAIN(5 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 5 + wk_TxBase).Text), Cn_Status6, True, True)
                    '20190806 CHG END
                End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
	...
	Sub AE_TabStop_SSSMAIN(ByVal pm_FromTx As Short, ByVal pm_ToTx As Short, ByVal pm_SetInOut As Boolean) 'Generated.
		...
		Do While wk_Tx <= pm_ToTx
			If wk_Tx >= PP_SSSMAIN.NrBodyTx And wk_Tx < 77 Then
			Else
				wk_Px = AE_Px(PP_SSSMAIN, wk_Tx)
				wk_InOutMode = (CP_SSSMAIN(wk_Px).InOutMode \ 256) And &HFFs
	...
	Sub DP_SSSMAIN_RATERT(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_TEKIDT(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_TUKNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_V_RATERT(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Function RD_SSSMAIN_RATERT(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 7 * De
		'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
		If IsNothing(CP_SSSMAIN(6 + wk_PxBase).CuVal) Then
			...
			RD_SSSMAIN_RATERT = 0@
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		ElseIf IsDbNull(CP_SSSMAIN(6 + wk_PxBase).CuVal) Then 
			'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_RATERT の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_RATERT = 0@
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_RATERT の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_RATERT = CP_SSSMAIN(6 + wk_PxBase).CuVal
		End If
	End Function
	
	Function RD_SSSMAIN_TEKIDT(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 7 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(5 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_TEKIDT = Space(8)
		ElseIf Not IsDate(CP_SSSMAIN(5 + wk_PxBase).CuVal) Then 
			RD_SSSMAIN_TEKIDT = Space(8)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_TEKIDT = VB6.Format(CP_SSSMAIN(5 + wk_PxBase).CuVal, "YYYYMMDD")
		End If
	End Function
	...
	Function RD_SSSMAIN_TUKKB(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 3 Then
				...
				RD_SSSMAIN_TUKKB = CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal) & Space(3 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_TUKKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_TUKKB = CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_TUKNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 7 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(4 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_TUKNM = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_TUKNM = CStr(CP_SSSMAIN(4 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_TUKNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_TUKNM = CStr(CP_SSSMAIN(4 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_V_DATKB(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_V_DATKB = CStr(CP_SSSMAIN(7 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_DATKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_DATKB = CStr(CP_SSSMAIN(7 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_RATERT(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 7 * De
		'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
		If IsNothing(CP_SSSMAIN(8 + wk_PxBase).CuVal) Then
			...
			RD_SSSMAIN_V_RATERT = 0@
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		ElseIf IsDbNull(CP_SSSMAIN(8 + wk_PxBase).CuVal) Then 
			'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_RATERT の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_V_RATERT = 0@
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_RATERT の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			RD_SSSMAIN_V_RATERT = CP_SSSMAIN(8 + wk_PxBase).CuVal
		End If
	End Function

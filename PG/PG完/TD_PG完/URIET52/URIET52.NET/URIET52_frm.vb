...
EventExitSub:
    ...
    'UPGRADE_WARNING: イベント BD_TNKKB.TextChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
...
EventExitSub:
    ...
    Private Sub BD_URIKN_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles BD_URIKN.Enter
        ...
        End If
        PP_SSSMAIN.De2 = PP_SSSMAIN.De
        'UPGRADE_WARNING: オブジェクト URIKN_Skip(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(60 + 88 * PP_SSSMAIN.De).CuVal), AE_NullCnv1_SSSMAIN(CP_SSSMAIN(66 + 88 * PP_SSSMAIN.De).CuVal), AE_NullCnv1_SSSMAIN(CP_SSSMAIN(64 + 88 * PP_SSSMAIN.De).CuVal)) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
...
EventExitSub:
    ...
    Private Sub CM_DeleteDe_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CM_DeleteDe.Click 'Generated.
        ...
        'UPGRADE_WARNING: オブジェクト DeleteDe_GetEvent(PP_SSSMAIN.De2, AE_NullCnv1_SSSMAIN(CP_SSSMAIN(126 + 88 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(75 + 88 * PP_SSSMAIN.De).CuVal)) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    Private Sub FR_SSSMAIN_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        '2019/06/07 ADD START
        FORM_LOAD_FLG = True
        '2019/06/07 ADD E N D
...
EventExitSub:
    ...
    Private Sub HD_DATNO_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_DATNO.Enter 'Generated.
        ...
        If wk_Int >= 0 Then Call AE_CursorSub_SSSMAIN(wk_Int) : Exit Sub
        'UPGRADE_WARNING: オブジェクト DATNO_Skip(AE_Controls(PP_SSSMAIN.CtB + 1)) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
...
EventExitSub:
    ...
    'UPGRADE_WARNING: イベント HD_EMGODNKB.CheckStateChanged は、フォームが初期化されたときに発生します。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"' をクリックしてください。
...
EventExitSub:
    ...
    Private Sub HD_TOKCD_TextChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_TOKCD.TextChanged 'Generated.
        ...
        If PP_SSSMAIN.MaskMode = False Then
            ...
            If AE_Change(PP_SSSMAIN, CP_SSSMAIN(7), HD_TOKCD, FORM_LOAD_FLG) Then
                '2019/06/06 CHG END'
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                PP_SSSMAIN.CursorDest = Cn_Dest9
...
EventExitSub:
    ...
    Private Sub HD_UDNDT_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles HD_UDNDT.Enter 'Generated.
        ...
        If wk_Int >= 0 Then Call AE_CursorSub_SSSMAIN(wk_Int) : Exit Sub
        'UPGRADE_WARNING: オブジェクト UDNDT_Skip(AE_Controls(PP_SSSMAIN.CtB + 6)) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
...
EventExitSub:
    ...
    '    ' === 20130522 === INSERT S - FWEST)Koroyasu 排他制御の解除
    ...
    '    'UPGRADE_WARNING: オブジェクト ClearDe_GetEvent(PP_SSSMAIN.De2, AE_NullCnv1_SSSMAIN(CP_SSSMAIN(126 + 88 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(75 + 88 * PP_SSSMAIN.De).CuVal)) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
...
EventExitSub:
    ...
    'Private Sub btnF5_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles btnF5.Click
    '    Dim Button As Short = eventArgs.Button \ &H100000
    '    Dim Shift As Short = System.Windows.Forms.Control.ModifierKeys \ &H10000
    '    Dim X As Single = VB6.PixelsToTwipsX(eventArgs.X)
    '    Dim Y As Single = VB6.PixelsToTwipsY(eventArgs.Y) 'Generated.
    ...
    Private Sub CS_NXTKB_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CS_NXTKB.Click
        ...
        PP_SSSMAIN.CursorDirection = 0
    End Sub
    Private Sub CS_URISU_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CS_URISU.Click 'Generated.
        Dim wk_Slisted As Object
        Dim wk_SaveTx As Short
        Dim wk_TxBase As Short
        Dim wk_PxBase As Short
    ...
    Private Sub CS_UDNDT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CS_UDNDT.Click 'Generated.
        Dim wk_Slisted As Object
        Dim wk_SaveTx As Short
        PP_SSSMAIN.ButtonClick = True
        If Not PP_SSSMAIN.Operable Then Exit Sub

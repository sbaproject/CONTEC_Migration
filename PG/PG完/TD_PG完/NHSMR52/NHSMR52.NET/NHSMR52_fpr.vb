...
CheckOrSkip: 
		...
		ElseIf PP_SSSMAIN.Tx = 17 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    AE_Controls(PP_SSSMAIN.CtB + 17).Text = wk_Slisted
		...
		ElseIf PP_SSSMAIN.Tx = 19 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    AE_Controls(PP_SSSMAIN.CtB + 19).Text = wk_Slisted
		...
		ElseIf PP_SSSMAIN.Tx = 21 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    AE_Controls(PP_SSSMAIN.CtB + 21).Text = wk_Slisted
		...
		ElseIf PP_SSSMAIN.Tx = 26 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    AE_Controls(PP_SSSMAIN.CtB + 26).Text = wk_Slisted
		...
		ElseIf PP_SSSMAIN.Tx = 28 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    AE_Controls(PP_SSSMAIN.CtB + 28).Text = wk_Slisted
		...
		ElseIf PP_SSSMAIN.Tx = 30 Then 
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    AE_Controls(PP_SSSMAIN.CtB + 30).Text = wk_Slisted
    ...
    Sub DP_SSSMAIN_BINCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(21).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(21).CuVal <> V Or CP_SSSMAIN(21).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_BINRN(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(22).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(22).CuVal <> V Or CP_SSSMAIN(22).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_CHIIKI(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(19).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(19).CuVal <> V Or CP_SSSMAIN(19).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_CHIIKIRN(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(20).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(20).CuVal <> V Or CP_SSSMAIN(20).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_GYOSHU(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(17).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(17).CuVal <> V Or CP_SSSMAIN(17).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_GYOSHURN(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(18).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(18).CuVal <> V Or CP_SSSMAIN(18).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NGRPCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(23).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(23).CuVal <> V Or CP_SSSMAIN(23).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSADA(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(9).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(9).CuVal <> V Or CP_SSSMAIN(9).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSADB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(10).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(10).CuVal <> V Or CP_SSSMAIN(10).StatusC <> Cn_Status8 Then
            '20190821 CHG START
	...
	Sub DP_SSSMAIN_NHSADC(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(11).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(11).CuVal <> V Or CP_SSSMAIN(11).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSBOSNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(15).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(15).CuVal <> V Or CP_SSSMAIN(15).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSCLAID(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(26).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(26).CuVal <> V Or CP_SSSMAIN(26).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSCLANM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(27).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(27).CuVal <> V Or CP_SSSMAIN(27).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSCLBID(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(28).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(28).CuVal <> V Or CP_SSSMAIN(28).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSCLBNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(29).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(29).CuVal <> V Or CP_SSSMAIN(29).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSCLCID(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(30).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(30).CuVal <> V Or CP_SSSMAIN(30).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSCLCNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(31).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(31).CuVal <> V Or CP_SSSMAIN(31).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSCTANM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(14).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(14).CuVal <> V Or CP_SSSMAIN(14).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSFX(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(13).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(13).CuVal <> V Or CP_SSSMAIN(13).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSMLAD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(16).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(16).CuVal <> V Or CP_SSSMAIN(16).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSNK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(5).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(5).CuVal <> V Or CP_SSSMAIN(5).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSNMB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(4).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(4).CuVal <> V Or CP_SSSMAIN(4).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSNMMKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(32).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(32).CuVal <> V Or CP_SSSMAIN(32).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSRN(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(6).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(6).CuVal <> V Or CP_SSSMAIN(6).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSRNNK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(7).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(7).CuVal <> V Or CP_SSSMAIN(7).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSTL(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(12).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(12).CuVal <> V Or CP_SSSMAIN(12).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_NHSZP(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(8).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(8).CuVal <> V Or CP_SSSMAIN(8).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_OLDNHSCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(24).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(24).CuVal <> V Or CP_SSSMAIN(24).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_OLNGRPCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(25).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(25).CuVal <> V Or CP_SSSMAIN(25).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_OPEID(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(33).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(33).CuVal <> V Or CP_SSSMAIN(33).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Sub DP_SSSMAIN_OPENM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(34).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(34).CuVal <> V Or CP_SSSMAIN(34).StatusC <> Cn_Status8 Then
            '20190821 CHG END
	...
	Public Function PF_Get_UWRTDTTM(ByRef pot_strWRTDT As String, ByRef pot_strWRTTM As String, ByRef pot_strUWRTDT As String, ByRef pot_strUWRTTM As String, Optional ByRef pin_intIDX As Short = 0) As Short
        ...
        pot_strWRTDT = DB_NHSMTA2.WRTDT '更新日付
        pot_strWRTTM = DB_NHSMTA2.WRTTM '更新時刻
        pot_strUWRTDT = DB_NHSMTA2.UWRTDT 'バッチ更新日付
        pot_strUWRTTM = DB_NHSMTA2.UWRTTM 'バッチ更新時刻
        '20190821 CHG END

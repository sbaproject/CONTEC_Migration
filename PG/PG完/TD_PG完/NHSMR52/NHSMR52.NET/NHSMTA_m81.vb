...
Module NHSMTA_M81
	...
	Function DelMst() As Short
		...
		If DBSTAT = 0 Then
            ...
            If Val(HAITA_NHSMTA.OPEID) <> Val(DB_NHSMTA2.OPEID) Or Val(HAITA_NHSMTA.CLTID) <> Val(DB_NHSMTA2.CLTID) Or Val(HAITA_NHSMTA.WRTDT) <> Val(DB_NHSMTA2.WRTDT) Or Val(HAITA_NHSMTA.WRTTM) <> Val(DB_NHSMTA2.WRTTM) Or Val(HAITA_NHSMTA.UOPEID) <> Val(DB_NHSMTA2.UOPEID) Or Val(HAITA_NHSMTA.UCLTID) <> Val(DB_NHSMTA2.UCLTID) Or Val(HAITA_NHSMTA.UWRTDT) <> Val(DB_NHSMTA2.UWRTDT) Or Val(HAITA_NHSMTA.UWRTTM) <> Val(DB_NHSMTA2.UWRTTM) Then
                '20190821 CHG END
            ...
            DB_NHSMTA2.DATKB = "9"
            DB_NHSMTA2.RELFL = "1"
            DB_NHSMTA2.WRTTM = wkWRTTM 'Format(Now, "hhmmss")
            DB_NHSMTA2.WRTDT = wkWRTDT 'Format(Now, "YYYYMMDD")
            DB_NHSMTA2.UOPEID = SSS_OPEID.Value
            DB_NHSMTA2.UCLTID = SSS_CLTID.Value
            DB_NHSMTA2.UWRTTM = wkWRTTM 'Format(Now, "hhmmss")
            DB_NHSMTA2.UWRTDT = wkWRTDT 'Format(Now, "YYYYMMDD")
            DB_NHSMTA2.PGID = SSS_PrgId
            '20190821 CHG END
	...
	Function UpdMst() As Short
		...
		Else
            ...
            DB_NHSMTA2.NHSMSTKB = SSS_MSTKB.Value
            DB_NHSMTA2.DATKB = "1"
            DB_NHSMTA2.RELFL = "1"
            DB_NHSMTA2.FOPEID = SSS_OPEID.Value
            DB_NHSMTA2.FCLTID = SSS_CLTID.Value
            DB_NHSMTA2.WRTFSTTM = wkWRTTM ' Format(Now, "hhmmss")
            DB_NHSMTA2.WRTFSTDT = wkWRTDT ' Format(Now, "YYYYMMDD")
            DB_NHSMTA2.WRTTM = wkWRTTM 'Format(Now, "hhmmss")
            DB_NHSMTA2.WRTDT = wkWRTDT 'Format(Now, "YYYYMMDD")
            DB_NHSMTA2.UOPEID = SSS_OPEID.Value
            DB_NHSMTA2.UCLTID = SSS_CLTID.Value

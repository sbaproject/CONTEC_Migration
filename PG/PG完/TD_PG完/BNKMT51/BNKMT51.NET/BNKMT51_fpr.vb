...
Module SSSMAIN0001
	...
	Public CP_SSSMAIN(167 + 11 + 0 + 1) As clsCP
	Public CL_SSSMAIN(167) As Short
    Public CQ_SSSMAIN(13) As String
    '20190725 ADD START
	...
	Sub AE_Check_SSSMAIN_BNKCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = BNKCD_CheckC(CC_NewVal, PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト BNKCD_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = BNKCD_CheckC(CC_NewVal, PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_BNKNK(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_BNKNM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = BNKNM_CheckC(CC_NewVal, PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト BNKNM_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = BNKNM_CheckC(CC_NewVal, PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_STNNK(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_STNNM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = STNNM_CheckC(CC_NewVal, PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト STNNM_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = STNNM_CheckC(CC_NewVal, PP_SSSMAIN.De2)
	...
	Function AE_CompleteCheck_SSSMAIN(ByVal pm_HeadCheck As Boolean) As Short 'Generated.
		...
		Do While Wk_De < PP_SSSMAIN.LastDe And PP_SSSMAIN.InCompletePx = -1
			wk_Px = 2 + 11 * Wk_De
			Call AE_CompleteCheckSub_SSSMAIN(wk_Px, wk_Px + 11, wk_IncompletionC, wk_IncompletionC2)
			Wk_De = Wk_De + 1
		Loop 
	...
	Sub AE_CursorCurrent_SSSMAIN() 'Generated.
		...
		If PP_SSSMAIN.Tx >= 0 And PP_SSSMAIN.Tx < 92 Then
	...
	Function AE_CursorDown_SSSMAIN(ByVal pm_Tx As Short, Optional ByVal pm_Int As Object = Nothing) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx < 92
			If wk_Tx < 1 Or wk_Tx >= 92 Then
				wk_Tx = wk_Tx + 1
			ElseIf wk_Tx = 1 Then 
				If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 1) >= 0 Then
					Do 
						wk_Tx = wk_Tx + 1
						If ((wk_Tx - 2) \ 6) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then Exit Do
			...
			ElseIf wk_Tx + 6 < PP_SSSMAIN.NrBodyTx Then 
				wk_Tx = wk_Tx + 6
				If ((wk_Tx - 2) \ 6) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 92
				'     以降は (wk_Tx + 6 >= PP_SSSMAIN.NrBodyTx) の場合
			ElseIf PP_SSSMAIN.TopDe < 14 - PP_SSSMAIN.MaxDspC Then 
				If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 11) >= 0 Then
					wk_Tx = wk_Tx + 6
					If ((wk_Tx - 2) \ 6) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then
						wk_Tx = 92
					Else
						wk_ExTopDe = PP_SSSMAIN.TopDe
						Call AE_Scrl_SSSMAIN(PP_SSSMAIN.TopDe + 1, False)
	...
	Sub AE_CursorMove_SSSMAIN(ByVal pm_Tx As Short) 'Generated.
		...
		If wk_Tx < 0 Or wk_Tx >= 92 Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest) : Exit Sub
	...
	Function AE_CursorNext_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx < 92
			...
			If wk_Tx = PP_SSSMAIN.NrBodyTx Then
				...
				End If
			End If
			If wk_Tx >= 2 And wk_Tx < 92 Then 'AE_BodyN > 0
				If ((wk_Tx - 2) \ 6) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 92
			End If
			If wk_Tx < 92 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
	...
	Function AE_CursorNextDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx < 91
			wk_Tx = wk_Tx + 1
			If wk_Tx = PP_SSSMAIN.NrBodyTx Then wk_Tx = 92
			If wk_Tx < 92 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
					Call AE_CursorMove_SSSMAIN(wk_Tx)
	...
	Function AE_CursorPrev_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx >= 0
			If wk_Tx = 92 Then
				...
				wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 6
				...
				If wk_Tx >= 2 Then
					Do 
						...
						End If
						wk_Tx = wk_Tx + 1
						If (wk_Tx - 2) Mod 6 = 0 Then wk_Tx = wk_Tx - 6 - 6
						If wk_Tx < 2 Then
	...
	Function AE_CursorPrevDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx >= 0
			If wk_Tx = 92 Then wk_Tx = PP_SSSMAIN.NrBodyTx
			wk_Tx = wk_Tx - 1
			If wk_Tx >= 0 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
					Call AE_CursorMove_SSSMAIN(wk_Tx)
	...
	Function AE_CursorSkip_SSSMAIN() As Boolean 'Generated.
		...
		Select Case PP_SSSMAIN.CursorDest
			...
			Case Cn_Dest3
				If Not AE_CursorPrev_SSSMAIN(92) Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest)
			Case Cn_Dest4
			...
			Case Else
				Select Case PP_SSSMAIN.CursorDirection
					...
					Case Cn_Direction2
						...
						If PP_SSSMAIN.CursorDest = Cn_Dest1 And wk_Bool = False Then wk_Bool = AE_CursorPrev_SSSMAIN(92)
						PP_SSSMAIN.CursorDirection = wk_CursorDirection
					Case Cn_Direction3
	...
	Sub AE_CursorSub_SSSMAIN(ByVal pm_CurSor As Short) 'Generated.
		...
		If pm_CurSor = Cn_CuInCompletePx Then
			...
			If wk_Tx >= 0 Then
				Call AE_CursorMove_SSSMAIN(wk_Tx)
			ElseIf PP_SSSMAIN.InCompletePx < 167 Then 
	...
	Function AE_CursorUp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx >= 0
			If wk_Tx < 2 Or wk_Tx > 92 Then
				wk_Tx = wk_Tx - 1
			ElseIf wk_Tx = 92 Then 
				wk_Tx = PP_SSSMAIN.NrBodyTx - 6
				wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 6
				If wk_LastTx < wk_Tx Then wk_Tx = wk_LastTx
				Do While wk_Tx >= 2
	...
	Sub AE_DeRestore_SSSMAIN(ByVal pm_De As Short) 'Generated.
		...
		''2007/12/26 add-end T.KAWAMUKAI
		bolRet = BNKMT51_MF_SaveRestore_UWRTDTTM(pm_De, 1) '復元
		' === 20080930 === UPDATE E - RISE)Izumi
		Do While wk_ww < 11
			If wk_ww + 1 = 11 Then PP_SSSMAIN.SuppressMultiTlDerived = False
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			If CP_SSSMAIN(168 + wk_ww).StatusC <> Cn_Status8 Or IsDbNull(CP_SSSMAIN(168 + wk_ww).CuVal) Then
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).TpStr = CP_SSSMAIN(168 + wk_ww).TpStr
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).CuVal = CP_SSSMAIN(168 + wk_ww).CuVal
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).ExVal = CP_SSSMAIN(168 + wk_ww).ExVal
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).FractionC = CP_SSSMAIN(168 + wk_ww).FractionC
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).StatusC = CP_SSSMAIN(168 + wk_ww).StatusC
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).StatusF = CP_SSSMAIN(168 + wk_ww).StatusF
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).ExStatus = CP_SSSMAIN(168 + wk_ww).ExStatus
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).InOutMode = CP_SSSMAIN(168 + wk_ww).InOutMode
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).CheckRtnCode = CP_SSSMAIN(168 + wk_ww).CheckRtnCode
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).Modified = CP_SSSMAIN(168 + wk_ww).Modified
                ...
                '20190724 CHG START
                'If wk_Tx >= 0 Then AE_Controls(PP_SSSMAIN.CtB + wk_Tx) = AE_Tpstr(CP_SSSMAIN(168 + wk_ww).TpStr, CP_SSSMAIN(168 + wk_ww).TypeA)
                If wk_Tx > 0 Then
                    AE_Controls(PP_SSSMAIN.CtB + wk_Tx).Text = AE_Tpstr(CP_SSSMAIN(168 + wk_ww).TpStr, CP_SSSMAIN(168 + wk_ww).TypeA)
                End If
                '20190724 CHG END
                If CP_SSSMAIN(wk_PxBaseTarget + wk_ww).StatusC <= Cn_Status5 And CP_SSSMAIN(168 + wk_ww).StatusC <= Cn_Status5 Then
			...
			Else
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).InOutMode = CP_SSSMAIN(168 + wk_ww).InOutMode
				Call AE_InitValBdDe_SSSMAIN(wk_PxBaseTarget + wk_ww, False, CP_SSSMAIN(168 + wk_ww).StatusF) ', PP_SSSMAIN.De
			End If
			wk_ww = wk_ww + 1
		Loop 
		PP_SSSMAIN.SuppressMultiTlDerived = False
	...
	Sub AE_DeSave_SSSMAIN(ByVal pm_De As Short) 'Generated.
		...
		Dim bolRet As Boolean
		'2007/12/26 add-end T.KAWAMUKAI
		wk_PxBaseSource = 2 + 11 * pm_De
		wk_ww = 0
		' === 20080930 === UPDATE S - RISE)Izumi チェック項目追加
		''2007/12/26 add-str T.KAWAMUKAI
		'      bolRet = MF_SaveRestore_UWRTDTTM(pm_De, 1)      '退避
		''2007/12/26 add-end T.KAWAMUKAI
		bolRet = BNKMT51_MF_SaveRestore_UWRTDTTM(pm_De, 0) '退避
		' === 20080930 === UPDATE E - RISE)Izumi
		Do While wk_ww < 11
			CP_SSSMAIN(168 + wk_ww).TpStr = CP_SSSMAIN(wk_PxBaseSource + wk_ww).TpStr
			CP_SSSMAIN(168 + wk_ww).CheckRtnCode = CP_SSSMAIN(wk_PxBaseSource + wk_ww).CheckRtnCode
			CP_SSSMAIN(168 + wk_ww).Modified = CP_SSSMAIN(wk_PxBaseSource + wk_ww).Modified
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CP_SSSMAIN(168 + wk_ww).CuVal = CP_SSSMAIN(wk_PxBaseSource + wk_ww).CuVal
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CP_SSSMAIN(168 + wk_ww).ExVal = CP_SSSMAIN(wk_PxBaseSource + wk_ww).ExVal
			CP_SSSMAIN(168 + wk_ww).FractionC = CP_SSSMAIN(wk_PxBaseSource + wk_ww).FractionC
			CP_SSSMAIN(168 + wk_ww).StatusC = CP_SSSMAIN(wk_PxBaseSource + wk_ww).StatusC
			CP_SSSMAIN(168 + wk_ww).StatusF = CP_SSSMAIN(wk_PxBaseSource + wk_ww).StatusF
			CP_SSSMAIN(168 + wk_ww).ExStatus = CP_SSSMAIN(wk_PxBaseSource + wk_ww).ExStatus
			CP_SSSMAIN(168 + wk_ww).InOutMode = CP_SSSMAIN(wk_PxBaseSource + wk_ww).InOutMode
			CP_SSSMAIN(168 + wk_ww).TypeA = CP_SSSMAIN(wk_PxBaseSource + wk_ww).TypeA
			wk_ww = wk_ww + 1
		Loop 
	End Sub
	...
	Sub AE_DeSub_SSSMAIN(ByVal pm_UD As Short) 'Generated.
		...
		'2007/12/26 add-end T.KAWAMUKAI
		wk_SaveDe = PP_SSSMAIN.De : wk_SaveDe2 = PP_SSSMAIN.De2
		wk_PxBaseTarget = 2 + 11 * PP_SSSMAIN.De
		wk_PxBaseSource = wk_PxBaseTarget + pm_UD * 11
		wk_ww = 0
		' === 20080930 === UPDATE S - RISE)Izumi チェック項目の追加
		''2007/12/26 add-str T.KAWAMUKAI
		'       bolRet = MF_UpDown_UWRTDTTM(PP_SSSMAIN.De, pm_UD)      '明細　削除・挿入
		''2007/12/26 add-end T.KAWAMUKAI
		bolRet = BNKMT51_MF_UpDown_UWRTDTTM(PP_SSSMAIN.De, pm_UD) '明細　削除・挿入
		' === 20080930 === UPDATE E - RISE)Izumi
		Do While wk_ww < 11
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
...
#End If
	...
	Sub AE_InOutModeM_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String) 'Generated.
		...
		wk_Qx = 0
		Do While wk_Qx < 13 And UCase(Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx)) <> wk_UCaseObjA
			wk_Qx = wk_Qx + 1
		Loop 
	...
	Sub AE_InOutModeN_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String, Optional ByVal pm_De As Object = Nothing) 'Generated.
		...
		wk_UCaseObjA = UCase(pm_ItemName)
		wk_Qx = 0
		Do While wk_Qx < 13 And Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx) <> wk_UCaseObjA
			wk_Qx = wk_Qx + 1
		Loop 
		If UCase(Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx)) <> wk_UCaseObjA Then
		...
		ElseIf wk_Qx < 13 Then 
			...
			If IsNothing(pm_De) Then
				If PP_SSSMAIN.De2 < 0 Or (Not PP_SSSMAIN.RecalcMode And PP_SSSMAIN.Tx >= 92) Then Exit Sub
				wk_Px = wk_Qx + 11 * PP_SSSMAIN.De
			Else
				'UPGRADE_WARNING: オブジェクト pm_De の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				wk_Px = wk_Qx + 11 * pm_De
			End If
		End If
...
CheckOrSkip: 
		...
		Select Case pm_NewMode
			Case Cn_Mode1
				If PP_SSSMAIN.Mode <> Cn_Mode1 Then
					...
					Call AE_TabStop_SSSMAIN(0, 91, False)
					AE_CursorRest(PP_SSSMAIN.ScX).TabStop = False
				End If
			Case Cn_Mode2
	...
	Sub AE_RecalcBdDe_SSSMAIN() 'Generated.
		...
		If PP_SSSMAIN.LastDe > 0 Then
			...
			If AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(3 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_BNKCD(AE_Val2(CP_SSSMAIN(3 + wk_PxBase)), CP_SSSMAIN(3 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(4 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(4 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(4 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_BNKNM(AE_Val2(CP_SSSMAIN(4 + wk_PxBase)), CP_SSSMAIN(4 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(5 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(5 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(5 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_BNKNK(AE_Val2(CP_SSSMAIN(5 + wk_PxBase)), CP_SSSMAIN(5 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(6 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(6 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(6 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_STNNM(AE_Val2(CP_SSSMAIN(6 + wk_PxBase)), CP_SSSMAIN(6 + wk_PxBase).StatusF, False, False)
			End If
			If AE_GetInOutMode(CP_SSSMAIN(7 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(7 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
				If CP_SSSMAIN(7 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_STNNK(AE_Val2(CP_SSSMAIN(7 + wk_PxBase)), CP_SSSMAIN(7 + wk_PxBase).StatusF, False, False)
			End If
		End If
	...
	Sub AE_Scrl_SSSMAIN(ByVal pm_DeNo As Short, ByVal pm_SetFocusOk As Short) 'Generated.
		...
		Do While Wk_De <= PP_SSSMAIN.MaxDspC
			wk_NewPxBase = 2 + 11 * (Wk_De + PP_SSSMAIN.TopDe) : wk_OutOfDe = False
			If wk_NewPxBase >= PP_SSSMAIN.EBodyPx Then wk_NewPxBase = 2 + 11 * (PP_SSSMAIN.MaxDe) : wk_OutOfDe = True
			wk_ExPxBase = 2 + 11 * (Wk_De + wk_ExTopDe)
			If wk_ExPxBase >= PP_SSSMAIN.EBodyPx Then wk_ExPxBase = 2 + 11 * (PP_SSSMAIN.MaxDe)
			wk_TxBase = 2 + 6 * Wk_De
			wk_ww = 0
			Do While wk_ww < 6
		...
		ElseIf wk_NewTx < 2 Then 
			wk_NewTx = 2 + (wk_ExTx - 2) Mod 6
		ElseIf wk_NewTx >= PP_SSSMAIN.NrBodyTx Then 
			wk_NewTx = 2 + 6 * PP_SSSMAIN.MaxDspC + (wk_ExTx - 2) Mod 6
		End If
		Call AE_ScrlMax(PP_SSSMAIN)
		If wk_Displacement > 0 Then
			...
			wk_NewTx = 2
			PP_SSSMAIN.CursorDirection = Cn_Direction1
			Do While wk_NewTx < 92 And PP_SSSMAIN.TopDe >= 0 And PP_SSSMAIN.TopDe < PP_SSSMAIN.MaxDe
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_NewTx)).TypeA, wk_NewTx) Then
					If pm_SetFocusOk Then Call AE_CursorMove_SSSMAIN(wk_NewTx)
					Exit Sub
				End If
		...
		ElseIf PP_SSSMAIN.Tx < 92 Then 
			...
			Select Case PP_SSSMAIN.Px
				Case 2 + wk_PxBase
					...
					End If
				Case 3 + wk_PxBase
					Call AE_Check_SSSMAIN_BNKCD(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 4 + wk_PxBase
					Call AE_Check_SSSMAIN_BNKNM(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 5 + wk_PxBase
					Call AE_Check_SSSMAIN_BNKNK(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 6 + wk_PxBase
					Call AE_Check_SSSMAIN_STNNM(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
				Case 7 + wk_PxBase
					Call AE_Check_SSSMAIN_STNNK(CC_NewVal, pm_Status, False, pm_HandIn)
					If AE_ErrorToInteger(Ck_Error) = 0 Then
					End If
			End Select
		End If
	...
	Sub AE_Slist_SSSMAIN() 'Generated.
		...
		ElseIf ((PP_SSSMAIN.Tx - 2) Mod 6 = 1) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 92 Then 
			If ((PP_SSSMAIN.Tx - 2) \ 6) <> (PP_SSSMAIN.De - PP_SSSMAIN.TopDe) Then
			...
			If Not IsDbNull(wk_Slisted) Then
				...
				If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    'Call AE_Check_SSSMAIN_BNKCD(AE_Val3(CP_SSSMAIN(3 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 3 + wk_TxBase).ToString()), Cn_Status6, True, True)
                    Call AE_Check_SSSMAIN_BNKCD(AE_Val3(CP_SSSMAIN(3 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 3 + wk_TxBase).Text), Cn_Status6, True, True)
                    '20190729 CHG END
                End If
			Else
				PP_SSSMAIN.CursorDest = Cn_Dest0
	...
	Sub AE_TabStop_SSSMAIN(ByVal pm_FromTx As Short, ByVal pm_ToTx As Short, ByVal pm_SetInOut As Boolean) 'Generated.
		...
		Do While wk_Tx <= pm_ToTx
			If wk_Tx >= PP_SSSMAIN.NrBodyTx And wk_Tx < 92 Then
			Else
				wk_Px = AE_Px(PP_SSSMAIN, wk_Tx)
				wk_InOutMode = (CP_SSSMAIN(wk_Px).InOutMode \ 256) And &HFFs
    ...
    Sub DP_SSSMAIN_BNKCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_BNKNK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_BNKNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_STNNK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_STNNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_V_BNKNK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_V_BNKNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_V_STNNK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Sub DP_SSSMAIN_V_STNNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
		Dim V As Object
		Dim wk_SaveMask As Boolean
		Dim wk_PxBase As Short
		wk_SaveMask = PP_SSSMAIN.MaskMode
	...
	Function RD_SSSMAIN_BNKCD(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 11 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(3 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_BNKCD = Space(7)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 7 Then
				...
				RD_SSSMAIN_BNKCD = CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal) & Space(7 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_BNKCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_BNKCD = CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_BNKNK(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 11 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(5 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_BNKNK = Space(30)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 30 Then
				...
				RD_SSSMAIN_BNKNK = CStr(CP_SSSMAIN(5 + wk_PxBase).CuVal) & Space(30 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_BNKNK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_BNKNK = CStr(CP_SSSMAIN(5 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_BNKNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 11 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(4 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_BNKNM = Space(50)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 50 Then
				...
				RD_SSSMAIN_BNKNM = CStr(CP_SSSMAIN(4 + wk_PxBase).CuVal) & Space(50 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_BNKNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_BNKNM = CStr(CP_SSSMAIN(4 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_STNNK(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 11 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(7 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_STNNK = Space(30)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 30 Then
				...
				RD_SSSMAIN_STNNK = CStr(CP_SSSMAIN(7 + wk_PxBase).CuVal) & Space(30 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_STNNK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_STNNK = CStr(CP_SSSMAIN(7 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_STNNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 11 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(6 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_STNNM = Space(50)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 50 Then
				...
				RD_SSSMAIN_STNNM = CStr(CP_SSSMAIN(6 + wk_PxBase).CuVal) & Space(50 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_STNNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_STNNM = CStr(CP_SSSMAIN(6 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_V_BNKNK(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 11 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(11 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_BNKNK = Space(30)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 30 Then
				...
				RD_SSSMAIN_V_BNKNK = CStr(CP_SSSMAIN(11 + wk_PxBase).CuVal) & Space(30 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_BNKNK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_BNKNK = CStr(CP_SSSMAIN(11 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_BNKNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 11 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(9 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_BNKNM = Space(50)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 50 Then
				...
				RD_SSSMAIN_V_BNKNM = CStr(CP_SSSMAIN(9 + wk_PxBase).CuVal) & Space(50 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_BNKNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_BNKNM = CStr(CP_SSSMAIN(9 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_V_STNNK(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 11 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(12 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_STNNK = Space(30)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 30 Then
				...
				RD_SSSMAIN_V_STNNK = CStr(CP_SSSMAIN(12 + wk_PxBase).CuVal) & Space(30 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_STNNK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_STNNK = CStr(CP_SSSMAIN(12 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_STNNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 11 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(10 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_STNNM = Space(50)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 50 Then
				...
				RD_SSSMAIN_V_STNNM = CStr(CP_SSSMAIN(10 + wk_PxBase).CuVal) & Space(50 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_STNNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_STNNM = CStr(CP_SSSMAIN(10 + wk_PxBase).CuVal)
			End If
		End If
	End Function

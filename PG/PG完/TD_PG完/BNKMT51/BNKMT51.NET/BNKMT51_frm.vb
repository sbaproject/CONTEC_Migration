...
EventExitSub: 
    ...
    Private Sub CM_UPDKB_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles CM_UPDKB.Click
        '20190729 CHG END
        PP_SSSMAIN.ButtonClick = True
        If Not PP_SSSMAIN.Operable Then Exit Sub
        PP_SSSMAIN.NeglectLostFocusCheck = True
    ...
    Private Sub CS_BNKCD_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles CS_BNKCD.Click
        Dim wk_Slisted As Object
...
EventExitSub: 
    ...
    Private Sub btnF3_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnF3.Click 'Generated.
        Dim wk_Cursor As Short
        PP_SSSMAIN.ButtonClick = True
        If Not PP_SSSMAIN.Operable Then Exit Sub
        If PP_SSSMAIN.Mode = Cn_Mode3 Then Beep() : Call AE_CursorCurrent_SSSMAIN() : Exit Sub
        If INSERTDE_GETEVENT() Then
            If PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 47 Then
                If (PP_SSSMAIN.Tx - 2) \ 3 + PP_SSSMAIN.TopDe < PP_SSSMAIN.LastDe Then
                    wk_Cursor = AE_InsertDe_SSSMAIN()
                End If
            Else
                Beep()
    ...
    Private Sub btnF4_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnF4.Click 'Generated.
        PP_SSSMAIN.ButtonClick = True
        If Not PP_SSSMAIN.Operable Then Exit Sub
        If PP_SSSMAIN.Mode = Cn_Mode3 Then Beep() : Call AE_CursorCurrent_SSSMAIN() : Exit Sub
        If PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 47 Then
    ...
    '        Do While wk_ww < 6
    '            Tx = 2 + 6 * De + wk_ww
    '            AE_Controls(PP_SSSMAIN.CtB + Tx).Text = Nothing
    '            wk_ww = wk_ww + 1
    '        Loop
    '        De = De + 1
    '        System.Windows.Forms.Application.DoEvents()
    ...
    Private Sub btnF10_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnF10.Click 'Generated.
        Dim wk_Cursor As Short
        PP_SSSMAIN.ButtonClick = True
        If Not PP_SSSMAIN.Operable Then Exit Sub
        If PP_SSSMAIN.Mode = Cn_Mode2 Then

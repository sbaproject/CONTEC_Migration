...
Module SSSMAIN0001
	...
	Public CP_SSSMAIN(182 + 36 + 0 + 1) As clsCP
	Public CL_SSSMAIN(182) As Short
    Public CQ_SSSMAIN(38) As String
    '20190816 ADD START
	...
	Sub AE_Check_SSSMAIN_HIKKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = HIKKB_CheckC(CC_NewVal)
			Else
				'UPGRADE_WARNING: オブジェクト HIKKB_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = HIKKB_CheckC(CC_NewVal)
	...
	Sub AE_Check_SSSMAIN_SALPALKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SALPALKB_CheckC(CC_NewVal)
			Else
				'UPGRADE_WARNING: オブジェクト SALPALKB_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SALPALKB_CheckC(CC_NewVal)
	...
	Sub AE_Check_SSSMAIN_SISNKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SISNKB_CheckC(CC_NewVal)
			Else
				'UPGRADE_WARNING: オブジェクト SISNKB_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SISNKB_CheckC(CC_NewVal)
	...
	Sub AE_Check_SSSMAIN_SOUADA(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_SOUADB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_SOUADC(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_SOUBSCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
            ...
            '20190822 CHG START
            'If .FormatClass = Cn_Code And .FormatChr <> "" And Not IsDBNull(CC_NewVal) Then CC_NewVal = AE_FormatC(CP_SSSMAIN(wk_Px), CC_NewVal)
            If .FormatClass = Cn_Code And .FormatChr <> "" And Not IsDBNull(CC_NewVal) Then CC_NewVal = CStr(CC_NewVal)
            '20190822 CHG END
            If PP_SSSMAIN.De = PP_SSSMAIN.LastDe And AE_GetInOutMode(.InOutMode, PP_SSSMAIN.Mode) = Cn_InOutMode3 And PP_SSSMAIN.ActiveDe < 0 And Not PP_SSSMAIN.CheckErrNglct And Not PP_SSSMAIN.RecalcMode Then
				'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
				If IsDbNull(CC_NewVal) Then
			...
			If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUBSCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2, "")
			Else
				'UPGRADE_WARNING: オブジェクト SOUBSCD_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUBSCD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(5 + 36 * PP_SSSMAIN.De).ExVal))
			End If
			.CheckRtnCode = AE_ErrorToInteger(Ck_Error)
			wk_SaveMask = PP_SSSMAIN.MaskMode
			PP_SSSMAIN.MaskMode = True
	...
	Sub AE_Check_SSSMAIN_SOUBSNM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_SOUCD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUCD_CheckC(PP_SSSMAIN, CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De), CC_NewVal, PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト SOUCD_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUCD_CheckC(PP_SSSMAIN, CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De), CC_NewVal, PP_SSSMAIN.De2)
			...
			If AE_ErrorToInteger(Ck_Error) = 0 Or (pm_Status >= Cn_Status7 And PP_SSSMAIN.CheckErrNglct) Then
				...
				Else
					...
					Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(wk_Px), CL_SSSMAIN(wk_Px))
					If Not PP_SSSMAIN.RecalcMode Then
						PP_SSSMAIN.DerivedOrigin = "BD_SOUCD"
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(12 + 36 * PP_SSSMAIN.De).ExVal = CP_SSSMAIN(12 + 36 * PP_SSSMAIN.De).CuVal 'HIKKB
						CP_SSSMAIN(12 + 36 * PP_SSSMAIN.De).ExStatus = CP_SSSMAIN(12 + 36 * PP_SSSMAIN.De).StatusC
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(15 + 36 * PP_SSSMAIN.De).ExVal = CP_SSSMAIN(15 + 36 * PP_SSSMAIN.De).CuVal 'SALPALKB
						CP_SSSMAIN(15 + 36 * PP_SSSMAIN.De).ExStatus = CP_SSSMAIN(15 + 36 * PP_SSSMAIN.De).StatusC
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(14 + 36 * PP_SSSMAIN.De).ExVal = CP_SSSMAIN(14 + 36 * PP_SSSMAIN.De).CuVal 'SISNKB
						CP_SSSMAIN(14 + 36 * PP_SSSMAIN.De).ExStatus = CP_SSSMAIN(14 + 36 * PP_SSSMAIN.De).StatusC
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(11 + 36 * PP_SSSMAIN.De).ExVal = CP_SSSMAIN(11 + 36 * PP_SSSMAIN.De).CuVal 'SOUKB
						CP_SSSMAIN(11 + 36 * PP_SSSMAIN.De).ExStatus = CP_SSSMAIN(11 + 36 * PP_SSSMAIN.De).StatusC
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(7 + 36 * PP_SSSMAIN.De).ExVal = CP_SSSMAIN(7 + 36 * PP_SSSMAIN.De).CuVal 'SOUKOKB
						CP_SSSMAIN(7 + 36 * PP_SSSMAIN.De).ExStatus = CP_SSSMAIN(7 + 36 * PP_SSSMAIN.De).StatusC
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
						CP_SSSMAIN(13 + 36 * PP_SSSMAIN.De).ExVal = CP_SSSMAIN(13 + 36 * PP_SSSMAIN.De).CuVal 'SRSCNKB
						CP_SSSMAIN(13 + 36 * PP_SSSMAIN.De).ExStatus = CP_SSSMAIN(13 + 36 * PP_SSSMAIN.De).StatusC
						If Not wk_Equal Or ex_CheckRtnCode <> 0 Then Call AE_Derived_SSSMAIN_bd_HIKKB(PP_SSSMAIN.De2)
						If Not wk_Equal Or ex_CheckRtnCode <> 0 Then Call AE_Derived_SSSMAIN_bd_SALPALKB(PP_SSSMAIN.De2)
						If Not wk_Equal Or ex_CheckRtnCode <> 0 Then Call AE_Derived_SSSMAIN_bd_SISNKB(PP_SSSMAIN.De2)
						If Not wk_Equal Or ex_CheckRtnCode <> 0 Then Call AE_Derived_SSSMAIN_bd_SOUKB(PP_SSSMAIN.De2)
						If Not wk_Equal Or ex_CheckRtnCode <> 0 Then Call AE_Derived_SSSMAIN_bd_SOUKOKB(PP_SSSMAIN.De2)
						If Not wk_Equal Or ex_CheckRtnCode <> 0 Then Call AE_Derived_SSSMAIN_bd_SRSCNKB(PP_SSSMAIN.De2)
						If PP_SSSMAIN.ErrorC = 0 Or wk_RecalcSw = False Then
							Call AE_Later_SSSMAIN()
							If pm_MoveCursor Then
								If AE_CursorSkip_SSSMAIN() = False And PP_SSSMAIN.CursorDirection = Cn_Direction1 Then Call AE_CursorSub_SSSMAIN(AE_ExecuteX_SSSMAIN())
	...
	Sub AE_Check_SSSMAIN_SOUFX(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUFX_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト SOUFX_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUFX_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_SOUKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUKB_CheckC(CC_NewVal)
			Else
				'UPGRADE_WARNING: オブジェクト SOUKB_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUKB_CheckC(CC_NewVal)
	...
	Sub AE_Check_SSSMAIN_SOUKOKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUKOKB_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2, "")
			Else
				'UPGRADE_WARNING: オブジェクト SOUKOKB_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUKOKB_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2, AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 36 * PP_SSSMAIN.De).ExVal))
			End If
			.CheckRtnCode = AE_ErrorToInteger(Ck_Error)
			wk_SaveMask = PP_SSSMAIN.MaskMode
			PP_SSSMAIN.MaskMode = True
	...
	Sub AE_Check_SSSMAIN_SOUKONM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_SOUNM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		...
		With CP_SSSMAIN(wk_Px)
			...
			If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUNM_CHECK(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト SOUNM_CHECK() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUNM_CHECK(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_SOUTL(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			If PP_SSSMAIN.RecalcMode Then
				...
				Ck_Error = .CheckRtnCode
			ElseIf (.CheckRtnCode <> 0) Then 
				'UPGRADE_WARNING: オブジェクト SOUTL_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUTL_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト SOUTL_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUTL_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_SOUTRICD(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			If (.CheckRtnCode <> 0) Then
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUTRICD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 36 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(14 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト SOUTRICD_Check() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUTRICD_Check(AE_NullCnv2_SSSMAIN(CC_NewVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 36 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(14 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_SOUTRINM(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
	...
	Sub AE_Check_SSSMAIN_SOUZP(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUZP_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
			Else
				'UPGRADE_WARNING: オブジェクト SOUZP_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SOUZP_CheckC(AE_NullCnv2_SSSMAIN(CC_NewVal), PP_SSSMAIN.De2)
	...
	Sub AE_Check_SSSMAIN_SRSCNKB(ByVal CC_NewVal As Object, ByVal pm_Status As Short, ByVal pm_MoveCursor As Boolean, ByVal pm_HandIn As Boolean) 'Generated.
		Dim wk_SaveMask As Boolean
		Dim RC_ErrorC As Short
		Dim wk_RecalcSw As Boolean
		Dim wk_Equal As Boolean
		...
		With CP_SSSMAIN(wk_Px)
			...
			ElseIf (.CheckRtnCode <> 0) Then 
				...
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SRSCNKB_CheckC(CC_NewVal)
			Else
				'UPGRADE_WARNING: オブジェクト SRSCNKB_CheckC() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト Ck_Error の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				Ck_Error = SRSCNKB_CheckC(CC_NewVal)
	...
	Function AE_CompleteCheck_SSSMAIN(ByVal pm_HeadCheck As Boolean) As Short 'Generated.
		...
		Do While Wk_De < PP_SSSMAIN.LastDe And PP_SSSMAIN.InCompletePx = -1
			wk_Px = 2 + 36 * Wk_De
			Call AE_CompleteCheckSub_SSSMAIN(wk_Px, wk_Px + 36, wk_IncompletionC, wk_IncompletionC2)
			Wk_De = Wk_De + 1
		Loop 
	...
	Sub AE_CursorCurrent_SSSMAIN() 'Generated.
		...
		If PP_SSSMAIN.Tx >= 0 And PP_SSSMAIN.Tx < 102 Then
	...
	Function AE_CursorDown_SSSMAIN(ByVal pm_Tx As Short, Optional ByVal pm_Int As Object = Nothing) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx < 102
			If wk_Tx < 1 Or wk_Tx >= 102 Then
				wk_Tx = wk_Tx + 1
			ElseIf wk_Tx = 1 Then 
				If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 1) >= 0 Then
					Do 
						wk_Tx = wk_Tx + 1
						If ((wk_Tx - 2) \ 20) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then Exit Do
						...
						If wk_Tx = PP_SSSMAIN.NrBodyTx - 1 Then
							If PP_SSSMAIN.TopDe < 4 - PP_SSSMAIN.MaxDspC Then
								...
								If PP_SSSMAIN.TopDe = wk_ExTopDe + 1 Then wk_Tx = wk_Tx - 20
							End If
						End If
					Loop Until wk_Tx >= PP_SSSMAIN.NrBodyTx - 1
				End If
				wk_Tx = 102
			ElseIf wk_Tx + 20 < PP_SSSMAIN.NrBodyTx Then 
				wk_Tx = wk_Tx + 20
				If ((wk_Tx - 2) \ 20) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 102
				'     以降は (wk_Tx + 20 >= PP_SSSMAIN.NrBodyTx) の場合
			ElseIf PP_SSSMAIN.TopDe < 4 - PP_SSSMAIN.MaxDspC Then 
				If AE_CursorInOutCheck_SSSMAIN(wk_Tx, 36) >= 0 Then
					wk_Tx = wk_Tx + 20
					If ((wk_Tx - 2) \ 20) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then
						wk_Tx = 102
					Else
						wk_ExTopDe = PP_SSSMAIN.TopDe
						Call AE_Scrl_SSSMAIN(PP_SSSMAIN.TopDe + 1, False)
	...
	Sub AE_CursorMove_SSSMAIN(ByVal pm_Tx As Short) 'Generated.
		...
		If wk_Tx < 0 Or wk_Tx >= 102 Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest) : Exit Sub
	...
	Function AE_CursorNext_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx < 102
			...
			If wk_Tx = PP_SSSMAIN.NrBodyTx Then
				...
				End If
			End If
			If wk_Tx >= 2 And wk_Tx < 102 Then 'AE_BodyN > 0
				If ((wk_Tx - 2) \ 20) + PP_SSSMAIN.TopDe > PP_SSSMAIN.LastDe - wk_DeC Then wk_Tx = 102
			End If
			If wk_Tx < 102 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
	...
	Function AE_CursorNextDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx < 101
			wk_Tx = wk_Tx + 1
			If wk_Tx = PP_SSSMAIN.NrBodyTx Then wk_Tx = 102
			If wk_Tx < 102 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
					Call AE_CursorMove_SSSMAIN(wk_Tx)
	...
	Function AE_CursorPrev_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		Do While wk_Tx >= 0
			If wk_Tx = 102 Then
				wk_Tx = PP_SSSMAIN.NrBodyTx - 20
				wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 20
				...
				If wk_Tx >= 2 Then
					Do 
						...
						End If
						wk_Tx = wk_Tx + 1
						If (wk_Tx - 2) Mod 20 = 0 Then wk_Tx = wk_Tx - 20 - 20
						If wk_Tx < 2 Then
	...
	Function AE_CursorPrevDsp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx >= 0
			If wk_Tx = 102 Then wk_Tx = PP_SSSMAIN.NrBodyTx
			wk_Tx = wk_Tx - 1
			If wk_Tx >= 0 Then
				If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_Tx)).TypeA, wk_Tx) Then
					Call AE_CursorMove_SSSMAIN(wk_Tx)
	...
	Function AE_CursorSkip_SSSMAIN() As Boolean 'Generated.
		...
		Select Case PP_SSSMAIN.CursorDest
			...
			Case Cn_Dest3
				If Not AE_CursorPrev_SSSMAIN(102) Then Call AE_CursorRestSub_SSSMAIN(Cn_CursorToRest)
			Case Cn_Dest4
			...
			Case Else
				Select Case PP_SSSMAIN.CursorDirection
					...
					Case Cn_Direction2
						...
						If PP_SSSMAIN.CursorDest = Cn_Dest1 And wk_Bool = False Then wk_Bool = AE_CursorPrev_SSSMAIN(102)
						PP_SSSMAIN.CursorDirection = wk_CursorDirection
					Case Cn_Direction3
	...
	Sub AE_CursorSub_SSSMAIN(ByVal pm_CurSor As Short) 'Generated.
		...
		If pm_CurSor = Cn_CuInCompletePx Then
			...
			If wk_Tx >= 0 Then
				Call AE_CursorMove_SSSMAIN(wk_Tx)
			ElseIf PP_SSSMAIN.InCompletePx < 182 Then 
	...
	Function AE_CursorUp_SSSMAIN(ByVal pm_Tx As Short) As Boolean 'Generated.
		...
		wk_Tx = pm_Tx
		Do While wk_Tx >= 0
			If wk_Tx < 2 Or wk_Tx > 102 Then
				wk_Tx = wk_Tx - 1
			ElseIf wk_Tx = 102 Then 
				wk_Tx = PP_SSSMAIN.NrBodyTx - 20
				wk_LastTx = 2 + (PP_SSSMAIN.LastDe - wk_DeC - PP_SSSMAIN.TopDe) * 20
				If wk_LastTx < wk_Tx Then wk_Tx = wk_LastTx
				Do While wk_Tx >= 2
				...
				Loop 
				wk_Tx = 1
			ElseIf wk_Tx - 20 >= 2 Then 
				wk_Tx = wk_Tx - 20
			Else 'wk_Tx - 20 < 2 Then
				If PP_SSSMAIN.TopDe > 0 Then
					Call AE_Scrl_SSSMAIN(PP_SSSMAIN.TopDe - 1, False)
				Else
					wk_Tx = 1
	...
	Sub AE_DeRestore_SSSMAIN(ByVal pm_De As Short) 'Generated.
		...
		''2007/12/26 add-end T.KAWAMUKAI
		bolRet = SOUMT51_MF_SaveRestore_UWRTDTTM(pm_De, 1) '復元
		' === 20080901 === UPDATE E - RISE)Izumi
		Do While wk_ww < 36
			If wk_ww + 1 = 36 Then PP_SSSMAIN.SuppressMultiTlDerived = False
			'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
			If CP_SSSMAIN(183 + wk_ww).StatusC <> Cn_Status8 Or IsDbNull(CP_SSSMAIN(183 + wk_ww).CuVal) Then
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).TpStr = CP_SSSMAIN(183 + wk_ww).TpStr
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).CuVal = CP_SSSMAIN(183 + wk_ww).CuVal
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).ExVal = CP_SSSMAIN(183 + wk_ww).ExVal
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).FractionC = CP_SSSMAIN(183 + wk_ww).FractionC
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).StatusC = CP_SSSMAIN(183 + wk_ww).StatusC
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).StatusF = CP_SSSMAIN(183 + wk_ww).StatusF
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).ExStatus = CP_SSSMAIN(183 + wk_ww).ExStatus
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).InOutMode = CP_SSSMAIN(183 + wk_ww).InOutMode
                ...
                If wk_Tx >= 0 Then DirectCast(AE_Controls(PP_SSSMAIN.CtB + wk_Tx), TextBox).SelectedText = AE_Tpstr(CP_SSSMAIN(183 + wk_ww).TpStr, CP_SSSMAIN(183 + wk_ww).TypeA)
                '20190819 CHG END
			...
			Else
				CP_SSSMAIN(wk_PxBaseTarget + wk_ww).InOutMode = CP_SSSMAIN(183 + wk_ww).InOutMode
				Call AE_InitValBdDe_SSSMAIN(wk_PxBaseTarget + wk_ww, False, CP_SSSMAIN(183 + wk_ww).StatusF) ', PP_SSSMAIN.De
			End If
			wk_ww = wk_ww + 1
		Loop 
		PP_SSSMAIN.SuppressMultiTlDerived = False
	...
	Sub AE_Derived_SSSMAIN_bd_HIKKB(ByVal De_Index As Short) 'Generated.
		...
		If PP_SSSMAIN.DerivedOrigin <> "" Then
			...
			'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			CC_NewVal = HIKKB_DerivedC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(12 + 36 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
            ...
            If IsDBNull(CC_NewVal) = False AndAlso IsDBNull(CP_SSSMAIN(wk_Px).CuVal) = False AndAlso CC_NewVal = CP_SSSMAIN(wk_Px).CuVal And CP_SSSMAIN(wk_Px).StatusC >= Cn_Status6 Then
                '20190820 CHG END
                Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(wk_Px), CL_SSSMAIN(wk_Px))
                'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
    ...
    Sub AE_Derived_SSSMAIN_bd_SALPALKB(ByVal De_Index As Short) 'Generated.
        Dim CC_NewVal As Object
        Dim wk_SaveMask As Boolean
        Dim wk_Px As Short
        wk_Px = 15 + 36 * PP_SSSMAIN.De
        If PP_SSSMAIN.DerivedOrigin <> "" Then
            ...
            'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            CC_NewVal = SALPALKB_DerivedC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(15 + 36 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
            'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
            If IsNothing(CC_NewVal) Then Exit Sub
            CP_SSSMAIN(wk_Px).CheckRtnCode = 0
            'UPGRADE_WARNING: オブジェクト AE_NormData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    Sub AE_Derived_SSSMAIN_bd_SISNKB(ByVal De_Index As Short) 'Generated.
        Dim CC_NewVal As Object
        Dim wk_SaveMask As Boolean
        Dim wk_Px As Short
        wk_Px = 14 + 36 * PP_SSSMAIN.De
        If PP_SSSMAIN.DerivedOrigin <> "" Then
            ...
            'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            CC_NewVal = SISNKB_DerivedC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(14 + 36 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
            'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
            If IsNothing(CC_NewVal) Then Exit Sub
            CP_SSSMAIN(wk_Px).CheckRtnCode = 0
            'UPGRADE_WARNING: オブジェクト AE_NormData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    Sub AE_Derived_SSSMAIN_bd_SOUKB(ByVal De_Index As Short) 'Generated.
        Dim CC_NewVal As Object
        Dim wk_SaveMask As Boolean
        Dim wk_Px As Short
        wk_Px = 11 + 36 * PP_SSSMAIN.De
        If PP_SSSMAIN.DerivedOrigin <> "" Then
            ...
            'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            CC_NewVal = SOUKB_DerivedC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(11 + 36 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
            'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
            If IsNothing(CC_NewVal) Then Exit Sub
            CP_SSSMAIN(wk_Px).CheckRtnCode = 0
            'UPGRADE_WARNING: オブジェクト AE_NormData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    Sub AE_Derived_SSSMAIN_bd_SOUKOKB(ByVal De_Index As Object) 'Generated.
        Dim CC_NewVal As Object
        Dim wk_SaveMask As Boolean
        Dim wk_Px As Short
        wk_Px = 7 + 36 * PP_SSSMAIN.De
        If PP_SSSMAIN.DerivedOrigin <> "" Then
            ...
            'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            CC_NewVal = SOUKOKB_DerivedC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(7 + 36 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
            'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
            If IsNothing(CC_NewVal) Then Exit Sub
            CP_SSSMAIN(wk_Px).CheckRtnCode = 0
            'UPGRADE_WARNING: オブジェクト AE_NormData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    Sub AE_Derived_SSSMAIN_bd_SRSCNKB(ByVal De_Index As Short) 'Generated.
        Dim CC_NewVal As Object
        Dim wk_SaveMask As Boolean
        Dim wk_Px As Short
        wk_Px = 13 + 36 * PP_SSSMAIN.De
        If PP_SSSMAIN.DerivedOrigin <> "" Then
            ...
            'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            CC_NewVal = SRSCNKB_DerivedC(AE_NullCnv2_SSSMAIN(CP_SSSMAIN(13 + 36 * PP_SSSMAIN.De).CuVal), AE_NullCnv2_SSSMAIN(CP_SSSMAIN(3 + 36 * PP_SSSMAIN.De).CuVal), PP_SSSMAIN.De2)
            'UPGRADE_WARNING: IsEmpty は、IsNothing にアップグレードされ、新しい動作が指定されました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"' をクリックしてください。
            If IsNothing(CC_NewVal) Then Exit Sub
            CP_SSSMAIN(wk_Px).CheckRtnCode = 0
            'UPGRADE_WARNING: オブジェクト AE_NormData() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
    ...
    Sub AE_DeSave_SSSMAIN(ByVal pm_De As Short) 'Generated.
        ...
        '      bolRet = SOUMT51_MF_SaveRestore_UWRTDTTM(pm_De, 1)      '復元
        bolRet = SOUMT51_MF_SaveRestore_UWRTDTTM(pm_De, 0) '退避
        '20080926 CHG END   RISE)Tanimura
        ' === 20080901 === UPDATE E - RISE)Izumi
        Do While wk_ww < 36
            CP_SSSMAIN(183 + wk_ww).TpStr = CP_SSSMAIN(wk_PxBaseSource + wk_ww).TpStr
            CP_SSSMAIN(183 + wk_ww).CheckRtnCode = CP_SSSMAIN(wk_PxBaseSource + wk_ww).CheckRtnCode
            CP_SSSMAIN(183 + wk_ww).Modified = CP_SSSMAIN(wk_PxBaseSource + wk_ww).Modified
            'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            CP_SSSMAIN(183 + wk_ww).CuVal = CP_SSSMAIN(wk_PxBaseSource + wk_ww).CuVal
            'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().ExVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            CP_SSSMAIN(183 + wk_ww).ExVal = CP_SSSMAIN(wk_PxBaseSource + wk_ww).ExVal
            CP_SSSMAIN(183 + wk_ww).FractionC = CP_SSSMAIN(wk_PxBaseSource + wk_ww).FractionC
            CP_SSSMAIN(183 + wk_ww).StatusC = CP_SSSMAIN(wk_PxBaseSource + wk_ww).StatusC
            CP_SSSMAIN(183 + wk_ww).StatusF = CP_SSSMAIN(wk_PxBaseSource + wk_ww).StatusF
            CP_SSSMAIN(183 + wk_ww).ExStatus = CP_SSSMAIN(wk_PxBaseSource + wk_ww).ExStatus
            CP_SSSMAIN(183 + wk_ww).InOutMode = CP_SSSMAIN(wk_PxBaseSource + wk_ww).InOutMode
            CP_SSSMAIN(183 + wk_ww).TypeA = CP_SSSMAIN(wk_PxBaseSource + wk_ww).TypeA
            wk_ww = wk_ww + 1
        Loop
    End Sub
    ...
    Sub AE_DeSub_SSSMAIN(ByVal pm_UD As Short) 'Generated.
        ...
        '2007/12/26 add-end T.KAWAMUKAI
        wk_SaveDe = PP_SSSMAIN.De : wk_SaveDe2 = PP_SSSMAIN.De2
        wk_PxBaseTarget = 2 + 36 * PP_SSSMAIN.De
        wk_PxBaseSource = wk_PxBaseTarget + pm_UD * 36
        wk_ww = 0
        ' === 20080901 === UPDATE S - RISE)Izumi チェック項目の追加
        ''2007/12/26 add-str T.KAWAMUKAI
        '       bolRet = MF_UpDown_UWRTDTTM(PP_SSSMAIN.De, pm_UD)      '明細　削除・挿入
        ''2007/12/26 add-end T.KAWAMUKAI
        bolRet = SOUMT51_MF_UpDown_UWRTDTTM(PP_SSSMAIN.De, pm_UD) '明細　削除・挿入
        ' === 20080901 === UPDATE E - RISE)Izumi
        Do While wk_ww < 36
            'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
            If CP_SSSMAIN(wk_PxBaseSource + wk_ww).StatusC <> Cn_Status8 Or IsDBNull(CP_SSSMAIN(wk_PxBaseSource + wk_ww).CuVal) Then
                ...
                If wk_Tx >= 0 Then DirectCast(AE_Controls(PP_SSSMAIN.CtB + wk_Tx), TextBox).SelectedText = AE_Tpstr(CP_SSSMAIN(wk_PxBaseSource + wk_ww).TpStr, CP_SSSMAIN(wk_PxBaseSource + wk_ww).TypeA)
                '20190819 CHG END
                Call AE_ColorSub(PP_SSSMAIN, CP_SSSMAIN(wk_PxBaseTarget + wk_ww), CL_SSSMAIN(wk_PxBaseTarget + wk_ww))
                If wk_Tx >= 0 Then Call AE_TabStop_SSSMAIN(wk_Tx, wk_Tx, False)
            Else
...
#End If
    ...
    Sub AE_InitValBdDe_SSSMAIN(ByVal pm_Px As Short, ByVal pm_SetInOut As Short, ByVal pm_Status As Short) 'Generated.
        ...
        If pm_Px = -2 Then
            ...
            If wk_Tx >= 0 Then
                Call AE_TabStop_SSSMAIN(wk_Tx, wk_Tx + 19, pm_SetInOut)
            End If
        ElseIf pm_Px >= 0 Then
    ...
    Sub AE_InitValBdDe_SSSMAIN_SOUCD(ByVal pm_Px As Short, ByVal wk_PxBase As Short) 'Generated.
        Dim CC_NewVal As Object
        'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        'UPGRADE_WARNING: オブジェクト CC_NewVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
        CC_NewVal = CP_SSSMAIN(37 + wk_PxBase).CuVal
        PP_SSSMAIN.DerivedOrigin = "BD_SOUCD"
        If pm_Px >= 0 And Not PP_SSSMAIN.SuppressMultiTlDerived Then Call AE_Derived_SSSMAIN_bd_HIKKB(PP_SSSMAIN.De2)
        If pm_Px >= 0 And Not PP_SSSMAIN.SuppressMultiTlDerived Then Call AE_Derived_SSSMAIN_bd_SALPALKB(PP_SSSMAIN.De2)
        If pm_Px >= 0 And Not PP_SSSMAIN.SuppressMultiTlDerived Then Call AE_Derived_SSSMAIN_bd_SISNKB(PP_SSSMAIN.De2)
        If pm_Px >= 0 And Not PP_SSSMAIN.SuppressMultiTlDerived Then Call AE_Derived_SSSMAIN_bd_SOUKB(PP_SSSMAIN.De2)
        If pm_Px >= 0 And Not PP_SSSMAIN.SuppressMultiTlDerived Then Call AE_Derived_SSSMAIN_bd_SOUKOKB(PP_SSSMAIN.De2)
        If pm_Px >= 0 And Not PP_SSSMAIN.SuppressMultiTlDerived Then Call AE_Derived_SSSMAIN_bd_SRSCNKB(PP_SSSMAIN.De2)
    End Sub
    ...
    Sub AE_InOutModeM_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String) 'Generated.
        ...
        wk_Qx = 0
        Do While wk_Qx < 38 And UCase(Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx)) <> wk_UCaseObjA
            wk_Qx = wk_Qx + 1
        Loop
    ...
    Sub AE_InOutModeN_SSSMAIN(ByVal pm_ItemName As String, ByVal pm_Mode As String, Optional ByVal pm_De As Object = Nothing) 'Generated.
        ...
        wk_UCaseObjA = UCase(pm_ItemName)
        wk_Qx = 0
        Do While wk_Qx < 38 And Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx) <> wk_UCaseObjA
            wk_Qx = wk_Qx + 1
        Loop
        If UCase(Mid(CQ_SSSMAIN(wk_Qx), Cn_AfterPrfx)) <> wk_UCaseObjA Then
        ...
        ElseIf wk_Qx < 38 Then
            ...
            If IsNothing(pm_De) Then
                If PP_SSSMAIN.De2 < 0 Or (Not PP_SSSMAIN.RecalcMode And PP_SSSMAIN.Tx >= 102) Then Exit Sub
                wk_Px = wk_Qx + 36 * PP_SSSMAIN.De
            Else
                'UPGRADE_WARNING: オブジェクト pm_De の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                wk_Px = wk_Qx + 36 * pm_De
            End If
        End If
...
KeyExecute:
        ...
        ElseIf pm_KeyCode = System.Windows.Forms.Keys.Delete And pm_Shift <= 2 Then
            ...
            '20190816 CHG START
            'Ct = pm_TA
            DirectCast(Ct, TextBox).SelectedText = pm_TA
            '20190816 CHG END
            'UPGRADE_WARNING: オブジェクト Ct.SelStart の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
            '20190816 CHG START
            'Ct.SelStart = wk_SS
...
CheckOrSkip:
        ...
        Select Case pm_NewMode
            Case Cn_Mode1
                If PP_SSSMAIN.Mode <> Cn_Mode1 Then
                    ...
                    Call AE_TabStop_SSSMAIN(0, 101, False)
                    AE_CursorRest(PP_SSSMAIN.ScX).TabStop = False
                End If
            Case Cn_Mode2
    ...
    Sub AE_RecalcBdDe_SSSMAIN() 'Generated.
        ...
        If PP_SSSMAIN.LastDe > 0 Then
            ...
            If AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(3 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(3 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUCD(AE_Val2(CP_SSSMAIN(3 + wk_PxBase)), CP_SSSMAIN(3 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(4 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(4 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(4 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUNM(AE_Val2(CP_SSSMAIN(4 + wk_PxBase)), CP_SSSMAIN(4 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(5 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(5 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(5 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUBSCD(AE_Val2(CP_SSSMAIN(5 + wk_PxBase)), CP_SSSMAIN(5 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(6 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(6 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(6 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUBSNM(AE_Val2(CP_SSSMAIN(6 + wk_PxBase)), CP_SSSMAIN(6 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(7 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(7 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(7 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUKOKB(AE_Val2(CP_SSSMAIN(7 + wk_PxBase)), CP_SSSMAIN(7 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(8 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(8 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(8 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUKONM(AE_Val2(CP_SSSMAIN(8 + wk_PxBase)), CP_SSSMAIN(8 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(9 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(9 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(9 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUTRICD(AE_Val2(CP_SSSMAIN(9 + wk_PxBase)), CP_SSSMAIN(9 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(10 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(10 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(10 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUTRINM(AE_Val2(CP_SSSMAIN(10 + wk_PxBase)), CP_SSSMAIN(10 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(11 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(11 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(11 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUKB(AE_Val2(CP_SSSMAIN(11 + wk_PxBase)), CP_SSSMAIN(11 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(12 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(12 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(12 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_HIKKB(AE_Val2(CP_SSSMAIN(12 + wk_PxBase)), CP_SSSMAIN(12 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(13 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(13 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(13 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SRSCNKB(AE_Val2(CP_SSSMAIN(13 + wk_PxBase)), CP_SSSMAIN(13 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(14 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(14 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(14 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SISNKB(AE_Val2(CP_SSSMAIN(14 + wk_PxBase)), CP_SSSMAIN(14 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(15 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(15 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(15 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SALPALKB(AE_Val2(CP_SSSMAIN(15 + wk_PxBase)), CP_SSSMAIN(15 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(16 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(16 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(16 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUZP(AE_Val2(CP_SSSMAIN(16 + wk_PxBase)), CP_SSSMAIN(16 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(17 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(17 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(17 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUADA(AE_Val2(CP_SSSMAIN(17 + wk_PxBase)), CP_SSSMAIN(17 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(18 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(18 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(18 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUADB(AE_Val2(CP_SSSMAIN(18 + wk_PxBase)), CP_SSSMAIN(18 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(19 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(19 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(19 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUADC(AE_Val2(CP_SSSMAIN(19 + wk_PxBase)), CP_SSSMAIN(19 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(20 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(20 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(20 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUTL(AE_Val2(CP_SSSMAIN(20 + wk_PxBase)), CP_SSSMAIN(20 + wk_PxBase).StatusF, False, False)
            End If
            If AE_GetInOutMode(CP_SSSMAIN(21 + wk_PxBase).InOutMode, Cn_Mode1) >= Cn_InOutMode2 Or AE_GetInOutMode(CP_SSSMAIN(21 + wk_PxBase).InOutMode, Cn_Mode4) >= Cn_InOutMode2 Then
                If CP_SSSMAIN(21 + wk_PxBase).StatusC >= Cn_Status2 Then Call AE_Check_SSSMAIN_SOUFX(AE_Val2(CP_SSSMAIN(21 + wk_PxBase)), CP_SSSMAIN(21 + wk_PxBase).StatusF, False, False)
            End If
        End If
    ...
    Sub AE_RecalcBdDeSub_SSSMAIN() 'Generated.
        Call AE_Derived_SSSMAIN_bd_HIKKB(PP_SSSMAIN.De2)
        Call AE_Derived_SSSMAIN_bd_SALPALKB(PP_SSSMAIN.De2)
        Call AE_Derived_SSSMAIN_bd_SISNKB(PP_SSSMAIN.De2)
        Call AE_Derived_SSSMAIN_bd_SOUKB(PP_SSSMAIN.De2)
        Call AE_Derived_SSSMAIN_bd_SOUKOKB(PP_SSSMAIN.De2)
        Call AE_Derived_SSSMAIN_bd_SRSCNKB(PP_SSSMAIN.De2)
    End Sub
    ...
    Sub AE_Scrl_SSSMAIN(ByVal pm_DeNo As Short, ByVal pm_SetFocusOk As Short) 'Generated.
        ...
        Do While Wk_De <= PP_SSSMAIN.MaxDspC
            wk_NewPxBase = 2 + 36 * (Wk_De + PP_SSSMAIN.TopDe) : wk_OutOfDe = False
            If wk_NewPxBase >= PP_SSSMAIN.EBodyPx Then wk_NewPxBase = 2 + 36 * (PP_SSSMAIN.MaxDe) : wk_OutOfDe = True
            wk_ExPxBase = 2 + 36 * (Wk_De + wk_ExTopDe)
            If wk_ExPxBase >= PP_SSSMAIN.EBodyPx Then wk_ExPxBase = 2 + 36 * (PP_SSSMAIN.MaxDe)
            wk_TxBase = 2 + 20 * Wk_De
            wk_ww = 0
            Do While wk_ww < 20
                ...
                ElseIf wk_OutOfDe Then
                    ...
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + wk_TxBase + wk_ww), TextBox).SelectedText = AE_Format(CP_SSSMAIN(wk_NewPxBase + wk_ww), System.DBNull.Value, 0, True)
                    '20190819 CHG END
                Else
                    'UPGRADE_WARNING: オブジェクト AE_Controls(PP_SSSMAIN.CtB + wk_TxBase + wk_ww) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    '20190819 CHG START
                    'AE_Controls(PP_SSSMAIN.CtB + wk_TxBase + wk_ww) = CP_SSSMAIN(wk_NewPxBase + wk_ww).TpStr
                    DirectCast(AE_Controls(PP_SSSMAIN.CtB + wk_TxBase + wk_ww), TextBox).SelectedText = CP_SSSMAIN(wk_NewPxBase + wk_ww).TpStr
                    '20190819 CHG END
                End If
        ...
        wk_NewTx = wk_ExTx - 20 * (PP_SSSMAIN.TopDe - wk_ExTopDe)
        If wk_ExTx < 0 Then
        ElseIf wk_NewTx < 2 Then
            wk_NewTx = 2 + (wk_ExTx - 2) Mod 20
        ElseIf wk_NewTx >= PP_SSSMAIN.NrBodyTx Then
            wk_NewTx = 2 + 20 * PP_SSSMAIN.MaxDspC + (wk_ExTx - 2) Mod 20
        End If
        Call AE_ScrlMax(PP_SSSMAIN)
        If wk_Displacement > 0 Then
            ...
            ElseIf wk_ExTx >= 0 Then
                ...
                Do While wk_NewTx2 < PP_SSSMAIN.NrBodyTx
                    If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_NewTx2)).TypeA, wk_NewTx2) Then
                        ...
                        Exit Sub
                    End If
                    wk_NewTx2 = wk_NewTx2 + 20
                Loop
                PP_SSSMAIN.CursorDirection = Cn_Direction1
                Do While wk_NewTx < 102
            ...
            wk_NewTx = 2
            PP_SSSMAIN.CursorDirection = Cn_Direction1
            Do While wk_NewTx < 102 And PP_SSSMAIN.TopDe >= 0 And PP_SSSMAIN.TopDe < PP_SSSMAIN.MaxDe
                If AE_CursorCheck_SSSMAIN(CP_SSSMAIN(AE_Px(PP_SSSMAIN, wk_NewTx)).TypeA, wk_NewTx) Then
                    If pm_SetFocusOk Then Call AE_CursorMove_SSSMAIN(wk_NewTx)
                    Exit Sub
                End If
        ...
        ElseIf PP_SSSMAIN.Tx < 102 Then
            ...
            Select Case PP_SSSMAIN.Px
                ...
                Case 4 + wk_PxBase
                    ...
                    End If
                Case 5 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUBSCD(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 6 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUBSNM(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 7 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUKOKB(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 8 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUKONM(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 9 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUTRICD(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 10 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUTRINM(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 11 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUKB(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 12 + wk_PxBase
                    Call AE_Check_SSSMAIN_HIKKB(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 13 + wk_PxBase
                    Call AE_Check_SSSMAIN_SRSCNKB(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 14 + wk_PxBase
                    Call AE_Check_SSSMAIN_SISNKB(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 15 + wk_PxBase
                    Call AE_Check_SSSMAIN_SALPALKB(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 16 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUZP(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 17 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUADA(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 18 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUADB(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 19 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUADC(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 20 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUTL(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
                Case 21 + wk_PxBase
                    Call AE_Check_SSSMAIN_SOUFX(CC_NewVal, pm_Status, False, pm_HandIn)
                    If AE_ErrorToInteger(Ck_Error) = 0 Then
                    End If
            End Select
        End If
    ...
    Sub AE_Slist_SSSMAIN() 'Generated.
        ...
        ElseIf ((PP_SSSMAIN.Tx - 2) Mod 20 = 1) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 102 Then
            If ((PP_SSSMAIN.Tx - 2) \ 20) <> (PP_SSSMAIN.De - PP_SSSMAIN.TopDe) Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    '20190816 CHG START
                    'Call AE_Check_SSSMAIN_SOUCD(AE_Val3(CP_SSSMAIN(3 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 3 + wk_TxBase).ToString()), Cn_Status6, True, True)
                    Call AE_Check_SSSMAIN_SOUCD(AE_Val3(CP_SSSMAIN(3 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 3 + wk_TxBase).Text), Cn_Status6, True, True)
                    '20190816 CHG END
                End If
            Else
                PP_SSSMAIN.CursorDest = Cn_Dest0
        ...
        ElseIf ((PP_SSSMAIN.Tx - 2) Mod 20 = 3) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 102 Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    ...
                    '20190822 CHG END
                    Call AE_Check_SSSMAIN_SOUBSCD(AE_Val3(CP_SSSMAIN(5 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 5 + wk_TxBase).ToString()), Cn_Status6, True, True)
                End If
            Else
                PP_SSSMAIN.CursorDest = Cn_Dest0
                PP_SSSMAIN.NextTx = PP_SSSMAIN.Tx
        ...
        ElseIf ((PP_SSSMAIN.Tx - 2) Mod 20 = 5) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 102 Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    CP_SSSMAIN(7 + wk_PxBase).TpStr = wk_Slisted
                    CP_SSSMAIN(7 + wk_PxBase).CIn = Cn_ChrInput
                    'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    'UPGRADE_WARNING: オブジェクト AE_Controls(PP_SSSMAIN.CtB + 7 + wk_TxBase) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    AE_Controls(PP_SSSMAIN.CtB + 7 + wk_TxBase) = wk_Slisted
                    '20190816 CHG START
                    'Call AE_Check_SSSMAIN_SOUKOKB(AE_Val3(CP_SSSMAIN(7 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 7 + wk_TxBase).ToString()), Cn_Status6, True, True)
                    Call AE_Check_SSSMAIN_SOUKOKB(AE_Val3(CP_SSSMAIN(7 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 7 + wk_TxBase).Text), Cn_Status6, True, True)
                    '20190816 CHG END
                End If
            Else
                PP_SSSMAIN.CursorDest = Cn_Dest0
        ...
        ElseIf ((PP_SSSMAIN.Tx - 2) Mod 20 = 7) And PP_SSSMAIN.Tx >= 2 And PP_SSSMAIN.Tx < 102 Then
            ...
            If Not IsDBNull(wk_Slisted) Then
                ...
                If PP_SSSMAIN.Mode <> Cn_Mode3 Then
                    'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    CP_SSSMAIN(9 + wk_PxBase).TpStr = wk_Slisted
                    CP_SSSMAIN(9 + wk_PxBase).CIn = Cn_ChrInput
                    'UPGRADE_WARNING: オブジェクト wk_Slisted の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    'UPGRADE_WARNING: オブジェクト AE_Controls(PP_SSSMAIN.CtB + 9 + wk_TxBase) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
                    AE_Controls(PP_SSSMAIN.CtB + 9 + wk_TxBase) = wk_Slisted
                    '20190816 CHG START
                    'Call AE_Check_SSSMAIN_SOUTRICD(AE_Val3(CP_SSSMAIN(9 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 9 + wk_TxBase).ToString()), Cn_Status6, True, True)
                    Call AE_Check_SSSMAIN_SOUTRICD(AE_Val3(CP_SSSMAIN(9 + wk_PxBase), AE_Controls(PP_SSSMAIN.CtB + 9 + wk_TxBase).Text), Cn_Status6, True, True)
                    '20190816 CHG END
                End If
            Else
                PP_SSSMAIN.CursorDest = Cn_Dest0
    ...
    Sub AE_TabStop_SSSMAIN(ByVal pm_FromTx As Short, ByVal pm_ToTx As Short, ByVal pm_SetInOut As Boolean) 'Generated.
        ...
        Do While wk_Tx <= pm_ToTx
            If wk_Tx >= PP_SSSMAIN.NrBodyTx And wk_Tx < 102 Then
            Else
                wk_Px = AE_Px(PP_SSSMAIN, wk_Tx)
                wk_InOutMode = (CP_SSSMAIN(wk_Px).InOutMode \ 256) And &HFFS
    ...
    Sub DP_SSSMAIN_HIKKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(12 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(12 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(12 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SALPALKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(15 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(15 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(15 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SISNKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(14 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(14 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(14 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUADA(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(17 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(17 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(17 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20290820 CHG END
    ...
    Sub DP_SSSMAIN_SOUADB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(18 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(18 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(18 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUADC(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(19 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(19 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(19 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUBSCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(5 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(5 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(5 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUBSNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(6 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(6 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(6 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUCD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(3 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(3 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(3 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUFX(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(21 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(21 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(21 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(11 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(11 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(11 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUKOKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(7 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(7 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(7 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUKONM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(8 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(8 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(8 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(4 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(4 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(4 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUTL(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(20 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(20 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(20 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUTRICD(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(9 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(9 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(9 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUTRINM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(10 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(10 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(10 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SOUZP(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(16 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(16 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(16 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_SRSCNKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(13 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(13 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(13 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_UPDKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(2 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(2 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(2 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_DATKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        ...
        If IsDBNull(CP_SSSMAIN(22 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(22 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(22 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_HIKKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(36 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(36 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(36 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SALPAL(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(37 + wk_PxBase).CuVal) = False AndAlso IsDBNull(CP_SSSMAIN(37 + wk_PxBase).CuVal) = False AndAlso CP_SSSMAIN(37 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(37 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SISNKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(33 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(33 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(33 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUADA(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(25 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(25 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(25 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUADB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(26 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(26 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(26 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUADC(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(27 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(27 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(27 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUBSC(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(30 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(30 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(30 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUFX(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(29 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(29 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(29 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUKB(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(31 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(31 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(31 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUKOK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(35 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(35 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(35 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUNM(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(23 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(23 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(23 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUTL(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(28 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(28 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(28 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUTRI(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(34 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(34 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(34 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SOUZP(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(24 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(24 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(24 + wk_PxBase).StatusC <> Cn_Status8 Then
            '20190820 CHG END
    ...
    Sub DP_SSSMAIN_V_SRSCNK(ByVal pm_De As Short, ByRef DBItem As Object) 'Generated.
        Dim V As Object
        Dim wk_SaveMask As Boolean
        Dim wk_PxBase As Short
        wk_SaveMask = PP_SSSMAIN.MaskMode
        ...
        If IsDBNull(CP_SSSMAIN(32 + wk_PxBase).CuVal) = False AndAlso IsDBNull(V) = False AndAlso CP_SSSMAIN(32 + wk_PxBase).CuVal <> V Or CP_SSSMAIN(32 + wk_PxBase).StatusC <> Cn_Status8 Then
            '2019820 CHG END
	...
	Function RD_SSSMAIN_HIKKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(12 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_HIKKB = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_HIKKB = CStr(CP_SSSMAIN(12 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_HIKKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_HIKKB = CStr(CP_SSSMAIN(12 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SALPALKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(15 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SALPALKB = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_SALPALKB = CStr(CP_SSSMAIN(15 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SALPALKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SALPALKB = CStr(CP_SSSMAIN(15 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SISNKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(14 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SISNKB = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_SISNKB = CStr(CP_SSSMAIN(14 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SISNKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SISNKB = CStr(CP_SSSMAIN(14 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUADA(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(17 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUADA = Space(40)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 40 Then
				...
				RD_SSSMAIN_SOUADA = CStr(CP_SSSMAIN(17 + wk_PxBase).CuVal) & Space(40 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUADA の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUADA = CStr(CP_SSSMAIN(17 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUADB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(18 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUADB = Space(40)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 40 Then
				...
				RD_SSSMAIN_SOUADB = CStr(CP_SSSMAIN(18 + wk_PxBase).CuVal) & Space(40 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUADB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUADB = CStr(CP_SSSMAIN(18 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUADC(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(19 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUADC = Space(40)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 40 Then
				...
				RD_SSSMAIN_SOUADC = CStr(CP_SSSMAIN(19 + wk_PxBase).CuVal) & Space(40 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUADC の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUADC = CStr(CP_SSSMAIN(19 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUBSCD(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(5 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUBSCD = Space(3)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 3 Then
				...
				RD_SSSMAIN_SOUBSCD = CStr(CP_SSSMAIN(5 + wk_PxBase).CuVal) & Space(3 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUBSCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUBSCD = CStr(CP_SSSMAIN(5 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUBSNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(6 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUBSNM = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				'UPGRADE_WARNING: オブジェクト LenWid() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUBSNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUBSNM = CStr(CP_SSSMAIN(6 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUBSNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUBSNM = CStr(CP_SSSMAIN(6 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_SOUCD(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 3 Then
				...
				RD_SSSMAIN_SOUCD = Space(3 - LenWid(st_Work)) & CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal)
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUCD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUCD = CStr(CP_SSSMAIN(3 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUFX(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(21 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUFX = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_SOUFX = CStr(CP_SSSMAIN(21 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUFX の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUFX = CStr(CP_SSSMAIN(21 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(11 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUKB = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_SOUKB = CStr(CP_SSSMAIN(11 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUKB = CStr(CP_SSSMAIN(11 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUKOKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(7 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUKOKB = Space(2)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 2 Then
				...
				RD_SSSMAIN_SOUKOKB = CStr(CP_SSSMAIN(7 + wk_PxBase).CuVal) & Space(2 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUKOKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUKOKB = CStr(CP_SSSMAIN(7 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUKONM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(8 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUKONM = Space(10)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 10 Then
				'UPGRADE_WARNING: オブジェクト LenWid() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUKONM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUKONM = CStr(CP_SSSMAIN(8 + wk_PxBase).CuVal) & Space(10 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUKONM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUKONM = CStr(CP_SSSMAIN(8 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_SOUNM(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_SOUNM = CStr(CP_SSSMAIN(4 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUNM = CStr(CP_SSSMAIN(4 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUTL(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(20 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUTL = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_SOUTL = CStr(CP_SSSMAIN(20 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUTL の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUTL = CStr(CP_SSSMAIN(20 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUTRICD(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(9 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUTRICD = Space(5)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 5 Then
				...
				RD_SSSMAIN_SOUTRICD = CStr(CP_SSSMAIN(9 + wk_PxBase).CuVal) & Space(5 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUTRICD の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUTRICD = CStr(CP_SSSMAIN(9 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUTRINM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(10 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUTRINM = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_SOUTRINM = CStr(CP_SSSMAIN(10 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUTRINM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUTRINM = CStr(CP_SSSMAIN(10 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SOUZP(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(16 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SOUZP = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_SOUZP = CStr(CP_SSSMAIN(16 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SOUZP の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SOUZP = CStr(CP_SSSMAIN(16 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_SRSCNKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(13 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_SRSCNKB = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_SRSCNKB = CStr(CP_SSSMAIN(13 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_SRSCNKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_SRSCNKB = CStr(CP_SSSMAIN(13 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	...
	Function RD_SSSMAIN_V_DATKB(ByVal De As Short) As Object 'Generated.
		...
		Else
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_V_DATKB = CStr(CP_SSSMAIN(22 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_DATKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_DATKB = CStr(CP_SSSMAIN(22 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_HIKKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(36 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_HIKKB = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_V_HIKKB = CStr(CP_SSSMAIN(36 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_HIKKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_HIKKB = CStr(CP_SSSMAIN(36 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SALPAL(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(37 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SALPAL = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			st_Work = CStr(CP_SSSMAIN(37 + wk_PxBase).CuVal)
			'UPGRADE_WARNING: オブジェクト LenWid(st_Work$) の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			If LenWid(st_Work) < 1 Then
				'UPGRADE_WARNING: オブジェクト LenWid() の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				...
				RD_SSSMAIN_V_SALPAL = CStr(CP_SSSMAIN(37 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SALPAL の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SALPAL = CStr(CP_SSSMAIN(37 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SISNKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(33 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SISNKB = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_V_SISNKB = CStr(CP_SSSMAIN(33 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SISNKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SISNKB = CStr(CP_SSSMAIN(33 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUADA(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(25 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUADA = Space(40)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 40 Then
				...
				RD_SSSMAIN_V_SOUADA = CStr(CP_SSSMAIN(25 + wk_PxBase).CuVal) & Space(40 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUADA の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUADA = CStr(CP_SSSMAIN(25 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUADB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(26 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUADB = Space(40)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 40 Then
				...
				RD_SSSMAIN_V_SOUADB = CStr(CP_SSSMAIN(26 + wk_PxBase).CuVal) & Space(40 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUADB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUADB = CStr(CP_SSSMAIN(26 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUADC(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(27 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUADC = Space(40)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 40 Then
				...
				RD_SSSMAIN_V_SOUADC = CStr(CP_SSSMAIN(27 + wk_PxBase).CuVal) & Space(40 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUADC の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUADC = CStr(CP_SSSMAIN(27 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUBSC(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(30 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUBSC = Space(3)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 3 Then
				...
				RD_SSSMAIN_V_SOUBSC = CStr(CP_SSSMAIN(30 + wk_PxBase).CuVal) & Space(3 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUBSC の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUBSC = CStr(CP_SSSMAIN(30 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUFX(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(29 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUFX = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_V_SOUFX = CStr(CP_SSSMAIN(29 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUFX の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUFX = CStr(CP_SSSMAIN(29 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUKB(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(31 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUKB = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_V_SOUKB = CStr(CP_SSSMAIN(31 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUKB の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUKB = CStr(CP_SSSMAIN(31 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUKOK(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(35 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUKOK = Space(2)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 2 Then
				...
				RD_SSSMAIN_V_SOUKOK = CStr(CP_SSSMAIN(35 + wk_PxBase).CuVal) & Space(2 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUKOK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUKOK = CStr(CP_SSSMAIN(35 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUNM(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(23 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUNM = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_V_SOUNM = CStr(CP_SSSMAIN(23 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUNM の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUNM = CStr(CP_SSSMAIN(23 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUTL(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(28 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUTL = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_V_SOUTL = CStr(CP_SSSMAIN(28 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUTL の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUTL = CStr(CP_SSSMAIN(28 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUTRI(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(34 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUTRI = Space(5)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 5 Then
				...
				RD_SSSMAIN_V_SOUTRI = CStr(CP_SSSMAIN(34 + wk_PxBase).CuVal) & Space(5 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUTRI の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUTRI = CStr(CP_SSSMAIN(34 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SOUZP(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(24 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SOUZP = Space(20)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 20 Then
				...
				RD_SSSMAIN_V_SOUZP = CStr(CP_SSSMAIN(24 + wk_PxBase).CuVal) & Space(20 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SOUZP の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SOUZP = CStr(CP_SSSMAIN(24 + wk_PxBase).CuVal)
			End If
		End If
	End Function
	
	Function RD_SSSMAIN_V_SRSCNK(ByVal De As Short) As Object 'Generated.
		Dim st_Work As String
		Dim wk_PxBase As Short
		wk_PxBase = 36 * De
		'UPGRADE_WARNING: Null/IsNull() の使用が見つかりました。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"' をクリックしてください。
		If IsDbNull(CP_SSSMAIN(32 + wk_PxBase).CuVal) Then
			RD_SSSMAIN_V_SRSCNK = Space(1)
		Else
			'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
			...
			If LenWid(st_Work) < 1 Then
				...
				RD_SSSMAIN_V_SRSCNK = CStr(CP_SSSMAIN(32 + wk_PxBase).CuVal) & Space(1 - LenWid(st_Work))
			Else
				'UPGRADE_WARNING: オブジェクト CP_SSSMAIN().CuVal の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				'UPGRADE_WARNING: オブジェクト RD_SSSMAIN_V_SRSCNK の既定プロパティを解決できませんでした。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"' をクリックしてください。
				RD_SSSMAIN_V_SRSCNK = CStr(CP_SSSMAIN(32 + wk_PxBase).CuVal)
			End If
		End If
	End Function

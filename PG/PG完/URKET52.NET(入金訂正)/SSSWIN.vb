...
Module SSSWIN_BAS
    ...
    Private Declare Function sDocumentProperties Lib "winspool.drv" Alias "DocumentPropertiesA" (ByVal hwnd As Integer, ByVal hPrinter As Integer, ByVal pDeviceName As String, ByRef pDevModeOutput As Byte, ByRef pDevModeInput As Byte, ByVal fmode As Integer) As Integer
    'UPGRADE_ISSUE: パラメータ 'As Any' の宣言はサポートされません。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="FAE78A8D-8978-4FD4-8208-5B7324A8F795"' をクリックしてください。
    ...
    Private Declare Function CreateDC Lib "gdi32" Alias "CreateDCA" (ByVal lpDriverName As String, ByVal lpDeviceName As String, ByVal lpOutput As String, ByRef lpInitData As Byte) As Integer
    '2019/05/22 CHG END
...
ErrDate: 
	...
	Sub SSSWIN_INIT()
        ...
        CType(FR_SSSMAIN.Controls("SYSDT"), Object).Caption = VB6.Format(Now, "YYYY/MM/DD")
